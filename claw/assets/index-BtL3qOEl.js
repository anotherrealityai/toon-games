...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},$d=class extends Vd{constructor(){super(),this.isOutputPass=!0,this.uniforms=Va.clone(Qd.uniforms),this.material=new Ga({name:Qd.name,uniforms:this.uniforms,vertexShader:Qd.vertexShader,fragmentShader:Qd.fragmentShader}),this._fsQuad=new Wd(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},K.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},ef=``+new URL(`neon-claw-v2-CCpG9NBW.glb`,import.meta.url).href;function tf(e=4){let t=new Uint8Array(e);for(let n=0;n<e;n++)t[n]=Math.round(n/(e-1)*255);let n=new di(t,e,1,O);return n.minFilter=i,n.magFilter=i,n.generateMipmaps=!1,n.needsUpdate=!0,n}var nf=tf(4);function rf(e=24){let t=new Uint8Array(e);for(let n=0;n<e;n++)t[n]=Math.round(n/(e-1)*255);let n=new di(t,e,1,O);return n.minFilter=s,n.magFilter=s,n.generateMipmaps=!1,n.needsUpdate=!0,n}rf(24);function af(e,t={}){return new Ja({color:e,gradientMap:nf,...t})}var of=1/120,sf=6,cf=8,lf=.02,uf=.005,df=6,ff=.25,pf=-6.5,mf=.986,hf=.45;function gf(e,t=1){let n=(1+Math.sqrt(5))/2,r=[[-1,n,0],[1,n,0],[-1,-n,0],[1,-n,0],[0,-1,n],[0,1,n],[0,-1,-n],[0,1,-n],[n,0,-1],[n,0,1],[-n,0,-1],[-n,0,1]].map(e=>new W(e[0],e[1],e[2])),i=[[0,11,5],[0,5,1],[0,1,7],[0,7,10],[0,10,11],[1,5,9],[5,11,4],[11,10,2],[10,7,6],[7,1,8],[3,9,4],[3,4,2],[3,2,6],[3,6,8],[3,8,9],[4,9,5],[2,4,11],[6,2,10],[8,6,7],[9,8,1]];for(let e=0;e<t;e++){let e=new Map,t=(t,n)=>{let i=t<n?t+`_`+n:n+`_`+t;if(e.has(i))return e.get(i);let a=r[t].clone().add(r[n]).multiplyScalar(.5),o=r.length;return r.push(a),e.set(i,o),o},n=[];for(let[e,r,a]of i){let i=t(e,r),o=t(r,a),s=t(a,e);n.push([e,i,s],[r,o,i],[a,s,o],[i,o,s])}i=n}return r=r.map(t=>t.normalize().multiplyScalar(e)),{verts:r,faces:i}}var _f=class{constructor(e,t,n=2,r={}){this.scene=e,this.radius=n,this.volumeUnits=r.volumeUnits??n**3,this.particleRadius=r.particleRadius??.22,this.shellStiffness=r.shellStiffness??lf,this.centerStiffness=r.centerStiffness??uf,this.pressureK=r.pressureK??df,this.shellStiffScale=1,this.velDamp=r.velDamp??mf,this.gravityCenter=r.gravityCenter??null,this.gravityStrength=r.gravityStrength??Math.abs(pf),this.gravityFalloffR=r.gravityFalloffR??null,this.gravityFalloffP=r.gravityFalloffP??2,this.waterZone=r.waterZone??null,this.gelColor=r.gelColor??16753592,this.coreColor=r.coreColor??16726883,this.outlineColor=r.outlineColor??3809072,this.gelOpacity=r.gelOpacity??.8,this.externalFace=r.externalFace??!1,this.subdivisions=r.subdivisions??2;let{verts:i,faces:a}=gf(n,this.subdivisions);this.faces=a,this.shellCount=i.length,this.pos=[],this.prev=[],this.ext=[];for(let e of i){let n=e.clone().add(t);this.pos.push(n),this.prev.push(n.clone()),this.ext.push(new W)}this.centerIdx=this.pos.length,this.pos.push(t.clone()),this.prev.push(t.clone()),this.ext.push(new W);let o=new Set;this.springs=[];let s=(e,t,n,r)=>{let i=e<t?e+`_`+t:t+`_`+e;o.has(i)||(o.add(i),this.springs.push({a:e,b:t,rest:this.pos[e].distanceTo(this.pos[t]),stiff:n,shell:r}))};for(let[e,t,n]of a)s(e,t,this.shellStiffness,!0),s(t,n,this.shellStiffness,!0),s(n,e,this.shellStiffness,!0);for(let e=0;e<this.shellCount;e++)s(e,this.centerIdx,this.centerStiffness,!1);this.restVolume=this._volume(),this.com=t.clone(),this.prevCom=t.clone(),this.velocity=new W,this.compression=0,this.grabActive=!1,this.grabParticles=[],this.grabLook=null,this.grabPoint=new W,this.grabStiff=0,this.grabbedMask=null,this.neckSoft=r.neckSoft??.12,this.returnRadius=r.returnRadius??null,this.returnStrength=r.returnStrength??1.5,this._buildMesh(),this._t1=new W,this._t2=new W,this._t3=new W,this._n=new W,this._up=new W(0,1,0),this._right=new W,this._dir=new W,this._acc=0,this._volGrad=[];for(let e=0;e<this.shellCount;e++)this._volGrad.push(new W)}_projectVolume(e){let t=this._volume(),n=this.restVolume-t;if(Math.abs(n)<1e-6*this.restVolume)return;for(let e of this._volGrad)e.set(0,0,0);for(let[e,t,n]of this.faces)this._volGrad[e].addScaledVector(this._t1.crossVectors(this.pos[t],this.pos[n]),1/6),this._volGrad[t].addScaledVector(this._t1.crossVectors(this.pos[n],this.pos[e]),1/6),this._volGrad[n].addScaledVector(this._t1.crossVectors(this.pos[e],this.pos[t]),1/6);let r=1e-9;for(let e of this._volGrad)r+=e.lengthSq();let i=e*n/r;for(let e=0;e<this.shellCount;e++)this.pos[e].addScaledVector(this._volGrad[e],i)}_volume(){let e=0;for(let[t,n,r]of this.faces){let i=this.pos[t],a=this.pos[n],o=this.pos[r];e+=i.x*(a.y*o.z-o.y*a.z)-i.y*(a.x*o.z-o.x*a.z)+i.z*(a.x*o.y-o.x*a.y)}return e/6}_buildMesh(){this.group=new wn;let e=new Na(this.radius,26,18);e.deleteAttribute(`uv`),e.deleteAttribute(`normal`),this.geo=Fu(e);let t=af(this.gelColor,{transparent:!0,opacity:this.gelOpacity,depthWrite:!1});this.mesh=new Y(this.geo,t),this.mesh.castShadow=!0,this.mesh.renderOrder=2,this.group.add(this.mesh);let n=new Br({color:this.outlineColor,side:1});if(this.outline=new Y(this.geo,n),this.outline.scale.setScalar(1.04),this.outline.renderOrder=0,this.group.add(this.outline),this.core=new Y(new Na(this.radius*.46,16,12),af(this.coreColor)),this.core.renderOrder=1,this.group.add(this.core),this.eyeWhites=[],this.eyePupils=[],!this.externalFace){let e=new Ja({color:16777215}),t=new Br({color:1710638});for(let n of[-1,1]){let r=new Y(new Na(.34,14,12),e),i=new Y(new Na(.17,12,10),t);r.userData.side=n,r.renderOrder=3,i.renderOrder=4,this.eyeWhites.push(r),this.eyePupils.push(i),this.group.add(r,i)}}this.front=new W(0,0,1),this.scene.add(this.group),this._bindMesh()}_bindMesh(){let e=this.geo.attributes.position,t=e.count;this.binds=Array(t);let n=new W;for(let r=0;r<t;r++){n.fromBufferAttribute(e,r).add(this.com);let t=[];for(let e=0;e<this.shellCount;e++)t.push({j:e,d:n.distanceTo(this.pos[e])});t.sort((e,t)=>e.d-t.d);let i=t.slice(0,6),a=this.radius*.12,o=0;for(let e of i)e.w=1/(e.d*e.d+a*a*4),o+=e.w;for(let e of i)e.w/=o;this.binds[r]=i}}clearForces(){for(let e of this.ext)e.set(0,0,0)}addWind(e){for(let t=0;t<this.shellCount;t++)this.ext[t].add(e)}addPointerPull(e,t,n){let r=this._t1;for(let i=0;i<this.shellCount;i++){r.copy(e).sub(this.pos[i]);let a=r.length();if(a>t)continue;let o=1-a/t;r.multiplyScalar(n*o/(a+.001));let s=n;r.length()>s&&r.setLength(s),this.ext[i].add(r)}}beginGrab(e,t=5){let n=[];for(let t=0;t<this.shellCount;t++)n.push({i:t,d:e.distanceToSquared(this.pos[t])});n.sort((e,t)=>e.d-t.d),this.grabParticles=n.slice(0,t).map(e=>e.i),this.grabActive=!0,this.grabbedMask?this.grabbedMask.fill(0):this.grabbedMask=new Uint8Array(this.pos.length);for(let e of this.grabParticles)this.grabbedMask[e]=1}pullGrab(e,t=9){if(!this.grabActive)return;let n=this._t1,r=t*1.25;for(let i of this.grabParticles){n.copy(e).sub(this.pos[i]);let a=n.length(),o=t*Math.min(a,1.2);n.multiplyScalar(o/(a+.001)),n.length()>r&&n.setLength(r),this.ext[i].add(n)}this.grabLook=e}setGrabTarget(e,t=.5){this.grabPoint.copy(e),this.grabStiff=t,this.grabLook=e}endGrab(){this.grabActive=!1,this.grabStiff=0,this.grabLook=null,this.grabbedMask&&this.grabbedMask.fill(0)}addVelocity(e){for(let t=0;t<=this.centerIdx;t++)this.prev[t].addScaledVector(e,-.008333333333333333)}stretchAlong(e,t){let n=Math.hypot(e.x,e.y,e.z)||1,r=e.x/n,i=e.y/n,a=e.z/n,o=this.shellCount,s=0;for(let e=0;e<o;e++){let t=this.pos[e];s+=(t.x-this.com.x)*r+(t.y-this.com.y)*i+(t.z-this.com.z)*a}s/=o;for(let e=0;e<o;e++){let n=this.pos[e],o=t*((n.x-this.com.x)*r+(n.y-this.com.y)*i+(n.z-this.com.z)*a-s)*of;this.prev[e].x-=r*o,this.prev[e].y-=i*o,this.prev[e].z-=a*o}}hop(e){for(let t=0;t<=this.centerIdx;t++)this.prev[t].y-=e*(.6+Math.random()*.4)*of}_step(e){let t=this._volume(),n=this.pressureK*(this.restVolume-t)/this.restVolume;if(n!==0)for(let[e,t,r]of this.faces){let i=this.pos[e],a=this.pos[t],o=this.pos[r];this._t1.subVectors(a,i),this._t2.subVectors(o,i),this._n.crossVectors(this._t1,this._t2),this._n.multiplyScalar(n/6),this.ext[e].add(this._n),this.ext[t].add(this._n),this.ext[r].add(this._n)}let r=this.gravityCenter,i=this.gravityStrength,a=this.waterZone,o=a?a.center:null,s=a?a.drag/of:0;for(let e=0;e<=this.centerIdx;e++){let t=this.pos[e],n=this.prev[e],c=(t.x-n.x)*this.velDamp,l=(t.y-n.y)*this.velDamp,u=(t.z-n.z)*this.velDamp;n.copy(t);let d=this.ext[e].x,f=this.ext[e].y,p=this.ext[e].z;if(r){let e=r.x-t.x,n=r.y-t.y,a=r.z-t.z,o=Math.sqrt(e*e+n*n+a*a)||1e-6,s=this.gravityFalloffR,c=s!==null&&o>s?i*(s/o)**+this.gravityFalloffP/o:i/o;this.returnRadius&&o>this.returnRadius&&(c+=this.returnStrength*(o-this.returnRadius)/o),d+=e*c,f+=n*c,p+=a*c}else f+=pf;if(a){let e=t.x-o.x,n=t.y-o.y,r=t.z-o.z,i=Math.sqrt(e*e+n*n+r*r)||1e-6;if(i<a.level&&(e*a.dir.x+n*a.dir.y+r*a.dir.z)/i>a.cosAng){let t=Math.min(a.level-i,a.maxDepth),o=a.buoyancy*t/(a.maxDepth*i);d+=e*o,f+=n*o,p+=r*o,d-=c*s,f-=l*s,p-=u*s}}let m=c+d*of*of,h=l+f*of*of,g=u+p*of*of,_=m*m+h*h+g*g;if(_>hf*hf){let e=hf/Math.sqrt(_);m*=e,h*=e,g*=e}t.x+=m,t.y+=h,t.z+=g}for(let t=0;t<cf;t++){if(this.grabActive&&this.grabStiff>0){let e=this.grabPoint,t=this.grabStiff;for(let n of this.grabParticles){let r=this.pos[n];r.x+=(e.x-r.x)*t,r.y+=(e.y-r.y)*t,r.z+=(e.z-r.z)*t}}let n=this.grabActive?this.grabbedMask:null;for(let e of this.springs){let t=this.pos[e.a],r=this.pos[e.b],i=r.x-t.x,a=r.y-t.y,o=r.z-t.z,s=Math.sqrt(i*i+a*a+o*o)||1e-6,c=n&&(n[e.a]||n[e.b])?this.neckSoft:1,l=(s-e.rest)/s*.5*e.stiff*this.shellStiffScale*c,u=i*l,d=a*l,f=o*l;t.x+=u,t.y+=d,t.z+=f,r.x-=u,r.y-=d,r.z-=f}if(this._projectVolume(ff),e){let n=t===cf-1;for(let t=0;t<=this.centerIdx;t++)e.resolveParticle(this.pos[t],this.prev[t],this.particleRadius,n)}}}update(e,t){this._acc+=Math.min(e,.05);let n=0;for(;this._acc>=of&&n<sf;)this._step(t),this._acc-=of,n++;this.prevCom.copy(this.com),this.com.set(0,0,0);for(let e=0;e<this.shellCount;e++)this.com.add(this.pos[e]);this.com.multiplyScalar(1/this.shellCount),e>0&&this.velocity.copy(this.com).sub(this.prevCom).multiplyScalar(1/e);let r=this._volume();this.compression=(this.restVolume-r)/this.restVolume,this._syncMesh()}_syncMesh(){let e=this.geo.attributes.position,t=this._t1;for(let n=0;n<e.count;n++){t.set(0,0,0);for(let e of this.binds[n])t.addScaledVector(this.pos[e.j],e.w);e.setXYZ(n,t.x-this.com.x,t.y-this.com.y,t.z-this.com.z)}e.needsUpdate=!0,this.geo.computeVertexNormals(),this.group.position.copy(this.com),this._t2.copy(this.pos[this.centerIdx]).sub(this.com),this.core.position.copy(this._t2),this.externalFace||this._updateEyes()}surfaceAlong(e,t,n){let r=Math.hypot(e.x,e.y,e.z)||1,i=e.x/r,a=e.y/r,o=e.z/r,s=0,c=-2;for(let e=0;e<this.shellCount;e++){let t=this.pos[e].x-this.com.x,n=this.pos[e].y-this.com.y,r=this.pos[e].z-this.com.z,l=Math.hypot(t,n,r)||1,u=(t*i+n*a+r*o)/l;u>c&&(c=u,s=e)}return n.set(this.pos[s].x-this.com.x+i*t,this.pos[s].y-this.com.y+a*t,this.pos[s].z-this.com.z+o*t),n}_updateEyes(){let e=this._t3.copy(this.velocity);if(e.y=0,e.lengthSq()>.05&&(e.normalize(),this.front.lerp(e,.12).normalize()),this.grabLook){let e=this._t3.copy(this.grabLook).sub(this.com);e.y=0,e.lengthSq()>.02&&(e.normalize(),this.front.lerp(e,.3).normalize())}let t=this._right.crossVectors(this._up,this.front).normalize();for(let e=0;e<2;e++){let n=this.eyeWhites[e].userData.side,r=this._dir.copy(this.front).addScaledVector(t,.42*n).addScaledVector(this._up,.34).normalize(),i=0,a=-2;for(let e=0;e<this.shellCount;e++){let t=this.pos[e].x-this.com.x,n=this.pos[e].y-this.com.y,o=this.pos[e].z-this.com.z,s=Math.hypot(t,n,o)||1,c=(t*r.x+n*r.y+o*r.z)/s;c>a&&(a=c,i=e)}let o=this._t2.copy(this.pos[i]).sub(this.com).addScaledVector(r,.16);this.eyeWhites[e].position.copy(o),this.eyePupils[e].position.copy(o).addScaledVector(r,.26)}}dispose(){this.scene.remove(this.group),this.geo.dispose()}},vf=Object.freeze({minX:-1.1,maxX:1.1,minZ:-.8,maxZ:.8,floorY:1.65,topY:3.8}),yf=Object.freeze({minX:.5,maxX:1.1,minZ:.2,maxZ:.8,bayFloorY:.25,sensorTop:.62,sensorBottom:.34,rampMinX:.34,rampMaxX:.5}),bf=1/120,xf=13,Sf=12,Cf=-6.5,wf=1e-8;function Tf(e,t,n){return Math.max(t,Math.min(n,e))}function Ef(e,t=0){return e.x>=yf.minX+t&&e.x<=yf.maxX-t&&e.z>=yf.minZ+t&&e.z<=yf.maxZ-t}function Df(e,t,n,r){let i=n.x-t.x,a=n.y-t.y,o=n.z-t.z,s=e.x-t.x,c=e.y-t.y,l=e.z-t.z,u=i*i+a*a+o*o||wf,d=Tf((s*i+c*a+l*o)/u,0,1);return r.set(t.x+i*d,t.y+a*d,t.z+o*d)}var Of=class{constructor(e){this.owner=e,this.activeBlob=null,this.friction=.18,this._closest=new W,this._normal=new W}resolveParticle(e,t,n,r){let i=e.x,a=e.y,o=e.z;e.x=Tf(e.x,vf.minX+n,vf.maxX-n),e.z=Tf(e.z,vf.minZ+n,vf.maxZ-n);let s=vf.floorY+n;if(e.z>=yf.minZ&&e.x>=yf.rampMinX&&e.x<yf.minX){let t=(e.x-yf.rampMinX)/(yf.minX-yf.rampMinX);s-=.13*Tf(t,0,1)}Ef(e,n*.2)&&(s=yf.bayFloorY+n),e.y<s&&(e.y=s);for(let t of this.owner.blobs){if(t===this.activeBlob||t.collected)continue;let r=e.x-t.body.com.x,i=e.y-t.body.com.y,a=e.z-t.body.com.z,o=t.radius*.78+n,s=r*r+i*i+a*a;if(s>=o*o)continue;let c=Math.sqrt(s)||1,l=(o-c)/c;e.x+=r*l,e.y+=i*l,e.z+=a*l}for(let t of this.owner.claw.colliders){let r=Df(e,t.a,t.b,this._closest);this._normal.copy(e).sub(r);let i=this._normal.length(),a=t.radius+n;if(i>=a)continue;i<wf&&(this._normal.copy(e).sub(this.owner.claw.head),this._normal.y-=.15,this._normal.lengthSq()<wf&&this._normal.set(1,0,0),i=this._normal.length());let o=a-i;this._normal.multiplyScalar(1/i),e.addScaledVector(this._normal,o),this.owner.claw.head.addScaledVector(this._normal,-o*.018),this.activeBlob&&(this.activeBlob.contacts++,this.owner.claw.contactIds.add(this.activeBlob.id))}r&&(e.x!==i||e.y!==a||e.z!==o)&&(t.x+=(e.x-t.x)*this.friction,t.z+=(e.z-t.z)*this.friction)}};function kf(e,t){let n=[],r=[];for(let i=0;i<xf;i++){let a=e.clone();a.y-=t*i/(xf-1),n.push(a),r.push(a.clone())}return{pos:n,prev:r,length:t,targetLength:t}}function Af(e){return{subdivisions:e.subdivisions??1,particleRadius:e.particleRadius??.025,shellStiffness:e.shellStiffness??.02,centerStiffness:e.centerStiffness??.005,pressureK:e.pressureK??6,velDamp:e.velDamp??.982,gelColor:e.gelColor??7467727,coreColor:e.coreColor??2473888,outlineColor:e.outlineColor??2364210,gelOpacity:e.gelOpacity??.86,externalFace:e.externalFace??!0}}var jf=class{constructor({scene:e=null,blobs:t=[],goal:n=t.length,idleMotion:r=!0}={}){this.renderSync=e!==null,this.scene=e??new Mn,this.goal=n,this.events=[],this.time=0,this._accumulator=0,this._released=!1,this._hadClosedGrip=!1,this._initial=t.map(e=>({...e})),this.idleMotion=r,this.world=new Of(this);let i=new W(0,vf.topY,.05),a=kf(i,.46);this.carriage={position:i.clone(),target:i.clone(),speed:.4},this.rope=a,this.claw={head:a.pos[a.pos.length-1],previousHead:a.prev[a.prev.length-1],grip:0,targetGrip:0,colliders:[],contactIds:new Set},this.blobs=this._initial.map((e,t)=>this._makeBlob(e,t)),this._updateClawColliders()}_makeBlob(e,t){let n=e.radius??.19,r=new W(e.x??-.72+t%5*.34,e.y??vf.floorY+n+.08,e.z??-.35+Math.floor(t/5)*.32),i=new _f(this.scene,r,n,Af(e)),a=i._syncMesh.bind(i);return i._syncMesh=()=>{},{id:e.id??`blob-${t+1}`,radius:n,body:i,collected:!1,collectedAt:null,liftQualified:!1,contacts:0,phase:t*1.713,renderSync:a,idleForce:new W}}setCarriageTarget(e,t){this.carriage.target.x=Tf(e,vf.minX+.16,vf.maxX-.16),this.carriage.target.z=Tf(t,vf.minZ+.16,vf.maxZ-.16)}setWinchTarget(e){this.rope.targetLength=Tf(e,.35,1.82)}setGripTarget(e){this.claw.targetGrip=Tf(e,0,1),e>.7?(this._hadClosedGrip=!0,this._released=!1):e<.2&&this._hadClosedGrip&&(this._released=!0)}release(){this.setGripTarget(0)}_stepRope(){let e=this.carriage,t=e.target.x-e.position.x,n=e.target.z-e.position.z,r=Math.hypot(t,n);if(r>wf){let i=Math.min(r,e.speed*bf);e.position.x+=t/r*i,e.position.z+=n/r*i}this.rope.length+=Tf(this.rope.targetLength-this.rope.length,-.72*bf,.72*bf),this.claw.grip+=Tf(this.claw.targetGrip-this.claw.grip,-3.6*bf,3.6*bf);let i=this.rope.pos,a=this.rope.prev;i[0].copy(e.position),a[0].copy(e.position);for(let e=1;e<i.length;e++){let t=i[e],n=a[e],r=(t.x-n.x)*.994,o=(t.y-n.y)*.994,s=(t.z-n.z)*.994;n.copy(t),t.x+=r,t.y+=o+Cf*bf*bf,t.z+=s}let o=this.rope.length/(i.length-1);for(let t=0;t<Sf;t++){i[0].copy(e.position);for(let e=0;e<i.length-1;e++){let t=i[e],n=i[e+1],r=n.x-t.x,a=n.y-t.y,s=n.z-t.z,c=Math.hypot(r,a,s)||wf,l=(c-o)/c;if(e===0)n.addScaledVector(new W(r,a,s),-l);else{let e=r*l*.5,i=a*l*.5,o=s*l*.5;t.x+=e,t.y+=i,t.z+=o,n.x-=e,n.y-=i,n.z-=o}}let t=this.claw.head;t.x=Tf(t.x,vf.minX+.09,vf.maxX-.09),t.z=Tf(t.z,vf.minZ+.09,vf.maxZ-.09),t.y=Math.max(vf.floorY+.34,t.y)}}_updateClawColliders(){let e=this.claw.head,t=this.claw.grip,n=[];for(let r=0;r<3;r++){let i=r*Math.PI*2/3,a=Math.cos(i),o=Math.sin(i),s=new W(e.x+a*.16,e.y-.06,e.z+o*.16),c=Dt.lerp(.3,.17,t),l=Dt.lerp(.42,.055,t),u=new W(e.x+a*c,e.y-.27,e.z+o*c),d=new W(e.x+a*l,e.y-.59,e.z+o*l);n.push({a:s,b:u,radius:.06,finger:r}),n.push({a:u,b:d,radius:.072,finger:r});let f=Dt.lerp(.47,.075,t),p=new W(e.x+a*f,e.y-.51,e.z+o*f);n.push({a:d,b:p,radius:.078,finger:r})}n.push({a:new W(e.x,e.y-.02,e.z),b:new W(e.x,e.y-.11,e.z),radius:.13,finger:-1}),this.claw.colliders=n}_checkDelivery(){for(let e of this.blobs){if(e.collected||!this._released||!e.liftQualified)continue;let t=e.body.com;Ef(t)&&t.y<=yf.sensorTop&&t.y>=yf.sensorBottom&&(e.collected=!0,e.collectedAt=this.time,this.events.push({type:`collected`,id:e.id,total:this.deliveredCount}))}this.deliveredCount>=this.goal&&!this._completeSent&&(this._completeSent=!0,this.events.push({type:`complete`,total:this.deliveredCount}))}_fixedStep(){this.time+=bf,this.claw.contactIds.clear();for(let e of this.blobs)e.contacts=0;this._stepRope(),this._updateClawColliders();for(let e of this.blobs)if(!(e.collected&&this.time-e.collectedAt>1)){if(this.world.activeBlob=e,e.body.clearForces(),this.idleMotion&&!e.collected&&this.claw.grip<.35&&e.body.com.y<vf.floorY+e.radius+.2&&!Ef(e.body.com)){let t=Math.sin(this.time*2.2+e.phase),n=Math.sin(this.time*1.35+e.phase*.73);e.idleForce.set(n*.11,Math.max(0,t)*.08,-n*.045),e.body.addWind(e.idleForce)}e.body.update(bf,this.world),this.claw.grip>.7&&e.contacts>0&&e.body.com.y>vf.floorY+.45&&(e.liftQualified=!0)}this.world.activeBlob=null,this._checkDelivery()}step(e){this._accumulator+=Math.min(Math.max(e,0),.1);let t=0;for(;this._accumulator>=bf&&t<12;)this._fixedStep(),this._accumulator-=bf,t++;if(this.renderSync)for(let e of this.blobs)e.renderSync();return this.getSnapshot()}get deliveredCount(){return this.blobs.reduce((e,t)=>e+Number(t.collected),0)}drainEvents(){return this.events.splice(0)}getSnapshot(){let e=this.rope.pos.map(e=>({x:e.x,y:e.y,z:e.z}));return{time:this.time,carriage:{x:this.carriage.position.x,y:this.carriage.position.y,z:this.carriage.position.z},head:{x:this.claw.head.x,y:this.claw.head.y,z:this.claw.head.z,radius:.13,up:this.rope.pos.length>1?{x:this.rope.pos.at(-2).x-this.claw.head.x,y:this.rope.pos.at(-2).y-this.claw.head.y,z:this.rope.pos.at(-2).z-this.claw.head.z}:{x:0,y:1,z:0}},rope:{length:this.rope.length,points:e},grip:this.claw.grip,fingers:this.claw.colliders.map(e=>({a:{x:e.a.x,y:e.a.y,z:e.a.z},b:{x:e.b.x,y:e.b.y,z:e.b.z},radius:e.radius,finger:e.finger})),contacts:[...this.claw.contactIds],delivered:this.deliveredCount,blobs:this.blobs.map(e=>({id:e.id,x:e.body.com.x,y:e.body.com.y,z:e.body.com.z,vx:e.body.velocity.x,vy:e.body.velocity.y,vz:e.body.velocity.z,compression:e.body.compression,contacts:e.contacts,deliveryEligible:e.liftQualified,collected:e.collected})),diagnostics:{maxRopeError:this._maxRopeError(),released:this._released}}}_maxRopeError(){let e=this.rope.length/(this.rope.pos.length-1),t=0;for(let n=0;n<this.rope.pos.length-1;n++)t=Math.max(t,Math.abs(this.rope.pos[n].distanceTo(this.rope.pos[n+1])-e));return t}reset(){for(let e of this.blobs)e.body.dispose();return this.events.length=0,this.time=0,this._accumulator=0,this._released=!1,this._hadClosedGrip=!1,this._completeSent=!1,this.carriage.position.set(0,vf.topY,.05),this.carriage.target.copy(this.carriage.position),this.rope=kf(this.carriage.position,.46),this.claw.head=this.rope.pos[this.rope.pos.length-1],this.claw.previousHead=this.rope.prev[this.rope.prev.length-1],this.claw.grip=0,this.claw.targetGrip=0,this.claw.contactIds.clear(),this.blobs=this._initial.map((e,t)=>this._makeBlob(e,t)),this._updateClawColliders(),this.getSnapshot()}dispose(){for(let e of this.blobs)e.body.dispose()}};function Mf(e){return new jf(e)}var Nf={x:0,z:-.1},Pf=class{constructor(e){this.physics=e,this.reset()}reset(){this.physics.reset(),this.phase=`idle`,this.elapsed=0,this.aim={...Nf},this.collected=0,this.beforeAttempt=0,this.events=[],this.physics.setCarriageTarget(this.aim.x,this.aim.z),this.physics.setWinchTarget(.38),this.physics.setGripTarget(0)}move(e,t,n){this.phase===`idle`&&(this.aim.x=Math.max(-.79,Math.min(.79,this.aim.x+e*.38*n)),this.aim.z=Math.max(-.51,Math.min(.51,this.aim.z+t*.38*n)))}drop(){return this.phase===`idle`?(this.phase=`lowering`,this.elapsed=0,this.beforeAttempt=this.collected,this.events.push({type:`phase`,phase:this.phase}),!0):!1}next(e){this.phase=e,this.elapsed=0,this.alignedFor=0,this.events.push({type:`phase`,phase:e})}update(e){if(this.elapsed+=e,this.phase===`idle`&&this.physics.setCarriageTarget(this.aim.x,this.aim.z),this.phase===`lowering`)this.physics.setWinchTarget(1.55),this.elapsed>2.2&&this.next(`closing`);else if(this.phase===`closing`)this.physics.setGripTarget(1),this.elapsed>1&&this.next(`lifting`);else if(this.phase===`lifting`)this.physics.setWinchTarget(.38),this.elapsed>2.3&&this.next(`returning`);else if(this.phase===`returning`){this.physics.setCarriageTarget(.79,.51);let t=this.physics.getSnapshot(),n=Math.hypot(t.carriage.x-.79,t.carriage.z-.51)<.025&&Math.hypot(t.head.x-.79,t.head.z-.51)<.075;this.alignedFor=n?(this.alignedFor??0)+e:0,this.alignedFor>.25&&this.next(`releasing`)}else if(this.phase===`releasing`)this.physics.release(),this.elapsed>3&&this.next(`homing`);else if(this.phase===`homing`){this.physics.setCarriageTarget(Nf.x,Nf.z);let e=this.physics.getSnapshot();if(Math.hypot(e.carriage.x-Nf.x,e.carriage.z-Nf.z)<.025&&this.elapsed>1.8){this.aim={...Nf};let e=this.physics.getSnapshot();this.collected>=e.blobs.length?this.next(`complete`):(this.next(`idle`),this.events.push({type:this.collected>this.beforeAttempt?`ready`:`miss`}))}}this.physics.step(e);for(let e of this.physics.drainEvents())e.type===`collected`&&this.collected++,this.events.push(e);let t=this.events;return this.events=[],t}},Ff=[6671103,7991239,16742836,16761199,12290815];function If(){let e=Array.from({length:15},(e,t)=>({id:`blob-${t}`,x:-.82+t%5*.37+Math.sin(t*2.3)*.055,z:-.5+Math.floor(t/5)*.36+Math.cos(t*1.9)*.035,y:2+t%4*.08,radius:.205+t%3*.012,gelColor:Ff[(t*3+Math.floor(t/5))%5],coreColor:Ff[(t*3+Math.floor(t/5))%5]}));for(let t of e)t.x+t.radius>.48&&t.z+t.radius>.18&&(t.x-=.32,t.y+=.25);return e}var Lf=new W(0,1,0),Rf=new W,zf=new W,Bf=new W,Vf=(e,t)=>Array.isArray(e)?t.fromArray(e):t.set(e.x,e.y,e.z),Hf=class{constructor(e,t){this.scene=e,this.backend=t,this.group=new wn,e.add(this.group),this.ropeMeshes=[],this.fingerMeshes=[],this.chrome=new Ka({color:12635621,metalness:.85,roughness:.24}),this.pad=new Ka({color:16756174,roughness:.4}),this.cord=new Ka({color:2170168,roughness:.65}),this.glow=new Ka({color:5824511,emissive:3723263,emissiveIntensity:2,roughness:.2}),this.head=new wn;let n=new Y(new ia(.13,.15,.18,24),this.chrome);this.head.add(n);let r=new Y(new Pa(.143,.012,8,32),this.glow);r.rotation.x=Math.PI/2,this.head.add(r),this.group.add(this.head),this.carriage=new Y(new ra(.28,.12,.25),this.chrome),this.group.add(this.carriage),this.faces=[],this.makeFloor()}makeFloor(){let e=new Ka({color:3683423,metalness:.25,roughness:.32}),t=(t,n,r,i,a,o,s=e)=>{let c=new Y(new ra(i,a,o),s);return c.position.set(t,n,r),this.group.add(c),c};t(-.38,1.62,0,1.44,.06,1.6),t(.72,1.62,-.3,.76,.06,1);let n=new Er;n.setAttribute(`position`,new mr([.34,1.65,.2,.34,1.65,.8,.5,1.52,.8,.5,1.52,.2],3)),n.setIndex([0,1,2,0,2,3]),n.computeVertexNormals(),this.group.add(new Y(n,e)),t(.5,1.666,.5,.018,.012,.6,this.glow),t(.8,1.666,.2,.6,.012,.018,this.glow),t(1.087,1,.5,.022,1.25,.6),t(.8,1,.795,.6,1.25,.022),t(.8,.22,.5,.6,.06,.6)}clearFaces(){for(let{face:e}of this.faces)e.traverse(e=>{e.geometry?.dispose(),e.material?.dispose()});this.faces=[]}addFaces(){for(let e of this.backend.blobs){let t=e.body;if(!t?.group)continue;t.outline.visible=!1,t.core.visible=!1;let n=t.gelColor??7851263;t.mesh.material.dispose(),t.mesh.material=new qa({color:n,roughness:.19,metalness:0,transmission:.16,thickness:.2,clearcoat:1}),t.mesh.renderOrder=0;let r=new wn;t.group.add(r);let i=new Br({color:1774648});for(let e of[-1,1]){let n=new Y(new Na(t.radius*.1,12,8),i);n.position.set(e*t.radius*.31,t.radius*.1,0),n.scale.set(1,1.3,.55),r.add(n);let a=new Y(new Na(t.radius*.027,8,6),new Br({color:16777215}));a.position.copy(n.position).add(new W(-t.radius*.024,t.radius*.04,t.radius*.045)),r.add(a)}let a=new Aa(new W(-t.radius*.13,-t.radius*.15,0),new W(0,-t.radius*.3,.01),new W(t.radius*.13,-t.radius*.15,0));r.add(new Y(new Fa(a,12,t.radius*.024,6,!1),i)),this.faces.push({body:t,face:r,phase:this.faces.length})}}segment(e,t,n,r){Vf(t,Rf),Vf(n,zf),Bf.subVectors(zf,Rf),e.position.copy(Rf).add(zf).multiplyScalar(.5),e.quaternion.setFromUnitVectors(Lf,Bf.clone().normalize()),e.scale.set(r,Math.max(1e-4,Bf.length()),r)}sync(e){let t=e.rope?.points??e.ropePoints??[];for(let e=0;e<t.length-1;e++){if(!this.ropeMeshes[e]){let e=new Y(new ia(1,1,1,8),this.cord);this.group.add(e),this.ropeMeshes.push(e)}this.segment(this.ropeMeshes[e],t[e],t[e+1],.016)}let n=e.head?.position??e.head;n&&Vf(n,this.head.position),e.head?.up&&this.head.quaternion.setFromUnitVectors(Lf,Vf(e.head.up,Bf).normalize()),e.carriage&&Vf(e.carriage.position??e.carriage,this.carriage.position);let r=e.fingers??e.claw?.fingers??[];for(let e=0;e<r.length;e++){let t=r[e];if(!this.fingerMeshes[e]){let t=new Y(new ia(1,1,1,12),e%2?this.pad:this.chrome);this.group.add(t),this.fingerMeshes.push(t)}this.segment(this.fingerMeshes[e],t.a,t.b,t.radius??.035)}for(let{body:e,face:t,phase:n}of this.faces){let r=new W(0,.22,1).normalize();e.surfaceAlong(r,.013,t.position);let i=Math.sin(performance.now()*5e-4+n*2.7)>.998;t.scale.y=i?.15:1}}},$=e=>document.getElementById(e),Uf=$(`game`),Wf=$(`stage`),Gf=$(`grab`),Kf=$(`status`),qf=new Pu({canvas:Uf,antialias:!0,powerPreference:`high-performance`});qf.setPixelRatio(Math.min(devicePixelRatio,1.5)),qf.toneMapping=4,qf.toneMappingExposure=.95;var Jf=new Mn;Jf.background=new J(723232),Jf.environment=new Vs(qf).fromScene(new Rd,.05).texture,Jf.environmentIntensity=.5;var Yf=new Ho(45,1,.05,40);Yf.position.set(.22,4.2,5.6),Jf.add(new Ao(12245759,1511468,1.1));var Xf=new Yo(15848447,2.4);Xf.position.set(-2,6,5),Jf.add(Xf);for(let[e,t,n,r]of[[3923199,-1,1,12],[16414666,1,-.5,14]]){let i=new Ko(e,r,6);i.position.set(t,3.2,n),Jf.add(i)}var Zf=new Jd(qf);Zf.addPass(new Yd(Jf,Yf)),Zf.addPass(new Zd(new U(800,600),.045,.2,1.8)),Zf.addPass(new $d);var Qf,$f,ep,tp=performance.now(),np=!1,rp,ip=performance.now(),ap=0,op=2.18,sp=new Set,cp=new Map,lp={idle:`Наведи клешню`,lowering:`Опускаем канат`,closing:`Закрываем клешню`,lifting:`Поднимаем`,returning:`Несём к выдаче`,releasing:`Открываем клешню`,homing:`Возвращаемся`,complete:`Все блобы собраны!`},up=Ff;new zu().load(ef,async e=>{try{let t=e.scene;Jf.add(t);let n=[],r=new Set;t.traverse(e=>{e.isMesh&&e.material&&!Array.isArray(e.material)&&!r.has(e.material)&&(r.add(e.material),e.material.emissiveIntensity=Math.min(e.material.emissiveIntensity??0,2.4)),(/^(FloorCreatures|CapturedBlob|PrizeBlob|ClawRig)$/.test(e.name)||/Chamber(Floor|LavenderBed)/.test(e.name.replace(/[\s_]/g,``)))&&n.push(e),e.isMesh&&e.material?.name===`Clear Chamber Glass`&&(e.material.transparent=!0,e.material.opacity=.09,e.material.depthWrite=!1)}),n.forEach(e=>e.removeFromParent()),Qf=await Mf({scene:Jf,blobs:If(),idleMotion:!0}),$f=new Pf(Qf),ep=new Hf(Jf,Qf),ep.addFaces(),$(`loading`).hidden=!0,fp()}catch(e){console.error(e),$(`loading`).textContent=`Не удалось запустить автомат. Обнови страницу.`}},void 0,e=>{console.error(e),$(`loading`).textContent=`Не удалось загрузить автомат. Обнови страницу.`});function dp(){sp.clear(),cp.clear(),document.querySelectorAll(`[data-move]`).forEach(e=>e.classList.remove(`active`))}function fp(){dp(),$(`finish`).hidden=!0,$(`toast`).textContent=``,$(`toast`).classList.remove(`show`),$(`collection`).innerHTML=``;for(let e=0;e<15;e++)$(`collection`).insertAdjacentHTML(`beforeend`,`<div class="slot" style="--c:#${up[e%5].toString(16)}"><i></i><b></b></div>`);$(`score`).textContent=`0 / 15`,Kf.textContent=lp.idle,Gf.disabled=!1}function pp(){$f&&(ep.clearFaces(),$f.reset(),ep.addFaces(),fp())}function mp(){$f?.drop()&&(dp(),Gf.disabled=!0,yp(230,.1))}function hp(e){$(`toast`).textContent=e,$(`toast`).classList.remove(`show`),$(`toast`).offsetWidth,$(`toast`).classList.add(`show`)}function gp(e){for(let t of e){if(t.type===`phase`&&(Kf.textContent=lp[t.phase]??``,Gf.disabled=t.phase!==`idle`,t.phase===`complete`&&($(`finish`).hidden=!1,$(`replay`).focus(),[523,659,784,1047].forEach((e,t)=>yp(e,.2,t*.1)))),t.type===`collected`){$(`score`).textContent=`${$f.collected} / 15`;let e=$(`collection`).children[$f.collected-1];if(e){let n=Qf.blobs.find(e=>e.id===t.id);e.style.setProperty(`--c`,`#${new J(n?.body.gelColor??up[0]).getHexString()}`),e.classList.add(`filled`)}hp(`Блоб в отсеке!`),yp(660,.15),yp(990,.2,.08)}t.type===`miss`&&hp(`Ускользнул! Попробуй ещё`)}}function _p(){let e=Wf.clientWidth,t=Wf.clientHeight;if(Uf.width!==Math.floor(e*qf.getPixelRatio())||Uf.height!==Math.floor(t*qf.getPixelRatio())){qf.setSize(e,t,!1),Zf.setSize(e,t),Yf.aspect=e/t;let n=Yf.position.distanceTo(new W(0,2.45,0)),r=e<700?2.85/Yf.aspect:3.8;Yf.fov=Dt.radToDeg(2*Math.atan(r/(2*n))),Yf.lookAt(0,e<700?2.18:2.2,0),Yf.updateProjectionMatrix()}}function vp(e){requestAnimationFrame(vp),ap++,e-ip>1e3&&(Uf.dataset.fps=(ap*1e3/(e-ip)).toFixed(1),ip=e,ap=0);let t=Math.min((e-tp)/1e3,.05);if(tp=e,$f){let e=[...cp.values()],n=(t,n,r)=>sp.has(t)||sp.has(n)||e.includes(r);$f.move(Number(n(`ArrowRight`,`KeyD`,`right`))-Number(n(`ArrowLeft`,`KeyA`,`left`)),Number(n(`ArrowDown`,`KeyS`,`down`))-Number(n(`ArrowUp`,`KeyW`,`up`)),t),gp($f.update(t));let r=Qf.getSnapshot();ep.sync(r);let i=r.head?.position??r.head;if(i){let e=new W(i.x??i[0],1.67,i.z??i[2]).project(Yf);$(`reticle`).style.setProperty(`--x`,`${(e.x*.5+.5)*100}%`),$(`reticle`).style.setProperty(`--y`,`${(-e.y*.5+.5)*100}%`)}}_p();let n=$f&&[`releasing`,`homing`].includes($f.phase),r=(Wf.clientWidth<700?2.18:2.2)-(n?1.05:0);op=Dt.lerp(op,r,1-Math.exp(-t*3)),Yf.lookAt(0,op,0),Zf.render()}requestAnimationFrame(vp),window.addEventListener(`keydown`,e=>{e.code===`Space`&&e.target.closest?.(`button,input,a`)||([`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`,`Space`].includes(e.code)&&e.preventDefault(),sp.add(e.code),e.code===`Space`&&!e.repeat&&mp())}),window.addEventListener(`keyup`,e=>sp.delete(e.code)),window.addEventListener(`blur`,dp),document.addEventListener(`visibilitychange`,()=>{dp(),tp=performance.now()});for(let e of document.querySelectorAll(`[data-move]`)){let t=0,n=t=>{let n=e.dataset.move;$f?.move(Number(n===`right`)-Number(n===`left`),Number(n===`down`)-Number(n===`up`),t)};e.addEventListener(`pointerdown`,n=>{n.preventDefault(),t=performance.now(),e.setPointerCapture(n.pointerId),cp.set(n.pointerId,e.dataset.move),e.classList.add(`active`)});let r=t=>{cp.delete(t.pointerId),e.classList.remove(`active`)};e.addEventListener(`pointerup`,e=>{let i=(performance.now()-t)/1e3;r(e),i<.12&&n(.12-i)}),e.addEventListener(`pointercancel`,r),e.addEventListener(`lostpointercapture`,r),e.addEventListener(`click`,e=>{e.detail===0&&n(.16)})}Gf.addEventListener(`click`,mp),$(`reset`).addEventListener(`click`,pp),$(`replay`).addEventListener(`click`,pp);function yp(e,t,n=0){if(np)return;rp??=new(window.AudioContext||window.webkitAudioContext),rp.state===`suspended`&&rp.resume();let r=rp.createOscillator(),i=rp.createGain(),a=rp.currentTime+n;r.type=`sine`,r.frequency.value=e,i.gain.setValueAtTime(1e-4,a),i.gain.exponentialRampToValueAtTime(.07,a+.02),i.gain.exponentialRampToValueAtTime(1e-4,a+t),r.connect(i).connect(rp.destination),r.start(a),r.stop(a+t+.03)}$(`sound`).addEventListener(`click`,()=>{np=!np,$(`sound`).textContent=np?`×`:`♫`,$(`sound`).setAttribute(`aria-label`,np?`Включить звук`:`Выключить звук`)});