...
void main() {
	...
	`}var Ys=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new $i(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Xd.BlurDirectionX=new U(1,0),Xd.BlurDirectionY=new U(0,1);var Zd={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Qd=class extends Bd{constructor(){super(),this.isOutputPass=!0,this.uniforms=Ba.clone(Zd.uniforms),this.material=new Wa({name:Zd.name,uniforms:this.uniforms,vertexShader:Zd.vertexShader,fragmentShader:Zd.fragmentShader}),this._fsQuad=new Ud(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},K.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},$d=``+new URL(`neon-claw-v2-CCpG9NBW.glb`,import.meta.url).href,ef=``+new URL(`claw-head-BN3OZ4sh.glb`,import.meta.url).href;function tf(e){let t=new Na(e.radius,48,32);t.deleteAttribute(`uv`),t.deleteAttribute(`normal`);let n=Pu(t);t.dispose();let r=n.attributes.position.array.slice(),i=e.pos.slice(0,e.shellCount).map(t=>t.clone().sub(e.com)),a=new Float32Array(r.length/3*i.length);for(let t=0;t<r.length/3;t++){let n=0;for(let o=0;o<i.length;o++){let s=(r[t*3]*i[o].x+r[t*3+1]*i[o].y+r[t*3+2]*i[o].z)/(e.radius*i[o].length()),c=Math.exp((s-1)*8);a[t*i.length+o]=c,n+=c}for(let e=0;e<i.length;e++)a[t*i.length+e]/=n}e.geo.dispose(),e.geo=n,e.mesh.geometry=n,e.outline.geometry=n;let o=new Float32Array(i.length*3);return()=>{for(let t=0;t<i.length;t++)o[t*3]=e.pos[t].x-e.com.x-i[t].x,o[t*3+1]=e.pos[t].y-e.com.y-i[t].y,o[t*3+2]=e.pos[t].z-e.com.z-i[t].z;let t=n.attributes.position;for(let e=0;e<t.count;e++){let n=r[e*3],s=r[e*3+1],c=r[e*3+2];for(let t=0;t<i.length;t++){let r=a[e*i.length+t];n+=r*o[t*3],s+=r*o[t*3+1],c+=r*o[t*3+2]}t.setXYZ(e,n,s,c)}t.needsUpdate=!0,n.computeVertexNormals(),e.group.position.copy(e.com),e.core.position.copy(e.pos[e.centerIdx]).sub(e.com)}}function nf(e=4){let t=new Uint8Array(e);for(let n=0;n<e;n++)t[n]=Math.round(n/(e-1)*255);let n=new di(t,e,1,O);return n.minFilter=i,n.magFilter=i,n.generateMipmaps=!1,n.needsUpdate=!0,n}var rf=nf(4);function af(e=24){let t=new Uint8Array(e);for(let n=0;n<e;n++)t[n]=Math.round(n/(e-1)*255);let n=new di(t,e,1,O);return n.minFilter=s,n.magFilter=s,n.generateMipmaps=!1,n.needsUpdate=!0,n}af(24);function of(e,t={}){return new qa({color:e,gradientMap:rf,...t})}var sf=1/120,cf=6,lf=8,uf=.02,df=.005,ff=6,pf=.25,mf=-6.5,hf=.986,gf=.45;function _f(e,t=1){let n=(1+Math.sqrt(5))/2,r=[[-1,n,0],[1,n,0],[-1,-n,0],[1,-n,0],[0,-1,n],[0,1,n],[0,-1,-n],[0,1,-n],[n,0,-1],[n,0,1],[-n,0,-1],[-n,0,1]].map(e=>new W(e[0],e[1],e[2])),i=[[0,11,5],[0,5,1],[0,1,7],[0,7,10],[0,10,11],[1,5,9],[5,11,4],[11,10,2],[10,7,6],[7,1,8],[3,9,4],[3,4,2],[3,2,6],[3,6,8],[3,8,9],[4,9,5],[2,4,11],[6,2,10],[8,6,7],[9,8,1]];for(let e=0;e<t;e++){let e=new Map,t=(t,n)=>{let i=t<n?t+`_`+n:n+`_`+t;if(e.has(i))return e.get(i);let a=r[t].clone().add(r[n]).multiplyScalar(.5),o=r.length;return r.push(a),e.set(i,o),o},n=[];for(let[e,r,a]of i){let i=t(e,r),o=t(r,a),s=t(a,e);n.push([e,i,s],[r,o,i],[a,s,o],[i,o,s])}i=n}return r=r.map(t=>t.normalize().multiplyScalar(e)),{verts:r,faces:i}}var vf=class{constructor(e,t,n=2,r={}){this.scene=e,this.radius=n,this.volumeUnits=r.volumeUnits??n**3,this.particleRadius=r.particleRadius??.22,this.shellStiffness=r.shellStiffness??uf,this.centerStiffness=r.centerStiffness??df,this.pressureK=r.pressureK??ff,this.shellStiffScale=1,this.velDamp=r.velDamp??hf,this.gravityCenter=r.gravityCenter??null,this.gravityStrength=r.gravityStrength??Math.abs(mf),this.gravityFalloffR=r.gravityFalloffR??null,this.gravityFalloffP=r.gravityFalloffP??2,this.waterZone=r.waterZone??null,this.gelColor=r.gelColor??16753592,this.coreColor=r.coreColor??16726883,this.outlineColor=r.outlineColor??3809072,this.gelOpacity=r.gelOpacity??.8,this.externalFace=r.externalFace??!1,this.subdivisions=r.subdivisions??2;let{verts:i,faces:a}=_f(n,this.subdivisions);this.faces=a,this.shellCount=i.length,this.pos=[],this.prev=[],this.ext=[];for(let e of i){let n=e.clone().add(t);this.pos.push(n),this.prev.push(n.clone()),this.ext.push(new W)}this.centerIdx=this.pos.length,this.pos.push(t.clone()),this.prev.push(t.clone()),this.ext.push(new W);let o=new Set;this.springs=[];let s=(e,t,n,r)=>{let i=e<t?e+`_`+t:t+`_`+e;o.has(i)||(o.add(i),this.springs.push({a:e,b:t,rest:this.pos[e].distanceTo(this.pos[t]),stiff:n,shell:r}))};for(let[e,t,n]of a)s(e,t,this.shellStiffness,!0),s(t,n,this.shellStiffness,!0),s(n,e,this.shellStiffness,!0);for(let e=0;e<this.shellCount;e++)s(e,this.centerIdx,this.centerStiffness,!1);this.restVolume=this._volume(),this.com=t.clone(),this.prevCom=t.clone(),this.velocity=new W,this.compression=0,this.grabActive=!1,this.grabParticles=[],this.grabLook=null,this.grabPoint=new W,this.grabStiff=0,this.grabbedMask=null,this.neckSoft=r.neckSoft??.12,this.returnRadius=r.returnRadius??null,this.returnStrength=r.returnStrength??1.5,this._buildMesh(),this._t1=new W,this._t2=new W,this._t3=new W,this._n=new W,this._up=new W(0,1,0),this._right=new W,this._dir=new W,this._acc=0,this._volGrad=[];for(let e=0;e<this.shellCount;e++)this._volGrad.push(new W)}_projectVolume(e){let t=this._volume(),n=this.restVolume-t;if(Math.abs(n)<1e-6*this.restVolume)return;for(let e of this._volGrad)e.set(0,0,0);for(let[e,t,n]of this.faces)this._volGrad[e].addScaledVector(this._t1.crossVectors(this.pos[t],this.pos[n]),1/6),this._volGrad[t].addScaledVector(this._t1.crossVectors(this.pos[n],this.pos[e]),1/6),this._volGrad[n].addScaledVector(this._t1.crossVectors(this.pos[e],this.pos[t]),1/6);let r=1e-9;for(let e of this._volGrad)r+=e.lengthSq();let i=e*n/r;for(let e=0;e<this.shellCount;e++)this.pos[e].addScaledVector(this._volGrad[e],i)}_volume(){let e=0;for(let[t,n,r]of this.faces){let i=this.pos[t],a=this.pos[n],o=this.pos[r];e+=i.x*(a.y*o.z-o.y*a.z)-i.y*(a.x*o.z-o.x*a.z)+i.z*(a.x*o.y-o.x*a.y)}return e/6}_buildMesh(){this.group=new wn;let e=new Na(this.radius,26,18);e.deleteAttribute(`uv`),e.deleteAttribute(`normal`),this.geo=Pu(e);let t=of(this.gelColor,{transparent:!0,opacity:this.gelOpacity,depthWrite:!1});this.mesh=new Y(this.geo,t),this.mesh.castShadow=!0,this.mesh.renderOrder=2,this.group.add(this.mesh);let n=new Br({color:this.outlineColor,side:1});if(this.outline=new Y(this.geo,n),this.outline.scale.setScalar(1.04),this.outline.renderOrder=0,this.group.add(this.outline),this.core=new Y(new Na(this.radius*.46,16,12),of(this.coreColor)),this.core.renderOrder=1,this.group.add(this.core),this.eyeWhites=[],this.eyePupils=[],!this.externalFace){let e=new qa({color:16777215}),t=new Br({color:1710638});for(let n of[-1,1]){let r=new Y(new Na(.34,14,12),e),i=new Y(new Na(.17,12,10),t);r.userData.side=n,r.renderOrder=3,i.renderOrder=4,this.eyeWhites.push(r),this.eyePupils.push(i),this.group.add(r,i)}}this.front=new W(0,0,1),this.scene.add(this.group),this._bindMesh()}_bindMesh(){let e=this.geo.attributes.position,t=e.count;this.binds=Array(t);let n=new W;for(let r=0;r<t;r++){n.fromBufferAttribute(e,r).add(this.com);let t=[];for(let e=0;e<this.shellCount;e++)t.push({j:e,d:n.distanceTo(this.pos[e])});t.sort((e,t)=>e.d-t.d);let i=t.slice(0,6),a=this.radius*.12,o=0;for(let e of i)e.w=1/(e.d*e.d+a*a*4),o+=e.w;for(let e of i)e.w/=o;this.binds[r]=i}}clearForces(){for(let e of this.ext)e.set(0,0,0)}addWind(e){for(let t=0;t<this.shellCount;t++)this.ext[t].add(e)}addPointerPull(e,t,n){let r=this._t1;for(let i=0;i<this.shellCount;i++){r.copy(e).sub(this.pos[i]);let a=r.length();if(a>t)continue;let o=1-a/t;r.multiplyScalar(n*o/(a+.001));let s=n;r.length()>s&&r.setLength(s),this.ext[i].add(r)}}beginGrab(e,t=5){let n=[];for(let t=0;t<this.shellCount;t++)n.push({i:t,d:e.distanceToSquared(this.pos[t])});n.sort((e,t)=>e.d-t.d),this.grabParticles=n.slice(0,t).map(e=>e.i),this.grabActive=!0,this.grabbedMask?this.grabbedMask.fill(0):this.grabbedMask=new Uint8Array(this.pos.length);for(let e of this.grabParticles)this.grabbedMask[e]=1}pullGrab(e,t=9){if(!this.grabActive)return;let n=this._t1,r=t*1.25;for(let i of this.grabParticles){n.copy(e).sub(this.pos[i]);let a=n.length(),o=t*Math.min(a,1.2);n.multiplyScalar(o/(a+.001)),n.length()>r&&n.setLength(r),this.ext[i].add(n)}this.grabLook=e}setGrabTarget(e,t=.5){this.grabPoint.copy(e),this.grabStiff=t,this.grabLook=e}endGrab(){this.grabActive=!1,this.grabStiff=0,this.grabLook=null,this.grabbedMask&&this.grabbedMask.fill(0)}addVelocity(e){for(let t=0;t<=this.centerIdx;t++)this.prev[t].addScaledVector(e,-.008333333333333333)}stretchAlong(e,t){let n=Math.hypot(e.x,e.y,e.z)||1,r=e.x/n,i=e.y/n,a=e.z/n,o=this.shellCount,s=0;for(let e=0;e<o;e++){let t=this.pos[e];s+=(t.x-this.com.x)*r+(t.y-this.com.y)*i+(t.z-this.com.z)*a}s/=o;for(let e=0;e<o;e++){let n=this.pos[e],o=t*((n.x-this.com.x)*r+(n.y-this.com.y)*i+(n.z-this.com.z)*a-s)*sf;this.prev[e].x-=r*o,this.prev[e].y-=i*o,this.prev[e].z-=a*o}}hop(e){for(let t=0;t<=this.centerIdx;t++)this.prev[t].y-=e*(.6+Math.random()*.4)*sf}_step(e){let t=this._volume(),n=this.pressureK*(this.restVolume-t)/this.restVolume;if(n!==0)for(let[e,t,r]of this.faces){let i=this.pos[e],a=this.pos[t],o=this.pos[r];this._t1.subVectors(a,i),this._t2.subVectors(o,i),this._n.crossVectors(this._t1,this._t2),this._n.multiplyScalar(n/6),this.ext[e].add(this._n),this.ext[t].add(this._n),this.ext[r].add(this._n)}let r=this.gravityCenter,i=this.gravityStrength,a=this.waterZone,o=a?a.center:null,s=a?a.drag/sf:0;for(let e=0;e<=this.centerIdx;e++){let t=this.pos[e],n=this.prev[e],c=(t.x-n.x)*this.velDamp,l=(t.y-n.y)*this.velDamp,u=(t.z-n.z)*this.velDamp;n.copy(t);let d=this.ext[e].x,f=this.ext[e].y,p=this.ext[e].z;if(r){let e=r.x-t.x,n=r.y-t.y,a=r.z-t.z,o=Math.sqrt(e*e+n*n+a*a)||1e-6,s=this.gravityFalloffR,c=s!==null&&o>s?i*(s/o)**+this.gravityFalloffP/o:i/o;this.returnRadius&&o>this.returnRadius&&(c+=this.returnStrength*(o-this.returnRadius)/o),d+=e*c,f+=n*c,p+=a*c}else f+=mf;if(a){let e=t.x-o.x,n=t.y-o.y,r=t.z-o.z,i=Math.sqrt(e*e+n*n+r*r)||1e-6;if(i<a.level&&(e*a.dir.x+n*a.dir.y+r*a.dir.z)/i>a.cosAng){let t=Math.min(a.level-i,a.maxDepth),o=a.buoyancy*t/(a.maxDepth*i);d+=e*o,f+=n*o,p+=r*o,d-=c*s,f-=l*s,p-=u*s}}let m=c+d*sf*sf,h=l+f*sf*sf,g=u+p*sf*sf,_=m*m+h*h+g*g;if(_>gf*gf){let e=gf/Math.sqrt(_);m*=e,h*=e,g*=e}t.x+=m,t.y+=h,t.z+=g}for(let t=0;t<lf;t++){if(this.grabActive&&this.grabStiff>0){let e=this.grabPoint,t=this.grabStiff;for(let n of this.grabParticles){let r=this.pos[n];r.x+=(e.x-r.x)*t,r.y+=(e.y-r.y)*t,r.z+=(e.z-r.z)*t}}let n=this.grabActive?this.grabbedMask:null;for(let e of this.springs){let t=this.pos[e.a],r=this.pos[e.b],i=r.x-t.x,a=r.y-t.y,o=r.z-t.z,s=Math.sqrt(i*i+a*a+o*o)||1e-6,c=n&&(n[e.a]||n[e.b])?this.neckSoft:1,l=(s-e.rest)/s*.5*e.stiff*this.shellStiffScale*c,u=i*l,d=a*l,f=o*l;t.x+=u,t.y+=d,t.z+=f,r.x-=u,r.y-=d,r.z-=f}if(this._projectVolume(pf),e){let n=t===lf-1;for(let t=0;t<=this.centerIdx;t++)e.resolveParticle(this.pos[t],this.prev[t],this.particleRadius,n)}}}update(e,t){this._acc+=Math.min(e,.05);let n=0;for(;this._acc>=sf&&n<cf;)this._step(t),this._acc-=sf,n++;this.prevCom.copy(this.com),this.com.set(0,0,0);for(let e=0;e<this.shellCount;e++)this.com.add(this.pos[e]);this.com.multiplyScalar(1/this.shellCount),e>0&&this.velocity.copy(this.com).sub(this.prevCom).multiplyScalar(1/e);let r=this._volume();this.compression=(this.restVolume-r)/this.restVolume,this._syncMesh()}_syncMesh(){let e=this.geo.attributes.position,t=this._t1;for(let n=0;n<e.count;n++){t.set(0,0,0);for(let e of this.binds[n])t.addScaledVector(this.pos[e.j],e.w);e.setXYZ(n,t.x-this.com.x,t.y-this.com.y,t.z-this.com.z)}e.needsUpdate=!0,this.geo.computeVertexNormals(),this.group.position.copy(this.com),this._t2.copy(this.pos[this.centerIdx]).sub(this.com),this.core.position.copy(this._t2),this.externalFace||this._updateEyes()}surfaceAlong(e,t,n){let r=Math.hypot(e.x,e.y,e.z)||1,i=e.x/r,a=e.y/r,o=e.z/r,s=0,c=-2;for(let e=0;e<this.shellCount;e++){let t=this.pos[e].x-this.com.x,n=this.pos[e].y-this.com.y,r=this.pos[e].z-this.com.z,l=Math.hypot(t,n,r)||1,u=(t*i+n*a+r*o)/l;u>c&&(c=u,s=e)}return n.set(this.pos[s].x-this.com.x+i*t,this.pos[s].y-this.com.y+a*t,this.pos[s].z-this.com.z+o*t),n}_updateEyes(){let e=this._t3.copy(this.velocity);if(e.y=0,e.lengthSq()>.05&&(e.normalize(),this.front.lerp(e,.12).normalize()),this.grabLook){let e=this._t3.copy(this.grabLook).sub(this.com);e.y=0,e.lengthSq()>.02&&(e.normalize(),this.front.lerp(e,.3).normalize())}let t=this._right.crossVectors(this._up,this.front).normalize();for(let e=0;e<2;e++){let n=this.eyeWhites[e].userData.side,r=this._dir.copy(this.front).addScaledVector(t,.42*n).addScaledVector(this._up,.34).normalize(),i=0,a=-2;for(let e=0;e<this.shellCount;e++){let t=this.pos[e].x-this.com.x,n=this.pos[e].y-this.com.y,o=this.pos[e].z-this.com.z,s=Math.hypot(t,n,o)||1,c=(t*r.x+n*r.y+o*r.z)/s;c>a&&(a=c,i=e)}let o=this._t2.copy(this.pos[i]).sub(this.com).addScaledVector(r,.16);this.eyeWhites[e].position.copy(o),this.eyePupils[e].position.copy(o).addScaledVector(r,.26)}}dispose(){this.scene.remove(this.group),this.geo.dispose()}},yf=Object.freeze({minX:-1.1,maxX:1.1,minZ:-.8,maxZ:.8,floorY:1.65,topY:3.8}),bf=Object.freeze({minX:.5,maxX:1.1,minZ:.2,maxZ:.8,bayFloorY:.25,sensorTop:.62,sensorBottom:.34,rampMinX:.34,rampMaxX:.5}),xf=Object.freeze([{minX:.43,maxX:.47,minY:1.52,maxY:1.95,minZ:.18,maxZ:.8},{minX:.43,maxX:1.1,minY:1.52,maxY:1.95,minZ:.16,maxZ:.2}]);function Sf(e,t,n){let r=n.minX-t,i=n.maxX+t,a=n.minY-t,o=n.maxY+t,s=n.minZ-t,c=n.maxZ+t;if(e.x<=r||e.x>=i||e.y<=a||e.y>=o||e.z<=s||e.z>=c)return;let l=[e.x-r,i-e.x,e.y-a,o-e.y,e.z-s,c-e.z],u=l.indexOf(Math.min(...l));u===0?e.x=r:u===1?e.x=i:u===2?e.y=a:u===3?e.y=o:u===4?e.z=s:e.z=c}var Cf=1/120,wf=13,Tf=12,Ef=-6.5,Df=1e-8;function Of(e,t,n){return Math.max(t,Math.min(n,e))}function kf(e,t=0){return e.x>=bf.minX+t&&e.x<=bf.maxX-t&&e.z>=bf.minZ+t&&e.z<=bf.maxZ-t}function Af(e,t,n,r){let i=n.x-t.x,a=n.y-t.y,o=n.z-t.z,s=e.x-t.x,c=e.y-t.y,l=e.z-t.z,u=i*i+a*a+o*o||Df,d=Of((s*i+c*a+l*o)/u,0,1);return r.set(t.x+i*d,t.y+a*d,t.z+o*d)}var jf=class{constructor(e){this.owner=e,this.activeBlob=null,this.friction=.18,this._closest=new W,this._normal=new W}resolveParticle(e,t,n,r){let i=e.x,a=e.y,o=e.z;e.x=Of(e.x,yf.minX+n,yf.maxX-n),e.z=Of(e.z,yf.minZ+n,yf.maxZ-n);let s=yf.floorY+n;if(e.z>=bf.minZ&&e.x>=bf.rampMinX&&e.x<bf.minX){let t=(e.x-bf.rampMinX)/(bf.minX-bf.rampMinX);s-=.13*Of(t,0,1)}e.y<yf.floorY-.13&&t.y<yf.floorY-.13?(e.x=Math.max(e.x,bf.minX+n),e.z=Math.max(e.z,bf.minZ+n),e.y=Math.max(e.y,bf.bayFloorY+n)):kf(e,n*.2)?e.y=Math.max(e.y,bf.bayFloorY+n):e.y<s&&(e.y=s);for(let t of xf)Sf(e,n,t);for(let t of this.owner.blobs){if(t===this.activeBlob||t.collected)continue;let r=e.x-t.body.com.x,i=e.y-t.body.com.y,a=e.z-t.body.com.z,o=t.radius*.78+n,s=r*r+i*i+a*a;if(s>=o*o)continue;let c=Math.sqrt(s)||1,l=(o-c)/c;e.x+=r*l,e.y+=i*l,e.z+=a*l}for(let t of this.owner.claw.colliders){let r=Af(e,t.a,t.b,this._closest);this._normal.copy(e).sub(r);let i=this._normal.length(),a=t.radius+n;if(i>=a)continue;i<Df&&(this._normal.copy(e).sub(this.owner.claw.head),this._normal.y-=.15,this._normal.lengthSq()<Df&&this._normal.set(1,0,0),i=this._normal.length());let o=a-i;this._normal.multiplyScalar(1/i),e.addScaledVector(this._normal,o),this.owner.claw.head.addScaledVector(this._normal,-o*.018),this.activeBlob&&(this.activeBlob.contacts++,this.owner.claw.contactIds.add(this.activeBlob.id))}r&&(e.x!==i||e.y!==a||e.z!==o)&&(t.x+=(e.x-t.x)*this.friction,t.z+=(e.z-t.z)*this.friction)}};function Mf(e,t){let n=[],r=[];for(let i=0;i<wf;i++){let a=e.clone();a.y-=t*i/(wf-1),n.push(a),r.push(a.clone())}return{pos:n,prev:r,length:t,targetLength:t}}function Nf(e){return{subdivisions:e.subdivisions??1,particleRadius:e.particleRadius??.025,shellStiffness:e.shellStiffness??.02,centerStiffness:e.centerStiffness??.005,pressureK:e.pressureK??6,velDamp:e.velDamp??.982,gelColor:e.gelColor??7467727,coreColor:e.coreColor??2473888,outlineColor:e.outlineColor??2364210,gelOpacity:e.gelOpacity??.86,externalFace:e.externalFace??!0}}var Pf=class{constructor({scene:e=null,blobs:t=[],goal:n=t.length,idleMotion:r=!0}={}){this.renderSync=e!==null,this.scene=e??new Mn,this.goal=n,this.events=[],this.time=0,this._accumulator=0,this._released=!1,this._hadClosedGrip=!1,this._initial=t.map(e=>({...e})),this.idleMotion=r,this.world=new jf(this);let i=new W(0,yf.topY,.05),a=Mf(i,.46);this.carriage={position:i.clone(),target:i.clone(),speed:.4},this.rope=a,this.claw={head:a.pos[a.pos.length-1],previousHead:a.prev[a.prev.length-1],grip:0,targetGrip:0,colliders:[],contactIds:new Set},this.blobs=this._initial.map((e,t)=>this._makeBlob(e,t)),this._updateClawColliders()}_makeBlob(e,t){let n=e.radius??.19,r=new W(e.x??-.72+t%5*.34,e.y??yf.floorY+n+.08,e.z??-.35+Math.floor(t/5)*.32),i=new vf(this.scene,r,n,Nf(e)),a=this.renderSync?tf(i):()=>{};return i._syncMesh=()=>{},{id:e.id??`blob-${t+1}`,radius:n,body:i,collected:!1,collectedAt:null,liftQualified:!1,contacts:0,phase:t*1.713,renderSync:a,idleForce:new W}}setCarriageTarget(e,t){this.carriage.target.x=Of(e,yf.minX+.16,yf.maxX-.16),this.carriage.target.z=Of(t,yf.minZ+.16,yf.maxZ-.16)}setWinchTarget(e){this.rope.targetLength=Of(e,.35,1.82)}setGripTarget(e){this.claw.targetGrip=Of(e,0,1),e>.7?(this._hadClosedGrip=!0,this._released=!1):e<.2&&this._hadClosedGrip&&(this._released=!0)}release(){this.setGripTarget(0)}_stepRope(){let e=this.carriage,t=e.target.x-e.position.x,n=e.target.z-e.position.z,r=Math.hypot(t,n);if(r>Df){let i=Math.min(r,e.speed*Cf);e.position.x+=t/r*i,e.position.z+=n/r*i}this.rope.length+=Of(this.rope.targetLength-this.rope.length,-.72*Cf,.72*Cf),this.claw.grip+=Of(this.claw.targetGrip-this.claw.grip,-3.6*Cf,3.6*Cf);let i=this.rope.pos,a=this.rope.prev;i[0].copy(e.position),a[0].copy(e.position);for(let e=1;e<i.length;e++){let t=i[e],n=a[e],r=(t.x-n.x)*.994,o=(t.y-n.y)*.994,s=(t.z-n.z)*.994;n.copy(t),t.x+=r,t.y+=o+Ef*Cf*Cf,t.z+=s}let o=this.rope.length/(i.length-1);for(let t=0;t<Tf;t++){i[0].copy(e.position);for(let e=0;e<i.length-1;e++){let t=i[e],n=i[e+1],r=n.x-t.x,a=n.y-t.y,s=n.z-t.z,c=Math.hypot(r,a,s)||Df,l=(c-o)/c;if(e===0)n.addScaledVector(new W(r,a,s),-l);else{let e=r*l*.5,i=a*l*.5,o=s*l*.5;t.x+=e,t.y+=i,t.z+=o,n.x-=e,n.y-=i,n.z-=o}}let t=this.claw.head;t.x=Of(t.x,yf.minX+.09,yf.maxX-.09),t.z=Of(t.z,yf.minZ+.09,yf.maxZ-.09),t.y=Math.max(yf.floorY+.34,t.y)}}_updateClawColliders(){let e=this.claw.head,t=this.claw.grip,n=[];for(let r=0;r<3;r++){let i=r*Math.PI*2/3,a=Math.cos(i),o=Math.sin(i),s=new W(e.x+a*.16,e.y-.06,e.z+o*.16),c=Dt.lerp(.3,.17,t),l=Dt.lerp(.42,.055,t),u=new W(e.x+a*c,e.y-.27,e.z+o*c),d=new W(e.x+a*l,e.y-.59,e.z+o*l);n.push({a:s,b:u,radius:.06,finger:r}),n.push({a:u,b:d,radius:.072,finger:r});let f=Dt.lerp(.47,.075,t),p=new W(e.x+a*f,e.y-.51,e.z+o*f);n.push({a:d,b:p,radius:.078,finger:r})}n.push({a:new W(e.x,e.y-.02,e.z),b:new W(e.x,e.y-.11,e.z),radius:.13,finger:-1}),this.claw.colliders=n}_checkDelivery(){for(let e of this.blobs){if(e.collected||!this._released||!e.liftQualified)continue;let t=e.body.com;kf(t)&&t.y<=bf.sensorTop&&t.y>=bf.sensorBottom&&(e.collected=!0,e.collectedAt=this.time,this.events.push({type:`collected`,id:e.id,total:this.deliveredCount}))}this.deliveredCount>=this.goal&&!this._completeSent&&(this._completeSent=!0,this.events.push({type:`complete`,total:this.deliveredCount}))}_fixedStep(){this.time+=Cf,this.claw.contactIds.clear();for(let e of this.blobs)e.contacts=0;this._stepRope(),this._updateClawColliders();for(let e of this.blobs)if(!(e.collected&&this.time-e.collectedAt>1)){if(this.world.activeBlob=e,e.body.clearForces(),this.idleMotion&&!e.collected&&this.claw.grip<.35&&e.body.com.y<yf.floorY+e.radius+.2&&!kf(e.body.com)){let t=Math.sin(this.time*2.2+e.phase),n=Math.sin(this.time*1.35+e.phase*.73);e.idleForce.set(n*.11,Math.max(0,t)*.08,-n*.045),e.body.addWind(e.idleForce)}e.body.update(Cf,this.world),this.claw.grip>.7&&e.contacts>0&&e.body.com.y>yf.floorY+.45&&(e.liftQualified=!0)}this.world.activeBlob=null,this._checkDelivery()}step(e){this._accumulator+=Math.min(Math.max(e,0),.1);let t=0;for(;this._accumulator>=Cf&&t<12;)this._fixedStep(),this._accumulator-=Cf,t++;if(this.renderSync)for(let e of this.blobs)e.renderSync();return this.getSnapshot()}get deliveredCount(){return this.blobs.reduce((e,t)=>e+Number(t.collected),0)}drainEvents(){return this.events.splice(0)}getSnapshot(){let e=this.rope.pos.map(e=>({x:e.x,y:e.y,z:e.z}));return{time:this.time,carriage:{x:this.carriage.position.x,y:this.carriage.position.y,z:this.carriage.position.z},head:{x:this.claw.head.x,y:this.claw.head.y,z:this.claw.head.z,radius:.13,up:this.rope.pos.length>1?{x:this.rope.pos.at(-2).x-this.claw.head.x,y:this.rope.pos.at(-2).y-this.claw.head.y,z:this.rope.pos.at(-2).z-this.claw.head.z}:{x:0,y:1,z:0}},rope:{length:this.rope.length,points:e},grip:this.claw.grip,fingers:this.claw.colliders.map(e=>({a:{x:e.a.x,y:e.a.y,z:e.a.z},b:{x:e.b.x,y:e.b.y,z:e.b.z},radius:e.radius,finger:e.finger})),contacts:[...this.claw.contactIds],delivered:this.deliveredCount,blobs:this.blobs.map(e=>({id:e.id,x:e.body.com.x,y:e.body.com.y,z:e.body.com.z,vx:e.body.velocity.x,vy:e.body.velocity.y,vz:e.body.velocity.z,compression:e.body.compression,contacts:e.contacts,deliveryEligible:e.liftQualified,collected:e.collected})),diagnostics:{maxRopeError:this._maxRopeError(),released:this._released}}}_maxRopeError(){let e=this.rope.length/(this.rope.pos.length-1),t=0;for(let n=0;n<this.rope.pos.length-1;n++)t=Math.max(t,Math.abs(this.rope.pos[n].distanceTo(this.rope.pos[n+1])-e));return t}reset(){for(let e of this.blobs)e.body.dispose();return this.events.length=0,this.time=0,this._accumulator=0,this._released=!1,this._hadClosedGrip=!1,this._completeSent=!1,this.carriage.position.set(0,yf.topY,.05),this.carriage.target.copy(this.carriage.position),this.rope=Mf(this.carriage.position,.46),this.claw.head=this.rope.pos[this.rope.pos.length-1],this.claw.previousHead=this.rope.prev[this.rope.prev.length-1],this.claw.grip=0,this.claw.targetGrip=0,this.claw.contactIds.clear(),this.blobs=this._initial.map((e,t)=>this._makeBlob(e,t)),this._updateClawColliders(),this.getSnapshot()}dispose(){for(let e of this.blobs)e.body.dispose()}};function Ff(e){return new Pf(e)}var If={x:0,z:-.1},Lf=class{constructor(e){this.physics=e,this.reset()}reset(){this.physics.reset(),this.phase=`idle`,this.elapsed=0,this.aim={...If},this.collected=0,this.beforeAttempt=0,this.events=[],this.physics.setCarriageTarget(this.aim.x,this.aim.z),this.physics.setWinchTarget(.38),this.physics.setGripTarget(0)}move(e,t,n){this.phase===`idle`&&(this.aim.x=Math.max(-.79,Math.min(.79,this.aim.x+e*.38*n)),this.aim.z=Math.max(-.51,Math.min(.51,this.aim.z+t*.38*n)))}drop(){return this.phase===`idle`?(this.phase=`lowering`,this.elapsed=0,this.beforeAttempt=this.collected,this.events.push({type:`phase`,phase:this.phase}),!0):!1}next(e){this.phase=e,this.elapsed=0,this.alignedFor=0,this.events.push({type:`phase`,phase:e})}update(e){if(this.elapsed+=e,this.phase===`idle`&&this.physics.setCarriageTarget(this.aim.x,this.aim.z),this.phase===`lowering`)this.physics.setWinchTarget(1.55),this.elapsed>2.2&&this.next(`closing`);else if(this.phase===`closing`)this.physics.setGripTarget(1),this.elapsed>1&&this.next(`lifting`);else if(this.phase===`lifting`)this.physics.setWinchTarget(.38),this.elapsed>2.3&&this.next(`returning`);else if(this.phase===`returning`){this.physics.setCarriageTarget(.79,.51);let t=this.physics.getSnapshot(),n=Math.hypot(t.carriage.x-.79,t.carriage.z-.51)<.025&&Math.hypot(t.head.x-.79,t.head.z-.51)<.075;this.alignedFor=n?(this.alignedFor??0)+e:0,this.alignedFor>.25&&this.next(`releasing`)}else if(this.phase===`releasing`)this.physics.release(),this.elapsed>3&&this.next(`homing`);else if(this.phase===`homing`){this.physics.setCarriageTarget(If.x,If.z);let e=this.physics.getSnapshot();if(Math.hypot(e.carriage.x-If.x,e.carriage.z-If.z)<.025&&this.elapsed>1.8){this.aim={...If};let e=this.physics.getSnapshot();this.collected>=e.blobs.length?this.next(`complete`):(this.next(`idle`),this.events.push({type:this.collected>this.beforeAttempt?`ready`:`miss`}))}}this.physics.step(e);for(let e of this.physics.drainEvents())e.type===`collected`&&this.collected++,this.events.push(e);let t=this.events;return this.events=[],t}},Rf=[6671103,7991239,16742836,16761199,12290815];function zf(){let e=[];for(let t of[-.54,-.06])for(let n of[-.78,-.26,.26,.78])e.push([n,1.94,t]);e.push([-.78,1.94,.46],[-.26,1.94,.46]);for(let t of[-.78,-.26,.26,.78])e.push([t,2.44,-.54]);return e.push([-.26,2.44,-.06]),e.map(([e,t,n],r)=>({id:`blob-${r}`,x:e,y:t,z:n,radius:.205+r%3*.012,gelColor:Rf[(r*3+Math.floor(r/5))%5],coreColor:Rf[(r*3+Math.floor(r/5))%5]}))}var Bf=new W(0,1,0),Vf=new W,Hf=new W,Uf=new W,Wf=(e,t)=>Array.isArray(e)?t.fromArray(e):t.set(e.x,e.y,e.z),Gf=class{constructor(e,t,n){this.scene=e,this.backend=t,this.group=new wn,e.add(this.group),this.ropeMeshes=[],this.fingerMeshes=[],this.fingerCaps=[],this.chrome=new Ga({color:12635621,metalness:.85,roughness:.24}),this.pad=new Ga({color:16756174,roughness:.4}),this.cord=new Ga({color:2170168,roughness:.65}),this.glow=new Ga({color:5824511,emissive:3723263,emissiveIntensity:2,roughness:.2}),this.head=new wn,this.head.add(n),this.group.add(this.head),this.carriage=new Y(new ra(.28,.12,.25),this.chrome),this.group.add(this.carriage),this.faces=[],this.makeFloor()}makeFloor(){let e=new Ga({color:3683423,metalness:.25,roughness:.32}),t=(t,n,r,i,a,o,s=e)=>{let c=new Y(new ra(i,a,o),s);return c.position.set(t,n,r),this.group.add(c),c};t(-.38,1.62,0,1.44,.06,1.6),t(.72,1.62,-.3,.76,.06,1);let n=new Er;n.setAttribute(`position`,new mr([.34,1.65,.2,.34,1.65,.8,.5,1.52,.8,.5,1.52,.2],3)),n.setIndex([0,1,2,0,2,3]),n.computeVertexNormals(),this.group.add(new Y(n,e)),t(.5,1.666,.5,.018,.012,.6,this.glow),t(.8,1.666,.2,.6,.012,.018,this.glow),t(1.087,1,.5,.022,1.25,.6),t(.8,1,.795,.6,1.25,.022),t(.8,.22,.5,.6,.06,.6);let r=new Ka({color:9367295,transparent:!0,opacity:.26,roughness:.12,depthWrite:!1});for(let e of xf)t((e.minX+e.maxX)/2,(e.minY+e.maxY)/2,(e.minZ+e.maxZ)/2,e.maxX-e.minX,e.maxY-e.minY,e.maxZ-e.minZ,r),t((e.minX+e.maxX)/2,e.maxY,(e.minZ+e.maxZ)/2,e.maxX-e.minX,.012,e.maxZ-e.minZ,this.glow)}clearFaces(){for(let{face:e}of this.faces)e.traverse(e=>{e.geometry?.dispose(),e.material?.dispose()});this.faces=[]}addFaces(){for(let e of this.backend.blobs){let t=e.body;if(!t?.group)continue;t.outline.visible=!1,t.core.visible=!1;let n=t.gelColor??7851263;t.mesh.material.dispose(),t.mesh.material=new Ka({color:n,roughness:.19,metalness:0,transmission:.16,thickness:.2,clearcoat:1}),t.mesh.renderOrder=0;let r=new wn;t.group.add(r);let i=new Br({color:1774648});for(let e of[-1,1]){let n=new Y(new Na(t.radius*.1,12,8),i);n.position.set(e*t.radius*.31,t.radius*.1,0),n.scale.set(1,1.3,.55),r.add(n);let a=new Y(new Na(t.radius*.027,8,6),new Br({color:16777215}));a.position.copy(n.position).add(new W(-t.radius*.024,t.radius*.04,t.radius*.045)),r.add(a)}let a=new Aa(new W(-t.radius*.13,-t.radius*.15,0),new W(0,-t.radius*.3,.01),new W(t.radius*.13,-t.radius*.15,0));r.add(new Y(new Pa(a,12,t.radius*.024,6,!1),i)),this.faces.push({body:t,face:r,phase:this.faces.length})}}segment(e,t,n,r){Wf(t,Vf),Wf(n,Hf),Uf.subVectors(Hf,Vf),e.position.copy(Vf).add(Hf).multiplyScalar(.5),e.quaternion.setFromUnitVectors(Bf,Uf.clone().normalize()),e.scale.set(r,Math.max(1e-4,Uf.length()),r)}sync(e){let t=e.rope?.points??e.ropePoints??[];for(let e=0;e<t.length-1;e++){if(!this.ropeMeshes[e]){let e=new Y(new ia(1,1,1,8),this.cord);this.group.add(e),this.ropeMeshes.push(e)}this.segment(this.ropeMeshes[e],t[e],t[e+1],.016)}let n=e.head?.position??e.head;n&&Wf(n,this.head.position),e.head?.up&&this.head.quaternion.setFromUnitVectors(Bf,Wf(e.head.up,Uf).normalize()),e.carriage&&Wf(e.carriage.position??e.carriage,this.carriage.position);let r=e.fingers??e.claw?.fingers??[];for(let e=0;e<r.length;e++){let t=r[e];if(!(t.finger<0)){if(!this.fingerMeshes[e]){let t=e%3==2?this.pad:this.chrome,n=new Y(new ia(1,1,1,24),t);this.group.add(n),this.fingerMeshes[e]=n,this.fingerCaps[e]=[0,1].map(()=>{let e=new Y(new Na(1,20,12),t);return this.group.add(e),e})}this.segment(this.fingerMeshes[e],t.a,t.b,t.radius);for(let[n,r]of[t.a,t.b].entries()){let i=this.fingerCaps[e][n];Wf(r,i.position),i.scale.setScalar(t.radius)}}}for(let{body:e,face:t,phase:n}of this.faces){let r=new W(0,.22,1).normalize();e.surfaceAlong(r,.013,t.position);let i=Math.sin(performance.now()*5e-4+n*2.7)>.998;t.scale.y=i?.15:1}}};function Kf(e,t,n=44){let r=Math.hypot(e,t);if(r<=4)return{x:0,z:0};let i=Math.min(1,(r-4)/(n-4));return{x:e/r*i,z:t/r*i}}var qf=class{constructor(e,t,n,r,i){this.canvas=e,this.camera=t,this.canUse=r,this.onDrop=i,this.value={x:0,z:0},this.pointer=null,this.press=0;let a=e=>{let t;return n.traverse(n=>{n.name.replace(/[\s_]/g,``)===e&&(t=n)}),t};this.ball=a(`JoystickIndigoBall`),this.button=a(`PeachActionButton`);let o=a(`JoystickStem`),s=a(`JoystickBase`);this.pivot=new wn,n.add(this.pivot),n.updateMatrixWorld(!0),this.pivot.position.copy(n.worldToLocal(s.getWorldPosition(new W))),this.pivot.updateMatrixWorld(!0),this.pivot.attach(o),this.pivot.attach(this.ball),this.buttonRest=this.button.position.clone(),e.addEventListener(`pointerdown`,e=>this.down(e)),e.addEventListener(`pointermove`,e=>this.move(e)),e.addEventListener(`pointerup`,e=>this.up(e));for(let t of[`pointercancel`,`lostpointercapture`])e.addEventListener(t,e=>{e.pointerId===this.pointer?.id&&this.cancel()})}point(e){let t=this.canvas.getBoundingClientRect(),n=e.getWorldPosition(new W).project(this.camera);return{x:t.left+(n.x+1)*t.width/2,y:t.top+(1-n.y)*t.height/2}}hit(e,t,n){let r=this.point(t);return Math.hypot(e.clientX-r.x,e.clientY-r.y)<=n}buttonHit(e){let t=this.point(this.button),n=this.button.getWorldPosition(new W);n.x+=.22,n.project(this.camera);let r=this.canvas.getBoundingClientRect(),i=Math.max(28,Math.abs(r.left+(n.x+1)*r.width/2-t.x));return this.hit(e,this.button,i)}down(e){if(e.button!==0||this.pointer||!this.canUse())return;let t=this.hit(e,this.ball,32)?`stick`:this.buttonHit(e)?`button`:null;t&&(e.preventDefault(),this.pointer={id:e.pointerId,kind:t,x:e.clientX,y:e.clientY},this.canvas.setPointerCapture(e.pointerId))}move(e){this.pointer?.id===e.pointerId&&(e.preventDefault(),this.pointer.kind===`stick`&&(this.value=Kf(e.clientX-this.pointer.x,e.clientY-this.pointer.y)))}up(e){if(this.pointer?.id!==e.pointerId)return;let t=this.pointer.kind===`button`&&this.buttonHit(e)&&this.canUse();this.cancel(),t&&(this.onDrop(),this.press=1)}cancel(){let e=this.pointer?.id;this.pointer=null,this.value={x:0,z:0},e!==void 0&&this.canvas.hasPointerCapture(e)&&this.canvas.releasePointerCapture(e)}update(e){!this.canUse()&&this.pointer&&this.cancel();let t=1-Math.exp(-e*18);this.pivot.rotation.x=Dt.lerp(this.pivot.rotation.x,this.value.z*.32,t),this.pivot.rotation.z=Dt.lerp(this.pivot.rotation.z,-this.value.x*.32,t),this.press=Math.max(0,this.press-e*5),this.button.position.copy(this.buttonRest),this.button.position.y-=.035*(this.pointer?.kind===`button`?1:this.press)}},$=e=>document.getElementById(e),Jf=$(`game`),Yf=$(`stage`),Xf=$(`grab`),Zf=$(`status`),Qf=new Nu({canvas:Jf,antialias:!0,powerPreference:`high-performance`});Qf.setPixelRatio(Math.min(devicePixelRatio,1.5)),Qf.toneMapping=4,Qf.toneMappingExposure=.95;var $f=new Mn;$f.background=new J(723232),$f.environment=new Bs(Qf).fromScene(new Ld,.05).texture,$f.environmentIntensity=.5;var ep=new Vo(45,1,.05,40);ep.position.set(.22,4.2,5.6),$f.add(new ko(12245759,1511468,1.1));var tp=new Jo(15848447,2.4);tp.position.set(-2,6,5),$f.add(tp);for(let[e,t,n,r]of[[3923199,-1,1,12],[16414666,1,-.5,14]]){let i=new Go(e,r,6);i.position.set(t,3.2,n),$f.add(i)}var np=new qd(Qf);np.addPass(new Jd($f,ep)),np.addPass(new Xd(new U(800,600),.045,.2,1.8)),np.addPass(new Qd);var rp,ip,ap,op,sp=performance.now(),cp=!1,lp,up=performance.now(),dp=0,fp=2.18,pp=new Set,mp=new Map,hp={idle:`Наведи клешню`,lowering:`Опускаем канат`,closing:`Закрываем клешню`,lifting:`Поднимаем`,returning:`Несём к выдаче`,releasing:`Открываем клешню`,homing:`Возвращаемся`,complete:`Все блобы собраны!`},gp=Rf;new Ru().load($d,async e=>{try{let t=e.scene;$f.add(t);let n=[],r=new Set;t.traverse(e=>{e.isMesh&&e.material&&!Array.isArray(e.material)&&!r.has(e.material)&&(r.add(e.material),e.material.emissiveIntensity=Math.min(e.material.emissiveIntensity??0,2.4)),(/^(FloorCreatures|CapturedBlob|PrizeBlob|ClawRig)$/.test(e.name)||/Chamber(Floor|LavenderBed)/.test(e.name.replace(/[\s_]/g,``)))&&n.push(e),e.isMesh&&e.material?.name===`Clear Chamber Glass`&&(e.material.transparent=!0,e.material.opacity=.09,e.material.depthWrite=!1)}),n.forEach(e=>e.removeFromParent()),rp=await Ff({scene:$f,blobs:zf(),idleMotion:!0});let i=await new Ru().loadAsync(ef);ip=new Lf(rp),ap=new Gf($f,rp,i.scene),ap.addFaces(),op=new qf(Jf,ep,t,()=>ip?.phase===`idle`,bp),$(`loading`).hidden=!0,vp()}catch(e){console.error(e),$(`loading`).textContent=`Не удалось запустить автомат. Обнови страницу.`}},void 0,e=>{console.error(e),$(`loading`).textContent=`Не удалось загрузить автомат. Обнови страницу.`});function _p(){op?.cancel(),pp.clear(),mp.clear(),document.querySelectorAll(`[data-move]`).forEach(e=>e.classList.remove(`active`))}function vp(){_p(),$(`finish`).hidden=!0,$(`toast`).textContent=``,$(`toast`).classList.remove(`show`),$(`collection`).innerHTML=``;for(let e=0;e<15;e++)$(`collection`).insertAdjacentHTML(`beforeend`,`<div class="slot" style="--c:#${gp[e%5].toString(16)}"><i></i><b></b></div>`);$(`score`).textContent=`0 / 15`,Zf.textContent=hp.idle,Xf.disabled=!1}function yp(){ip&&(ap.clearFaces(),ip.reset(),ap.addFaces(),vp())}function bp(){ip?.drop()&&(_p(),Xf.disabled=!0,Ep(230,.1))}function xp(e){$(`toast`).textContent=e,$(`toast`).classList.remove(`show`),$(`toast`).offsetWidth,$(`toast`).classList.add(`show`)}function Sp(e){for(let t of e){if(t.type===`phase`&&(Zf.textContent=hp[t.phase]??``,Xf.disabled=t.phase!==`idle`,t.phase===`complete`&&($(`finish`).hidden=!1,$(`replay`).focus(),[523,659,784,1047].forEach((e,t)=>Ep(e,.2,t*.1)))),t.type===`collected`){$(`score`).textContent=`${ip.collected} / 15`;let e=$(`collection`).children[ip.collected-1];if(e){let n=rp.blobs.find(e=>e.id===t.id);e.style.setProperty(`--c`,`#${new J(n?.body.gelColor??gp[0]).getHexString()}`),e.classList.add(`filled`)}xp(`Блоб в отсеке!`),Ep(660,.15),Ep(990,.2,.08)}t.type===`miss`&&xp(`Ускользнул! Попробуй ещё`)}}function Cp(){return Yf.clientWidth>=700?1.95:Yf.clientHeight<740?1.85:2.18}function wp(){let e=Yf.clientWidth,t=Yf.clientHeight;if(Jf.width!==Math.floor(e*Qf.getPixelRatio())||Jf.height!==Math.floor(t*Qf.getPixelRatio())){Qf.setSize(e,t,!1),np.setSize(e,t),ep.aspect=e/t;let n=ep.position.distanceTo(new W(0,2.45,0)),r=e<700?2.85/ep.aspect:3.8;ep.fov=Dt.radToDeg(2*Math.atan(r/(2*n))),ep.lookAt(0,Cp(),0),ep.updateProjectionMatrix()}}function Tp(e){requestAnimationFrame(Tp),dp++,e-up>1e3&&(Jf.dataset.fps=(dp*1e3/(e-up)).toFixed(1),up=e,dp=0);let t=Math.min((e-sp)/1e3,.05);if(sp=e,ip){let e=[...mp.values()],n=(t,n,r)=>pp.has(t)||pp.has(n)||e.includes(r),r=op?.value??{x:0,z:0};ip.move(Math.max(-1,Math.min(1,r.x+Number(n(`ArrowRight`,`KeyD`,`right`))-Number(n(`ArrowLeft`,`KeyA`,`left`)))),Math.max(-1,Math.min(1,r.z+Number(n(`ArrowDown`,`KeyS`,`down`))-Number(n(`ArrowUp`,`KeyW`,`up`)))),t),op?.update(t),Sp(ip.update(t));let i=rp.getSnapshot();ap.sync(i);let a=i.head?.position??i.head;if(a){let e=new W(a.x??a[0],1.67,a.z??a[2]).project(ep);$(`reticle`).style.setProperty(`--x`,`${(e.x*.5+.5)*100}%`),$(`reticle`).style.setProperty(`--y`,`${(-e.y*.5+.5)*100}%`)}}wp();let n=ip&&[`releasing`,`homing`].includes(ip.phase),r=Cp()-(n?1.05:0);fp=Dt.lerp(fp,r,1-Math.exp(-t*3)),ep.lookAt(0,fp,0),np.render()}requestAnimationFrame(Tp),window.addEventListener(`keydown`,e=>{e.code===`Space`&&e.target.closest?.(`button,input,a`)||([`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`,`Space`].includes(e.code)&&e.preventDefault(),pp.add(e.code),e.code===`Space`&&!e.repeat&&bp())}),window.addEventListener(`keyup`,e=>pp.delete(e.code)),window.addEventListener(`blur`,_p),document.addEventListener(`visibilitychange`,()=>{_p(),sp=performance.now()});for(let e of document.querySelectorAll(`[data-move]`)){let t=0,n=t=>{let n=e.dataset.move;ip?.move(Number(n===`right`)-Number(n===`left`),Number(n===`down`)-Number(n===`up`),t)};e.addEventListener(`pointerdown`,n=>{n.preventDefault(),t=performance.now(),e.setPointerCapture(n.pointerId),mp.set(n.pointerId,e.dataset.move),e.classList.add(`active`)});let r=t=>{mp.delete(t.pointerId),e.classList.remove(`active`)};e.addEventListener(`pointerup`,e=>{let i=(performance.now()-t)/1e3;r(e),i<.12&&n(.12-i)}),e.addEventListener(`pointercancel`,r),e.addEventListener(`lostpointercapture`,r),e.addEventListener(`click`,e=>{e.detail===0&&n(.16)})}Xf.addEventListener(`click`,bp),$(`reset`).addEventListener(`click`,yp),$(`replay`).addEventListener(`click`,yp);function Ep(e,t,n=0){if(cp)return;lp??=new(window.AudioContext||window.webkitAudioContext),lp.state===`suspended`&&lp.resume();let r=lp.createOscillator(),i=lp.createGain(),a=lp.currentTime+n;r.type=`sine`,r.frequency.value=e,i.gain.setValueAtTime(1e-4,a),i.gain.exponentialRampToValueAtTime(.07,a+.02),i.gain.exponentialRampToValueAtTime(1e-4,a+t),r.connect(i).connect(lp.destination),r.start(a),r.stop(a+t+.03)}$(`sound`).addEventListener(`click`,()=>{cp=!cp,$(`sound`).textContent=cp?`×`:`♫`,$(`sound`).setAttribute(`aria-label`,cp?`Включить звук`:`Выключить звук`)});