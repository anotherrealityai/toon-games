...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ho(e,t,n){let r=new Float32Array(Oo),i=new H(0,1,0);return new na({name:`SphericalGaussianBlur`,defines:{n:Oo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Go(),fragmentShader:`
	...
	`}var Ko=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ni(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var _c={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function vc(e,t){let n=_c[t];return n===void 0?(L(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var yc=new H;function bc(){return W.getLuminanceCoefficients(yc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${yc.x.toFixed(4)}, ${yc.y.toFixed(4)}, ${yc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=lc(i,i.VERTEX_SHADER,y),S=lc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=hc(i,x,`vertex`),n=hc(i,S,`fragment`);R(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
}`,xl=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new Li(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new na({vertexShader:yl,fragmentShader:bl,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new K(new Wi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Sl=class extends nt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,u=null,d=null,f=null,p=null,h=null,g=typeof XRWebGLBinding<`u`,_=new xl,v={},b=t.getContextAttributes(),x=null,S=null,C=[],D=[],ee=new V,te=null,O=new Va;O.viewport=new Gt;let ne=new Va;ne.viewport=new Gt;let k=[O,ne],A=new Ya,re=null,ie=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new Dn,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new Dn,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new Dn,C[e]=t),t.getHandSpace()};function j(e){let t=D.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ae(){r.removeEventListener(`select`,j),r.removeEventListener(`selectstart`,j),r.removeEventListener(`selectend`,j),r.removeEventListener(`squeeze`,j),r.removeEventListener(`squeezestart`,j),r.removeEventListener(`squeezeend`,j),r.removeEventListener(`end`,ae),r.removeEventListener(`inputsourceschange`,oe);for(let e=0;e<C.length;e++){let t=D[e];t!==null&&(D[e]=null,C[e].disconnect(t))}re=null,ie=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(x),p=null,f=null,d=null,r=null,S=null,pe.stop(),n.isPresenting=!1,e.setPixelRatio(te),e.setSize(ee.width,ee.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&L(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&L(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return h},this.getSession=function(){return r},this.setSession=async function(u){if(r=u,r!==null){if(x=e.getRenderTarget(),r.addEventListener(`select`,j),r.addEventListener(`selectstart`,j),r.addEventListener(`selectend`,j),r.addEventListener(`squeeze`,j),r.addEventListener(`squeezestart`,j),r.addEventListener(`squeezeend`,j),r.addEventListener(`end`,ae),r.addEventListener(`inputsourceschange`,oe),b.xrCompatible!==!0&&await t.makeXRCompatible(),te=e.getPixelRatio(),e.getSize(ee),g&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;b.depth&&(o=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=b.stencil?E:T,a=b.stencil?y:m);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};d=this.getBinding(),f=d.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new qt(f.textureWidth,f.textureHeight,{format:w,type:l,depthTexture:new Fi(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new qt(p.framebufferWidth,p.framebufferHeight,{format:w,type:l,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),pe.setContext(r),pe.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function oe(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=D.indexOf(n);r>=0&&(D[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=D.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=D.length){D.push(n),r=e;break}else if(D[e]===null){D[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let se=new H,ce=new H;function le(e,t,n){se.setFromMatrixPosition(t.matrixWorld),ce.setFromMatrixPosition(n.matrixWorld);let r=se.distanceTo(ce),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function ue(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),A.near=ne.near=O.near=t,A.far=ne.far=O.far=n,(re!==A.near||ie!==A.far)&&(r.updateRenderState({depthNear:A.near,depthFar:A.far}),re=A.near,ie=A.far),A.layers.mask=e.layers.mask|6,O.layers.mask=A.layers.mask&-5,ne.layers.mask=A.layers.mask&-3;let i=e.parent,a=A.cameras;ue(A,i);for(let e=0;e<a.length;e++)ue(a[e],i);a.length===2?le(A,O,ne):A.projectionMatrix.copy(O.projectionMatrix),de(e,A,i)};function de(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=ot*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return A},this.getFoveation=function(){if(!(f===null&&p===null))return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(A)},this.getCameraTexture=function(e){return v[e]};let M=null;function fe(t,i){if(u=i.getViewerPose(c||a),h=i,u!==null){let t=u.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==A.cameras.length&&(A.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=d.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=k[n];o===void 0&&(o=new Va,o.layers.enable(n),o.viewport=new Gt,k[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(A.matrix.copy(o.matrix),A.matrix.decompose(A.position,A.quaternion,A.scale)),i===!0&&A.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&g){d=n.getBinding();let e=d.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&g){e.state.unbindTexture(),d=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new Li,v[n]=e);let t=d.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=D[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}M&&M(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),h=null}let pe=new ho;pe.setAnimationLoop(fe),this.setAnimationLoop=function(e){M=e},this.dispose=function(){}}},Cl=new Xt,wl=new U;wl.set(-1,0,0,0,1,0,0,0,1);function Tl(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,Qi(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(Cl.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(wl),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function El(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(g(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,v));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return R(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let e=0,t=r.length;e<t;e++){let t=r[e];if(Array.isArray(t))for(let n=0,r=t.length;n<r;n++)p(t[n],e,n,a);else p(t,e,0,a)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(t,n,r,i){if(h(t,n,r,i)===!0){let n=t.__offset,r=t.value;if(Array.isArray(r)){let e=0;for(let n=0;n<r.length;n++){let i=r[n],a=_(i);m(i,t.__data,e),typeof i!=`number`&&typeof i!=`boolean`&&!i.isMatrix3&&!ArrayBuffer.isView(i)&&(e+=a.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(r,t.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,n,t.__data)}}function m(e,t,n){typeof e==`number`||typeof e==`boolean`?t[0]=e:e.isMatrix3?(t[0]=e.elements[0],t[1]=e.elements[1],t[2]=e.elements[2],t[3]=0,t[4]=e.elements[3],t[5]=e.elements[4],t[6]=e.elements[5],t[7]=0,t[8]=e.elements[6],t[9]=e.elements[7],t[10]=e.elements[8],t[11]=0):ArrayBuffer.isView(e)?t.set(new e.constructor(e.buffer,e.byteOffset,t.length)):e.toArray(t,n)}function h(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:ArrayBuffer.isView(i)?r[a]=i.slice():r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function g(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=_(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function _(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?L(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):L(`WebGLRenderer: Unsupported uniform value type.`,e),t}function v(t){let n=t.target;n.removeEventListener(`dispose`,v);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function y(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:y}}var Dl=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Ol=null;function kl(){return Ol===null&&(Ol=new _i(Dl,16,16,te,g),Ol.name=`DFG_LUT`,Ol.minFilter=o,Ol.magFilter=o,Ol.wrapS=t,Ol.wrapT=t,Ol.generateMipmaps=!1,Ol.needsUpdate=!0),Ol}var Al=class{constructor(e={}){let{canvas:t=Ye(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:u=!1,powerPreference:d=`default`,failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:b=l}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);x=n.getContextAttributes().alpha}else x=a;let S=b,C=new Set([ne,O,ee]),w=new Set([l,m,f,y,_,v]),T=new Uint32Array(4),E=new Int32Array(4),D=new H,te=null,k=null,A=[],re=[],ie=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let j=this,ae=!1,oe=null,se=null,ce=null,le=null;this._outputColorSpace=Be;let ue=0,de=0,M=null,fe=-1,pe=null,me=new Gt,he=new Gt,ge=null,_e=new G(0),ve=0,ye=t.width,be=t.height,xe=1,Se=null,Ce=null,we=new Gt(0,0,ye,be),Te=new Gt(0,0,ye,be),Ee=!1,De=new Ti,Oe=!1,ke=!1,Ae=new Xt,je=new H,Me=new Gt,Ne={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Pe=!1;function Fe(){return M===null?xe:1}let N=n;function Ie(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:p};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r185`),t.addEventListener(`webglcontextlost`,lt,!1),t.addEventListener(`webglcontextrestored`,ut,!1),t.addEventListener(`webglcontextcreationerror`,dt,!1),N===null){let t=`webgl2`;if(N=Ie(t,e),N===null)throw Ie(t)?Error(`THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.`):Error(`THREE.WebGLRenderer: Error creating WebGL context.`)}}catch(e){throw R(`WebGLRenderer: `+e.message),e}let Le,Re,P,ze,F,I,Ve,He,Ue,We,Ke,qe,Je,Xe,Qe,$e,tt,nt,rt,it,at,ot,st;function z(){Le=new Jo(N),Le.init(),at=new vl(N,Le),Re=new wo(N,Le,e,at),P=new gl(N,Le),Re.reversedDepthBuffer&&h&&P.buffers.depth.setReversed(!0),se=N.createFramebuffer(),ce=N.createFramebuffer(),le=N.createFramebuffer(),ze=new Zo(N),F=new Xc,I=new _l(N,Le,P,F,Re,at,ze),Ve=new qo(j),He=new go(N),ot=new So(N,He),Ue=new Yo(N,He,ze,ot),We=new $o(N,Ue,He,ot,ze),nt=new Qo(N,Re,I),Qe=new To(F),Ke=new Yc(j,Ve,Le,Re,ot,Qe),qe=new Tl(j,F),Je=new el,Xe=new sl(Le),tt=new xo(j,Ve,P,We,x,s),$e=new hl(j,We,Re),st=new El(N,ze,Re,P),rt=new Co(N,Le,ze),it=new Xo(N,Le,ze),ze.programs=Ke.programs,j.capabilities=Re,j.extensions=Le,j.properties=F,j.renderLists=Je,j.shadowMap=$e,j.state=P,j.info=ze}z(),S!==1009&&(ie=new ts(S,t.width,t.height,o,r,i));let ct=new Sl(j,N);this.xr=ct,this.getContext=function(){return N},this.getContextAttributes=function(){return N.getContextAttributes()},this.forceContextLoss=function(){let e=Le.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=Le.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return xe},this.setPixelRatio=function(e){e!==void 0&&(xe=e,this.setSize(ye,be,!1))},this.getSize=function(e){return e.set(ye,be)},this.setSize=function(e,n,r=!0){if(ct.isPresenting){L(`WebGLRenderer: Can't change size while VR device is presenting.`);return}ye=e,be=n,t.width=Math.floor(e*xe),t.height=Math.floor(n*xe),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),ie!==null&&ie.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(ye*xe,be*xe).floor()},this.setDrawingBufferSize=function(e,n,r){ye=e,be=n,xe=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){R(`WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){L(`WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}ie.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(me)},this.getViewport=function(e){return e.copy(we)},this.setViewport=function(e,t,n,r){e.isVector4?we.set(e.x,e.y,e.z,e.w):we.set(e,t,n,r),P.viewport(me.copy(we).multiplyScalar(xe).round())},this.getScissor=function(e){return e.copy(Te)},this.setScissor=function(e,t,n,r){e.isVector4?Te.set(e.x,e.y,e.z,e.w):Te.set(e,t,n,r),P.scissor(he.copy(Te).multiplyScalar(xe).round())},this.getScissorTest=function(){return Ee},this.setScissorTest=function(e){P.setScissorTest(Ee=e)},this.setOpaqueSort=function(e){Se=e},this.setTransparentSort=function(e){Ce=e},this.getClearColor=function(e){return e.copy(tt.getClearColor())},this.setClearColor=function(){tt.setClearColor(...arguments)},this.getClearAlpha=function(){return tt.getClearAlpha()},this.setClearAlpha=function(){tt.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(M!==null){let t=M.texture.format;e=C.has(t)}if(e){let e=M.texture.type,t=w.has(e),n=tt.getClearColor(),r=tt.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,N.clearBufferuiv(N.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,N.clearBufferiv(N.COLOR,0,E))}else r|=N.COLOR_BUFFER_BIT}t&&(r|=N.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=N.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&N.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),oe=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,lt,!1),t.removeEventListener(`webglcontextrestored`,ut,!1),t.removeEventListener(`webglcontextcreationerror`,dt,!1),tt.dispose(),Je.dispose(),Xe.dispose(),F.dispose(),Ve.dispose(),We.dispose(),ot.dispose(),st.dispose(),Ke.dispose(),ct.dispose(),ct.removeEventListener(`sessionstart`,vt),ct.removeEventListener(`sessionend`,yt),bt.stop()};function lt(e){e.preventDefault(),Ze(`WebGLRenderer: Context Lost.`),ae=!0}function ut(){Ze(`WebGLRenderer: Context Restored.`),ae=!1;let e=ze.autoReset,t=$e.enabled,n=$e.autoUpdate,r=$e.needsUpdate,i=$e.type;z(),ze.autoReset=e,$e.enabled=t,$e.autoUpdate=n,$e.needsUpdate=r,$e.type=i}function dt(e){R(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function ft(e){let t=e.target;t.removeEventListener(`dispose`,ft),pt(t)}function pt(e){mt(e),F.remove(e)}function mt(e){let t=F.get(e).programs;t!==void 0&&(t.forEach(function(e){Ke.releaseProgram(e)}),e.isShaderMaterial&&Ke.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=Ne);let o=i.isMesh&&i.matrixWorld.determinantAffine()<0,s=Ot(e,t,n,r,i);P.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Ue.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;ot.setup(i,r,s,n,c);let h,g=rt;if(c!==null&&(h=He.get(c),g=it,g.setIndex(h)),i.isMesh)r.wireframe===!0?(P.setLineWidth(r.wireframeLinewidth*Fe()),g.setMode(N.LINES)):g.setMode(N.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),P.setLineWidth(e*Fe()),i.isLineSegments?g.setMode(N.LINES):i.isLineLoop?g.setMode(N.LINE_LOOP):g.setMode(N.LINE_STRIP)}else i.isPoints?g.setMode(N.POINTS):i.isSprite&&g.setMode(N.TRIANGLES);if(i.isBatchedMesh)if(Le.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?He.get(c).bytesPerElement:1,o=F.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(N,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function ht(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,Et(e,t,n),e.side=0,e.needsUpdate=!0,Et(e,t,n),e.side=2):Et(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),k=Xe.get(n),k.init(t),re.push(k),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),k.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];ht(a,n,e),r.add(a)}else ht(t,n,e),r.add(t)}),k=re.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){F.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}Le.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let gt=null;function _t(e){gt&&gt(e)}function vt(){bt.stop()}function yt(){bt.start()}let bt=new ho;bt.setAnimationLoop(_t),typeof self<`u`&&bt.setContext(self),this.setAnimationLoop=function(e){gt=e,ct.setAnimationLoop(e),e===null?bt.stop():bt.start()},ct.addEventListener(`sessionstart`,vt),ct.addEventListener(`sessionend`,yt),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){R(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ae===!0)return;oe!==null&&oe.renderStart(e,t);let n=ct.enabled===!0&&ct.isPresenting===!0,r=ie!==null&&(M===null||n)&&ie.begin(j,M);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),ct.enabled===!0&&ct.isPresenting===!0&&(ie===null||ie.isCompositing()===!1)&&(ct.cameraAutoUpdate===!0&&ct.updateCamera(t),t=ct.getCamera()),e.isScene===!0&&e.onBeforeRender(j,e,t,M),k=Xe.get(e,re.length),k.init(t),k.state.textureUnits=I.getTextureUnits(),re.push(k),Ae.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),De.setFromProjectionMatrix(Ae,Ge,t.reversedDepth),ke=this.localClippingEnabled,Oe=Qe.init(this.clippingPlanes,ke),te=Je.get(e,A.length),te.init(),A.push(te),ct.enabled===!0&&ct.isPresenting===!0){let e=j.xr.getDepthSensingMesh();e!==null&&xt(e,t,-1/0,j.sortObjects)}xt(e,t,0,j.sortObjects),te.finish(),j.sortObjects===!0&&te.sort(Se,Ce,t.reversedDepth),Pe=ct.enabled===!1||ct.isPresenting===!1||ct.hasDepthSensing()===!1,Pe&&tt.addToRenderList(te,e),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Oe===!0&&Qe.beginShadows();let i=k.state.shadowsArray;if($e.render(i,e,t),Oe===!0&&Qe.endShadows(),(r&&ie.hasRenderPass())===!1){let n=te.opaque,r=te.transmissive;if(k.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];Ct(n,r,e,a)}Pe&&tt.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];St(te,e,n,n.viewport)}}else r.length>0&&Ct(n,r,e,t),Pe&&tt.render(e),St(te,e,t)}M!==null&&de===0&&(I.updateMultisampleRenderTarget(M),I.updateRenderTargetMipmap(M)),r&&ie.end(j),e.isScene===!0&&e.onAfterRender(j,e,t),ot.resetDefaultState(),fe=-1,pe=null,re.pop(),re.length>0?(k=re[re.length-1],I.setTextureUnits(k.state.textureUnits),Oe===!0&&Qe.setGlobalState(j.clippingPlanes,k.state.camera)):k=null,A.pop(),te=A.length>0?A[A.length-1]:null,oe!==null&&oe.renderEnd()};function xt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)k.pushLightProbeGrid(e);else if(e.isLight)k.pushLight(e),e.castShadow&&k.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||De.intersectsSprite(e)){r&&Me.setFromMatrixPosition(e.matrixWorld).applyMatrix4(Ae);let t=We.update(e),i=e.material;i.visible&&te.push(e,t,i,n,Me.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||De.intersectsObject(e))){let t=We.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),Me.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Me.copy(e.boundingSphere.center)),Me.applyMatrix4(e.matrixWorld).applyMatrix4(Ae)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&te.push(e,t,s,n,Me.z,o)}}else i.visible&&te.push(e,t,i,n,Me.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)xt(i[e],t,n,r)}function St(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;k.setupLightsView(n),Oe===!0&&Qe.setGlobalState(j.clippingPlanes,n),r&&P.viewport(me.copy(r)),i.length>0&&wt(i,t,n),a.length>0&&wt(a,t,n),o.length>0&&wt(o,t,n),P.buffers.depth.setTest(!0),P.buffers.depth.setMask(!0),P.buffers.color.setMask(!0),P.setPolygonOffset(!1)}function Ct(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(k.state.transmissionRenderTarget[r.id]===void 0){let e=Le.has(`EXT_color_buffer_half_float`)||Le.has(`EXT_color_buffer_float`);k.state.transmissionRenderTarget[r.id]=new qt(1,1,{generateMipmaps:!0,type:e?g:l,minFilter:c,samples:Math.max(4,Re.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:W.workingColorSpace})}let a=k.state.transmissionRenderTarget[r.id],o=r.viewport||me;a.setSize(o.z*j.transmissionResolutionScale,o.w*j.transmissionResolutionScale);let s=j.getRenderTarget(),u=j.getActiveCubeFace(),d=j.getActiveMipmapLevel();j.setRenderTarget(a),j.getClearColor(_e),ve=j.getClearAlpha(),ve<1&&j.setClearColor(16777215,.5),j.clear(),Pe&&tt.render(n);let f=j.toneMapping;j.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),k.setupLightsView(r),Oe===!0&&Qe.setGlobalState(j.clippingPlanes,r),wt(e,n,r),I.updateMultisampleRenderTarget(a),I.updateRenderTargetMipmap(a),Le.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,Tt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(I.updateMultisampleRenderTarget(a),I.updateRenderTargetMipmap(a))}j.setRenderTarget(s,u,d),j.setClearColor(_e,ve),p!==void 0&&(r.viewport=p),j.toneMapping=f}function wt(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&Tt(o,t,n,s,l,c)}}function Tt(e,t,n,r,i,a){e.onBeforeRender(j,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(j,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,j.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,j.renderBufferDirect(n,t,r,i,e,a),i.side=2):j.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(j,t,n,r,i,a)}function Et(e,t,n){t.isScene!==!0&&(t=Ne);let r=F.get(e),i=k.state.lights,a=k.state.shadowsArray,o=i.state.version,s=Ke.getParameters(e,i.state,a,t,n,k.state.lightProbeGridArray),c=Ke.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Ve.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,ft),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return B(e,s),d}else s.uniforms=Ke.getUniforms(e),oe!==null&&e.isNodeMaterial&&oe.build(e,n,s),e.onBeforeCompile(s,j),d=Ke.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Qe.uniform),B(e,s),r.needsLights=At(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=k.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function Dt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=cc.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function B(e,t){let n=F.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function V(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function Ot(e,t,n,r,i){t.isScene!==!0&&(t=Ne),I.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=M===null?j.outputColorSpace:M.isXRRenderTarget===!0?M.texture.colorSpace:W.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Ve.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(M===null||M.isXRRenderTarget===!0)&&(h=j.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=F.get(r),y=k.state.lights;if(Oe===!0&&(ke===!0||e!==pe)){let t=e===pe&&r.id===fe;Qe.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Qe.numPlanes||v.numIntersection!==Qe.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=k.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=Et(r,t,i),oe&&r.isNodeMaterial&&oe.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(P.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==fe&&(fe=r.id,C=!0),v.needsLights){let e=V(k.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||pe!==e){P.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(N,`projectionMatrix`,e.projectionMatrix),T.setValue(N,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(N,je.setFromMatrixPosition(e.matrixWorld)),Re.logarithmicDepthBuffer&&T.setValue(N,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(N,`isOrthographic`,e.isOrthographicCamera===!0),pe!==e&&(pe=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(N,`directionalShadowMap`,y.state.directionalShadowMap,I),y.state.spotShadowMap.length>0&&T.setValue(N,`spotShadowMap`,y.state.spotShadowMap,I),y.state.pointShadowMap.length>0&&T.setValue(N,`pointShadowMap`,y.state.pointShadowMap,I)),i.isSkinnedMesh){T.setOptional(N,i,`bindMatrix`),T.setOptional(N,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(N,`boneTexture`,e.boneTexture,I))}i.isBatchedMesh&&(T.setOptional(N,i,`batchingTexture`),T.setValue(N,`batchingTexture`,i._matricesTexture,I),T.setOptional(N,i,`batchingIdTexture`),T.setValue(N,`batchingIdTexture`,i._indirectTexture,I),T.setOptional(N,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(N,`batchingColorTexture`,i._colorsTexture,I));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&nt.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(N,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=kl()),C){if(T.setValue(N,`toneMappingExposure`,j.toneMappingExposure),v.needsLights&&kt(E,w),a&&r.fog===!0&&qe.refreshFogUniforms(E,a),qe.refreshMaterialUniforms(E,r,xe,be,k.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}cc.upload(N,Dt(v),E,I)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(cc.upload(N,Dt(v),E,I),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(N,`center`,i.center),T.setValue(N,`modelViewMatrix`,i.modelViewMatrix),T.setValue(N,`normalMatrix`,i.normalMatrix),T.setValue(N,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];st.update(n,x),st.bind(n,x)}}return x}function kt(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function At(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return ue},this.getActiveMipmapLevel=function(){return de},this.getRenderTarget=function(){return M},this.setRenderTargetTextures=function(e,t,n){let r=F.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),F.get(e.texture).__webglTexture=t,F.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=F.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0},this.setRenderTarget=function(e,t=0,n=0){M=e,ue=t,de=n;let r=null,i=!1,a=!1;if(e){let o=F.get(e);if(o.__useDefaultFramebuffer!==void 0){P.bindFramebuffer(N.FRAMEBUFFER,o.__webglFramebuffer),me.copy(e.viewport),he.copy(e.scissor),ge=e.scissorTest,P.viewport(me),P.scissor(he),P.setScissorTest(ge),fe=-1;return}else if(o.__webglFramebuffer===void 0)I.setupRenderTarget(e);else if(o.__hasExternalTextures)I.rebindTextures(e,F.get(e.texture).__webglTexture,F.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&F.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.`);I.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=F.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&I.useMultisampledRTT(e)===!1?F.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,me.copy(e.viewport),he.copy(e.scissor),ge=e.scissorTest}else me.copy(we).multiplyScalar(xe).floor(),he.copy(Te).multiplyScalar(xe).floor(),ge=Ee;if(n!==0&&(r=se),P.bindFramebuffer(N.FRAMEBUFFER,r)&&P.drawBuffers(e,r),P.viewport(me),P.scissor(he),P.setScissorTest(ge),i){let r=F.get(e.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=F.get(e.textures[t]);N.framebufferTextureLayer(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=F.get(e.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,t.__webglTexture,n)}fe=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=F.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){P.bindFramebuffer(N.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+s),!Re.textureFormatReadable(c)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Re.textureTypeReadable(l)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&N.readPixels(t,n,r,i,at.convert(c),at.convert(l),a)}finally{let e=M===null?null:F.get(M).__webglFramebuffer;P.bindFramebuffer(N.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=F.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){P.bindFramebuffer(N.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+s),!Re.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Re.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=N.createBuffer();N.bindBuffer(N.PIXEL_PACK_BUFFER,d),N.bufferData(N.PIXEL_PACK_BUFFER,a.byteLength,N.STREAM_READ),N.readPixels(t,n,r,i,at.convert(l),at.convert(u),0);let f=M===null?null:F.get(M).__webglFramebuffer;P.bindFramebuffer(N.FRAMEBUFFER,f);let p=N.fenceSync(N.SYNC_GPU_COMMANDS_COMPLETE,0);return N.flush(),await et(N,p,4),N.bindBuffer(N.PIXEL_PACK_BUFFER,d),N.getBufferSubData(N.PIXEL_PACK_BUFFER,0,a),N.deleteBuffer(d),N.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;I.setTexture2D(e,0),N.copyTexSubImage2D(N.TEXTURE_2D,n,0,0,o,s,i,a),P.unbindTexture()},this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=at.convert(t.format),_=at.convert(t.type),v;t.isData3DTexture?(I.setTexture3D(t,0),v=N.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(I.setTexture2DArray(t,0),v=N.TEXTURE_2D_ARRAY):(I.setTexture2D(t,0),v=N.TEXTURE_2D),P.activeTexture(N.TEXTURE0),P.pixelStorei(N.UNPACK_FLIP_Y_WEBGL,t.flipY),P.pixelStorei(N.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),P.pixelStorei(N.UNPACK_ALIGNMENT,t.unpackAlignment);let y=P.getParameter(N.UNPACK_ROW_LENGTH),b=P.getParameter(N.UNPACK_IMAGE_HEIGHT),x=P.getParameter(N.UNPACK_SKIP_PIXELS),S=P.getParameter(N.UNPACK_SKIP_ROWS),C=P.getParameter(N.UNPACK_SKIP_IMAGES);P.pixelStorei(N.UNPACK_ROW_LENGTH,h.width),P.pixelStorei(N.UNPACK_IMAGE_HEIGHT,h.height),P.pixelStorei(N.UNPACK_SKIP_PIXELS,l),P.pixelStorei(N.UNPACK_SKIP_ROWS,u),P.pixelStorei(N.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=F.get(e),r=F.get(t),h=F.get(n.__renderTarget),g=F.get(r.__renderTarget);P.bindFramebuffer(N.READ_FRAMEBUFFER,h.__webglFramebuffer),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,F.get(e).__webglTexture,i,d+n),N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,F.get(t).__webglTexture,a,m+n)),N.blitFramebuffer(l,u,o,s,f,p,o,s,N.DEPTH_BUFFER_BIT,N.NEAREST);P.bindFramebuffer(N.READ_FRAMEBUFFER,null),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||F.has(e)){let n=F.get(e),r=F.get(t);P.bindFramebuffer(N.READ_FRAMEBUFFER,ce),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,le);for(let e=0;e<c;e++)w?N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):N.framebufferTexture2D(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,n.__webglTexture,i),T?N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):N.framebufferTexture2D(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,r.__webglTexture,a),i===0?T?N.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):N.copyTexSubImage2D(v,a,f,p,l,u,o,s):N.blitFramebuffer(l,u,o,s,f,p,o,s,N.COLOR_BUFFER_BIT,N.NEAREST);P.bindFramebuffer(N.READ_FRAMEBUFFER,null),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?N.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?N.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):N.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?N.texSubImage2D(N.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?N.compressedTexSubImage2D(N.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):N.texSubImage2D(N.TEXTURE_2D,a,f,p,o,s,g,_,h);P.pixelStorei(N.UNPACK_ROW_LENGTH,y),P.pixelStorei(N.UNPACK_IMAGE_HEIGHT,b),P.pixelStorei(N.UNPACK_SKIP_PIXELS,x),P.pixelStorei(N.UNPACK_SKIP_ROWS,S),P.pixelStorei(N.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&N.generateMipmap(v),P.unbindTexture()},this.initRenderTarget=function(e){F.get(e).__webglFramebuffer===void 0&&I.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?I.setTextureCube(e,0):e.isData3DTexture?I.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?I.setTexture2DArray(e,0):I.setTexture2D(e,0),P.unbindTexture()},this.resetState=function(){ue=0,de=0,M=null,P.reset(),ot.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Ge}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=W._getDrawingBufferColorSpace(e),t.unpackColorSpace=W._getUnpackColorSpace()}},jl=1710638;function Ml(e=4){let t=new Uint8Array(e);for(let n=0;n<e;n++)t[n]=Math.round(n/(e-1)*255);let n=new _i(t,e,1,D);return n.minFilter=r,n.magFilter=r,n.generateMipmaps=!1,n.needsUpdate=!0,n}var Nl=Ml(4),Pl=new Map;function Fl(e){if(Pl.has(e))return Pl.get(e);let t=new ia({color:e,gradientMap:Nl});return Pl.set(e,t),t}function Il(e,t={}){return new ia({color:e,gradientMap:Nl,...t})}var Ll=null;function Rl(){return Ll||=new ri({color:jl,side:1}),Ll}function zl(e,t,n=1.05){let r=new Tn,i=new K(e,Fl(t));i.castShadow=!0,i.receiveShadow=!0;let a=new K(e,Rl());return a.scale.setScalar(n),r.add(i),r.add(a),r}function Bl(e,t,n,r){e.background=Vl(n,r),new Da().load(t,t=>{t.mapping=303,t.colorSpace=Be,e.background=t})}function Vl(e,t){let n=document.createElement(`canvas`);n.width=2,n.height=256;let r=n.getContext(`2d`),i=r.createLinearGradient(0,0,0,256);i.addColorStop(0,e),i.addColorStop(1,t),r.fillStyle=i,r.fillRect(0,0,2,256);let a=new Pi(n);return a.colorSpace=Be,a}function Hl(e,{count:t=600,near:n=60,far:r=150}={}){let i=new Float32Array(t*3),a=new Float32Array(t);for(let e=0;e<t;e++){let t=n+Math.random()*(r-n),o=Math.random()*Math.PI*2,s=Math.acos(2*Math.random()-1);i[e*3]=t*Math.sin(s)*Math.cos(o),i[e*3+1]=t*Math.cos(s),i[e*3+2]=t*Math.sin(s)*Math.sin(o),a[e]=.4+Math.random()*1.4}let o=new Dr;o.setAttribute(`position`,new fr(i,3)),o.setAttribute(`size`,new fr(a,1));let s=new ji(o,new Ei({color:16777215,size:1.1,sizeAttenuation:!0,transparent:!0,opacity:.9}));return e.add(s),s}function Ul(e,t){let n=t||[{r:7,color:16752451,position:[-45,22,-70]},{r:4,color:15952096,position:[55,-8,-60]}];for(let t of n){let n=zl(new Ki(t.r,32,24),t.color,1.03);n.position.set(t.position[0],t.position[1],t.position[2]),e.add(n)}}var Wl=``+new URL(`nebula-6ckb_XRn.jpg`,import.meta.url).href,Gl=class{constructor(){this.ctx=null,this.master=null,this.muted=!1,this._noiseBuf=null,this._lastSquish=0}ensure(){if(this.ctx){this.ctx.state===`suspended`&&this.ctx.resume();return}let e=window.AudioContext||window.webkitAudioContext;this.ctx=new e,this.master=this.ctx.createGain(),this.master.gain.value=this.muted?0:.1,this.master.connect(this.ctx.destination),this._buildNoise(),this._startAmbient()}_buildNoise(){let e=this.ctx.sampleRate*.5,t=this.ctx.createBuffer(1,e,this.ctx.sampleRate),n=t.getChannelData(0);for(let t=0;t<e;t++)n[t]=Math.random()*2-1;this._noiseBuf=t}_startAmbient(){let e=this.ctx.createGain();e.gain.value=.5;let t=this.ctx.createBiquadFilter();t.type=`lowpass`,t.frequency.value=620,e.connect(t).connect(this.master);for(let t of[-6,0,7]){let n=this.ctx.createOscillator();n.type=`sine`,n.frequency.value=110,n.detune.value=t,n.connect(e),n.start()}let n=this.ctx.createOscillator();n.frequency.value=.07;let r=this.ctx.createGain();r.gain.value=.18,n.connect(r).connect(e.gain),n.start()}squish(e){if(!this.ctx||this.muted)return;let t=this.ctx.currentTime;if(t-this._lastSquish<.07)return;this._lastSquish=t;let n=.25+.6*Math.min(1,e),r=this.ctx.createBufferSource();r.buffer=this._noiseBuf;let i=this.ctx.createBiquadFilter();i.type=`lowpass`,i.frequency.setValueAtTime(900+Math.random()*400,t),i.frequency.exponentialRampToValueAtTime(180,t+.14);let a=this.ctx.createGain();a.gain.setValueAtTime(1e-4,t),a.gain.exponentialRampToValueAtTime(.5*n,t+.012),a.gain.exponentialRampToValueAtTime(1e-4,t+.16),r.connect(i).connect(a).connect(this.master),r.start(t),r.stop(t+.18);let o=this.ctx.createOscillator();o.type=`sine`;let s=240+Math.random()*260;o.frequency.setValueAtTime(s,t),o.frequency.exponentialRampToValueAtTime(s*.6,t+.13);let c=this.ctx.createGain();c.gain.setValueAtTime(1e-4,t),c.gain.exponentialRampToValueAtTime(.32*n,t+.02),c.gain.exponentialRampToValueAtTime(1e-4,t+.19),o.connect(c).connect(this.master),o.start(t),o.stop(t+.2)}chime(){if(!this.ctx||this.muted)return;let e=this.ctx.currentTime,t=this.ctx.createGain();t.gain.setValueAtTime(1e-4,e),t.gain.exponentialRampToValueAtTime(.5,e+.01),t.gain.exponentialRampToValueAtTime(1e-4,e+.7),t.connect(this.master);for(let[n,r]of[[1318,1],[1976,.5],[2637,.28]]){let i=this.ctx.createOscillator();i.type=`sine`,i.frequency.value=n;let a=this.ctx.createGain();a.gain.value=r,i.connect(a).connect(t),i.start(e),i.stop(e+.72)}}gate(){if(!this.ctx||this.muted)return;let e=this.ctx.currentTime,t=this.ctx.createOscillator();t.type=`sawtooth`,t.frequency.setValueAtTime(70,e),t.frequency.exponentialRampToValueAtTime(150,e+.5);let n=this.ctx.createBiquadFilter();n.type=`lowpass`,n.frequency.setValueAtTime(220,e),n.frequency.exponentialRampToValueAtTime(600,e+.5);let r=this.ctx.createGain();r.gain.setValueAtTime(1e-4,e),r.gain.exponentialRampToValueAtTime(.32,e+.06),r.gain.exponentialRampToValueAtTime(1e-4,e+.75),t.connect(n).connect(r).connect(this.master),t.start(e),t.stop(e+.8)}splat(e=1){if(!this.ctx||this.muted)return;let t=this.ctx.currentTime,n=.4+.6*Math.min(1,e),r=this.ctx.createOscillator();r.type=`sine`,r.frequency.setValueAtTime(115,t),r.frequency.exponentialRampToValueAtTime(42,t+.18);let i=this.ctx.createBiquadFilter();i.type=`lowpass`,i.frequency.value=240;let a=this.ctx.createGain();a.gain.setValueAtTime(1e-4,t),a.gain.exponentialRampToValueAtTime(.55*n,t+.014),a.gain.exponentialRampToValueAtTime(1e-4,t+.34),r.connect(i).connect(a).connect(this.master),r.start(t),r.stop(t+.36),this.squish(.5+.5*e)}splash(e=1){if(!this.ctx||this.muted)return;let t=this.ctx.currentTime,n=.35+.65*Math.min(1,e),r=this.ctx.createBufferSource();r.buffer=this._noiseBuf;let i=this.ctx.createBiquadFilter();i.type=`bandpass`,i.Q.value=.9,i.frequency.setValueAtTime(400,t),i.frequency.exponentialRampToValueAtTime(2600,t+.22);let a=this.ctx.createGain();a.gain.setValueAtTime(1e-4,t),a.gain.exponentialRampToValueAtTime(.42*n,t+.015),a.gain.exponentialRampToValueAtTime(1e-4,t+.3),r.connect(i).connect(a).connect(this.master),r.start(t),r.stop(t+.32);let o=this.ctx.createBufferSource();o.buffer=this._noiseBuf;let s=this.ctx.createBiquadFilter();s.type=`lowpass`,s.frequency.setValueAtTime(520,t),s.frequency.exponentialRampToValueAtTime(120,t+.26);let c=this.ctx.createGain();c.gain.setValueAtTime(1e-4,t),c.gain.exponentialRampToValueAtTime(.5*n,t+.02),c.gain.exponentialRampToValueAtTime(1e-4,t+.34),o.connect(s).connect(c).connect(this.master),o.start(t),o.stop(t+.36)}nom(){if(!this.ctx||this.muted)return;this.squish(.5);let e=this.ctx.currentTime,t=this.ctx.createOscillator();t.type=`triangle`,t.frequency.setValueAtTime(300,e),t.frequency.exponentialRampToValueAtTime(560,e+.12);let n=this.ctx.createGain();n.gain.setValueAtTime(1e-4,e),n.gain.exponentialRampToValueAtTime(.34,e+.02),n.gain.exponentialRampToValueAtTime(1e-4,e+.24),t.connect(n).connect(this.master),t.start(e),t.stop(e+.26)}pop(){if(!this.ctx||this.muted)return;let e=this.ctx.currentTime,t=this.ctx.createOscillator();t.type=`sine`,t.frequency.setValueAtTime(680,e),t.frequency.exponentialRampToValueAtTime(240,e+.09);let n=this.ctx.createGain();n.gain.setValueAtTime(1e-4,e),n.gain.exponentialRampToValueAtTime(.22,e+.008),n.gain.exponentialRampToValueAtTime(1e-4,e+.12),t.connect(n).connect(this.master),t.start(e),t.stop(e+.14)}pew(e=1){if(!this.ctx||this.muted)return;let t=this.ctx.currentTime,n=Math.min(1,Math.max(0,e)),r=380+260*n,i=r*(2.4+1.2*n),a=.26-.09*n,o=this.ctx.createOscillator();o.type=`triangle`,o.frequency.setValueAtTime(r,t),o.frequency.exponentialRampToValueAtTime(i,t+a);let s=this.ctx.createGain();s.gain.setValueAtTime(1e-4,t),s.gain.exponentialRampToValueAtTime(.16+.16*n,t+.012),s.gain.exponentialRampToValueAtTime(1e-4,t+a),o.connect(s).connect(this.master),o.start(t),o.stop(t+a+.02)}pum(){if(!this.ctx||this.muted)return;let e=this.ctx.currentTime,t=this.ctx.createOscillator();t.type=`sine`,t.frequency.setValueAtTime(120,e),t.frequency.exponentialRampToValueAtTime(165,e+.07),t.frequency.exponentialRampToValueAtTime(62,e+.24);let n=this.ctx.createBiquadFilter();n.type=`lowpass`,n.frequency.value=320;let r=this.ctx.createGain();r.gain.setValueAtTime(1e-4,e),r.gain.exponentialRampToValueAtTime(.34,e+.03),r.gain.exponentialRampToValueAtTime(1e-4,e+.28),t.connect(n).connect(r).connect(this.master),t.start(e),t.stop(e+.3);let i=this.ctx.createBufferSource();i.buffer=this._noiseBuf;let a=this.ctx.createBiquadFilter();a.type=`lowpass`,a.frequency.setValueAtTime(700,e),a.frequency.exponentialRampToValueAtTime(220,e+.16);let o=this.ctx.createGain();o.gain.setValueAtTime(1e-4,e),o.gain.exponentialRampToValueAtTime(.14,e+.02),o.gain.exponentialRampToValueAtTime(1e-4,e+.18),i.connect(a).connect(o).connect(this.master),i.start(e),i.stop(e+.2)}ding(){if(!this.ctx||this.muted)return;let e=this.ctx.currentTime,t=this.ctx.createGain();t.gain.setValueAtTime(1e-4,e),t.gain.exponentialRampToValueAtTime(.42,e+.008),t.gain.exponentialRampToValueAtTime(1e-4,e+.38),t.connect(this.master);for(let[n,r]of[[1568,1],[2349,.45],[3136,.22]]){let i=this.ctx.createOscillator();i.type=`sine`,i.frequency.setValueAtTime(n,e),i.frequency.exponentialRampToValueAtTime(n*1.33,e+.3);let a=this.ctx.createGain();a.gain.value=r,i.connect(a).connect(t),i.start(e),i.stop(e+.4)}}setPurr(e){if(!this.ctx)return;if(!this._purr){let e=this.ctx.createOscillator();e.type=`sine`,e.frequency.value=58;let t=this.ctx.createBiquadFilter();t.type=`lowpass`,t.frequency.value=320;let n=this.ctx.createGain();n.gain.value=.5;let r=this.ctx.createOscillator();r.frequency.value=22;let i=this.ctx.createGain();i.gain.value=.5,r.connect(i).connect(n.gain);let a=this.ctx.createGain();a.gain.value=0,e.connect(t).connect(n).connect(a).connect(this.master),e.start(),r.start(),this._purr={g:a}}let t=this.muted?0:Math.min(1,e)*.16;this._purr.g.gain.setTargetAtTime(t,this.ctx.currentTime,.12)}setSnore(e){if(!this.ctx)return;if(!this._snore){let e=this.ctx.createBufferSource();e.buffer=this._noiseBuf,e.loop=!0;let t=this.ctx.createBiquadFilter();t.type=`lowpass`,t.frequency.value=380;let n=this.ctx.createGain();n.gain.value=.5;let r=this.ctx.createOscillator();r.type=`sine`,r.frequency.value=.13;let i=this.ctx.createGain();i.gain.value=.5,r.connect(i).connect(n.gain);let a=this.ctx.createGain();a.gain.value=0,e.connect(t).connect(n).connect(a).connect(this.master),e.start(),r.start(),this._snore={g:a}}let t=this.muted?0:Math.min(1,e)*.06;this._snore.g.gain.setTargetAtTime(t,this.ctx.currentTime,.4)}setMuted(e){this.muted=e,this.master&&this.master.gain.setTargetAtTime(e?0:.1,this.ctx.currentTime,.05)}},Kl=.94,ql=.9,Jl=.92;function Yl(e,t,n,r,i,a,o){let s=e.x-r.x,c=e.y-r.y,l=e.z-r.z,u=Math.sqrt(s*s+c*c+l*l),d=i+n;if(u>=d)return;let f,p,m;u<1e-6?(f=0,p=1,m=0,u=1e-6):(f=s/u,p=c/u,m=l/u),e.x=r.x+f*d,e.y=r.y+p*d,e.z=r.z+m*d;let h=o?a:1,g=e.x-t.x,_=e.y-t.y,v=e.z-t.z,y=g*f+_*p+v*m,b=g-f*y,x=_-p*y,S=v-m*y;t.x=e.x-b*h,t.y=e.y-x*h,t.z=e.z-S*h}var Xl=new H,Zl=new H;function Ql(e,t,n,r=new H){return Xl.set(-e.z,0,e.x),Xl.lengthSq()<1e-8&&Xl.set(1,0,0),Xl.normalize(),Zl.crossVectors(e,Xl).normalize(),r.copy(e).multiplyScalar(Math.cos(t)).addScaledVector(Xl,Math.cos(n)*Math.sin(t)).addScaledVector(Zl,Math.sin(n)*Math.sin(t)).normalize()}var $l=class{constructor({center:e=new H(0,0,0),radius:t=14,sea:n=null}={}){this.center=e.clone(),this.radius=t,this.obstacles=[],this.sea=null,this.waterZone=null,this._u=new H,this._t=new H,n&&this.setSea(n)}setSea({dir:e,radius:t,depth:n,shoreBand:r=t,buoyancy:i,drag:a,maxDepth:o,island:s=null}){let c=t/this.radius;if(this.sea={dir:e.clone().normalize(),radius:t,depth:n,angRadius:c,shoreBand:Math.min(Math.max(r,1e-6),t),cosAng:Math.cos(c),level:this.radius,island:null},s){let e=s.arc/this.radius;this.sea.island={dir:s.dir.clone().normalize(),arc:s.arc,flat:s.flat,rise:s.rise,angArc:e,cosAng:Math.cos(e),dryArc:0},this.sea.island.dryArc=this._measureDryArc()}return this.waterZone={center:this.center,dir:this.sea.dir,cosAng:this.sea.cosAng,level:this.sea.level,buoyancy:i,drag:a,maxDepth:o},this.sea}_measureDryArc(){let e=this.sea.island,t=new H,n=(n,r)=>(Ql(e.dir,n/this.radius,r,t).multiplyScalar(this.radius).add(this.center),this.floorRadius(t)>=this.sea.level),r=1/0;for(let t=0;t<16;t++){let i=t/16*Math.PI*2;if(!n(0,i))return 0;let a=0,o=e.arc;for(let e=0;e<24;e++){let e=(a+o)/2;n(e,i)?a=e:o=e}r=Math.min(r,a)}return r}addObstacle(e,t){return this.obstacles.push({center:e.clone(),radius:t}),this.obstacles[this.obstacles.length-1]}floorRadius(e){let t=this.sea;if(!t)return this.radius;let n=e.x-this.center.x,r=e.y-this.center.y,i=e.z-this.center.z,a=Math.sqrt(n*n+r*r+i*i);if(a<1e-6)return this.radius;let o=(n*t.dir.x+r*t.dir.y+i*t.dir.z)/a;if(o<=t.cosAng)return this.radius;let s=Math.acos(o>1?1:o)*this.radius,c=Math.min(1,(t.radius-s)/t.shoreBand),l=this.radius-t.depth*c*c*(3-2*c),u=t.island;if(u){let e=(n*u.dir.x+r*u.dir.y+i*u.dir.z)/a;if(e>u.cosAng){let t=Math.acos(e>1?1:e)/u.angArc,n=Math.min(1,Math.max(0,(1-t)/(1-u.flat))),r=n*n*(3-2*n);l+=(this.radius+u.rise-l)*r}}return l}isWater(e){let t=this.sea;if(!t)return!1;let n=e.x-this.center.x,r=e.y-this.center.y,i=e.z-this.center.z,a=Math.sqrt(n*n+r*r+i*i)||1e-6;return a<t.level&&(n*t.dir.x+r*t.dir.y+i*t.dir.z)/a>t.cosAng}waterInfo(e,t){let n=this.sea;if(!n)return null;let r=e.distanceTo(this.center),i=this._u.copy(e).sub(this.center).multiplyScalar(1/(r||1e-6)),a=Math.acos(B.clamp(i.dot(n.dir),-1,1))*this.radius,o=n.radius-a,s=!1,c=n.island;if(c){let e=Math.acos(B.clamp(i.dot(c.dir),-1,1))*this.radius-c.dryArc;e<o&&(o=e,s=!0)}if(t){let e=s?c.dir:n.dir;this._t.copy(e).addScaledVector(i,-i.dot(e)),s||this._t.negate(),this._t.lengthSq()<1e-8&&(this._t.set(-i.z,0,i.x),this._t.lengthSq()<1e-8&&this._t.set(1,0,0)),t.copy(this._t).normalize()}return{over:r-n.level,depth:n.level-this.floorRadius(e),dist:o,toIsland:s}}resolveParticle(e,t,n,r=!0){Yl(e,t,n,this.center,this.floorRadius(e),Kl,r);for(let i of this.obstacles)Yl(e,t,n,i.center,i.radius,ql,r)}},eu=class{constructor(e,t=[]){this.world=e,this.others=t,this.center=e.center,this.radius=e.radius}resolveParticle(e,t,n,r=!0){this.world.resolveParticle(e,t,n,r);for(let i of this.others)Yl(e,t,n,i.com,i.radius,Jl,r)}},tu=class{constructor(e,{minV:t,fullV:n,cooldown:r=.5}={}){this.world=e,this.minV=t,this.fullV=n,this.cooldown=r,this.inWater=!1,this.splash=0,this._cd=0}update(e,t,n){this.splash=0,this._cd=Math.max(0,this._cd-e);let r=this.world.sea;if(!r)return this.inWater=!1,0;let i=this.world.center,a=t.x-i.x,o=t.y-i.y,s=t.z-i.z,c=Math.sqrt(a*a+o*o+s*s)||1e-6,l=c<r.level&&(a*r.dir.x+o*r.dir.y+s*r.dir.z)/c>r.cosAng;if(l&&!this.inWater&&this._cd===0){let e=-(a*n.x+o*n.y+s*n.z)/c;if(e>=this.minV){let t=Math.min(1,(e-this.minV)/Math.max(1e-6,this.fullV-this.minV));this.splash=.25+.75*t,this._cd=this.cooldown}}return this.inWater=l,this.splash}},nu=typeof location<`u`&&new URLSearchParams(location.search).has(`big`),ru=nu?105:35,iu=14/ru,au=2.2,ou=3.5*au,su=2.9,cu=3*au,lu=.55,uu=.4,du=2*au,fu=.25,pu=.12,mu=3.5,hu=6.5,gu=[1.1,3.6],_u=1.35,vu=1.7,yu=.62,bu=.37,xu=1.2,Su=1.6,Cu=3.2,wu=.5,Tu=new H(.15,1,.35).normalize(),Eu=new H(.43,.77,1).normalize(),Du=new H;function Ou(e,t=new H){let n=Du.copy(e).normalize(),r=B.clamp(Tu.dot(n),-1,1),i=Math.acos(r);if(i<1e-6)return t.copy(Tu);n.addScaledVector(Tu,-r).normalize();let a=i*iu;return t.copy(Tu).multiplyScalar(Math.cos(a)).addScaledVector(n,Math.sin(a)).normalize()}var ku=Ou(Eu),Au=46,ju=B.degToRad(60),Mu=B.degToRad(200);function Nu(e,t,n){let r=e.clone().normalize(),i=new H(-r.z,0,r.x);i.lengthSq()<1e-6&&i.set(1,0,0),i.normalize();let a=new H().crossVectors(r,i).normalize(),o=t/ru;return r.multiplyScalar(Math.cos(o)).addScaledVector(i,Math.cos(n)*Math.sin(o)).addScaledVector(a,Math.sin(n)*Math.sin(o)).normalize()}var Pu=Nu(Tu,Au,ju),Fu=Nu(Pu,7,Mu);function Iu(){let e=Tu,t=new H(-e.z,0,e.x).normalize(),n=new H().crossVectors(e,t).normalize(),r=B.degToRad(65)*iu,i=B.degToRad(18)*iu,a=[e.clone()];for(let o=0;o<3;o++){let s=i+o*2*Math.PI/3;a.push(e.clone().multiplyScalar(Math.cos(r)).addScaledVector(t,Math.cos(s)*Math.sin(r)).addScaledVector(n,Math.sin(s)*Math.sin(r)).normalize())}return a}var Lu=[[18.75,44],[20.25,90],[15.5,172],[20.5,215]],Ru=24,zu=B.degToRad(157);function Bu(){let e=[];for(let t=0;t<4;t++){let[n,r]=Lu[t%Lu.length];e.push(Nu(Tu,n,B.degToRad(r)))}return e}function Vu(){let e=[];for(let t=0;t<2;t++)e.push(Nu(Tu,Ru,zu+t*2*Math.PI/2));return e}function Hu(e,t,n=new H(0,0,0)){let r=new H(-e.z,0,e.x).normalize(),i=new H().crossVectors(e,r).normalize(),a=au*.6/ru,o=t*Math.PI/2,s=e.clone().multiplyScalar(Math.cos(a)).addScaledVector(r,Math.cos(o)*Math.sin(a)).addScaledVector(i,Math.sin(o)*Math.sin(a)).normalize();return{nestDir:s,nestPos:s.clone().multiplyScalar(ru).add(n)}}var Uu=new H(0,1,0),Wu=new Ot,Gu=new H;function Ku(e,t,n,r=40){let i=new K(new Ki(e,r,Math.max(8,Math.round(r*.5)),0,Math.PI*2,0,t),Il(n));return i.receiveShadow=!0,i}function qu(e){let t=new Tn,n=1.1+e%2*.35,r=zl(new Bi(.16,.22,n,10),9067067,1.06);r.position.y=n/2,t.add(r);let i=zl(new Ki(.85+e%3*.12,18,14),e%2?5750874:7327866,1.05);if(i.position.y=n+.55,i.children[0].castShadow=!0,t.add(i),e%2==0){let e=zl(new Ki(.5,14,12),8378506,1.06);e.position.y=n+1.25,t.add(e)}return t}function Ju(e){let t=new Tn,n=.12+e%3*.05,r=[1.5,1.25,1],i=[.19,.15,.12],a=t;for(let e=0;e<r.length;e++){let t=new Tn;t.rotation.z=n;let o=zl(new Bi(i[e]*.85,i[e],r[e],9),1012e4,1.07);o.position.y=r[e]/2,t.add(o),a.add(t);let s=new Tn;s.position.y=r[e],t.add(s),a=s}let o=Il(5226338);for(let t=0;t<5;t++){let n=new K(new Ki(.62,12,8),o);n.scale.set(1.9,.16,.55),n.position.set(1.05,-.1,0);let r=new Tn;r.rotation.y=t/5*Math.PI*2+e,r.rotation.z=-.38,r.add(n),a.add(r)}let s=new K(new Ki(.22,10,8),Il(8016688));return a.add(s),t}var Yu=[new H(-1,.2,.3).normalize(),new H(.9,-.3,.4).normalize(),new H(.2,-1,-.15).normalize(),new H(-.5,-.6,.8).normalize(),new H(.3,.35,-1).normalize(),new H(-.8,.5,-.6).normalize()],Xu=[{dir:new H(-.9,-.4,-.3).normalize(),r:1.2},{dir:new H(.55,-.85,.5).normalize(),r:.95},{dir:new H(1,.25,-.5).normalize(),r:1.3},{dir:new H(-.2,.55,-1).normalize(),r:1}],Zu=[{dir:Ou(new H(.9,1,.6)),r:1.4},{dir:Ou(new H(-.35,1,-.6)),r:1.1},{dir:Ou(new H(.2,.85,-.7)),r:.9}],Qu=[Ou(new H(-.4,1,.5)),Ou(new H(.1,1,.75)),Ou(new H(-.7,.9,-.2)),Ou(new H(.45,1,.55)),...Yu];function $u(e,t){let n=t.radius,r=t.center,i=new Tn;i.position.copy(r),e.add(i);let a=(e,t)=>{Gu.copy(t).normalize(),Wu.setFromUnitVectors(Uu,Gu),e.quaternion.copy(Wu)},o=(e,t,r=0)=>{Gu.copy(t).normalize(),e.position.copy(Gu).multiplyScalar(n+r),a(e,Gu),i.add(e)},s=(e,o)=>{let s=zl(new Ki(o,16,12),10133677,1.05);s.children[0].castShadow=!0,s.children[0].receiveShadow=!0,Gu.copy(e).normalize(),s.position.copy(Gu).multiplyScalar(n+o*.35),a(s,Gu),s.scale.set(1,.8,1.1),i.add(s);let c=Gu.clone().multiplyScalar(n+o*.35).add(r);t.addObstacle(c,o*.85)},c=zl(new Ki(n,n>50?144:72,n>50?104:52),6539359,1.015);c.children[0].receiveShadow=!0,i.add(c);let l=Ku(n+.05,.44*iu,10217583);a(l,Ou(new H(.15,1,.35))),i.add(l);let u=16/n,d=Ku(n+.06,u*1.12,15916974);a(d,Pu),i.add(d);let f=Ku(n+.08,u,4169692);a(f,Pu),i.add(f);let p=Ku(n+.1,12/16*u,2781102);a(p,Pu),i.add(p);let m=t.sea&&t.sea.island;if(m){let e=Ku(n+uu+.05,m.dryArc*1.05/n,16246459);a(e,Fu),i.add(e),o(Ju(0),Fu,uu)}for(let e=0;e<3;e++)o(Ju(e+1),Nu(Pu,16.96,e/3*Math.PI*2+.6),0);for(let e=0;e<Qu.length;e++)o(qu(e),Qu[e],0);let h=[Ou(new H(-.15,1,.55)),Ou(new H(.28,1,.62)),Ou(new H(-.5,1,.2))],g=[16739179,16767293,15952096];for(let e=0;e<h.length;e++){let t=new Tn,n=zl(new Bi(.05,.06,.7,8),6012763,1.08);n.position.y=.35,t.add(n);let r=zl(new Ki(.26,14,12),g[e%g.length],1.08);r.scale.set(1,.55,1),r.position.y=.72,t.add(r);let i=new K(new Ki(.12,10,8),Il(16769914));i.position.y=.78,t.add(i),o(t,h[e],0)}for(let{dir:e,r:t}of Zu)s(e,t);for(let{dir:e,r:t}of Xu)s(e,t);let _=ed(i,t,a);return{group:i,nestDir:_.dir,nestPos:_.pos}}function ed(e,t,n){let r=t.radius,i=t.center,a=ku,o=2.86/r,s=new H(-a.z,0,a.x);s.lengthSq()<1e-5&&s.set(1,0,0),s.normalize();let c=new H().crossVectors(a,s).normalize(),l=(e,t,n)=>{let r=o*e,i=Math.cos(r),l=Math.sin(r);return n.copy(a).multiplyScalar(i).addScaledVector(s,l*Math.cos(t)).addScaledVector(c,l*Math.sin(t)).normalize()},u=new H,d=new K(new Ki(r+.07,30,16,0,Math.PI*2,0,o*1.08),Il(7645258));d.receiveShadow=!0,n(d,a),e.add(d);let f=new K(new Ki(r+.09,26,14,0,Math.PI*2,0,o*.66),Il(6263872));n(f,a),e.add(f);let p=[16239062,13625552,14208752,16114352,16305586,13623541],m=.5;for(let a=0;a<12;a++){l(1,a/12*Math.PI*2,u);let o=zl(new Ki(m,14,11),p[a%p.length],1.06);o.children[0].castShadow=!0,o.children[0].receiveShadow=!0,o.position.copy(u).multiplyScalar(r+m*.35),n(o,u),o.scale.set(1.05,.72,1.05),e.add(o);let s=u.clone().multiplyScalar(r+m*.3).add(i);t.addObstacle(s,m*.55)}let h=Il(6012763);for(let t of[Math.PI*.3,Math.PI*1.15]){l(1.02,t,u);let i=new K(new Vi(.06,.7,6),h);i.geometry.translate(0,.35,0),i.position.copy(u).multiplyScalar(r+.02),n(i,u),i.rotation.x+=.25,e.add(i)}return{dir:a.clone(),pos:a.clone().multiplyScalar(r).add(i)}}function td(e,t=1e-4){t=Math.max(t,2**-52);let n={},r=e.getIndex(),i=e.getAttribute(`position`),a=r?r.count:i.count,o=0,s=Object.keys(e.attributes),c={},l={},u=[],d=[`getX`,`getY`,`getZ`,`getW`],f=[`setX`,`setY`,`setZ`,`setW`];for(let t=0,n=s.length;t<n;t++){let n=s[t],r=e.attributes[n];c[n]=new r.constructor(new r.array.constructor(r.count*r.itemSize),r.itemSize,r.normalized);let i=e.morphAttributes[n];i&&(l[n]||(l[n]=[]),i.forEach((e,t)=>{let r=new e.array.constructor(e.count*e.itemSize);l[n][t]=new e.constructor(r,e.itemSize,e.normalized)}))}let p=t*.5,m=10**Math.log10(1/t),h=p*m;for(let t=0;t<a;t++){let i=r?r.getX(t):t,a=``;for(let t=0,n=s.length;t<n;t++){let n=s[t],r=e.getAttribute(n),o=r.itemSize;for(let e=0;e<o;e++)a+=`${~~(r[d[e]](i)*m+h)},`}if(a in n)u.push(n[a]);else{for(let t=0,n=s.length;t<n;t++){let n=s[t],r=e.getAttribute(n),a=e.morphAttributes[n],u=r.itemSize,p=c[n],m=l[n];for(let e=0;e<u;e++){let t=d[e],n=f[e];if(p[n](o,r[t](i)),a)for(let e=0,r=a.length;e<r;e++)m[e][n](o,a[e][t](i))}}n[a]=o,u.push(o),o++}}let g=e.clone();for(let t in e.attributes){let e=c[t];if(g.setAttribute(t,new e.constructor(e.array.slice(0,o*e.itemSize),e.itemSize,e.normalized)),t in l)for(let e=0;e<l[t].length;e++){let n=l[t][e];g.morphAttributes[t][e]=new n.constructor(n.array.slice(0,o*n.itemSize),n.itemSize,n.normalized)}}return g.setIndex(u),g}var nd=1/120,rd=6,id=8,ad=.02,od=.005,sd=6,cd=.25,ld=-6.5,ud=.986,dd=.45;function fd(e,t=1){let n=(1+Math.sqrt(5))/2,r=[[-1,n,0],[1,n,0],[-1,-n,0],[1,-n,0],[0,-1,n],[0,1,n],[0,-1,-n],[0,1,-n],[n,0,-1],[n,0,1],[-n,0,-1],[-n,0,1]].map(e=>new H(e[0],e[1],e[2])),i=[[0,11,5],[0,5,1],[0,1,7],[0,7,10],[0,10,11],[1,5,9],[5,11,4],[11,10,2],[10,7,6],[7,1,8],[3,9,4],[3,4,2],[3,2,6],[3,6,8],[3,8,9],[4,9,5],[2,4,11],[6,2,10],[8,6,7],[9,8,1]];for(let e=0;e<t;e++){let e=new Map,t=(t,n)=>{let i=t<n?t+`_`+n:n+`_`+t;if(e.has(i))return e.get(i);let a=r[t].clone().add(r[n]).multiplyScalar(.5),o=r.length;return r.push(a),e.set(i,o),o},n=[];for(let[e,r,a]of i){let i=t(e,r),o=t(r,a),s=t(a,e);n.push([e,i,s],[r,o,i],[a,s,o],[i,o,s])}i=n}return r=r.map(t=>t.normalize().multiplyScalar(e)),{verts:r,faces:i}}var pd=class{constructor(e,t,n=2,r={}){this.scene=e,this.radius=n,this.volumeUnits=r.volumeUnits??n**3,this.particleRadius=r.particleRadius??.22,this.shellStiffness=r.shellStiffness??ad,this.centerStiffness=r.centerStiffness??od,this.pressureK=r.pressureK??sd,this.shellStiffScale=1,this.velDamp=r.velDamp??ud,this.gravityCenter=r.gravityCenter??null,this.gravityStrength=r.gravityStrength??Math.abs(ld),this.gravityFalloffR=r.gravityFalloffR??null,this.gravityFalloffP=r.gravityFalloffP??2,this.waterZone=r.waterZone??null,this.gelColor=r.gelColor??16753592,this.coreColor=r.coreColor??16726883,this.outlineColor=r.outlineColor??3809072,this.gelOpacity=r.gelOpacity??.8,this.externalFace=r.externalFace??!1,this.subdivisions=r.subdivisions??2;let{verts:i,faces:a}=fd(n,this.subdivisions);this.faces=a,this.shellCount=i.length,this.pos=[],this.prev=[],this.ext=[];for(let e of i){let n=e.clone().add(t);this.pos.push(n),this.prev.push(n.clone()),this.ext.push(new H)}this.centerIdx=this.pos.length,this.pos.push(t.clone()),this.prev.push(t.clone()),this.ext.push(new H);let o=new Set;this.springs=[];let s=(e,t,n,r)=>{let i=e<t?e+`_`+t:t+`_`+e;o.has(i)||(o.add(i),this.springs.push({a:e,b:t,rest:this.pos[e].distanceTo(this.pos[t]),stiff:n,shell:r}))};for(let[e,t,n]of a)s(e,t,this.shellStiffness,!0),s(t,n,this.shellStiffness,!0),s(n,e,this.shellStiffness,!0);for(let e=0;e<this.shellCount;e++)s(e,this.centerIdx,this.centerStiffness,!1);this.restVolume=this._volume(),this.com=t.clone(),this.prevCom=t.clone(),this.velocity=new H,this.compression=0,this.grabActive=!1,this.grabParticles=[],this.grabLook=null,this.grabPoint=new H,this.grabStiff=0,this.grabbedMask=null,this.neckSoft=r.neckSoft??.12,this.returnRadius=r.returnRadius??null,this.returnStrength=r.returnStrength??1.5,this._buildMesh(),this._t1=new H,this._t2=new H,this._t3=new H,this._n=new H,this._up=new H(0,1,0),this._right=new H,this._dir=new H,this._acc=0,this._volGrad=[];for(let e=0;e<this.shellCount;e++)this._volGrad.push(new H)}_projectVolume(e){let t=this._volume(),n=this.restVolume-t;if(Math.abs(n)<1e-6*this.restVolume)return;for(let e of this._volGrad)e.set(0,0,0);for(let[e,t,n]of this.faces)this._volGrad[e].addScaledVector(this._t1.crossVectors(this.pos[t],this.pos[n]),1/6),this._volGrad[t].addScaledVector(this._t1.crossVectors(this.pos[n],this.pos[e]),1/6),this._volGrad[n].addScaledVector(this._t1.crossVectors(this.pos[e],this.pos[t]),1/6);let r=1e-9;for(let e of this._volGrad)r+=e.lengthSq();let i=e*n/r;for(let e=0;e<this.shellCount;e++)this.pos[e].addScaledVector(this._volGrad[e],i)}_volume(){let e=0;for(let[t,n,r]of this.faces){let i=this.pos[t],a=this.pos[n],o=this.pos[r];e+=i.x*(a.y*o.z-o.y*a.z)-i.y*(a.x*o.z-o.x*a.z)+i.z*(a.x*o.y-o.x*a.y)}return e/6}_buildMesh(){this.group=new Tn;let e=new Ki(this.radius,26,18);e.deleteAttribute(`uv`),e.deleteAttribute(`normal`),this.geo=td(e);let t=Il(this.gelColor,{transparent:!0,opacity:this.gelOpacity,depthWrite:!1});this.mesh=new K(this.geo,t),this.mesh.castShadow=!0,this.mesh.renderOrder=2,this.group.add(this.mesh);let n=new ri({color:this.outlineColor,side:1});if(this.outline=new K(this.geo,n),this.outline.scale.setScalar(1.04),this.outline.renderOrder=0,this.group.add(this.outline),this.core=new K(new Ki(this.radius*.46,16,12),Il(this.coreColor)),this.core.renderOrder=1,this.group.add(this.core),this.eyeWhites=[],this.eyePupils=[],!this.externalFace){let e=new ia({color:16777215}),t=new ri({color:1710638});for(let n of[-1,1]){let r=new K(new Ki(.34,14,12),e),i=new K(new Ki(.17,12,10),t);r.userData.side=n,r.renderOrder=3,i.renderOrder=4,this.eyeWhites.push(r),this.eyePupils.push(i),this.group.add(r,i)}}this.front=new H(0,0,1),this.scene.add(this.group),this._bindMesh()}_bindMesh(){let e=this.geo.attributes.position,t=e.count;this.binds=Array(t);let n=new H;for(let r=0;r<t;r++){n.fromBufferAttribute(e,r).add(this.com);let t=[];for(let e=0;e<this.shellCount;e++)t.push({j:e,d:n.distanceTo(this.pos[e])});t.sort((e,t)=>e.d-t.d);let i=t.slice(0,6),a=this.radius*.12,o=0;for(let e of i)e.w=1/(e.d*e.d+a*a*4),o+=e.w;for(let e of i)e.w/=o;this.binds[r]=i}}clearForces(){for(let e of this.ext)e.set(0,0,0)}addWind(e){for(let t=0;t<this.shellCount;t++)this.ext[t].add(e)}addPointerPull(e,t,n){let r=this._t1;for(let i=0;i<this.shellCount;i++){r.copy(e).sub(this.pos[i]);let a=r.length();if(a>t)continue;let o=1-a/t;r.multiplyScalar(n*o/(a+.001));let s=n;r.length()>s&&r.setLength(s),this.ext[i].add(r)}}beginGrab(e,t=5){let n=[];for(let t=0;t<this.shellCount;t++)n.push({i:t,d:e.distanceToSquared(this.pos[t])});n.sort((e,t)=>e.d-t.d),this.grabParticles=n.slice(0,t).map(e=>e.i),this.grabActive=!0,this.grabbedMask?this.grabbedMask.fill(0):this.grabbedMask=new Uint8Array(this.pos.length);for(let e of this.grabParticles)this.grabbedMask[e]=1}pullGrab(e,t=9){if(!this.grabActive)return;let n=this._t1,r=t*1.25;for(let i of this.grabParticles){n.copy(e).sub(this.pos[i]);let a=n.length(),o=t*Math.min(a,1.2);n.multiplyScalar(o/(a+.001)),n.length()>r&&n.setLength(r),this.ext[i].add(n)}this.grabLook=e}setGrabTarget(e,t=.5){this.grabPoint.copy(e),this.grabStiff=t,this.grabLook=e}endGrab(){this.grabActive=!1,this.grabStiff=0,this.grabLook=null,this.grabbedMask&&this.grabbedMask.fill(0)}addVelocity(e){for(let t=0;t<=this.centerIdx;t++)this.prev[t].addScaledVector(e,-.008333333333333333)}stretchAlong(e,t){let n=Math.hypot(e.x,e.y,e.z)||1,r=e.x/n,i=e.y/n,a=e.z/n,o=this.shellCount,s=0;for(let e=0;e<o;e++){let t=this.pos[e];s+=(t.x-this.com.x)*r+(t.y-this.com.y)*i+(t.z-this.com.z)*a}s/=o;for(let e=0;e<o;e++){let n=this.pos[e],o=t*((n.x-this.com.x)*r+(n.y-this.com.y)*i+(n.z-this.com.z)*a-s)*nd;this.prev[e].x-=r*o,this.prev[e].y-=i*o,this.prev[e].z-=a*o}}hop(e){for(let t=0;t<=this.centerIdx;t++)this.prev[t].y-=e*(.6+Math.random()*.4)*nd}_step(e){let t=this._volume(),n=this.pressureK*(this.restVolume-t)/this.restVolume;if(n!==0)for(let[e,t,r]of this.faces){let i=this.pos[e],a=this.pos[t],o=this.pos[r];this._t1.subVectors(a,i),this._t2.subVectors(o,i),this._n.crossVectors(this._t1,this._t2),this._n.multiplyScalar(n/6),this.ext[e].add(this._n),this.ext[t].add(this._n),this.ext[r].add(this._n)}let r=this.gravityCenter,i=this.gravityStrength,a=this.waterZone,o=a?a.center:null,s=a?a.drag/nd:0;for(let e=0;e<=this.centerIdx;e++){let t=this.pos[e],n=this.prev[e],c=(t.x-n.x)*this.velDamp,l=(t.y-n.y)*this.velDamp,u=(t.z-n.z)*this.velDamp;n.copy(t);let d=this.ext[e].x,f=this.ext[e].y,p=this.ext[e].z;if(r){let e=r.x-t.x,n=r.y-t.y,a=r.z-t.z,o=Math.sqrt(e*e+n*n+a*a)||1e-6,s=this.gravityFalloffR,c=s!==null&&o>s?i*(s/o)**+this.gravityFalloffP/o:i/o;this.returnRadius&&o>this.returnRadius&&(c+=this.returnStrength*(o-this.returnRadius)/o),d+=e*c,f+=n*c,p+=a*c}else f+=ld;if(a){let e=t.x-o.x,n=t.y-o.y,r=t.z-o.z,i=Math.sqrt(e*e+n*n+r*r)||1e-6;if(i<a.level&&(e*a.dir.x+n*a.dir.y+r*a.dir.z)/i>a.cosAng){let t=Math.min(a.level-i,a.maxDepth),o=a.buoyancy*t/(a.maxDepth*i);d+=e*o,f+=n*o,p+=r*o,d-=c*s,f-=l*s,p-=u*s}}let m=c+d*nd*nd,h=l+f*nd*nd,g=u+p*nd*nd,_=m*m+h*h+g*g;if(_>dd*dd){let e=dd/Math.sqrt(_);m*=e,h*=e,g*=e}t.x+=m,t.y+=h,t.z+=g}for(let t=0;t<id;t++){if(this.grabActive&&this.grabStiff>0){let e=this.grabPoint,t=this.grabStiff;for(let n of this.grabParticles){let r=this.pos[n];r.x+=(e.x-r.x)*t,r.y+=(e.y-r.y)*t,r.z+=(e.z-r.z)*t}}let n=this.grabActive?this.grabbedMask:null;for(let e of this.springs){let t=this.pos[e.a],r=this.pos[e.b],i=r.x-t.x,a=r.y-t.y,o=r.z-t.z,s=Math.sqrt(i*i+a*a+o*o)||1e-6,c=n&&(n[e.a]||n[e.b])?this.neckSoft:1,l=(s-e.rest)/s*.5*e.stiff*this.shellStiffScale*c,u=i*l,d=a*l,f=o*l;t.x+=u,t.y+=d,t.z+=f,r.x-=u,r.y-=d,r.z-=f}if(this._projectVolume(cd),e){let n=t===id-1;for(let t=0;t<=this.centerIdx;t++)e.resolveParticle(this.pos[t],this.prev[t],this.particleRadius,n)}}}update(e,t){this._acc+=Math.min(e,.05);let n=0;for(;this._acc>=nd&&n<rd;)this._step(t),this._acc-=nd,n++;this.prevCom.copy(this.com),this.com.set(0,0,0);for(let e=0;e<this.shellCount;e++)this.com.add(this.pos[e]);this.com.multiplyScalar(1/this.shellCount),e>0&&this.velocity.copy(this.com).sub(this.prevCom).multiplyScalar(1/e);let r=this._volume();this.compression=(this.restVolume-r)/this.restVolume,this._syncMesh()}_syncMesh(){let e=this.geo.attributes.position,t=this._t1;for(let n=0;n<e.count;n++){t.set(0,0,0);for(let e of this.binds[n])t.addScaledVector(this.pos[e.j],e.w);e.setXYZ(n,t.x-this.com.x,t.y-this.com.y,t.z-this.com.z)}e.needsUpdate=!0,this.geo.computeVertexNormals(),this.group.position.copy(this.com),this._t2.copy(this.pos[this.centerIdx]).sub(this.com),this.core.position.copy(this._t2),this.externalFace||this._updateEyes()}surfaceAlong(e,t,n){let r=Math.hypot(e.x,e.y,e.z)||1,i=e.x/r,a=e.y/r,o=e.z/r,s=0,c=-2;for(let e=0;e<this.shellCount;e++){let t=this.pos[e].x-this.com.x,n=this.pos[e].y-this.com.y,r=this.pos[e].z-this.com.z,l=Math.hypot(t,n,r)||1,u=(t*i+n*a+r*o)/l;u>c&&(c=u,s=e)}return n.set(this.pos[s].x-this.com.x+i*t,this.pos[s].y-this.com.y+a*t,this.pos[s].z-this.com.z+o*t),n}_updateEyes(){let e=this._t3.copy(this.velocity);if(e.y=0,e.lengthSq()>.05&&(e.normalize(),this.front.lerp(e,.12).normalize()),this.grabLook){let e=this._t3.copy(this.grabLook).sub(this.com);e.y=0,e.lengthSq()>.02&&(e.normalize(),this.front.lerp(e,.3).normalize())}let t=this._right.crossVectors(this._up,this.front).normalize();for(let e=0;e<2;e++){let n=this.eyeWhites[e].userData.side,r=this._dir.copy(this.front).addScaledVector(t,.42*n).addScaledVector(this._up,.34).normalize(),i=0,a=-2;for(let e=0;e<this.shellCount;e++){let t=this.pos[e].x-this.com.x,n=this.pos[e].y-this.com.y,o=this.pos[e].z-this.com.z,s=Math.hypot(t,n,o)||1,c=(t*r.x+n*r.y+o*r.z)/s;c>a&&(a=c,i=e)}let o=this._t2.copy(this.pos[i]).sub(this.com).addScaledVector(r,.16);this.eyeWhites[e].position.copy(o),this.eyePupils[e].position.copy(o).addScaledVector(r,.26)}}dispose(){this.scene.remove(this.group),this.geo.dispose()}},md=.5,hd=1.3,gd={shellScale:1,pressureMul:1},_d={restMul:1,jumpUpMul:1,jumpTangMul:1,idleMul:1,energyDecayMul:1,sleepTrigger:.2,lowEnergy:.3,clingy:!1,shy:!1};function vd(e,t,n,r,i={},a={}){let o={...gd,...i};return o.shellScale=Math.min(hd,Math.max(md,o.shellScale)),{id:e,name:t,emoji:n,palette:r,body:o,brain:{..._d,...a}}}var yd=vd(`neutral`,`Обычный`,`🙂`,{gel:16769610,core:16773280,lid:16173375,outline:5915664}),bd={kisel:vd(`kisel`,`Кисель`,`🍮`,{gel:16763299,core:16773341,lid:16101763,outline:7028509},{shellScale:.6,pressureMul:.75},{restMul:1.6,jumpUpMul:.75,jumpTangMul:.8,idleMul:1.8,energyDecayMul:.8,sleepTrigger:.3,lowEnergy:.45}),popryg:vd(`popryg`,`Попрыгун`,`⚡`,{gel:13168730,core:15925184,lid:11460170,outline:4151824},{shellScale:1.25,pressureMul:1.15},{restMul:.6,jumpUpMul:1.3,jumpTangMul:1.15,idleMul:.35,energyDecayMul:1.3}),lipuchka:vd(`lipuchka`,`Липучка`,`💗`,{gel:16753602,core:16769260,lid:16092080,outline:5902384},{},{restMul:.9,clingy:!0}),dichok:vd(`dichok`,`Дичок`,`🌱`,{gel:10733823,core:14740991,lid:9155573,outline:1915499},{},{shy:!0})},xd=6041378,Sd=class{constructor(e,t,n,r=2.2,i=yd){this.world=t,this.traits=i,this.brain=null;let a=i.palette;this.body=new pd(e,n.clone(),r,{subdivisions:2,gravityCenter:t.center,gravityStrength:6.5,returnRadius:t.radius*5,returnStrength:1.5,externalFace:!0,volumeUnits:r**3,gelColor:a.gel,coreColor:a.core,outlineColor:a.outline,gelOpacity:.82,waterZone:t.waterZone??null}),this.body.core.material.emissive=new G(a.gel),this.body.core.material.emissiveIntensity=.5,this.body.core.scale.setScalar(.78),this.basePressureK=this.body.pressureK,this.body.pressureK=this.basePressureK*i.body.pressureMul,this.body.shellStiffScale=i.body.shellScale,this.group=this.body.group,this.R=r,this.up=new H(0,1,0),this.front=new H(0,0,1),this.right=new H(1,0,0),this.faceDir=new H(0,.4,1).normalize(),this._fr=new H,this._fu=new H,this.faceRig=new Tn,this.faceR=r,this.t=0,this.blinkTimer=2+Math.random()*3,this.blink=0,this.lidClose=0,this.mouthOpen=0,this.yawnTimer=10+Math.random()*8,this.yawn=0,this.squeeze=0,this.sleepiness=0,this.asleepTarget=0,this.sleep=0,this.sleepFaceDir=new H(0,1,0),this.breathPhase=0,this.grabbed=!1,this.grabTime=0,this.surprise=0,this.joy=0,this.landSquint=0,this.eyeScale=1,this.flying=!1,this.moodExcited=0,this.moodSad=0,this.mouthDrive=0,this.sproutPerk=0,this.lookTarget=null,this.landImpact=0,this.prevRadial=0,this.wasAir=!1,this.landCooldown=0,this._m=new Xt,this._x=new H,this._y=new H,this._z=new H,this._p=new H,this._d=new H,this._tf=new H,this._buildFace(),this.isActive=!1}setActive(e){this.isActive=!!e}get com(){return this.body.com}_setBasis(e,t,n,r){this._z.copy(n).normalize(),this._x.crossVectors(r,this._z),this._x.lengthSq()<1e-5&&this._x.set(1,0,0),this._x.normalize(),this._y.crossVectors(this._z,this._x).normalize(),this._m.makeBasis(this._x,this._y,this._z),e.position.copy(t),e.quaternion.setFromRotationMatrix(this._m)}_buildFace(){let e=this.group;e.add(this.faceRig);let t=(e,t,n,r,i=0,a=!0)=>{let o=new H(t,n,r).normalize();if(e.position.copy(o).multiplyScalar(this.R+i),a){let t=o.clone(),n=new H().crossVectors(new H(0,1,0),t);n.lengthSq()<1e-5&&n.set(1,0,0),n.normalize();let r=new H().crossVectors(t,n).normalize();e.quaternion.setFromRotationMatrix(new Xt().makeBasis(n,r,t))}this.faceRig.add(e)},n=this.R*.095,r=new ri({color:2825748}),i=new ri({color:16777215}),a=new ia({color:this.traits.palette.lid});this._lidMat=a,this.eyes=[];for(let e of[-1,1]){let o=new Tn,s=new K(new Ki(n,14,12),r);s.renderOrder=4;let c=new K(new Ki(n*.28,8,8),i);c.position.set(n*.3,n*.35,n*.75),c.renderOrder=5;let l=new Tn,u=new K(new Ki(n*1.25,16,10,0,Math.PI*2,0,Math.PI*.62),a);u.renderOrder=6,l.add(u),l.rotation.x=-1.45,o.add(s,c,l),t(o,.3*e,.16,1,n*.5,!1),this.eyes.push({rig:o,lidPivot:l,dot:s,side:e,wR:n})}let o=new ri({color:xd}),s=new Tn,c=new K(new qi(this.R*.09,this.R*.018,8,20,Math.PI),o);c.rotation.z=Math.PI,c.position.z=.02,c.renderOrder=4;let l=new K(new zi(this.R*.085,20),o);l.position.z=.015,l.renderOrder=3;let u=new K(new zi(this.R*.045,12),new ri({color:16743066}));u.position.set(0,-this.R*.03,.02),u.renderOrder=4,l.visible=!1,u.visible=!1,s.add(l,u,c),t(s,0,-.22,1,this.R*.03,!1),this.mouthRig=s,this.mouthO=l,this.mouthTongue=u,this.mouthSmile=c;let d=new ri({color:16751280,transparent:!0,opacity:.6});this.cheeks=[];for(let e of[-1,1]){let n=new K(new zi(this.R*.12,16),d);n.renderOrder=3,t(n,.5*e,-.08,1,.045),this.cheeks.push({mesh:n,side:e})}let f=new ia({color:9099370});this.antennae=[];{let t=new K(new Bi(.035,.075,1,8),f);t.geometry.translate(0,.5,0);let n=new Tn;for(let e of[-1,1]){let t=new K(new Ki(.16,12,10),f);t.scale.set(.55,1,.3),t.position.set(e*.16,.12,0),t.rotation.z=-e*.7,n.add(t)}e.add(t,n),this.antennae.push({stalk:t,tip:n,az:0,len:.72,off:new H,vel:new H})}}_dir(e,t,n){return this._d.copy(this.front).multiplyScalar(e).addScaledVector(this.right,t).addScaledVector(this.up,n).normalize()}update(e,t){this.t+=e;let n=this.body;this.sleep+=(this.asleepTarget-this.sleep)*(1-Math.exp(-e*.9)),this.up.copy(this.com).sub(this.world.center).normalize(),this._d.copy(t.position).sub(this.com),this.camEl=B.clamp(this._d.dot(this.up)/(this._d.length()+1e-6),0,.85);let r=this._d.dot(this.up);if(this.front.copy(this._d).addScaledVector(this.up,-r),this.front.lengthSq()<1e-4&&this.front.set(1,0,0),this.front.normalize(),this.lookTarget){this._d.copy(this.lookTarget).sub(this.com);let e=this._d.dot(this.up);this._d.addScaledVector(this.up,-e),this._d.lengthSq()>1e-4&&this.front.copy(this._d).normalize()}this.right.crossVectors(this.up,this.front).normalize(),this._d.copy(this.front).addScaledVector(this.up,.3+this.camEl*.9).normalize(),this.sleep>.001&&this._d.lerp(this.sleepFaceDir,this.sleep).normalize();let i=5*(1-this.sleep)+.6*this.sleep;this.faceDir.lerp(this._d,1-Math.exp(-e*i)).normalize();let a=1e-6,o=0,s=1e-6,c=0;for(let e=0;e<n.shellCount;e++){this._x.copy(n.pos[e]).sub(this.com);let t=this._x.length()+1e-6,r=this._x.dot(this.faceDir)/t;if(r>.55){let e=(r-.55)*(r-.55);a+=e,o+=t*e}let i=this._x.dot(this.up)/t;if(i>.55){let e=(i-.55)*(i-.55);s+=e,c+=t*e}}this.faceR+=((o>0?o/a:this.R)-this.faceR)*Math.min(1,e*10),this.crownR=(this.crownR??this.R)+((c>0?c/s:this.R)-(this.crownR??this.R))*Math.min(1,e*10);let l=this.com.distanceTo(this.world.center)-this.world.radius,u=B.clamp((l-this.R*.9)/this.R,0,1),d=n.velocity.length(),f=Math.max(0,n.compression),p=n.velocity.dot(this.up);if(this.landCooldown=Math.max(0,this.landCooldown-e),u>.5&&(this.wasAir=!0),this.wasAir&&this.landCooldown===0&&l<this.R*.7&&this.prevRadial<-2&&p>this.prevRadial+1.5){let e=B.clamp(-this.prevRadial/12,.25,1);this.landImpact=e,this.landSquint=1,this.joy=1.5,this.surprise=0,this.wasAir=!1,this.landCooldown=.4}this.prevRadial=p,this.grabTime=this.grabbed?this.grabTime+e:0,this.surprise=Math.max(0,this.surprise-e*1.5),this.joy=Math.max(0,this.joy-e),this.landSquint=Math.max(0,this.landSquint-e*3.5);let m=this.grabbed&&d<.7?B.clamp((this.grabTime-1.2)*.4,0,.32):0;this.blinkTimer-=e,this.blinkTimer<=0&&this.blink===0&&(this.blink=.001,this.blinkTimer=3+Math.random()*3),this.blink>0&&(this.blink+=e*7,this.blink>=2&&(this.blink=0));let h=this.blink===0?0:Math.sin(Math.min(this.blink,1)*Math.PI);this.yawnTimer-=e,this.yawnTimer<=0&&this.yawn===0&&this.sleep<.5&&(this.yawn=.001,this.yawnTimer=this.sleepiness>.3?4+Math.random()*4:12+Math.random()*10),this.yawn>0&&(this.yawn+=e*.9,this.yawn>=2&&(this.yawn=0));let g=this.yawn===0?0:Math.sin(Math.min(this.yawn,1)*Math.PI),_=d<.25&&f<.02&&u<.05?.28:0,v=Math.max(h,this.squeeze,f*4,_,g*.6,this.landSquint,m,this.sleepiness*.55,this.sleep);this.lidClose+=(v-this.lidClose)*Math.min(1,e*16),this.mouthDrive=Math.max(0,this.mouthDrive-e*2),this.sproutPerk=Math.max(0,this.sproutPerk-e*1.5);let y=Math.max(u*.9,f*5,this.squeeze*.8,this.surprise*.35,this.mouthDrive,+!!this.flying)*(1-this.sleep);y=Math.max(y,g);let b=Math.min(1,y);this.mouthOpen+=(b-this.mouthOpen)*Math.min(1,e*14);let x=1+.4*Math.max(this.surprise,u*.8,+!!this.flying)+.3*this.moodExcited;this.eyeScale+=(x-this.eyeScale)*Math.min(1,e*12),this.squeeze=Math.max(0,this.squeeze-e*2.5);let S=1.6*(1-.5*this.sleep),C=.018*(1+this.sleep)*(1-u);this.breathPhase+=e*S;let w=1+Math.sin(this.breathPhase)*C;this.group.scale.setScalar(w),this._layoutFace(h,e)}_layoutFace(e,t){this._setBasis(this.faceRig,this._p.set(0,0,0),this.faceDir,this.up),this.faceRig.scale.setScalar(this.faceR/this.R);for(let e of this.eyes)e.lidPivot.rotation.x=B.lerp(-1.45,.55,this.lidClose),e.dot.scale.setScalar(this.eyeScale);{let e=this.mouthOpen,t=B.clamp(this.joy,0,1),n=e>.3;if(this.mouthSmile.visible=!n,this.mouthO.visible=n,this.mouthTongue.visible=n&&e>.45,n){let t=.55+e*.75;this.mouthO.scale.set(t,t*(.9+e*.25),1),this.mouthTongue.scale.setScalar(.6+e*.5)}else{let e=1-.45*this.sleep;this.mouthSmile.scale.set((1+t*.35)*e,(1+t*.2)*e,1)}}this._d.copy(this.body.velocity);let n=this._d.dot(this.up);this._d.addScaledVector(this.up,-n).multiplyScalar(-.12),this._d.addScaledVector(this.up,-n*.05);for(let e of this.antennae){this._p.copy(this.up).addScaledVector(this.faceDir,.15).normalize().multiplyScalar((this.crownR??this.R)-.02);let n=this._d;e.vel.addScaledVector(this._x.copy(n).sub(e.off),Math.min(1,t*9)),e.vel.multiplyScalar(.86),e.off.addScaledVector(e.vel,1),this._y.copy(this.up).addScaledVector(e.off,1),this.moodSad>.001&&(this._tf.copy(this.faceDir).addScaledVector(this.up,-this.faceDir.dot(this.up)),this._tf.lengthSq()>1e-6&&this._tf.normalize(),this._y.addScaledVector(this._tf,this.moodSad*.6).addScaledVector(this.up,-this.moodSad*.32)),this._y.normalize();let r=1+this.moodExcited*.25+this.sproutPerk*.45;this._m.identity();let i=this._z.set(1,0,0);this._x.crossVectors(this._y,i),this._x.lengthSq()<1e-5&&this._x.set(0,0,1),this._x.normalize(),this._z.crossVectors(this._x,this._y).normalize(),this._m.makeBasis(this._x,this._y,this._z);let a=e.len*r;e.stalk.position.copy(this._p),e.stalk.quaternion.setFromRotationMatrix(this._m),e.stalk.scale.set(1,a,1),e.tip.position.copy(this._p).addScaledVector(this._y,a),e.tip.quaternion.setFromRotationMatrix(this._m)}}poke(e=1){this.squeeze=Math.min(1,this.squeeze+e)}mouthPop(e=1){this.mouthDrive=Math.max(this.mouthDrive,Math.min(1,e))}sproutBoost(){this.sproutPerk=1}chomp(){this.mouthDrive=1,this.squeeze=.15,this.joy=Math.max(this.joy,1.2)}lookAt(e){this.lookTarget=e?this._look?this._look.copy(e):this._look=e.clone():null}mouthWorld(e){return this.mouthRig.getWorldPosition(e)}crownWorld(e){return e.copy(this.com).addScaledVector(this.up,this.crownR??this.R)}setTemperament(e){this.traits=e;let t=e.palette;this.body.mesh.material.color.setHex(t.gel),this.body.core.material.color.setHex(t.core),this.body.core.material.emissive.setHex(t.gel),this.body.outline.material.color.setHex(t.outline),this._lidMat.color.setHex(t.lid);let n=this.basePressureK*e.body.pressureMul;this.body.pressureK=n,this.brain&&this.brain._pressK0!=null&&(this.brain._pressK0=n),this.body.shellStiffScale=e.body.shellScale}setGrabbed(e){this.grabbed=e,e&&(this.surprise=1,this.grabTime=0,this.wasAir=!1)}dispose(){this.body.dispose()}};function Cd(e,t,n,r=0){let i=t.clone().normalize(),a=i.clone().multiplyScalar(n.floorRadius(i.clone().multiplyScalar(n.radius).add(n.center))+e.R+r).add(n.center),o=e.body,s=a.clone().sub(o.com);for(let e=0;e<o.pos.length;e++)o.pos[e].add(s),o.prev[e].add(s);return o.com.add(s),o.group&&o.group.position.copy(o.com),e}var wd=B.degToRad(75),Td=.006,Ed=.98,Dd=class{constructor(e,t,{dist:n=34,minDist:r=6,maxDist:i=40}={}){this.camera=e,this.target=t.clone(),this.yaw=.5,this.pitch=.35,this.dist=n,this.minDist=r,this.maxDist=i,this.yawVel=0,this.pitchVel=0,this.dragging=!1,this._p=new H,this.apply()}startDrag(){this.dragging=!0,this.yawVel=0,this.pitchVel=0}endDrag(){this.dragging=!1}drag(e,t){let n=-e*Td,r=t*Td;this.yaw+=n,this.pitch=B.clamp(this.pitch+r,-wd,wd),this.yawVel=n,this.pitchVel=r}zoom(e){this.dist=B.clamp(this.dist+e,this.minDist,this.maxDist)}update(e){if(!this.dragging){this.yaw+=this.yawVel,this.pitch=B.clamp(this.pitch+this.pitchVel,-wd,wd);let t=Ed**(e*60);this.yawVel*=t,this.pitchVel*=t}this.apply()}apply(){let e=this._p,t=Math.cos(this.pitch),n=Math.sin(this.pitch);e.set(this.target.x+this.dist*t*Math.sin(this.yaw),this.target.y+this.dist*n,this.target.z+this.dist*t*Math.cos(this.yaw)),this.camera.position.copy(e),this.camera.up.set(0,1,0),this.camera.lookAt(this.target)}},Od=5596888,kd=6.5,Ad=.34,jd=.995,Md=.35,Nd=26,Pd=3,Fd=class{constructor(e,t,n,r={}){this.world=t,this.R=r.radius??.5,this.dish=r.dish||null,this.boostMul=Number.isFinite(r.boostMul)?r.boostMul:0,this.boostDur=Number.isFinite(r.boostDur)?r.boostDur:0,this.color=Number.isFinite(r.color)?r.color:Od;let i=t.center,a=n.clone().normalize(),o=r.startDist??t.radius+this.R*12;this.pos=i.clone().addScaledVector(a,o),this.vel=new H,this.age=0,this.settled=!1,this.restedAt=null,this.beingEaten=!1,this.dead=!1,this.scale=1,this.bobPhase=Math.random()*Math.PI*2,this._t=new H,this._surfN=new H,this._build(e),this._sync()}_build(e){this.group=new Tn;let t=zl(new Ki(this.R,18,14),this.color,1.06);if(t.children[0].castShadow=!0,this.group.add(t),this.dish){e.add(this.group);return}let n=new K(new Ki(this.R*.28,10,8),new ri({color:2761552}));n.position.y=this.R*.92,n.scale.set(1,.5,1),this.group.add(n);let r=Il(7061339),i=new K(new Bi(.03,.04,this.R*.7,6),r);i.position.y=this.R*1.2,this.group.add(i);let a=new K(new Ki(this.R*.42,10,8),r);a.scale.set(1,.28,.6),a.position.set(this.R*.28,this.R*1.35,0),a.rotation.z=-.5,this.group.add(a),e.add(this.group)}update(e){if(this.dead)return;this.age+=e;let t=this.world.center;if(this.beingEaten){this._sync();return}this._t.copy(t).sub(this.pos);let n=this._t.length()||1e-6;if(this.vel.addScaledVector(this._t,kd/n*e),this.vel.multiplyScalar(jd),this.world.isWater&&this.world.isWater(this.pos)){let n=this.pos.distanceTo(t)||1e-6,r=this.R*2,i=Math.min(this.world.sea.level-n,r);this._t.copy(this.pos).sub(t).multiplyScalar(1/n),this.vel.addScaledVector(this._t,i/r*Nd*e),this.vel.multiplyScalar(Math.max(0,1-Pd*e)),this.vel.length()<Md&&!this.settled&&(this.settled=!0,this.restedAt=this.age)}this.pos.addScaledVector(this.vel,e);let r=this.pos.distanceTo(t),i=(this.world.floorRadius?this.world.floorRadius(this.pos):this.world.radius)+this.R;if(r<i){let e=(this.pos.x-t.x)/(r||1e-6),n=(this.pos.y-t.y)/(r||1e-6),a=(this.pos.z-t.z)/(r||1e-6);this.pos.set(t.x+e*i,t.y+n*i,t.z+a*i);let o=this.vel.x*e+this.vel.y*n+this.vel.z*a,s=this.vel.x-e*o,c=this.vel.y-n*o,l=this.vel.z-a*o,u=o<0?-o*Ad:0;this.vel.set(s*.6+e*u,c*.6+n*u,l*.6+a*u),this.vel.length()<Md&&(this.vel.set(0,0,0),this.settled||(this.settled=!0,this.restedAt=this.age))}this._sync()}_sync(){this._surfN.copy(this.pos).sub(this.world.center).normalize();let e=this.group;if(!e)return;e.position.copy(this.pos),e.quaternion.setFromUnitVectors(Id,this._surfN);let t=this.scale;if(this.settled&&!this.beingEaten){let n=Math.sin(this.age*2.2+this.bobPhase);t*=1+n*.04,e.position.addScaledVector(this._surfN,n*.03)}let n=Math.max(.001,t);this.dish?e.scale.set(n*1.05,n*.72,n*1.05):e.scale.setScalar(n)}startEat(){this.beingEaten=!0,this.settled=!1,this.vel.set(0,0,0)}magnetize(e,t){this.pos.lerp(e,.35),this.scale=Math.max(0,1-t)}finishEat(){this.dead=!0}cancelEat(){this.beingEaten=!1,this.scale=1,this.settled=!1,this.vel.set(0,0,0)}dispose(){this.group&&this.world&&this.group.parent&&this.group.parent.remove(this.group)}},Id=new H(0,1,0);function Ld(e,t=[]){if(!e||e.dead||e.beingEaten)return!1;for(let n of t)if(n&&n.phase===`eat`&&n.eatBerry===e)return!1;return!0}function Rd(e,t,n,r=[]){let i=e.indexOf(t);return i<0||!Ld(t,r)?!1:(e.splice(i,1),t.dead=!0,n.add(`berry`,1),!0)}var zd={spiceSugar:{id:`spiceSugar`,icon:`✨`,name:`Сахарная пыльца`,price:10},spiceMint:{id:`spiceMint`,icon:`🌿`,name:`Мятная искра`,price:15}};function Bd(e){return Object.prototype.hasOwnProperty.call(zd,e)}function Vd(e){let t=e&&typeof e==`object`?e:zd[e],n=t&&t.price;return Number.isFinite(n)&&n>0?Math.floor(n):0}var Hd=`ember`,Ud=`🪨`,Wd=`Уголёк`,Gd={jam:{id:`jam`,dish:`dishJam`,icon:`🍯`,name:`Ягодный джем`,ingredients:{berry:2,spiceSugar:1},boostMul:2,boostDur:180},mousse:{id:`mousse`,dish:`dishMousse`,icon:`🍧`,name:`Мятный мусс`,ingredients:{berry:2,spiceMint:1},boostMul:2,boostDur:300},cake:{id:`cake`,dish:`dishCake`,icon:`🎂`,name:`Праздничный пирог`,ingredients:{berry:3,spiceSugar:1,spiceMint:1},boostMul:3,boostDur:180}};function Kd(e){return Object.prototype.hasOwnProperty.call(Gd,e)}function qd(e){return e&&typeof e==`object`?Kd(e.id)?Gd[e.id]:null:Kd(e)?Gd[e]:null}function Jd(e,t){let n=qd(t);if(!n||!e)return!1;for(let[t,r]of Object.entries(n.ingredients))if(e.count(t)<r)return!1;return!0}function Yd(e,t){let n=qd(t);if(!Jd(e,n))return null;for(let[t,r]of Object.entries(n.ingredients))e.remove(t,r);return n}function Xd(e,t){let n=qd(e);return n&&t?{dish:n.dish}:{ember:Hd}}function Zd(e){let t={mul:1,t:0};if(!e||typeof e!=`object`)return t;let n=Number(e.mul??e.m),r=Number(e.t);return!Number.isFinite(n)||!Number.isFinite(r)||!(n>1)||!(r>0)?t:{mul:n,t:r}}function Qd(e,t,n){let r=Number(t),i=Number(n);return!Number.isFinite(r)||!Number.isFinite(i)||!(r>1)||!(i>0)?(e.mul=1,e.t=0,e):(e.mul=r,e.t=i,e)}function $d(e,t){if(!e)return e;let n=Number.isFinite(t)&&t>0?t:0;return e.t>0?(e.t-=n,e.t<=0&&(e.t=0,e.mul=1),e):(e.mul=1,e.t=0,e)}function ef(e,t){let n=Number.isFinite(e)&&e>0?e:1,r=t&&t.t>0&&Number.isFinite(t.mul)&&t.mul>1?t.mul:1;return Math.max(n,r)}var tf={berry:{id:`berry`,icon:`🫐`,name:`Черника`},seed:{id:`seed`,icon:`🌰`,name:`Семечко`}};for(let e of Object.values(zd))tf[e.id]={id:e.id,icon:e.icon,name:e.name};for(let e of Object.values(Gd))tf[e.dish]={id:e.dish,icon:e.icon,name:e.name};tf[Hd]={id:Hd,icon:Ud,name:Wd};function nf(e){return Object.prototype.hasOwnProperty.call(tf,e)}function rf(){return{berry:5}}function af(e){return!Number.isFinite(e)||e<=0?0:Math.floor(e)}var of=class{constructor(e={}){if(this.items={},e&&typeof e==`object`)for(let[t,n]of Object.entries(e)){if(!nf(t))continue;let e=af(n);e>0&&(this.items[t]=e)}}count(e){return this.items[e]||0}add(e,t=1){if(!nf(e))return 0;let n=af(t);return n===0?this.count(e):(this.items[e]=this.count(e)+n,this.items[e])}remove(e,t=1){if(!nf(e))return 0;let n=af(t),r=this.count(e),i=Math.min(n,r);return i<=0?0:(i===r?delete this.items[e]:this.items[e]=r-i,i)}toJSON(){return{...this.items}}};function sf(e){if(!e||typeof e!=`object`)return new of(rf());let t=e.inv;return!t||typeof t!=`object`||Array.isArray(t)?new of(rf()):new of(t)}function cf(e,t,n,r={}){let i=r.radius??3.5,a=r.pull??6,o=r.boost??1,s=r.eatR??.9,c=r.damp??8,l=[];if(!t||!Number.isFinite(e)||e<=0)return l;for(let r of n){if(!r||r.dead||r.beingEaten)continue;let n=t.x-r.pos.x,u=t.y-r.pos.y,d=t.z-r.pos.z,f=Math.sqrt(n*n+u*u+d*d);if(f>i)continue;if(f<s){l.push(r);continue}let p=a*(1+o*(1-f/i)),m=Math.min(p*e,f),h=m/f;r.pos.x+=n*h,r.pos.y+=u*h,r.pos.z+=d*h,r.vel&&r.vel.multiplyScalar(Math.max(0,1-c*e)),f-m<s&&l.push(r)}return l}var lf={plot:{id:`plot`,icon:`🫐`,name:`Грядка`,ready:!0,seed:!0,bush:!0,cost:25},pen:{id:`pen`,icon:`🏠`,name:`Загон`,ready:!0,seed:!1,bush:!1,trough:!0,cost:40},feedPen:{id:`feedPen`,icon:`🐔`,name:`Загон живой еды`,ready:!1},trap:{id:`trap`,icon:`🪤`,name:`Ловушка`,ready:!1}};function uf(e){return Object.prototype.hasOwnProperty.call(lf,e)}function df(e){let t=lf[e],n=t&&t.cost;return Number.isFinite(n)&&n>0?Math.floor(n):0}var ff=[`sprout`,`bush`,`ripen`,`ripe`],pf={sprout:60,bush:120,ripen:60,ripe:1/0},mf=(e,t=0)=>Number.isFinite(e)?e:t;function hf(e){return!!(e&&lf[e]&&lf[e].trough)}function gf(e,t){if(!hf(e))return 0;let n=Math.floor(mf(t,0));return Math.max(0,Math.min(6,n))}function _f(e){return!e||!hf(e.building)||!(e.trough<6)?!1:(e.trough=Math.max(0,Math.floor(mf(e.trough,0)))+1,!0)}function vf(e){if(!e||!hf(e.building))return!1;let t=Math.max(0,Math.floor(mf(e.trough,0)));return t<=0?(e.trough=0,!1):(e.trough=t-1,!0)}var yf=class{constructor(e={}){this.wild=!!e.wild;let t=this.wild?`bush`:`sprout`,n=ff.includes(e.stage)?e.stage:t;this.wild&&n===`sprout`&&(n=`bush`),this.stage=n,this.t=Math.max(0,mf(e.t,0));let r=this.yield;this.n=this.stage===`ripe`?Math.min(r,Math.max(1,Math.floor(mf(e.n,r)))):0}get yield(){return this.wild?2:3}get ripe(){return this.stage===`ripe`}get stageTime(){let e=pf[this.stage];return e===1/0?1/0:e*(this.wild?2:1)}advance(e){if(!Number.isFinite(e)||e<=0)return this;for(this.t+=e;;){let e=this.stageTime;if(!(this.t>=e))break;if(this.t-=e,this.stage=ff[ff.indexOf(this.stage)+1],this.stage===`ripe`){this.n=this.yield,this.t=0;break}}return this}offlineAdvance(e){return this.advance(Number.isFinite(e)&&e>0?e:0)}pick(){return!this.ripe||this.n<=0?0:(--this.n,this.n===0&&(this.stage=`bush`,this.t=0),1)}harvest(){let e=0;for(;this.pick();)e+=1;return e}toJSON(){let e={stage:this.stage,t:this.t};return this.n>0&&(e.n=this.n),e}},bf=class{constructor(e={}){let t=e&&typeof e==`object`?e:{},n=Array.isArray(t.slots)?t.slots:[];this.slots=[];for(let e=0;e<4;e++){let t=n[e];if(t&&typeof t==`object`&&uf(t.b)){let e=lf[t.b].bush?new yf({stage:t.stage,t:t.t,n:t.n}):null;this.slots.push({building:t.b,bush:e,trough:gf(t.b,t.f)})}else this.slots.push({building:null,bush:null,trough:0})}let r=Array.isArray(t.wild)?t.wild:[];this.wild=[];for(let e=0;e<2;e++){let t=r[e]&&typeof r[e]==`object`?r[e]:{};this.wild.push(new yf({wild:!0,stage:t.stage,t:t.t,n:t.n}))}let i=Math.floor(mf(t.seedProg,0));this.seedProg=i>0&&i<3?i:0}slot(e){return e>=0&&e<this.slots.length?this.slots[e]:null}plant(e,t,n=`plot`,r=null){let i=this.slot(e);if(!i||i.building!==null)return!1;let a=lf[n];if(!a||!a.ready)return!1;let o=df(n);return o>0&&!(r&&r.canAfford(o))||a.seed&&(!t||t.count(`seed`)<1)?!1:(o>0&&r.spend(o),a.seed&&t.remove(`seed`,1),i.building=n,i.bush=a.bush?new yf({wild:!1}):null,i.trough=0,!0)}demolish(e){let t=this.slot(e);return!t||t.building===null?!1:(t.building=null,t.bush=null,t.trough=0,!0)}bushes(){let e=[];for(let t of this.slots)t.bush&&e.push(t.bush);for(let t of this.wild)e.push(t);return e}advance(e){for(let t of this.bushes())t.advance(e);return this}offlineAdvance(e){for(let t of this.bushes())t.offlineAdvance(e);return this}harvest(e,t){if(!e)return 0;let n=0;for(;e.pick();)t&&t.add(`berry`,1),this.collected(t,1),n+=1;return n}collected(e,t=1){let n=0,r=Math.floor(Number.isFinite(t)?t:0);for(let t=0;t<r;t++)this.seedProg+=1,this.seedProg>=3&&(this.seedProg=0,e&&e.add(`seed`,1),n+=1);return n}toJSON(){return{seedProg:this.seedProg,slots:this.slots.map(e=>e.building?{b:e.building,...e.bush?e.bush.toJSON():{},...e.trough>0?{f:e.trough}:{}}:null),wild:this.wild.map(e=>e.toJSON())}}};function xf(e,t,n){let r=n.r*n.r,i=e=>{let t=e.x-n.center.x,r=e.y-n.center.y,i=e.z-n.center.z;return t*t+r*r+i*i};return i(e)<r==i(t)<r}function Sf(e,t,n=[]){if(!e||!t)return!1;for(let r of n)if(!xf(e,t,r))return!1;return!0}function Cf(e){if(!e||typeof e!=`object`)return new bf;let t=e.farm;return!t||typeof t!=`object`||Array.isArray(t)?new bf:new bf(t)}var wf=.3,Tf=.7,Ef=.22,Df=9,Of=7,kf=9,Af=B.degToRad(10),jf=4.5,Mf=6,Nf=12,Pf=.002,Ff=.25,If=.85,Lf=.5,Rf=.9,zf=1.2,Bf=.6,Vf=.1,Hf=4,Uf=.14,Wf=.3,Gf=1,Kf=.004,qf=.005,Jf=.02,Yf=.004,Xf=.04,Zf=.12,Qf=.95,$f=1.5,ep=.6,tp=.35,np=1.15,rp=.08,ip=.2,ap=2.4,op=.35,sp=.55,cp=10,lp=.45,up=.35,dp=5,fp=1.12,pp=1,mp=.95,hp=5.2,gp=.4,_p=.35,vp=1.2,yp=1.2,bp=6.5,xp=5.5,Sp=1.2,Cp=.5,wp=1.4,Tp=9,Ep=.4,Dp=1.2,Op=1.12,kp=1,Ap=25,jp=1.5,Mp=3,Np=6,Pp=2,Fp=.34,Ip=.3,Lp=2.2,Rp=.4,zp=new H(0,0,1),Bp=class{constructor(e,t,n={}){this.blob=e,this.world=t,e.brain=this,this.satiety=n.satiety??.6,this.energy=n.energy??.85,this.nestDir=n.nestDir?n.nestDir.clone().normalize():null,this.nestPos=n.nestPos?n.nestPos.clone():null,this.sleepState=`awake`,this.forcedSleep=!1,this.nightSleep=!1,this.fallTimer=0,this.wakeTimer=0,this.wakeNatural=!1,this._sleepLerp=0,this._pressK0=null,this._stretched=!1,this._sleepyMood=0,this.phase=`rest`,this.timer=this._restTime(),this.idleTimer=this._idleTime(),this.mode=`idle`,this.inPlaceLeft=0,this.hopCount=0,this.attentionPoint=null,this.sinceTouch=0,this.pleadTimer=Vp(Mp,Np),this.returnHops=0,this.trust=0,this.fleeHops=0,this._scarePoint=null,this._fleeDir=new H,this.targetBerry=null,this.eatBerry=null,this.eatTimer=0,this.gulpTimer=0,this.stun=0,this.askTimer=Vp(2,4),this.inWater=!1,this.waterTime=0,this.strokeTimer=0,this.swimDist=1/0,this.swimAshore=!1,this.shakeTimer=0,this.shakePhase=0,this.shakeEvent=null,this._swimTang=new H,this._probe=new H,this.time=0,this.danceT0=0,this.danceEnd=0,this.danceBeat=-1,this.danceStep=0,this.danceAz=0,this.crystalTimer=this._crystalTime(),this.boost={mul:1,t:0},this.crystalBlocked=!1,this.crystalCount=0,this._cUp=new H,this._cBack=new H,this.chompEvent=null,this.danceHeartEvent=null,this.crystalEvent=null,this._excited=0,this._sad=0,this._up=new H,this._goal=new H,this._tang=new H,this._imp=new H,this._m=new H,this._mouth=new H}isHopping(){return this.phase===`windup`||this.phase===`air`}get traits(){return this.blob.traits||yd}_restTime(){let e=this.traits.brain.restMul;return Vp(wf*e,Tf*e)}_idleTime(){let e=this.traits.brain.idleMul;return Vp(Mf*e,Nf*e)}notifyPoke(){this.sinceTouch=0,this.mode===`attention`&&(this.mode=`idle`),this.traits.brain.clingy&&(this.blob.joy=Math.max(this.blob.joy,1.2),this.mode=`inplace`,this.inPlaceLeft=2)}_greatCircle(e,t){let n=B.clamp(e.dot(t),-1,1);return Math.acos(n)*this.world.radius}_nearestVisible(e,t){let n=null,r=1/0,i=Lf*14,a=Rf*14;for(let o of e){if(o.beingEaten||o.dead)continue;this._m.copy(o.pos).sub(this.world.center).normalize();let e=this._greatCircle(t,this._m);e<(o.visionLim?o.visionLim(t,this.world,i):this.world.isWater&&this.world.isWater(o.pos)?a:i)&&e<r&&(r=e,n=o)}return n}update(e,t=[]){let n=this.blob,r=n.body,i=this.world.center,a=this.world.radius;this.chompEvent=null,this.danceHeartEvent=null,this.shakeEvent=null,this.crystalEvent=null,this.time+=e;let o=e*(this.ecoTimeScale||1);if(this.satiety=B.clamp(this.satiety-Pf*o,0,1),$d(this.boost,o),this._updateCrystal(o),this.sleepState===`sleeping`)this.energy=B.clamp(this.energy+Xf*o,0,1);else{let e=Kf*this.traits.brain.energyDecayMul;this.energy=B.clamp(this.energy-e*o,0,1)}let s=n.com;this._up.copy(s).sub(i);let c=this._up.length()||1e-6;this._up.multiplyScalar(1/c);let l=c-a,u=r.velocity.length(),d=r.velocity.dot(this._up),f=l>n.R*1.15,p=this._up;this.stun=Math.max(0,this.stun-e),this.sinceTouch+=e;let m=this.traits.brain.lowEnergy,h=this.energy<m?(m-this.energy)/m:0,g=this.sleepState===`awake`||this.sleepState===`going`?h:0;if(this._sleepyMood+=(g-this._sleepyMood)*(1-Math.exp(-e*3)),n.sleepiness=this._sleepyMood,this.gulpTimer>0&&(this.gulpTimer-=e,r.addWind(this._imp.copy(this._up).multiplyScalar(-26))),n.grabbed){this.sinceTouch=0,(this.sleepState===`going`||this.sleepState===`falling`||this.sleepState===`sleeping`)&&(this.forcedSleep=!1,this._wakeUp(!1)),this.mode===`dance`&&this._stopDance(),this.phase===`eat`&&this._cancelEat(!1),this.phase!==`held`&&this.traits.brain.shy&&(this._scarePoint=s.clone(),n.surprise=1.5),this.phase=`held`,this.timer=this._restTime(),this.targetBerry=null,this._updateSleepPhysics(e),this._applyMood(e,!1,!1);return}this.phase===`held`&&(this.phase=`rest`,this.stun=.4,this._afterRelease(s));let _=this.world.waterInfo?this.world.waterInfo(s,this._swimTang):null,v=!!_&&_.depth>0&&_.over<n.R*2.5;if(this._updateWater(e,v,s),v){(this.sleepState===`falling`||this.sleepState===`sleeping`)&&this._wakeUp(!1),this.sleepState===`waking`&&this._runSleep(e,this._up,f,u),this.mode===`dance`&&this._stopDance(),this.phase===`eat`&&this._cancelEat(!0),this._runSwim(e,l,t,_),this._updateSleepPhysics(e),this._applyMood(e,!1,this.satiety<Wf);return}if(!this.forcedSleep&&!this.nightSleep&&(this.sleepState===`sleeping`||this.sleepState===`falling`)&&t.length){let e=op*14;for(let n of t)if(!n.dead&&(this._m.copy(n.pos).sub(i).normalize(),this._greatCircle(p,this._m)<e)){this._wakeUp(!1);break}}if(this.sleepState===`awake`&&this.nestPos&&this.phase!==`thrown`&&(this.forcedSleep||this.nightSleep||this.energy<this.traits.brain.sleepTrigger)&&(!(!this.forcedSleep&&!this.nightSleep&&(this.targetBerry||this.phase===`eat`))||this.energy<Zf)&&(this.phase===`eat`&&this._cancelEat(!0),this.mode===`dance`&&this._stopDance(),this.sleepState=`going`,this.targetBerry=null,this.mode=`approach`),this.sleepState===`going`){if(this._greatCircle(p,this.nestDir)<ap&&!f&&u<jf){this._enterFalling(),this._updateSleepPhysics(e),this._applyMood(e,!1,!1);return}}else if(this.sleepState!==`awake`){this._runSleep(e,this._up,f,u),this._updateSleepPhysics(e),this._applyMood(e,!1,!1);return}if(this.mode===`dance`){let t=l<n.R*fp&&d<pp;this._runDance(!t),this._updateSleepPhysics(e),this._applyMood(e,!1,!1);return}if(this.phase===`rest`&&f&&l>n.R*1.5&&d>3&&(this.phase=`thrown`,this.energy=B.clamp(this.energy-Jf,0,1),this.stun=Math.max(this.stun,Gf)),this.phase===`thrown`){!f&&u<1.5&&(this.phase=`rest`,this.energy=B.clamp(this.energy-Yf,0,1),this.timer=this._restTime(),this.stun=Math.max(this.stun,Gf)),this._applyMood(e,!1,!1);return}if(this.phase===`eat`){this._runEat(e),this._applyMood(e,!0,!1);return}let y=this.sleepState===`going`||this.satiety>=If?null:this._nearestVisible(t,p),b=!!y,x=this.satiety<Wf;if(y){if(this.targetBerry!==y&&(this.mode===`idle`&&(this.mode=`inplace`,this.inPlaceLeft=2),this.targetBerry=y,n.sproutBoost()),s.distanceTo(y.pos)<n.R+zf&&this.phase!==`windup`){this._startEat(y),this._applyMood(e,!0,x);return}}else this.targetBerry=null,!(this.mode===`attention`||this.mode===`flee`||this.mode===`inplace`&&this.inPlaceLeft>0&&this.traits.brain.clingy)&&this.mode!==`idle`&&(this.mode=`idle`);switch(x&&!y&&(this.askTimer-=e,this.askTimer<=0&&(n.mouthPop(.7),this.askTimer=Vp(3,6))),this.traits.brain.clingy&&this.attentionPoint&&!y&&this.returnHops===0&&this.sinceTouch>Ap?(this.mode=`attention`,this.pleadTimer-=e,this.pleadTimer<=0&&(n.mouthPop(.8),this.pleadTimer=Vp(Mp,Np))):this.mode===`attention`&&(this.mode=`idle`),this.phase){case`rest`:this.timer-=e,this.timer<=0&&this.stun<=0&&u<jf&&!f&&(this.mode===`inplace`&&this.inPlaceLeft>0?this._beginWindup(`inplace`):this.mode===`flee`&&this.fleeHops>0?this._beginWindup(`flee`):this.targetBerry||this.sleepState===`going`||this.returnHops>0&&this.attentionPoint||this.mode===`attention`&&this.attentionPoint&&this._greatCircle(p,this._m.copy(this.attentionPoint).sub(i).normalize())>jp*n.R?this._beginWindup(`approach`):(this.idleTimer-=1*.5*this.traits.brain.restMul,this.idleTimer<=0?(this.mode===`attention`?(this.inPlaceLeft=1,this._beginWindup(`inplace`)):this._beginWindup(`idle`),this.idleTimer=this._idleTime()):this.timer=this._restTime()));break;case`windup`:this.timer-=e,this._imp.copy(this._up).multiplyScalar(-34),r.addWind(this._imp),this.timer<=0&&this._launch();break;case`air`:!f&&d<=.5&&u<3&&(this.phase=`rest`,this.timer=this._restTime());break}this._updateSleepPhysics(e),this._applyMood(e,b,x)}_beginWindup(e){this.launchMode=e,this.phase=`windup`,this.timer=Ef,this.blob.poke(.3)}_launch(){let e=this.blob,t=e.body,n=this.world.center,r=e.com;this._up.copy(r).sub(n).normalize();let i=this.traits.brain,a=Df*i.jumpUpMul,o=Of*i.jumpTangMul;if(this.satiety<Wf&&(a*=.7,o*=.8),this.energy<i.lowEnergy&&(a*=.7,o*=.75),this.energy=B.clamp(this.energy-qf,0,1),this.hopCount++,this.launchMode===`inplace`)this._tang.set(0,0,0),a=kf,o=0,this.inPlaceLeft=Math.max(0,this.inPlaceLeft-1),this.inPlaceLeft===0&&this.targetBerry&&(this.mode=`approach`);else if(this.launchMode===`flee`){this._tang.copy(this._fleeDir),this._tang.addScaledVector(this._up,-this._tang.dot(this._up)),this._tang.lengthSq()<1e-6&&this._basisTangent(this._up,Math.random()*6.28,this._tang),this._tang.normalize();let e=1+Ip*(1-this.trust);a*=e,o*=e,this.fleeHops=Math.max(0,this.fleeHops-1),this.fleeHops===0&&(this.mode=`idle`)}else{let e=this.launchMode===`approach`?this.sleepState===`going`?this.nestPos:this.targetBerry?this.targetBerry.pos:this.attentionPoint:null;if(this.launchMode===`approach`&&this.returnHops>0&&this.returnHops--,e){this._goal.copy(e).sub(n).normalize();let t=this._goal.dot(this._up);this._tang.copy(this._goal).addScaledVector(this._up,-t);let r=this._greatCircle(this._up,this._goal),i=B.clamp(r/(14*.25),.45,1);o*=i}else{let e=Math.random()*Math.PI*2;this._basisTangent(this._up,e,this._tang)}this._tang.lengthSq()<1e-6&&this._basisTangent(this._up,Math.random()*6.28,this._tang),this._tang.normalize();let t=(Math.random()*2-1)*Af;this._rotateAround(this._tang,this._up,t)}this._imp.copy(this._up).multiplyScalar(a).addScaledVector(this._tang,o),t.addVelocity(this._imp),this.phase=`air`,this.blob.mouthPop(.4)}_afterRelease(e){let t=this.traits.brain;t.shy&&this.trust<1?(this.fleeHops=2-Math.floor(this.trust*2),this.mode=`flee`,this._up.copy(e).sub(this.world.center).normalize(),this._goal.set(0,0,0),this._scarePoint&&(this._goal.copy(e).sub(this._scarePoint),this._goal.addScaledVector(this._up,-this._goal.dot(this._up))),this._goal.lengthSq()>1e-4?this._fleeDir.copy(this._goal).normalize():this._basisTangent(this._up,Math.random()*6.28,this._fleeDir)):t.clingy&&this.attentionPoint&&(this.returnHops=Pp,this.sinceTouch=0)}forceSleep(){this.forcedSleep=!0,this._goToBed()}_goToBed(){this.phase===`eat`&&this._cancelEat(!0),this.mode===`dance`&&this._stopDance(),this.targetBerry=null,this.sleepState===`awake`&&!this.blob.grabbed&&this.nestPos&&this.phase!==`thrown`&&this.phase!==`held`&&(this.sleepState=`going`,this.mode=`approach`)}setNightSleep(e){let t=!!e;t!==this.nightSleep&&(this.nightSleep=t,t?this._goToBed():this.sleepState!==`awake`&&!this.forcedSleep&&this._wakeUp(!0))}forceWake(){this.forcedSleep=!1,this.sleepState!==`awake`&&this._wakeUp(!1)}startDance(e,t=cp){this.danceT0=e??this.time,this.danceEnd=this.danceT0+t,this.danceBeat=-1,this.danceStep=0,this.danceAz=Math.random()*Math.PI*2,this.targetBerry=null,this.phase===`eat`&&this._cancelEat(!0),this.mode=`dance`}_danceActive(){return this.time<this.danceEnd}_stopDance(){this.danceEnd=0,this.mode===`dance`&&(this.mode=`idle`),this.phase=`rest`,this.timer=this._restTime()}_runDance(e){let t=this.blob,n=t.body;if(!this._danceActive()){this._stopDance();return}let r=Math.floor((this.time-this.danceT0)/sp);if(r>=0&&r>this.danceBeat){if(this.danceBeat=r,e){t.joy=Math.max(t.joy,.9);return}let i=this.traits.brain;this._up.copy(t.com).sub(this.world.center).normalize(),this._basisTangent(this._up,this.danceAz,this._tang);let a=Df*lp*i.jumpUpMul,o=Of*up*i.jumpTangMul*(this.danceStep%2?1:-1);this.danceStep++,this._imp.copy(this._up).multiplyScalar(a).addScaledVector(this._tang,o),n.addVelocity(this._imp),this.energy=B.clamp(this.energy-qf,0,1),this.hopCount++,this.phase=`air`,t.sproutBoost(),this.danceStep%2==0&&t.mouthPop(.5),this.danceStep%dp===0&&(this.danceHeartEvent={pos:t.com.clone()})}t.joy=Math.max(t.joy,.9)}_crystalTime(){let e=fu;return 75*Vp(1-e,1+e)}_updateCrystal(e){if(this.crystalBlocked||this.satiety<.6)return;if(this.crystalTimer>0){let t=this.sleepState===`sleeping`?2:1;if(this.crystalTimer-=e*ef(t,this.boost),this.crystalTimer>0)return}let t=this.blob,n=this.world.center;if(t.grabbed||this.inWater)return;let r=this._cUp.copy(t.com).sub(n),i=r.length()||1e-6;if(r.multiplyScalar(1/i),i-(this.world.floorRadius?this.world.floorRadius(t.com):this.world.radius)>t.R*1.15||t.body.velocity.length()>jf)return;let a=this._cBack.copy(t.faceDir||zp);a.addScaledVector(r,-a.dot(r)).negate(),a.lengthSq()<1e-6&&this._basisTangent(r,Math.random()*6.28,a),a.normalize();let o=t.com.clone().addScaledVector(a,t.R*.85).addScaledVector(r,-t.R*.5),s=this.world.floorRadius?this.world.floorRadius(o)+t.R*.25:0,c=o.distanceTo(n);c<s&&o.sub(n).multiplyScalar(s/(c||1e-6)).add(n),this.crystalEvent={pos:o,vel:a.clone().multiplyScalar(Lp).addScaledVector(r,Rp),kind:this.traits.id},this.satiety=B.clamp(this.satiety-pu,0,1),this.crystalTimer=this._crystalTime(),this.crystalCount++,t.mouthPop(.6),t.poke(.35)}_updateWater(e,t,n){t?(this.inWater||(this.strokeTimer=.15),this.waterTime+=e):(this.inWater&&(this.phase===`swim`&&(this.phase=`rest`,this.timer=this._restTime()),this.waterTime>Cp&&(this.shakeTimer=wp,this.shakePhase=0,this._basisTangent(this._up,Math.random()*Math.PI*2,this._swimTang),this.shakeEvent={pos:n.clone()})),this.waterTime=0,this.shakeTimer>0&&this._runShake(e)),this.inWater=t}_runShake(e){if(this.shakeTimer-=e,this.shakePhase+=e*Tp*Math.PI*2,this.shakeTimer<=0){this.shakeTimer=0;return}let t=this.blob,n=t.com.distanceTo(this.world.center)-this.world.radius,r=t.body.velocity.dot(this._up);n>t.R*Op||r>kp||t.body.addWind(this._imp.copy(this._swimTang).multiplyScalar(Math.sin(this.shakePhase)*Dp))}_runSwim(e,t,n,r){let i=this.blob,a=i.body,o=this.world.center,s=i.com;this.phase=`swim`,this.mode=`idle`,this.targetBerry=null,this.swimDist=r?r.dist:1/0,this.sleepState===`going`&&this.nestDir&&(this._goal.copy(this.nestDir),this._swimTang.copy(this._goal).addScaledVector(this._up,-this._goal.dot(this._up)),this._swimTang.lengthSq()>1e-8&&this._swimTang.normalize());let c=null;if(!this.forcedSleep&&this.sleepState===`awake`&&this.satiety<If){let e=this._nearestVisible(n,this._up);e&&this.world.isWater(e.pos)&&(c=e)}if(c){if(this.targetBerry=c,s.distanceTo(c.pos)<i.R+Sp){this._swallowFloating(c);return}this._goal.copy(c.pos).sub(o).normalize(),this._swimTang.copy(this._goal).addScaledVector(this._up,-this._goal.dot(this._up)),this._swimTang.lengthSq()<1e-8&&this._basisTangent(this._up,Math.random()*6.28,this._swimTang),this._swimTang.normalize(),i.lookAt(c.pos)}else i.lookAt(null);let l=t+(r?r.depth:0);this._probe.copy(s).addScaledVector(this._swimTang,i.R);let u=s.distanceTo(o)-this.world.floorRadius(this._probe),d=Math.min(l,u)<i.R*1.15;this.swimAshore=d;let f=d?a.velocity.length()<jf:t<=i.R*_p&&t>-i.R*vp&&a.velocity.length()<yp;if(this.strokeTimer-=e,this.strokeTimer<=0&&f){let e=this.traits.brain,t=d?bp*e.jumpUpMul:gp,n=(d?xp:hp)*e.jumpTangMul;this._imp.copy(this._up).multiplyScalar(t).addScaledVector(this._swimTang,n),a.addVelocity(this._imp),this.strokeTimer=mp*(.7+.3*e.restMul)*Vp(.9,1.1),this.energy=B.clamp(this.energy-qf,0,1),i.mouthPop(.35)}}_swallowFloating(e){e.startEat(),e.finishEat(),this._foodBoost(e),this.satiety=B.clamp(this.satiety+Ff,0,1),this.trust=Math.min(1,this.trust+Fp),this.chompEvent={pos:this.blob.com.clone()},this.gulpTimer=Uf,this.blob.joy=Math.max(this.blob.joy,1.2),this.blob.mouthPop(1),this.blob.lookAt(null),this.targetBerry=null}_foodBoost(e){!e||!e.boostMul||Qd(this.boost,e.boostMul,e.boostDur)}_startEat(e){let t=this.blob;this.phase=`eat`,this.eatTimer=Bf,this.eatBerry=e,e.startEat(),t.mouthWorld(this._mouth),t.body.beginGrab(this._mouth,Hf),t.mouthPop(1),t.sproutBoost()}_runEat(e){let t=this.blob,n=t.body,r=this.eatBerry;if(!r||r.dead){this._cancelEat(!0);return}this.eatTimer-=e,t.lookAt(r.pos),t.mouthPop(1),n.setGrabTarget(r.pos,Vf),t.mouthWorld(this._mouth);let i=B.clamp(1-this.eatTimer/Bf,0,1);r.magnetize(this._mouth,i),this.eatTimer<=0&&this._swallow()}_swallow(){let e=this.blob;e.body.endGrab(),e.lookAt(null),this.eatBerry&&this.eatBerry.finishEat(),this._foodBoost(this.eatBerry),this.satiety=B.clamp(this.satiety+Ff,0,1),this.trust=Math.min(1,this.trust+Fp),this.chompEvent={pos:e.com.clone()},this.gulpTimer=Uf,e.joy=Math.max(e.joy,1.2),this.eatBerry=null,this.targetBerry=null,this.mode=`idle`,this.phase=`rest`,this.timer=this._restTime()}_cancelEat(e){e&&this.blob.body.endGrab(),this.blob.lookAt(null),this.eatBerry&&this.eatBerry.cancelEat(),this.eatBerry=null,this.targetBerry=null,this.mode=`idle`,this.phase===`eat`&&(this.phase=`rest`)}_applyMood(e,t,n){let r=1-Math.exp(-e*4),i=Math.max(+!!n,this.mode===`attention`?.5:0);this._excited+=(+!!t-this._excited)*r,this._sad+=(i-this._sad)*r,this.blob.moodExcited=this._excited,this.blob.moodSad=this._sad}_enterFalling(){this.sleepState=`falling`,this.fallTimer=$f,this.phase=`rest`,this.timer=999,this.mode=`idle`,this.targetBerry=null,this.blob.blink=.001,this.blob.yawn=.001}_enterSleeping(e){this.sleepState=`sleeping`,this.blob.asleepTarget=1,this._pressK0??=this.blob.body.pressureK;let t=this._tang&&this._tang.lengthSq()>1e-6?this._imp.copy(this._tang).normalize():this._imp.set(0,0,0);this.blob.sleepFaceDir.copy(e).addScaledVector(t,.35).normalize()}_runSleep(e,t,n,r){let i=this.blob.body;this.sleepState===`falling`?(this.fallTimer-=e,i.addWind(this._imp.copy(t).multiplyScalar(-26*.6)),this.fallTimer<=0&&this._enterSleeping(t)):this.sleepState===`sleeping`?(i.addWind(this._imp.copy(t).multiplyScalar(-26)),!this.forcedSleep&&!this.nightSleep&&this.energy>=Qf&&this._wakeUp(!0)):this.sleepState===`waking`&&(this.wakeTimer-=e,this.wakeNatural&&!this._stretched&&(i.addVelocity(this._imp.copy(t).multiplyScalar(3.2)),this.blob.yawn=.001,this._stretched=!0),this.wakeTimer<=0&&this._finishWake(t))}_wakeUp(e){this.sleepState===`awake`||this.sleepState===`waking`||(this.sleepState=`waking`,this.wakeNatural=e,this.wakeTimer=np,this._stretched=!1,this.blob.asleepTarget=0,this.blob.blink=.001)}_finishWake(e){let t=this.blob.body;this.sleepState=`awake`,t.shellStiffScale=this.traits.body.shellScale,this._pressK0!=null&&(t.pressureK=this._pressK0),this._sleepLerp=0,this.blob.asleepTarget=0,this.phase=`rest`,this.timer=this._restTime(),this.stun=.3,this.mode=this._danceActive()?`dance`:`idle`,this.wakeNatural&&t.addVelocity(this._imp.copy(e).multiplyScalar(Df*.5)),this.wakeNatural=!1}_updateSleepPhysics(e){let t=this.blob.body,n=+(this.sleepState===`sleeping`||this.sleepState===`falling`),r=n>this._sleepLerp?ep:tp;this._sleepLerp+=(n-this._sleepLerp)*(1-Math.exp(-e/r)),n===0&&this._sleepLerp<.001&&(this._sleepLerp=0);let i=this._sleepLerp,a=this.shakeTimer>0?1-Ep*.5*(1-Math.cos(this.shakePhase)):1;t.shellStiffScale=this.traits.body.shellScale*(1-i+rp*i)*a,this._pressK0!=null&&(t.pressureK=this._pressK0*(1-i+ip*i))}_basisTangent(e,t,n){let r=-e.z,i=0,a=e.x;r*r+i*i+a*a<1e-6&&(r=1,i=0,a=0);let o=Math.hypot(r,i,a);r/=o,i/=o,a/=o;let s=e.y*a-e.z*i,c=e.z*r-e.x*a,l=e.x*i-e.y*r,u=Math.cos(t),d=Math.sin(t);n.set(r*u+s*d,i*u+c*d,a*u+l*d)}_rotateAround(e,t,n){let r=Math.cos(n),i=Math.sin(n),a=e.x*t.x+e.y*t.y+e.z*t.z,o=t.y*e.z-t.z*e.y,s=t.z*e.x-t.x*e.z,c=t.x*e.y-t.y*e.x;e.set(e.x*r+o*i+t.x*a*(1-r),e.y*r+s*i+t.y*a*(1-r),e.z*r+c*i+t.z*a*(1-r))}};function Vp(e,t){return e+Math.random()*(t-e)}var Hp=6.5,Up=.22,Wp=.995,Gp=.3,Kp=.6,qp=1.8,Jp=2.5,Yp=26,Xp=3;function Zp(e,t){return{id:e,color:t.palette.lid,glow:t.palette.core,name:t.name,price:5}}var Qp={};for(let[e,t]of Object.entries(bd))Qp[e]=Zp(e,t);var $p=Zp(`neutral`,yd);function em(e){return Qp[e]||$p}function tm(e){let t=e&&typeof e==`object`?e:em(e),n=t&&t.price;return Number.isFinite(n)&&n>0?Math.floor(n):0}var nm=2.2,rm=.55,im=null,am=!1;function om(){if(am)return im;if(am=!0,typeof document>`u`||!document.createElement)return null;let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`);if(!t)return null;let n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);return n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.25,`rgba(255,255,255,0.55)`),n.addColorStop(.6,`rgba(255,255,255,0.16)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,128,128),im=new Pi(e),im.colorSpace=Be,im}var sm=class{constructor(e,t,n={}){this.world=t,this.kind=em(n.kind),this.R=n.radius??.55,this.pos=n.pos?n.pos.clone():t.center.clone().addScaledVector(new H(0,1,0),t.radius+this.R),this.vel=n.vel?n.vel.clone():new H,this.age=0,this.settled=!1,this.dead=!1,this.scale=1,this.pulsePhase=Math.random()*Math.PI*2,this._t=new H,this._surfN=new H,this._build(e),this._sync()}_build(e){this.group=new Tn;let t=zl(new Ui(this.R,0),this.kind.color,1.1);t.children[0].castShadow=!0,t.scale.set(.78,1.25,.78),this.group.add(t);let n=new K(new Ui(this.R*.5,0),Il(this.kind.glow,{emissive:new G(this.kind.glow),emissiveIntensity:.9}));n.scale.set(.78,1.25,.78),this.group.add(n),this.core=n;let r=om();r&&(this.halo=new qr(new Nr({map:r,color:this.kind.glow,transparent:!0,blending:2,depthWrite:!1,opacity:rm})),this.halo.scale.setScalar(this.R*nm*2),this.group.add(this.halo)),e.add(this.group)}update(e){if(this.dead)return;this.age+=e;let t=this.world.center;this._t.copy(t).sub(this.pos);let n=this._t.length()||1e-6;if(this.vel.addScaledVector(this._t,Hp/n*e),this.vel.multiplyScalar(Wp),this.world.isWater&&this.world.isWater(this.pos)){let n=this.pos.distanceTo(t)||1e-6,r=this.R*2,i=Math.min(this.world.sea.level-n,r);this._t.copy(this.pos).sub(t).multiplyScalar(1/n),this.vel.addScaledVector(this._t,i/r*Yp*e),this.vel.multiplyScalar(Math.max(0,1-Xp*e)),this.vel.length()<Gp&&!this.settled&&(this.settled=!0)}this.pos.addScaledVector(this.vel,e);let r=this.pos.distanceTo(t),i=(this.world.floorRadius?this.world.floorRadius(this.pos):this.world.radius)+this.R;if(r<i){let n=(this.pos.x-t.x)/(r||1e-6),a=(this.pos.y-t.y)/(r||1e-6),o=(this.pos.z-t.z)/(r||1e-6);this.pos.set(t.x+n*i,t.y+a*i,t.z+o*i);let s=this.vel.x*n+this.vel.y*a+this.vel.z*o,c=this.vel.x-n*s,l=this.vel.y-a*s,u=this.vel.z-o*s;s<-.6&&(c*=Kp,l*=Kp,u*=Kp);let d=Math.max(0,1-qp*e);c*=d,l*=d,u*=d;let f=Math.sqrt(c*c+l*l+u*u);if(f>1e-9){let t=Math.max(0,f-Jp*e)/f;c*=t,l*=t,u*=t}let p=s<0?-s*Up:0;this.vel.set(c+n*p,l+a*p,u+o*p),this.vel.length()<Gp&&(this.settled=!0)}this._sync()}_sync(){this._surfN.copy(this.pos).sub(this.world.center).normalize();let e=this.group;if(!e)return;e.position.copy(this.pos),e.quaternion.setFromUnitVectors(cm,this._surfN);let t=1+Math.sin(this.age*2.4+this.pulsePhase)*.05;if(e.scale.setScalar(Math.max(.001,this.scale*t)),this.core&&(this.core.material.emissiveIntensity=.7+.4*(1-Math.sin(this.age*2.4+this.pulsePhase))),this.halo){let e=1+(t-1)*2.4;this.halo.scale.setScalar(this.R*nm*2*e),this.halo.material.opacity=rm*(.82+(t-1)*3.6)}}collect(){this.dead=!0}dispose(){this.group&&this.group.parent&&this.group.parent.remove(this.group)}},cm=new H(0,1,0);function lm(e,t,n){let r=e.indexOf(t);return r<0?n:(e.splice(r,1),t.collect(),n+1)}function um(e,t,n={}){let r=n.decay??.002,i=n.period??75,a=n.floor??.3,o=n.minSatiety??.6,s=n.cap??40,c=Array.isArray(e)?e:[],l=Number.isFinite(t)&&t>0?t:0,u=0,d=[];for(let e of c){let t=Number.isFinite(e&&e.satiety)?Math.min(1,Math.max(0,e.satiety)):0;d.push(Math.max(a,t-r*l));let n=0;a>o?n=l:t>o&&r>0&&(n=Math.min(l,(t-o)/r)),n>0&&i>0&&(u+=Math.floor(n/i))}return{crystals:Math.min(s,u),satiety:d}}function dm(e){return!Number.isFinite(e)||e<=0?0:Math.floor(e)}var fm=class{constructor(e=0){this.coins=dm(e)}add(e=1){return this.coins+=dm(e),this.coins}canAfford(e){return this.coins>=dm(e)}spend(e){let t=dm(e);return this.coins<t?!1:(this.coins-=t,!0)}toJSON(){return this.coins}};function pm(e,t,n=null){let r={sold:{},coins:0};if(!e||typeof e!=`object`||!t)return r;let i=Object.keys(n&&typeof n==`object`?n:e);for(let t of i){let i=dm(e[t]),a=n?dm(n[t]):i,o=Math.min(i,a);o<=0||(e[t]=i-o,e[t]===0&&delete e[t],r.sold[t]=(r.sold[t]||0)+o,r.coins+=o*tm(t))}return r.coins>0&&t.add(r.coins),r}function mm(e,t,n,r=1){if(!e||!t||!Bd(n))return!1;let i=dm(r);if(i<=0)return!1;let a=Vd(n)*i;return a<=0||!e.spend(a)?!1:(t.add(n,i),!0)}function hm(){return Object.values(zd)}var gm=new H(0,1,0),_m=5221970,vm=4033604,ym=9067067,bm=5596888,xm=7031347,Sm=.43,Cm=1.3,wm={sprout:.35,bush:.75,ripen:.92,ripe:1},Tm=class{constructor(e,t,n){this.bush=t,this.pos=n.clone(),this.vel=new H,this.onBush=!0,this.dead=!1,this.beingEaten=!1,this.scale=1,this.R=Sm,this._build(e)}_build(e){this.group=new Tn;let t=zl(new Ki(this.R,14,11),bm,1.07);t.children[0].castShadow=!0,this.group.add(t);let n=new K(new Ki(this.R*.3,8,6),new ri({color:2761552}));n.position.y=this.R*.9,n.scale.set(1,.5,1),this.group.add(n),this.group.position.copy(this.pos),e.add(this.group)}update(){this._sync()}_sync(){this.group&&(this.group.position.copy(this.pos),this.group.scale.setScalar(Math.max(.001,this.scale)))}startEat(){this.beingEaten=!0}magnetize(e,t){this.pos.lerp(e,.35),this.scale=Math.max(0,1-t),this._sync()}finishEat(){this.dead=!0}cancelEat(){this.beingEaten=!1,this.scale=1,this._sync()}dispose(){this.group&&this.group.parent&&this.group.parent.remove(this.group),this.group=null}},Em=class{constructor(e,t,n,r,i={}){this.scene=e,this.world=t,this.bush=n,this.dir=r.clone().normalize(),this.plot=i.plot!==!1,this.berries=[],this.base=this.dir.clone().multiplyScalar(t.radius).add(t.center),this.t1=new H(-this.dir.z,0,this.dir.x),this.t1.lengthSq()<1e-6&&this.t1.set(1,0,0),this.t1.normalize(),this.t2=new H().crossVectors(this.dir,this.t1).normalize(),this._stage=null,this._build()}_build(){if(this.group=new Tn,this.group.position.copy(this.base),this.group.quaternion.setFromUnitVectors(gm,this.dir),this.scene.add(this.group),this.plot){let e=new K(new Bi(Cm*.92,Cm*.92,.12,20),Il(xm));e.position.y=.06,e.receiveShadow=!0,this.group.add(e)}this.plant=new Tn;let e=zl(new Bi(.09,.13,.55,8),ym,1.08);e.position.y=.28,this.plant.add(e);let t=zl(new Ki(.62,16,12),_m,1.06);t.children[0].castShadow=!0,t.position.y=.85,t.scale.set(1.15,.9,1.15),this.plant.add(t);let n=zl(new Ki(.4,14,10),vm,1.07);n.position.set(.3,1.15,-.1),this.plant.add(n),this.group.add(this.plant),this._applyStage()}berryPos(e,t){let n=e/Math.max(1,t)*Math.PI*2+.4,r=.52;return this.base.clone().addScaledVector(this.t1,Math.cos(n)*r).addScaledVector(this.t2,Math.sin(n)*r).addScaledVector(this.dir,1.05)}_applyStage(){let e=wm[this.bush.stage]??1;this.plant.scale.setScalar(e),this._stage=this.bush.stage}update(e){let t=[];for(let n=this.berries.length-1;n>=0;n--){let r=this.berries[n];r.update(e),r.dead&&(this.berries.splice(n,1),this.bush.pick(),r.dispose(),t.push(r))}let n=this.bush.n;if(this.berries.length<n){let e=this.bush.yield;for(let t=this.berries.length;t<n;t++)this.berries.push(new Tm(this.scene,this.bush,this.berryPos(t,e)))}return this.bush.stage!==this._stage&&this._applyStage(),t}dispose(){for(let e of this.berries)e.dispose();this.berries.length=0,this.group&&this.group.parent&&this.group.parent.remove(this.group),this.group=null}};function Dm(e,t,n){let r=n.clone().normalize(),i=new Tn;i.position.copy(r).multiplyScalar(t.radius+.06).add(t.center),i.quaternion.setFromUnitVectors(gm,r);let a=new K(new Bi(Cm,Cm,.08,22),Il(9075294));a.receiveShadow=!0,i.add(a);let o=new K(new Bi(Cm*.68,Cm*.68,.1,20),Il(7299143));return i.add(o),e.add(i),i}function Om(e,t,n=[]){return!e||!Ld(e,n)?!1:(e.dead=!0,t.add(`berry`,1),!0)}var km=new H(0,1,0),Am=10120005,jm=11567957,Mm=9140822,Nm=15255698,Pm=13213791,Fm=5596888;function Im(e,t,n=new H){return n.copy(e).normalize().multiplyScalar(t.radius).add(t.center)}function Lm(e,t){let n=e.clone().normalize(),r=new H(-n.z,0,n.x);r.lengthSq()<1e-6&&r.set(1,0,0),r.normalize();let i=new H().crossVectors(n,r).normalize(),a=[];for(let e=0;e<25;e++){let o=e/25*Math.PI*2,s=hu/t.radius,c=n.clone().multiplyScalar(Math.cos(s)).addScaledVector(r,Math.cos(o)*Math.sin(s)).addScaledVector(i,Math.sin(o)*Math.sin(s)).normalize();for(let e of gu)a.push({com:c.clone().multiplyScalar(t.radius+e).add(t.center),radius:1})}return a}function Rm(e){let t=e.clone().normalize(),n=new H(-t.z,0,t.x);return n.lengthSq()<1e-6&&n.set(1,0,0),n.normalize(),{d:t,t1:n,t2:new H().crossVectors(t,n).normalize()}}function zm(e,t,n){let r=Tu.clone().addScaledVector(e,-Tu.dot(e));return r.lengthSq()<1e-8?0:(r.normalize(),Math.atan2(r.dot(n),r.dot(t)))}function Bm(e,t){let{d:n,t1:r,t2:i}=Rm(e),a=zm(n,r,i),o=(hu-_u)/t.radius,s=n.clone().multiplyScalar(Math.cos(o)).addScaledVector(r,Math.cos(a)*Math.sin(o)).addScaledVector(i,Math.sin(a)*Math.sin(o)).normalize(),c=t.radius*(1-Math.cos(o))+.02,l=n.clone().addScaledVector(s,-n.dot(s));l.lengthSq()<1e-8&&l.copy(r),l.normalize();let u=l.clone().negate(),d=new H().crossVectors(s,u).normalize();return{dir:s,pos:s.clone().multiplyScalar(t.radius+c).add(t.center),n:s,away:u,along:d}}function Vm(e,t,n=6){let r=vu-bu-.14,i=n>1?t/(n-1)*2-1:0;return e.pos.clone().addScaledVector(e.along,i*r).addScaledVector(e.n,bu+.22)}function Hm(e,t,n=hu){let r=e.x-t.x,i=e.y-t.y,a=e.z-t.z;return r*r+i*i+a*a<n*n}var Um=class{constructor(e,t,n){this.pos=t.clone(),this.penDir=(n||t).clone().normalize(),this.vel=new H,this.onTrough=!0,this.dead=!1,this.beingEaten=!1,this.scale=1,this.R=bu,this._build(e)}_build(e){this.group=new Tn;let t=zl(new Ki(this.R,12,9),Fm,1.08);t.children[0].castShadow=!0,this.group.add(t),this.group.position.copy(this.pos),e.add(this.group)}update(){this._sync()}_sync(){this.group&&(this.group.position.copy(this.pos),this.group.scale.setScalar(Math.max(.001,this.scale)))}visionLim(e,t,n){let r=t&&t.radius||1,i=Math.max(-1,Math.min(1,e.dot(this.penDir)));return Math.acos(i)*r<6.5?2*hu:n}startEat(){this.beingEaten=!0}magnetize(e,t){this.pos.lerp(e,.35),this.scale=Math.max(0,1-t),this._sync()}finishEat(){this.dead=!0}cancelEat(){this.beingEaten=!1,this.scale=1,this._sync()}dispose(){this.group&&this.group.parent&&this.group.parent.remove(this.group),this.group=null}},Wm=class{constructor(e,t,n){this.scene=e,this.world=t,this.dir=n.clone().normalize(),this.center=Im(this.dir,t),this.trough=Bm(this.dir,t),this.berries=[],this._build()}_build(){this.group=new Tn,this.group.position.copy(this.center),this.group.quaternion.setFromUnitVectors(km,this.dir),this.scene.add(this.group);let e=new K(new Bi(hu,hu,.12,32),Il(Mm));e.position.y=.06,e.receiveShadow=!0,this.group.add(e);let t=gu[gu.length-1]+1*.4;for(let e=0;e<25;e++){let n=e/25*Math.PI*2,r=zl(new Bi(1*.42,1*.5,t,7),Am,1.08);r.children[0].castShadow=!0,r.position.set(Math.cos(n)*hu,t/2,Math.sin(n)*hu),this.group.add(r)}for(let e of gu){let t=new K(new qi(hu,1*.22,6,40),Il(jm));t.rotation.x=Math.PI/2,t.position.y=e,this.group.add(t)}this._buildTrough()}_buildTrough(){let e=this.trough,t=this.group.quaternion.clone().invert(),n=e=>e.clone().applyQuaternion(t),r=e.pos.clone().sub(this.center).applyQuaternion(t),i=n(e.along),a=n(e.n),o=n(e.away),s=new Tn;s.position.copy(r),s.quaternion.setFromRotationMatrix(new Xt().makeBasis(i,a,o));let c=.13,l=.36,u=zl(new Ri(vu*2,.14,yu*2),Nm,1.05);u.position.y=.07,u.children[0].receiveShadow=!0,s.add(u);for(let e of[-1,1]){let t=zl(new Ri(vu*2,l,c),Pm,1.05);t.position.set(0,l/2,e*(yu-c/2)),s.add(t);let n=zl(new Ri(c,l,yu*2),Pm,1.05);n.position.set(e*(vu-c/2),l/2,0),s.add(n)}this.troughGroup=s,this.group.add(s)}update(e,t){let n=[];for(let r=this.berries.length-1;r>=0;r--){let i=this.berries[r];i.update(e),i.dead&&(this.berries.splice(r,1),vf(t),i.dispose(),n.push(i))}let r=Math.max(0,Math.min(6,t?Math.floor(t.trough||0):0));for(;this.berries.length<r;)this.berries.push(new Um(this.scene,Vm(this.trough,this.berries.length),this.dir));for(;this.berries.length>r;){let e=this.berries.pop();e.dead=!0,e.dispose(),n.push(e)}return n}dispose(){for(let e of this.berries)e.dead=!0,e.dispose();this.berries.length=0,this.group&&this.group.parent&&this.group.parent.remove(this.group),this.group=null}},Gm=450,Km=[{len:280,m0:0,m1:0,night:!1},{len:20,m0:0,m1:1,night:!1},{len:130,m0:1,m1:1,night:!0},{len:20,m0:1,m1:0,night:!0}],qm=(e,t=0)=>Number.isFinite(e)?e:t;function Jm(e){let t=e&&typeof e==`object`?e.t:e,n=qm(typeof t==`number`?t:NaN,0);if(!(n>0))return 0;let r=n%Gm;return Number.isFinite(r)&&r>=0?r:0}function Ym(e){let t=e;for(let e=0;e<Km.length;e++){let n=Km[e];if(t<n.len||e===Km.length-1)return{s:n,u:Math.min(t,n.len)};t-=n.len}return{s:Km[0],u:0}}function Xm(e){let{s:t,u:n}=Ym(Jm(e));return t.m0+(t.m1-t.m0)*(t.len>0?n/t.len:0)}function Zm(e){return Jm(e)<300?`day`:`night`}function Qm(e){return 1+1*Math.max(0,Math.min(1,qm(e,0)))}var $m=Km.reduce((e,t)=>e+t.len*Qm((t.m0+t.m1)/2),0);function eh(e){let t=Math.max(0,Math.min(Gm,e)),n=0;for(let e of Km){if(t<=0)break;let r=Math.min(t,e.len),i=e.m0+(e.m1-e.m0)*(e.len>0?r/e.len:0)/2;n+=r*Qm(i),t-=r}return n}function th(e,t){let n=qm(t,0);if(!(n>0))return 0;let r=Jm(e),i=Math.floor(n/Gm),a=r+(n-i*Gm),o=a<=Gm?eh(a)-eh(r):$m-eh(r)+eh(a-Gm);return i*$m+o}var nh=class{constructor(e){this.t=Jm(e)}advance(e){let t=qm(e,0);if(t>0){let e=(this.t+t)%Gm;this.t=Number.isFinite(e)&&e>=0?e:0}return this}phase(){return Zm(this.t)}mix(){return Xm(this.t)}isNight(){return this.phase()===`night`}growthMul(){return Qm(this.mix())}toJSON(){return this.t}},rh={sun:{color:16774376,intensity:2.2},ambient:{color:13616366,intensity:.85},hemi:{sky:16771570,ground:9405632,intensity:.45},background:1,stars:.35},ih={sun:{color:10335999,intensity:.5},ambient:{color:7300804,intensity:.62},hemi:{sky:9404376,ground:2761552,intensity:.5},background:.42,stars:1};function ah(e,t,n){let r=e>>16&255,i=e>>8&255,a=e&255,o=t>>16&255,s=t>>8&255,c=t&255,l=Math.round(r+(o-r)*n),u=Math.round(i+(s-i)*n),d=Math.round(a+(c-a)*n);return l<<16|u<<8|d}var oh=(e,t,n)=>e+(t-e)*n;function sh(e){let t=Math.max(0,Math.min(1,qm(e,0)));return{sun:{color:ah(rh.sun.color,ih.sun.color,t),intensity:oh(rh.sun.intensity,ih.sun.intensity,t)},ambient:{color:ah(rh.ambient.color,ih.ambient.color,t),intensity:oh(rh.ambient.intensity,ih.ambient.intensity,t)},hemi:{sky:ah(rh.hemi.sky,ih.hemi.sky,t),ground:ah(rh.hemi.ground,ih.hemi.ground,t),intensity:oh(rh.hemi.intensity,ih.hemi.intensity,t)},background:oh(rh.background,ih.background,t),stars:oh(rh.stars,ih.stars,t)}}var ch=B.degToRad(60),lh=B.degToRad(10),uh=26.3,dh=uh/11,fh=.35,ph=1.2,mh=.9,hh=1.3,gh=ru+ou,_h=su,vh=.15,yh=(e,t,n)=>e<t?t:e>n?n:e,bh=new H,xh=new H,Sh=new H,Ch=new H,wh=new H,Th=new H;function Eh(e,t,n){let r=bh.copy(t).normalize(),i=xh.copy(n).sub(e),a=i.length()||1e-6;i.multiplyScalar(1/a);let o=Math.acos(yh(r.dot(i),-1,1)),s=Sh.copy(i).addScaledVector(r,-i.dot(r)),c=s.lengthSq()<1e-12?null:s.normalize();return{grabR:a,ang:o,s:a*o,tang:c}}function Dh(e,t,n){let r=fh*t,i=n/dh;return yh((e-r)/(i-r),0,1)}function Oh({center:e,anchorDir:t,fingerPoint:n,R:r,throwMax:i},a=null){let{s:o,tang:s}=Eh(e,t,n);if(o<.35*r||!s)return null;let c=Math.min(dh*o,i),l=Dh(o,r,i),u=ch+(lh-ch)*l;return{v0:(a||new H).copy(s).multiplyScalar(-Math.cos(u)*c).addScaledVector(bh,Math.sin(u)*c),s:o,elev:u,pull:l}}function kh({center:e,anchorDir:t,fingerPoint:n,maxArc:r},i){let{grabR:a,ang:o,tang:s}=Eh(e,t,n),c=Math.min(o,r/a);return!s||c<=1e-6?i.copy(e).addScaledVector(bh,a):i.copy(e).addScaledVector(bh,Math.cos(c)*a).addScaledVector(s,Math.sin(c)*a)}function Ah({center:e,startPos:t,v0:n,gravityStrength:r,velDamp:i,landRadius:a,falloffR:o=null,falloffP:s=2,dt:c=1/120,maxT:l=40},u=null){let d=u?u.pts:[];d.length=0;let f=0,p=()=>{if(!u){let e=new H;return d.push(e),e}for(;u.pool.length<=f;)u.pool.push(new H);let e=u.pool[f++];return d.push(e),e},m=Ch.copy(t),h=wh.copy(n);p().copy(m);let g=0,_=0,v=hh,y=!1,b=null,x=l;for(;g<l;){Th.copy(e).sub(m);let t=Th.length()||1e-6,n=o!==null&&t>o?r*(o/t)**+s:r;Th.multiplyScalar(n/t),h.multiplyScalar(i).addScaledVector(Th,c),m.addScaledVector(h,c),g+=c,_+=h.length()*c;let l=m.distanceTo(e);if(!y)l>a&&(y=!0);else if(l<=a){b=p().copy(m).sub(e).setLength(a).add(e),x=g;break}if(_>=v&&(_=0,p().copy(m),d.length>=192)){let e=1;for(let t=2;t<d.length;t+=2)d[e++].copy(d[t]);d.length=e,f=e,v*=2,_=v/2}}return{points:d,landPos:b,flightT:x}}function jh(e){let t={damp0:e.velDamp,fall0:e.gravityFalloffR,fallP0:e.gravityFalloffP,grav0:e.gravityStrength,t:0,rose:!1};return e.velDamp=1,e.gravityFalloffR=gh,e.gravityFalloffP=_h,e.gravityStrength=t.grav0*2,t}function Mh(e,t){e.velDamp=t.damp0,e.gravityFalloffR=t.fall0,e.gravityFalloffP=t.fallP0,e.gravityStrength=t.grav0}var Nh={gravityStrength:0,velDamp:1,falloffR:gh,falloffP:_h};function Ph(e){return Nh.gravityStrength=e.gravityStrength*2,Nh}function Fh(e,t){let n=jh(e);return e.addVelocity(t),e.stretchAlong(t,3),n}function Ih(e,t,n,r,i){t.t+=n;let a=e.com.x-r.x,o=e.com.y-r.y,s=e.com.z-r.z,c=Math.sqrt(a*a+o*o+s*s),l=i+vh;if(!t.rose)c>l&&(t.rose=!0);else if(c<=l&&a*e.velocity.x+o*e.velocity.y+s*e.velocity.z<=0)return Mh(e,t),!1;return t.t>=40?(Mh(e,t),!1):!0}var Lh=`blob-planet-progress`,Rh=e=>e<0?0:e>1?1:e;function zh(e,t){if(!e)return null;let n=t?.x??0,r=t?.y??0,i=t?.z??0,a=e.x-n,o=e.y-r,s=e.z-i,c=Math.sqrt(a*a+o*o+s*s);return!Number.isFinite(c)||c<1e-6?null:[a/c,o/c,s/c]}function Bh(e,t={}){let n={v:1,blobs:{}};for(let r of e){let e={satiety:r.brain.satiety,energy:r.brain.energy,trust:r.brain.trust},i=zh(r.blob.com,t.center);i&&(e.dir=i);let a=r.brain.boost;a&&a.t>0&&a.mul>1&&(e.boost={mul:a.mul,t:a.t}),n.blobs[r.blob.traits.id]=e}n.crystals=Number.isFinite(t.crystals)?Math.max(0,Math.floor(t.crystals)):0,n.coins=Number.isFinite(t.coins)?Math.max(0,Math.floor(t.coins)):0,n.lastSeen=Number.isFinite(t.lastSeen)?t.lastSeen:Date.now(),n.ground=[];for(let e of Array.isArray(t.ground)?t.ground:[]){let t=e&&e.pos;!t||!Number.isFinite(t.x)||!Number.isFinite(t.y)||!Number.isFinite(t.z)||n.ground.push({kind:String(e.kind??``),pos:[t.x,t.y,t.z]})}return t.inv!=null&&(n.inv=(t.inv instanceof of?t.inv:new of(t.inv)).toJSON()),t.farm!=null&&(n.farm=(t.farm instanceof bf?t.farm:new bf(t.farm)).toJSON()),n.day=Jm(t.day),n}function Vh(e){let t={crystals:0,coins:0,lastSeen:null,ground:[],inv:sf(e),farm:Cf(e),day:Jm(e&&typeof e==`object`?e.day:void 0)};if(!e||typeof e!=`object`)return t;if(Number.isFinite(e.crystals)&&(t.crystals=Math.max(0,Math.floor(e.crystals))),Number.isFinite(e.coins)&&(t.coins=Math.max(0,Math.floor(e.coins))),Number.isFinite(e.lastSeen)&&(t.lastSeen=e.lastSeen),Array.isArray(e.ground))for(let n of e.ground){if(!n||typeof n!=`object`)continue;let e=n.pos;!Array.isArray(e)||e.length!==3||!e.every(Number.isFinite)||t.ground.push({kind:typeof n.kind==`string`?n.kind:``,pos:[e[0],e[1],e[2]]})}return t}function Hh(e){let t={};if(!e||typeof e!=`object`||!e.blobs||typeof e.blobs!=`object`)return t;for(let[n,r]of Object.entries(e.blobs)){if(!r||typeof r!=`object`)continue;let e=r.dir;if(!Array.isArray(e)||e.length!==3||!e.every(Number.isFinite))continue;let i=Math.hypot(e[0],e[1],e[2]);i>1e-6&&(t[n]=[e[0]/i,e[1]/i,e[2]/i])}return t}function Uh(e,t){if(!t||typeof t!=`object`||t.v!==1||!t.blobs||typeof t.blobs!=`object`)return!1;for(let n of e){let e=t.blobs[n.blob.traits.id];if(!(!e||typeof e!=`object`)&&(Number.isFinite(e.satiety)&&(n.brain.satiety=Rh(e.satiety)),Number.isFinite(e.energy)&&(n.brain.energy=Rh(e.energy)),Number.isFinite(e.trust)&&(n.brain.trust=Rh(e.trust)),n.brain.boost)){let t=Zd(e.boost);n.brain.boost.mul=t.mul,n.brain.boost.t=t.t}}return!0}function Wh(){return{w:window.innerWidth||document.body.clientWidth||390,h:window.innerHeight||document.body.clientHeight||700}}var Gh=new Al({antialias:!0,preserveDrawingBuffer:!0});{let{w:e,h:t}=Wh();Gh.setSize(e,t)}Gh.setPixelRatio(Math.min(window.devicePixelRatio,2)),Gh.outputColorSpace=Be,Gh.toneMapping=0,Gh.shadowMap.enabled=!0,Gh.shadowMap.type=2,document.getElementById(`app`).appendChild(Gh.domElement);var Y=new Nn;Bl(Y,Wl,`#1a1436`,`#2c2154`);var Kh=Hl(Y,{count:520,near:175,far:550});Ul(Y,[{r:7,color:16752451,position:[-120,65,-200]},{r:4.5,color:7069904,position:[145,-35,-175]},{r:3,color:15952096,position:[100,85,-237.5]}]);var qh=new Wa(16774376,2.2);qh.position.set(55,85,45),qh.castShadow=!0,qh.shadow.mapSize.set(2048,2048),qh.shadow.camera.near=1,qh.shadow.camera.far=400,qh.shadow.camera.left=-75,qh.shadow.camera.right=75,qh.shadow.camera.top=75,qh.shadow.camera.bottom=-75,qh.shadow.bias=-4e-4,qh.shadow.radius=4,Y.add(qh,qh.target);var Jh=new Ga(13616366,.85),Yh=new ka(16771570,9405632,.45);Y.add(Jh,Yh);var X=new $l({center:new H(0,0,0),radius:ru,sea:{dir:Pu,radius:16,depth:cu,shoreBand:4,buoyancy:30,drag:2,maxDepth:du,island:{dir:Fu,arc:5,flat:lu,rise:uu}}}),{nestDir:Xh,nestPos:Zh}=$u(Y,X),Qh=.85,$h=[`kisel`,`popryg`,`lipuchka`,`dichok`],eg=Iu(),Z=$h.map((e,t)=>{let n=new Sd(Y,X,eg[t].clone().multiplyScalar(ru+3),au,bd[e]);return{blob:n,brain:new Bp(n,X,Hu(Xh,t,X.center)),zTimer:.6,view:null,flight:null,trailTimer:0,water:new tu(X,{minV:Su,fullV:8}),ringTimer:0}});for(let e of Z)e.baseOthers=Z.filter(t=>t!==e).map(e=>({com:e.blob.body.com,radius:e.blob.R*Qh})),e.view=new eu(X,e.baseOthers),e.homeNest={nestDir:e.brain.nestDir.clone(),nestPos:e.brain.nestPos.clone()},e.penSleep=!1;var tg=28,ng=6,rg=30,ig=au*8,ag=[];if(nu){let e=[`dichok`,`popryg`,`kisel`,`lipuchka`];for(let t=0;t<tg;t++){let n=Math.acos(1-2*(t+.5)/tg),r=Math.PI*(1+Math.sqrt(5))*t,i=new Sd(Y,X,new H(Math.sin(n)*Math.cos(r),Math.cos(n),Math.sin(n)*Math.sin(r)).multiplyScalar(ru+3),au,bd[e[t%e.length]]),a=new Bp(i,X,{satiety:.5,energy:.8});a.crystalBlocked=!0,ag.push({blob:i,brain:a,view:new eu(X,[]),zTimer:.6,ringTimer:0,water:new tu(X,{minV:Su,fullV:8})})}console.log(`[big-world] R=${ru}, диких: ${ag.length}, лимит живых: ${ng}`)}var og=[],sg=0,cg=0,lg=new fm(0),ug=$p.id,dg=new of(rf()),fg=new bf,pg=new nh;try{let e=localStorage.getItem(Lh);if(e){let t=JSON.parse(e);Uh(Z,t);let n=Hh(t);for(let e of Z){let t=n[e.blob.traits.id];t&&Cd(e.blob,new H(t[0],t[1],t[2]),X)}let r=Vh(t);sg=r.crystals,lg=new fm(r.coins),dg=r.inv,fg=r.farm,pg=new nh(r.day);for(let e of r.ground){if(og.length>=20)break;og.push(new sm(Y,X,{kind:e.kind,pos:new H(e.pos[0],e.pos[1],e.pos[2])}))}if(r.lastSeen!=null){let e=(Date.now()-r.lastSeen)/1e3,t=um(Z.map(e=>({satiety:e.brain.satiety})),e);Z.forEach((e,n)=>{e.brain.satiety=t.satiety[n]}),cg=t.crystals,sg+=cg;for(let t of Z)$d(t.brain.boost,e);let n=pg.t;pg.advance(e),fg.offlineAdvance(th(n,e))}}}catch{}function mg(){try{localStorage.setItem(Lh,JSON.stringify(Bh(Z,{crystals:sg,coins:lg.coins,lastSeen:Date.now(),ground:og.map(e=>({kind:e.kind.id,pos:e.pos})),inv:dg,farm:fg,day:pg.t,center:X.center})))}catch{}}window.addEventListener(`pagehide`,mg),document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`hidden`&&mg()});var hg=Z[0];hg.blob.setActive(!0);var gg=[],_g=12;function vg(e){e.group&&Y.remove(e.group)}function yg(e){gg.length>=_g&&(vg(gg.shift()),Q.pop()),gg.push(new Fd(Y,X,e,{startDist:ru+au*4}))}var bg={dishJam:14717231,dishMousse:9429181,dishCake:15907023,[Hd]:4867666};function xg(e,t){let n=Object.values(Gd).find(e=>e.dish===t);gg.length>=_g&&(vg(gg.shift()),Q.pop()),gg.push(new Fd(Y,X,e,{startDist:ru+au*4,dish:t,color:bg[t],boostMul:n?n.boostMul:0,boostDur:n?n.boostDur:0}))}var Sg=Bu(),Cg=Vu(),wg=Sg.map(e=>e.clone().multiplyScalar(ru).add(X.center)),Tg=Sg.map(e=>Dm(Y,X,e)),Eg=Sg.map(()=>null),Dg=Sg.map(()=>null),Og=[],kg=Cg.map((e,t)=>new Em(Y,X,fg.wild[t],e,{plot:!1})),Ag=[],jg=[],Mg=[],Ng=-1,Pg=1;function Fg(e){let t=fg.slot(e),n=t.building===`pen`;if(n&&!Dg[e])Dg[e]=new Wm(Y,X,Sg[e]),Og.push({slot:e,center:wg[e],r:hu,spheres:Lm(Sg[e],X)});else if(!n&&Dg[e]){Dg[e].dispose(),Dg[e]=null;let t=Og.findIndex(t=>t.slot===e);t>=0&&Og.splice(t,1)}if(t.bush&&!Eg[e])Eg[e]=new Em(Y,X,t.bush,Sg[e],{plot:!0});else if(!t.bush&&Eg[e]){for(let t of Eg[e].berries)t.dead=!0;Eg[e].dispose(),Eg[e]=null}Tg[e].visible=!t.building}for(let e=0;e<fg.slots.length;e++)Fg(e);function Ig(){for(let e of Z){if(!Og.length){e.view.others=e.baseOthers;continue}let t=e.baseOthers;for(let n of Og)e.blob.com.distanceToSquared(n.center)>10.9*10.9||(t=(t===e.baseOthers?e.baseOthers.slice():t).concat(n.spheres));e.view.others=t}}var Lg=new H;function Rg(){for(let e of Z)if(Og.length&&Og.some(t=>Hm(e.blob.com,t.center,t.r))){let t=e.brain.sleepState;if(t!==`awake`&&t!==`going`||!e.brain.nestDir)continue;Lg.copy(e.blob.com).sub(X.center).normalize(),e.brain.nestDir.copy(Lg),e.brain.nestPos.copy(Lg).multiplyScalar(ru).add(X.center),e.penSleep=!0}else e.penSleep&&(e.brain.sleepState===`awake`||e.brain.sleepState===`going`)&&(e.brain.nestDir.copy(e.homeNest.nestDir),e.brain.nestPos.copy(e.homeNest.nestPos),e.penSleep=!1)}function zg(e){fg.advance(e*Pg*pg.growthMul());for(let t of Eg)t&&t.update(e);for(let t of kg)t.update(e);Ag.length=0;for(let e of Eg)if(e)for(let t of e.berries)Ag.push(t);for(let e of kg)for(let t of e.berries)Ag.push(t);jg.length=0;for(let t=0;t<Dg.length;t++){let n=Dg[t];if(n){n.update(e,fg.slot(t));for(let e of n.berries)jg.push(e)}}}var Bg=null;function Vg(){let e=pg.isNight();if(e!==Bg){Bg=e;for(let t of Z)t.brain.setNightSleep(e);for(let t of ag)t.brain.setNightSleep(e)}}var Hg=new G,Ug=new G,Wg=new G,Gg=new G;function Kg(){let e=sh(pg.mix());qh.intensity=e.sun.intensity,qh.color.copy(Hg.setHex(e.sun.color)),Jh.intensity=e.ambient.intensity,Jh.color.copy(Ug.setHex(e.ambient.color)),Yh.intensity=e.hemi.intensity,Yh.color.copy(Wg.setHex(e.hemi.sky)),Yh.groundColor.copy(Gg.setHex(e.hemi.ground)),Y.backgroundIntensity=e.background,Kh&&Kh.material&&(Kh.material.opacity=e.stars)}var Q=new Gl,qg=!0,Jg={nom:()=>{qg&&Q.nom()},pum:()=>{qg&&Q.pum()},splat:e=>{qg&&Q.splat(e)},splash:e=>{qg&&Q.splash(e)},squish:e=>{qg&&Q.squish(e)}},Yg=new Va(54,Wh().w/Wh().h,.1,2e3),Xg=new Dd(Yg,X.center,{dist:ru*2.6,minDist:6,maxDist:ru*3.4});Xg.yaw=Math.atan2(Tu.x,Tu.z),Xg.pitch=Math.asin(Tu.y)-.17;var Zg=22;function Qg(e=!1){let{w:t,h:n}=Wh(),r=t/n,i=B.degToRad(Yg.fov)/2,a=Math.atan(Math.tan(i)*r),o=Math.min(i,a),s=ru*1.4/Math.tan(o);Xg.maxDist=Math.max(ru*2.2,s),e&&(Xg.dist=B.clamp(ru+Zg/2/Math.tan(o),Xg.minDist,Xg.maxDist)),Xg.dist=B.clamp(Xg.dist,Xg.minDist,Xg.maxDist)}var $g=new lo,e_=new V,t_=new yr(X.center,ru),n_=new H,r_=new H,i_=new H,a_=new H,o_=`idle`,s_=0,c_=0,l_=0,u_=0,d_=0,f_=0,p_=0,m_=au*2.4,h_=.55,g_=42,__=null,v_=0,y_=0,b_=new H,x_=new H,S_=new H,C_=0,w_=.3,T_=8,E_=`undecided`,D_=new H,O_=new H,k_=new H,A_=new H,j_=null,M_={pool:[],pts:[]},N_=0,P_=0;function F_(e,t){e_.x=e/window.innerWidth*2-1,e_.y=-(t/window.innerHeight)*2+1}var I_=new yr,L_=new H,R_=1/0;function z_(){$g.setFromCamera(e_,Yg);let e=null,t=1/0;for(let n of Z){if(I_.set(n.blob.com,n.blob.R*1.25),!$g.ray.intersectSphere(I_,L_))continue;let r=L_.distanceTo($g.ray.origin);r<t&&(t=r,e=n)}return R_=t,e}var B_=1.1;function V_(){$g.setFromCamera(e_,Yg);let e=null,t=1/0;for(let n of og){if(n.dead||(I_.set(n.pos,B_),!$g.ray.intersectSphere(I_,L_)))continue;let r=L_.distanceTo($g.ray.origin);r<t&&(t=r,e=n)}return e?{c:e,t}:null}var H_=1;function U_(){$g.setFromCamera(e_,Yg);let e=null,t=1/0,n=Z.map(e=>e.brain);for(let r of gg.concat(Ag)){if(r.dish||!Ld(r,n)||(I_.set(r.pos,H_),!$g.ray.intersectSphere(I_,L_)))continue;let i=L_.distanceTo($g.ray.origin);i<t&&(t=i,e=r)}return e?{b:e,t}:null}function W_(){$g.setFromCamera(e_,Yg);let e=-1,t=1/0;for(let n=0;n<Dg.length;n++){let r=Dg[n];if(!r||(I_.set(r.trough.pos,xu),!$g.ray.intersectSphere(I_,L_)))continue;let i=L_.distanceTo($g.ray.origin);i<t&&(t=i,e=n)}return e}var G_=Cm+.4;function K_(){$g.setFromCamera(e_,Yg);let e=-1,t=1/0;for(let n=0;n<wg.length;n++){if(I_.set(wg[n],G_),!$g.ray.intersectSphere(I_,L_))continue;let r=L_.distanceTo($g.ray.origin);r<t&&(t=r,e=n)}return e}function q_(e){hg!==e&&(hg.blob.setActive(!1),hg=e,hg.blob.setActive(!0),zy())}function J_(e,t){if($g.setFromCamera(e_,Yg),t_.radius=e,$g.ray.intersectSphere(t_,t))return t;let n=$g.ray.origin,r=$g.ray.direction,i=i_.copy(X.center).sub(n).dot(r);return a_.copy(n).addScaledVector(r,Math.max(i,0)),t.copy(a_).sub(X.center).setLength(e).add(X.center)}Gh.domElement.addEventListener(`pointerdown`,e=>{if(Q.ensure(),F_(e.clientX,e.clientY),s_=e.clientX,c_=e.clientY,u_=performance.now(),d_=e.clientX,f_=e.clientY,p_=0,!Sy){let t=W_();if(t>=0){Fv(t,e.clientX,e.clientY),o_=`idle`;return}}let t=z_(),n=Sy?null:V_();if(n&&(!t||n.t<R_)){yv(n.c,e.clientX,e.clientY),o_=`idle`;return}if(Ng=-1,!t&&!Sy){let t=U_();if(t){Iv(t.b,e.clientX,e.clientY),o_=`idle`;return}Ng=K_()}if(t){o_=`grab`,__=t,q_(t);let e=t.blob;t.flight&&(Mh(e.body,t.flight),t.flight=null,e.flying=!1),C_=performance.now(),$g.setFromCamera(e_,Yg);let n=$g.ray.intersectSphere(new yr(e.com,e.R),i_)?i_.clone():e.com.clone();e.body.beginGrab(n,5),v_=e.com.distanceTo(X.center),y_=0,E_=`undecided`,j_=null,b_.copy(n),x_.copy(n),S_.set(0,0,0),e.setGrabbed(!0),e.poke(.5),t.brain.notifyPoke(),Q.squish(.6)}else Sy?(o_=`vacuum`,Cy=!0):(o_=`rotate`,Xg.startDrag())}),window.addEventListener(`pointermove`,e=>{if(o_===`idle`)return;let t=e.clientX-s_,n=e.clientY-c_;if(s_=e.clientX,c_=e.clientY,F_(e.clientX,e.clientY),p_=Math.max(p_,Math.hypot(e.clientX-d_,e.clientY-f_)),o_===`rotate`){Xg.drag(t,n);let e=Math.sign(t);e!==0&&(e===-P_&&Math.abs(t)>7&&(N_=Math.min(1.6,N_+Math.abs(t)*.012)),P_=e)}else o_===`grab`&&(l_=Math.min(1,l_+Math.hypot(t,n)*.02))});function Y_(e){if(Cy=!1,o_===`rotate`&&(Xg.endDrag(),performance.now()-u_<250&&p_<6&&(Ov?Nv(e):!Sy&&Ng>=0&&Hv(Ng))),o_===`grab`&&__){let e=__.blob;if(e.body.endGrab(),e.setGrabbed(!1),E_===`sling`){j_&&(__.flight=Fh(e.body,j_.v0),Q.pew(j_.pull)),j_=null,gb(),__=null,o_=`idle`;return}if(S_.length()>.4){i_.copy(S_).clampLength(0,g_);let t=a_.copy(e.com).sub(X.center).normalize(),n=i_.length(),r=i_.dot(t);r_.copy(i_).addScaledVector(t,-r);let i=r_.length();i>.001&&r_.multiplyScalar(1/i);let a=Math.max(r,0)+n*.25*(i/n);i_.copy(r_).multiplyScalar(i).addScaledVector(t,a).clampLength(0,g_),e.body.addVelocity(i_)}__=null}o_=`idle`}window.addEventListener(`pointerup`,Y_),window.addEventListener(`pointercancel`,Y_);var X_=!1;Gh.domElement.addEventListener(`wheel`,e=>{e.preventDefault(),X_=!0,Xg.zoom(e.deltaY*.0012*Xg.dist)},{passive:!1});var Z_=0;Gh.domElement.addEventListener(`touchstart`,e=>{e.touches.length===2&&(Z_=Math.hypot(e.touches[0].clientX-e.touches[1].clientX,e.touches[0].clientY-e.touches[1].clientY),o_===`grab`&&__&&(__.blob.body.endGrab(),__.blob.setGrabbed(!1),j_=null,gb(),__=null),o_===`rotate`&&Xg.endDrag(),o_=`idle`,Sy&&Dy(!1),Cy=!1)},{passive:!1}),Gh.domElement.addEventListener(`touchmove`,e=>{if(e.touches.length===2){e.preventDefault();let t=Math.hypot(e.touches[0].clientX-e.touches[1].clientX,e.touches[0].clientY-e.touches[1].clientY);X_=!0,Xg.zoom((Z_-t)*.003*Xg.dist),Z_=t}},{passive:!1});var Q_=document.getElementById(`btn-mute`),$_=document.getElementById(`sat-fill`),ev=document.getElementById(`energy-fill`),tv=document.getElementById(`hud-temper`),nv=document.getElementById(`temper-label`),rv=!1;Q_.addEventListener(`click`,()=>{rv=!rv,Q_.textContent=rv?`🔇`:`🔊`,Q.setMuted(rv)});var iv=1;function av(e){iv=Math.min(e,10);for(let t of Z)t.brain.ecoTimeScale=e/iv;for(let t of ag)t.brain.ecoTimeScale=e/iv;Pg=e/iv}var ov=document.getElementById(`btn-timescale`),sv=typeof location<`u`&&(location.pathname.indexOf(`planet-test`)!==-1||new URLSearchParams(location.search).has(`debug`));if(ov&&sv){let e=[1,10,50],t=0;ov.hidden=!1,ov.addEventListener(`click`,()=>{t=(t+1)%e.length;let n=e[t];av(n),ov.textContent=`⏩ ×${n}`,ov.classList.toggle(`active`,n>1)})}var cv=document.getElementById(`hud-crystals`),lv=document.getElementById(`crystal-count`),uv=document.getElementById(`offline-pop`),dv=document.getElementById(`offline-n`),fv=document.getElementById(`hud-coins`),pv=document.getElementById(`coin-count`);function mv(){lv&&(lv.textContent=String(sg))}function hv(){pv&&(pv.textContent=String(lg.coins))}function gv(e){e&&(e.classList.remove(`bump`),e.offsetWidth,e.classList.add(`bump`))}mv(),hv(),uv&&cg>0&&(dv&&(dv.textContent=String(cg)),uv.hidden=!1,uv.addEventListener(`pointerdown`,e=>{e.stopPropagation(),uv.hidden=!0}));var _v=.55,vv=[];function yv(e,t,n){let r=sg;sg=lm(og,e,sg),sg!==r&&(e.dispose(),mv(),Q.ensure(),Q.ding(),bv(t,n,{target:cv,glyph:`◆`,color:`#`+e.kind.color.toString(16).padStart(6,`0`)}))}function bv(e,t,n={}){let r=n.target;if(!r||typeof document>`u`)return;let i=r.getBoundingClientRect();Sv(e,t,i.left+i.width/2,i.top+i.height/2,r,n)}function xv(e,t,n,r={}){if(!e||typeof document>`u`)return;let i=e.getBoundingClientRect();Sv(i.left+i.width/2,i.top+i.height/2,t,n,e,r)}function Sv(e,t,n,r,i,a){let o=document.createElement(`div`);o.className=`crystal-fly`+(a.cls?` `+a.cls:``),o.textContent=a.glyph||`◆`,a.color&&(o.style.color=a.color),document.body.appendChild(o),vv.push({el:o,life:0,bump:i,x0:e,y0:t,x1:n,y1:r,cx:(e+n)/2,cy:Math.min(t,r)-90})}function Cv(e){for(let t=vv.length-1;t>=0;t--){let n=vv[t];n.life+=e;let r=n.life/_v;if(r>=1){n.el.remove(),vv.splice(t,1),gv(n.bump);continue}let i=1-r,a=i*i*n.x0+2*i*r*n.cx+r*r*n.x1,o=i*i*n.y0+2*i*r*n.cy+r*r*n.y1;n.el.style.transform=`translate(${a-11}px, ${o-14}px) scale(${1-r*.55})`,n.el.style.opacity=String(r>.8?(1-r)/.2:1)}}var wv=document.getElementById(`hud-tray`),Tv=document.getElementById(`tray-slots`),Ev=document.getElementById(`tray-head`),Dv=new Map,Ov=null;if(Tv)for(let e of Object.values(tf)){let t=document.createElement(`button`);t.className=`tray-slot`,t.dataset.product=e.id,t.title=e.name,t.innerHTML=`<span class="slot-ico">${e.icon}</span><span class="slot-n">0</span>`,t.addEventListener(`click`,()=>{Q.ensure(),Av(Ov===e.id?null:e.id)}),Tv.appendChild(t),Dv.set(e.id,t)}Ev&&wv&&Ev.addEventListener(`click`,()=>{wv.classList.toggle(`collapsed`),Av(null)});function kv(){for(let[e,t]of Dv){let n=dg.count(e);t.querySelector(`.slot-n`).textContent=String(n),t.classList.toggle(`empty`,n===0)}}kv();function Av(e){let t=e&&dg.count(e)>0?e:null;if(t!==Ov){Ov=t;for(let[e,t]of Dv)t.classList.toggle(`armed`,e===Ov)}}typeof document<`u`&&document.addEventListener(`pointerdown`,e=>{if(!Ov)return;let t=e.target;t!==Gh.domElement&&(t&&t.closest&&t.closest(`.tray-slot`)||Av(null))},!0);var jv={berry:e=>yg(e)};for(let e of Object.values(Gd))jv[e.dish]=t=>xg(t,e.dish);jv[Hd]=e=>xg(e,Hd);var Mv=new H;function Nv(e){let t=Ov;if(t){if(e&&F_(e.clientX,e.clientY),t===`seed`){let e=K_();if(e<0){Av(null);return}Rv(e),Av(dg.count(t)>0?t:null);return}if(!jv[t]){Av(null);return}if($g.setFromCamera(e_,Yg),$g.ray.intersectSphere(new yr(X.center,ru),Mv)){if(dg.remove(t,1)!==1){Av(null);return}jv[t](Mv.clone().sub(X.center)),kv(),Q.ensure(),Q.squish(.25),Av(dg.count(t)>0?t:null)}}}function Pv(e,t,n){let r=n?fg.collected(dg,1):0;kv(),Q.ensure(),Q.pop(),bv(e,t,{target:Dv.get(`berry`)||wv,glyph:tf.berry.icon,cls:`berry-fly`}),r>0&&(Q.ding(),bv(e,t,{target:Dv.get(`seed`)||wv,glyph:tf.seed.icon,cls:`seed-fly`}))}function Fv(e,t,n){let r=fg.slot(e);if(!r||!hf(r.building)||r.trough>=6||dg.count(`berry`)<=0||!_f(r))return!1;dg.remove(`berry`,1),kv(),Q.ensure(),Q.pop();let i=Dg[e],a=i?Oy(i.trough.pos):{x:t,y:n};return xv(Dv.get(`berry`)||wv,a.x,a.y,{glyph:tf.berry.icon,cls:`berry-fly`}),!0}function Iv(e,t,n){let r=Z.map(e=>e.brain);if(e&&e.onBush){if(!Om(e,dg,r))return}else{if(!Rd(gg,e,dg,r))return;vg(e)}Pv(t,n,!!(e&&e.onBush))}var Lv=document.getElementById(`slot-menu`);function Rv(e,t=`plot`){return fg.plant(e,dg,t,lg)?(Fg(e),hv(),kv(),Q.ensure(),Q.squish(.35),!0):!1}function zv(e){return fg.demolish(e)?(Fg(e),Q.ensure(),Q.pop(),!0):!1}function Bv(){Lv&&(Lv.hidden=!0)}function Vv(e,t){let n=document.createElement(`button`);return n.className=`ui-row`+(t?` `+t:``),n.innerHTML=e,n}function Hv(e){let t=fg.slot(e);if(!Lv||!t)return;Lv.innerHTML=``;let n=document.createElement(`div`);n.className=`ui-card`;let r=document.createElement(`div`);if(r.className=`ui-title`,n.appendChild(r),t.building){let i=lf[t.building];r.textContent=`${i.icon} ${i.name}`;let a=Vv(`<span class="ui-ico">🗑</span><span>Снести</span>`);a.addEventListener(`click`,()=>{zv(e),Bv()}),n.appendChild(a)}else{r.textContent=`Что построить?`;let t=dg.count(`seed`);for(let r of Object.values(lf)){if(!r.ready){let e=Vv(`<span class="ui-ico">${r.icon}</span><span>${r.name}</span><span class="ui-note">🔒 скоро</span>`,`disabled`);n.appendChild(e);continue}let i=df(r.id),a=lg.canAfford(i)&&(!r.seed||t>0),o=`<span class="ui-price">${i} 🪙</span>`,s=Vv(`<span class="ui-ico">${r.icon}</span><span>${r.name}</span><span class="ui-note">${o}${r.seed?` · 🌰 ${t}`:``}</span>`,a?``:`disabled`);a&&s.addEventListener(`click`,()=>{Rv(e,r.id),Bv()}),n.appendChild(s)}}n.addEventListener(`pointerdown`,e=>e.stopPropagation()),Lv.appendChild(n),Lv.hidden=!1}Lv&&Lv.addEventListener(`pointerdown`,()=>Bv());var Uv=document.getElementById(`shop-panel`),Wv=document.getElementById(`btn-shop`);function Gv(){Uv&&(Uv.hidden=!0)}function Kv(e){let t={[ug]:sg};pm(t,lg,e===null?null:{[ug]:e}).coins<=0||(sg=t[ug]||0,mv(),hv(),gv(fv),Q.ensure(),Q.ding(),qv(),mg())}function qv(){if(!Uv)return;Uv.innerHTML=``;let e=document.createElement(`div`);e.className=`ui-card`;let t=document.createElement(`div`);t.className=`ui-title`,t.textContent=`🛒 Магазин`,e.appendChild(t);let n=document.createElement(`div`);n.className=`ui-sub`,n.textContent=`Продать`,e.appendChild(n);let r=tm(ug),i=document.createElement(`div`);i.className=`ui-row shop-item`,i.innerHTML=`<span class="shop-line"><span class="ui-ico">💠</span><span>Кристаллы</span><span class="ui-note">× ${sg}</span></span><span class="shop-rate"><span class="ui-price">${r} 🪙</span> за штуку</span>`,e.appendChild(i);let a=sg>0,o=document.createElement(`div`);o.className=`ui-btns`;let s=document.createElement(`button`);s.className=`ui-btn`+(a?``:` disabled`),s.textContent=`Продать 1`;let c=document.createElement(`button`);c.className=`ui-btn ui-btn-primary`+(a?``:` disabled`),c.textContent=`Продать всё`,a&&(s.addEventListener(`click`,()=>Kv(1)),c.addEventListener(`click`,()=>Kv(null))),o.appendChild(s),o.appendChild(c),e.appendChild(o);let l=document.createElement(`div`);l.className=`ui-sub`,l.textContent=`Специи`,e.appendChild(l);for(let t of hm()){let n=Vd(t.id),r=lg.canAfford(n),i=Vv(`<span class="ui-ico">${t.icon}</span><span>${t.name}</span><span class="ui-note"><span class="ui-price">${n} 🪙</span> · ${dg.count(t.id)}</span>`,r?``:`disabled`);r&&i.addEventListener(`click`,()=>{mm(lg,dg,t.id)&&(hv(),kv(),gv(fv),Q.ensure(),Q.ding(),qv(),mg())}),e.appendChild(i)}let u=document.createElement(`div`);u.className=`ui-hint`,u.textContent=`постройки покупаются на пятачках базы`,e.appendChild(u),e.addEventListener(`pointerdown`,e=>e.stopPropagation()),Uv.appendChild(e),Uv.hidden=!1}Uv&&Uv.addEventListener(`pointerdown`,()=>Gv()),Wv&&Wv.addEventListener(`click`,()=>{Q.ensure(),Uv&&!Uv.hidden?Gv():qv()});var Jv=document.getElementById(`kitchen-panel`),Yv=document.getElementById(`btn-kitchen`);function Xv(){Jv&&(Jv.hidden=!0)}function Zv(e){let t=[];for(let[n,r]of Object.entries(e.ingredients)){let e=dg.count(n),i=tf[n]&&tf[n].icon||`•`;t.push(`${i} ${e}/${r}`)}return t.join(` · `)}function Qv(){if(!Jv)return;Jv.innerHTML=``;let e=document.createElement(`div`);e.className=`ui-card`;let t=document.createElement(`div`);t.className=`ui-title`,t.textContent=`🍳 Кухня`,e.appendChild(t);let n=document.createElement(`div`);n.className=`ui-sub`,n.textContent=`Рецепты`,e.appendChild(n);for(let t of Object.values(Gd)){let n=Jd(dg,t),r=Vv(`<span class="ui-ico">${t.icon}</span><span class="kitchen-line"><span>${t.name}</span><span class="kitchen-need">${Zv(t)}</span></span><span class="ui-note">💠 ×${t.boostMul} · ${t.boostDur} c</span>`,n?``:`disabled`);n&&r.addEventListener(`click`,()=>{Xv(),oy(t)}),e.appendChild(r)}let r=document.createElement(`div`);r.className=`ui-hint`,r.textContent=`блюдо ускоряет кристаллы · специи покупаются в 🛒`,e.appendChild(r),e.addEventListener(`pointerdown`,e=>e.stopPropagation()),Jv.appendChild(e),Jv.hidden=!1}Jv&&Jv.addEventListener(`pointerdown`,()=>Xv()),Yv&&Yv.addEventListener(`click`,()=>{Q.ensure(),Jv&&!Jv.hidden?Xv():Qv()});var $v=document.getElementById(`cut-game`),ey=document.getElementById(`cut-canvas`),ty=ey?ey.getContext(`2d`):null,ny=34,ry=.55,iy=380,$={on:!1,rec:null,queue:[],items:[],bits:[],burn:0,spawn:0,px:0,py:0,had:!1};function ay(){let{w:e,h:t}=Wh();return{w:e,h:t}}function oy(e){let t=Yd(dg,e);if(t){kv(),$.rec=t,$.queue=[];for(let[e,n]of Object.entries(t.ingredients))for(let t=0;t<n;t++)$.queue.push(tf[e]&&tf[e].icon||`🫐`);$.items.length=0,$.bits.length=0,$.burn=0,$.spawn=.6,$.had=!1,$.on=!0,$v&&($v.hidden=!1),Q.ensure(),Q.pop()}}function sy(e){let t=$.rec;$.on=!1,$.rec=null,$v&&($v.hidden=!0);let n=Xd(t,e),r=n.dish||n.ember;dg.add(r,1),kv(),gv(Dv.get(r)||wv),Q.ensure(),e?Q.ding():Q.pop(),mg()}function cy(){let e=$.queue.shift();if(!e)return;let{w:t,h:n}=ay(),r=n*ry,i=8*r/(Cu*Cu),a=-(4*r)/Cu,o=Math.random()<.5?-1:1;$.items.push({glyph:e,x:t*(.3+Math.random()*.4),y:n+ny,vx:o*(t*(.06+Math.random()*.1))/Cu,vy:a,g:i,spin:(Math.random()-.5)*4,rot:0,cut:!1})}function ly(e,t,n){if(!$.on)return;if(!$.had){$.px=e,$.py=t,$.had=!0;return}let r=e-$.px,i=t-$.py,a=Math.hypot(r,i),o=a/Math.max(.001,n);if($.px=e,$.py=t,!(o<iy||a<.001))for(let n of $.items){if(n.cut)continue;let o=Math.max(0,Math.min(1,((n.x-(e-r))*r+(n.y-(t-i))*i)/(a*a))),s=e-r+r*o,c=t-i+i*o;if(!(Math.hypot(n.x-s,n.y-c)>ny)){n.cut=!0;for(let e of[-1,1])$.bits.push({glyph:n.glyph,x:n.x,y:n.y,vx:n.vx+e*160,vy:n.vy-60,g:n.g,life:.5,rot:e*2});Q.ensure(),Q.pop()}}}function uy(e){if(!$.on)return;let{w:t,h:n}=ay();ey&&(ey.width!==t||ey.height!==n)&&(ey.width=t,ey.height=n),$.queue.length&&($.spawn-=e,$.spawn<=0&&(cy(),$.spawn=3));for(let t=$.items.length-1;t>=0;t--){let r=$.items[t];if(r.vy+=r.g*e,r.x+=r.vx*e,r.y+=r.vy*e,r.rot+=r.spin*e,r.cut){$.items.splice(t,1);continue}if(r.y>n+ny*2&&($.items.splice(t,1),$.burn=Math.min(1,$.burn+wu),Q.ensure(),Q.squish(.3),$.burn>=1)){sy(!1);return}}for(let t=$.bits.length-1;t>=0;t--){let n=$.bits[t];n.vy+=n.g*e,n.x+=n.vx*e,n.y+=n.vy*e,n.life-=e,n.life<=0&&$.bits.splice(t,1)}if(!$.queue.length&&!$.items.length){sy($.burn<1);return}dy(t,n)}function dy(e,t){let n=ty;if(!n)return;n.clearRect(0,0,e,t),n.textAlign=`center`,n.textBaseline=`middle`;for(let e of $.bits)n.save(),n.globalAlpha=Math.max(0,e.life*2),n.translate(e.x,e.y),n.rotate(e.rot*e.life),n.font=`${ny}px serif`,n.fillText(e.glyph,0,0),n.restore();for(let e of $.items)n.save(),n.translate(e.x,e.y),n.rotate(e.rot),n.font=`${ny*1.8}px serif`,n.fillText(e.glyph,0,0),n.restore();let r=Math.min(240,e-80);n.fillStyle=`rgba(255,255,255,0.18)`,n.fillRect((e-r)/2,26,r,10),n.fillStyle=`#ff8a5c`,n.fillRect((e-r)/2,26,r*$.burn,10)}if($v){let e=performance.now();$v.addEventListener(`pointerdown`,t=>{e=performance.now(),$.had=!1,ly(t.clientX,t.clientY,.016),t.preventDefault()}),$v.addEventListener(`pointermove`,t=>{let n=performance.now(),r=Math.min(.05,(n-e)/1e3);e=n,ly(t.clientX,t.clientY,r)}),$v.addEventListener(`pointerup`,()=>{$.had=!1}),$v.addEventListener(`pointercancel`,()=>{$.had=!1})}var fy=document.getElementById(`btn-sleep`),py=document.getElementById(`btn-dance`),my=10,hy=0,gy=0,_y=5,vy=null;function yy(){return Z.some(e=>e.brain.forcedSleep)}function by(){if(!fy)return;let e=yy();e!==vy&&(vy=e,fy.textContent=e?`☀️`:`😴`,fy.title=e?`Подъём`:`Сон`)}by(),fy&&sv&&(fy.hidden=!1),fy&&fy.addEventListener(`click`,()=>{Q.ensure();let e=yy();for(let t of Z)e?t.brain.forceWake():t.brain.forceSleep();Q.pop(),by()}),py&&py.addEventListener(`click`,()=>{Q.ensure();for(let e of Z)e.brain.forceWake(),e.brain.startDance(hy,my);Q.pop(),by()});var xy=document.getElementById(`btn-vacuum`),Sy=!1,Cy=!1,wy=new H,Ty=[],Ey=new H;function Dy(e){Sy=!!e,Sy?Av(null):Cy=!1,xy&&xy.classList.toggle(`active`,Sy)}xy&&xy.addEventListener(`click`,()=>{Q.ensure(),Dy(!Sy),Q.pop()});function Oy(e){Ey.copy(e).project(Yg);let{w:t,h:n}=Wh();return{x:(Ey.x*.5+.5)*t,y:(-Ey.y*.5+.5)*n}}var ky=20,Ay=.5,jy=7,My=.035,Ny=[];{let e=cb();for(let t=0;t<ky;t++){let t=new qr(new Nr({map:e,color:13625599,transparent:!0,depthWrite:!1,opacity:0}));t.visible=!1,Y.add(t),Ny.push({spr:t,ang:0,rad:0,up:0,life:0,active:!1})}}var Py=0,Fy=0;function Iy(){let e=-1;for(let t=0;t<Ny.length;t++)if(!Ny[t].active){e=t;break}e<0&&(e=Fy,Fy=(Fy+1)%Ny.length);let t=Ny[e];t.ang=Math.random()*Math.PI*2,t.rad=mu*(.75+Math.random()*.3),t.up=.3+Math.random()*1.2,t.life=0,t.active=!0,t.spr.visible=!0,t.spr.scale.setScalar(.22+Math.random()*.16)}function Ly(e,t){t&&(Py-=e,Py<=0&&(Iy(),Py=My));let n=!1;for(let e of Ny)if(e.active){n=!0;break}if(n){Ib(wy);for(let t of Ny){if(!t.active)continue;t.life+=e,t.rad-=6*e,t.ang+=jy*e,t.up*=Math.max(0,1-3*e);let n=t.life/Ay;if(n>=1||t.rad<=.15){t.active=!1,t.spr.visible=!1;continue}t.spr.position.copy(wy).addScaledVector(Pb,Math.cos(t.ang)*t.rad).addScaledVector(Fb,Math.sin(t.ang)*t.rad).addScaledVector(Nb,t.up+.2),t.spr.material.opacity=.75*(1-n)}}}function Ry(e){let t=Sy&&Cy;if(t){J_(ru,wy),Ty.length=0;for(let e of gg)e.dish||Ty.push(e);for(let e of Ag)Ty.push(e);for(let e of og)Ty.push(e);if(Og.length)for(let e=Ty.length-1;e>=0;e--)Sf(Ty[e].pos,wy,Og)||Ty.splice(e,1);let t=cf(e,wy,Ty);for(let e of t){let t=Oy(e.pos);e.onBush||gg.indexOf(e)>=0?Iv(e,t.x,t.y):yv(e,t.x,t.y)}}Ly(e,t)}function zy(){nv&&(nv.textContent=`${hg.blob.traits.emoji} ${hg.blob.traits.name}`)}zy(),tv&&tv.addEventListener(`click`,()=>{q_(Z[(Z.indexOf(hg)+1)%Z.length]),Uy(hg.blob.com,.7),Q.ensure(),Q.pop()});function By(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`);t.translate(64/2,64/2),t.fillStyle=`#fff2a0`,t.beginPath();for(let e=0;e<8;e++){let n=e/8*Math.PI*2,r=e%2==0?64*.46:64*.17;t[e===0?`moveTo`:`lineTo`](Math.cos(n)*r,Math.sin(n)*r)}t.closePath(),t.fill();let n=new Pi(e);return n.colorSpace=Be,n}var Vy=By(),Hy=[];function Uy(e,t){let n=5+Math.round(t*3),r=i_.copy(e).sub(X.center).normalize().clone(),i=new H(-r.z,0,r.x);i.lengthSq()<1e-4&&i.set(1,0,0),i.normalize();let a=new H().crossVectors(r,i);for(let t=0;t<n;t++){let t=new qr(new Nr({map:Vy,color:16769610,transparent:!0,depthWrite:!1}));t.scale.setScalar(.55+Math.random()*.45),t.position.copy(e).addScaledVector(r,au*.9);let n=Math.random()*Math.PI*2,o=2+Math.random()*2.5,s=r.clone().multiplyScalar(3+Math.random()*2).addScaledVector(i,Math.cos(n)*o).addScaledVector(a,Math.sin(n)*o);Y.add(t),Hy.push({spr:t,vel:s,life:0,ttl:.8+Math.random()*.35})}}function Wy(e){for(let t=Hy.length-1;t>=0;t--){let n=Hy[t];n.life+=e;let r=n.life/n.ttl;if(r>=1){Y.remove(n.spr),n.spr.material.dispose(),Hy.splice(t,1);continue}n.spr.position.addScaledVector(n.vel,e),n.vel.multiplyScalar(.9),n.spr.material.opacity=1-r,n.spr.scale.setScalar(.75*(1-r*.5))}}var Gy=24,Ky=.08,qy=.5,Jy=[];for(let e=0;e<Gy;e++){let e=new qr(new Nr({map:Vy,color:16773296,transparent:!0,depthWrite:!1,opacity:0}));e.visible=!1,Y.add(e),Jy.push({spr:e,life:0,active:!1})}var Yy=0;function Xy(e){let t=-1;for(let e=0;e<Jy.length;e++)if(!Jy[e].active){t=e;break}t<0&&(t=Yy,Yy=(Yy+1)%Jy.length);let n=Jy[t];n.spr.position.copy(e),n.life=0,n.active=!0,n.spr.visible=!0}function Zy(e){for(let t of Jy){if(!t.active)continue;t.life+=e;let n=t.life/qy;if(n>=1){t.active=!1,t.spr.visible=!1;continue}t.spr.material.opacity=.85*(1-n),t.spr.scale.setScalar(.5*(1-n*.55))}}function Qy(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`);t.fillStyle=`#ff5c8a`,t.beginPath(),t.arc(64*.32,64*.34,64*.2,Math.PI,0),t.arc(64*.68,64*.34,64*.2,Math.PI,0),t.lineTo(64*.5,64*.82),t.closePath(),t.fill();let n=new Pi(e);return n.colorSpace=Be,n}var $y=Qy(),eb=[];function tb(e){let t=3+Math.floor(Math.random()*3),n=i_.copy(e).sub(X.center).normalize().clone(),r=new H(-n.z,0,n.x);r.lengthSq()<1e-4&&r.set(1,0,0),r.normalize();let i=new H().crossVectors(n,r);for(let a=0;a<t;a++){let t=new qr(new Nr({map:$y,color:16745896,transparent:!0,depthWrite:!1}));t.scale.setScalar(.5+Math.random()*.3);let a=Math.random()*Math.PI*2,o=.6+Math.random()*.8;t.position.copy(e).addScaledVector(n,au*.7).addScaledVector(r,Math.cos(a)*o).addScaledVector(i,Math.sin(a)*o);let s=n.clone().multiplyScalar(2.2+Math.random()*1.2).addScaledVector(r,Math.cos(a)*.6).addScaledVector(i,Math.sin(a)*.6);Y.add(t),eb.push({spr:t,vel:s,up:n.clone(),life:0,ttl:1.2+Math.random()*.3})}}function nb(e){for(let t=eb.length-1;t>=0;t--){let n=eb[t];n.life+=e;let r=n.life/n.ttl;if(r>=1){Y.remove(n.spr),n.spr.material.dispose(),eb.splice(t,1);continue}n.spr.position.addScaledVector(n.vel,e),n.vel.multiplyScalar(.96),n.spr.material.opacity=(1-r)*.95,n.spr.scale.setScalar(.65*(1+r*.4))}}function rb(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`);t.font=`bold 50px system-ui, -apple-system, sans-serif`,t.textAlign=`center`,t.textBaseline=`middle`,t.lineWidth=6,t.strokeStyle=`#3a4a7a`,t.strokeText(`Z`,64/2,64/2),t.fillStyle=`#eef4ff`,t.fillText(`Z`,64/2,64/2);let n=new Pi(e);return n.colorSpace=Be,n}var ib=rb(),ab=[];function ob(e,t){let n=new H(-t.z,0,t.x);n.lengthSq()<1e-4&&n.set(1,0,0),n.normalize();let r=new qr(new Nr({map:ib,color:14674687,transparent:!0,depthWrite:!1,opacity:.9})),i=.42+Math.random()*.5;r.scale.setScalar(i),r.position.copy(e).addScaledVector(t,.1),Y.add(r),ab.push({spr:r,up:t.clone(),t1:n,size:i,life:0,ttl:2,phase:Math.random()*6.28})}function sb(e){for(let t=ab.length-1;t>=0;t--){let n=ab[t];n.life+=e;let r=n.life/n.ttl;if(r>=1){Y.remove(n.spr),n.spr.material.dispose(),ab.splice(t,1);continue}n.spr.position.addScaledVector(n.up,1.5*e),n.spr.position.addScaledVector(n.t1,Math.cos(n.life*5+n.phase)*.8*e),n.spr.material.opacity=(1-r)*.9,n.spr.scale.setScalar(n.size*(1+r*.9))}}function cb(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);n.addColorStop(0,`rgba(255,250,226,1)`),n.addColorStop(.4,`rgba(255,231,150,0.9)`),n.addColorStop(1,`rgba(255,214,110,0)`),t.fillStyle=n,t.fillRect(0,0,64,64);let r=new Pi(e);return r.colorSpace=Be,r}var lb=44,ub=[];{let e=cb();for(let t=0;t<lb;t++){let t=new qr(new Nr({map:e,color:16773309,transparent:!0,depthWrite:!1,opacity:0}));t.visible=!1,Y.add(t),ub.push(t)}}var db=new K(new Gi(au*.5,au*.72,30),new ri({color:16765286,transparent:!0,opacity:.8,side:2,depthWrite:!1}));db.visible=!1,Y.add(db);var fb=new H(0,0,1),pb=new H,mb=!1;function hb(e){let t=e.points,n=Math.min(lb,t.length);for(let e=0;e<lb;e++){let r=ub[e];if(n<2||e>=n){r.visible=!1;continue}let i=Math.round(e*(t.length-1)/(n-1));r.position.copy(t[i]);let a=e/(n-1);r.material.opacity=.9*(1-a*.7),r.scale.setScalar(.5-a*.16),r.visible=!0}e.landPos?(pb.copy(e.landPos).sub(X.center).normalize(),db.position.copy(X.center).addScaledVector(pb,ru+.08),db.quaternion.setFromUnitVectors(fb,pb),db.visible=!0):db.visible=!1,mb=!0}function gb(){if(mb){for(let e of ub)e.visible=!1;db.visible=!1,mb=!1}}var _b=4,vb=.9,yb=.6,bb=2.2,xb=.55,Sb=.3,Cb=[];{let e=new Gi(.84,1,40);for(let t=0;t<_b;t++){let t=new K(e,new ri({color:16769958,transparent:!0,opacity:0,side:2,depthWrite:!1}));t.visible=!1,Y.add(t),Cb.push({mesh:t,life:0,active:!1,R:au})}}var wb=0,Tb=0,Eb=new H;function Db(e,t){let n=-1;for(let e=0;e<Cb.length;e++)if(!Cb[e].active){n=e;break}n<0&&(n=Tb,Tb=(Tb+1)%Cb.length);let r=Cb[n];Eb.copy(e).sub(X.center).normalize(),r.mesh.position.copy(X.center).addScaledVector(Eb,ru+.06),r.mesh.quaternion.setFromUnitVectors(fb,Eb),r.R=t,r.life=0,r.active=!0,r.mesh.visible=!0}function Ob(e,t){for(let n of Cb){if(!n.active)continue;n.life+=e*(t?1:3);let r=n.life/vb;if(r>=1){n.active=!1,n.mesh.visible=!1;continue}n.mesh.scale.setScalar(n.R*(yb+(bb-yb)*r)),n.mesh.material.opacity=.5*(1-r)}}var kb=30,Ab=.7,jb=[];{let e=cb();for(let t=0;t<kb;t++){let t=new qr(new Nr({map:e,color:12577279,transparent:!0,depthWrite:!1,opacity:0}));t.visible=!1,Y.add(t),jb.push({spr:t,vel:new H,up:new H,life:0,active:!1})}}var Mb=0,Nb=new H,Pb=new H,Fb=new H;function Ib(e){Nb.copy(e).sub(X.center).normalize(),Pb.set(-Nb.z,0,Nb.x),Pb.lengthSq()<1e-4&&Pb.set(1,0,0),Pb.normalize(),Fb.crossVectors(Nb,Pb)}function Lb(e,t){Ib(e);let n=5+Math.round(t*9);for(let e=0;e<n;e++){let e=-1;for(let t=0;t<jb.length;t++)if(!jb[t].active){e=t;break}e<0&&(e=Mb,Mb=(Mb+1)%jb.length);let n=jb[e],r=Math.random()*Math.PI*2,i=(1.6+Math.random()*2.4)*(.6+t);n.spr.position.copy(X.center).addScaledVector(Nb,ru+.2).addScaledVector(Pb,Math.cos(r)*.6).addScaledVector(Fb,Math.sin(r)*.6),n.vel.copy(Nb).multiplyScalar((3.5+Math.random()*3)*(.6+t)).addScaledVector(Pb,Math.cos(r)*i).addScaledVector(Fb,Math.sin(r)*i),n.up.copy(Nb),n.life=0,n.active=!0,n.spr.visible=!0,n.spr.scale.setScalar(.28+Math.random()*.22)}}function Rb(e){for(let t of jb){if(!t.active)continue;t.life+=e;let n=t.life/Ab;if(n>=1){t.active=!1,t.spr.visible=!1;continue}t.spr.position.addScaledVector(t.vel,e),t.vel.addScaledVector(t.up,-24*e),t.spr.material.opacity=.95*(1-n*n)}}var zb=6,Bb=1.2,Vb=.5,Hb=3,Ub=[];{let e=new Gi(.9,1,44);for(let t=0;t<zb;t++){let t=new K(e,new ri({color:14677247,transparent:!0,opacity:0,side:2,depthWrite:!1}));t.visible=!1,Y.add(t),Ub.push({mesh:t,life:0,active:!1})}}var Wb=0;function Gb(e){let t=-1;for(let e=0;e<Ub.length;e++)if(!Ub[e].active){t=e;break}t<0&&(t=Wb,Wb=(Wb+1)%Ub.length);let n=Ub[t];Eb.copy(e).sub(X.center).normalize(),n.mesh.position.copy(X.center).addScaledVector(Eb,ru+.12),n.mesh.quaternion.setFromUnitVectors(fb,Eb),n.life=0,n.active=!0,n.mesh.visible=!0}function Kb(e){for(let t of Ub){if(!t.active)continue;t.life+=e;let n=t.life/Bb;if(n>=1){t.active=!1,t.mesh.visible=!1;continue}t.mesh.scale.setScalar(au*(Vb+(Hb-Vb)*n)),t.mesh.material.opacity=.45*(1-n)}}var qb=cb(),Jb=[];function Yb(e){let t=6+Math.floor(Math.random()*3);Ib(e);let n=Nb.clone(),r=Pb.clone(),i=Fb.clone();for(let a=0;a<t;a++){let t=new qr(new Nr({map:qb,color:15920344,transparent:!0,depthWrite:!1,opacity:.7})),a=.4+Math.random()*.35;t.scale.setScalar(a);let o=Math.random()*Math.PI*2,s=.9+Math.random()*1.1;t.position.copy(e).addScaledVector(r,Math.cos(o)*.2).addScaledVector(i,Math.sin(o)*.2);let c=r.clone().multiplyScalar(Math.cos(o)*s).addScaledVector(i,Math.sin(o)*s).addScaledVector(n,.5+Math.random()*.5);Y.add(t),Jb.push({spr:t,vel:c,size:a,life:0,ttl:.55+Math.random()*.3})}}function Xb(e){for(let t=Jb.length-1;t>=0;t--){let n=Jb[t];n.life+=e;let r=n.life/n.ttl;if(r>=1){Y.remove(n.spr),n.spr.material.dispose(),Jb.splice(t,1);continue}n.spr.position.addScaledVector(n.vel,e),n.vel.multiplyScalar(.88),n.spr.material.opacity=.7*(1-r),n.spr.scale.setScalar(n.size*(1+r*.8))}}function Zb(){E_=`sling`;let e=__.blob;D_.copy(e.com).sub(X.center).normalize(),j_=null,S_.set(0,0,0),wb=0,e.poke(.55),Q.squish(.5)}function Qb(e){let t=__.blob;if(y_+=(0-y_)*Math.min(1,e*6),J_(v_+y_,k_),kh({center:X.center,anchorDir:D_,fingerPoint:k_,maxArc:ph*t.R},A_),t.body.setGrabTarget(A_,h_),j_=Oh({center:X.center,anchorDir:D_,fingerPoint:k_,R:t.R,throwMax:uh},O_),wb-=e,wb<=0){Db(t.com,t.R);let e=j_?j_.pull:0;wb=xb+(Sb-xb)*e}if(!j_){gb();return}hb(Ah({center:X.center,startPos:t.com,v0:j_.v0,...Ph(t.body),landRadius:ru+mh*t.R},M_))}var $b=1.75*au,ex=6,tx=1,nx=new Map,rx=new H,ix=new H;function ax(e){for(let t=0;t<Z.length;t++)for(let n=t+1;n<Z.length;n++){let r=t*Z.length+n,i=Math.max(0,(nx.get(r)||0)-e),a=Z[t].blob,o=Z[n].blob;rx.copy(a.com).sub(o.com);let s=rx.length()||1e-6,c=-ix.copy(a.body.velocity).sub(o.body.velocity).dot(rx)/s;i<=0&&s<$b&&c>ex?(a.poke(.5),o.poke(.5),Jg.squish(.4),nx.set(r,tx)):nx.set(r,i)}}var ox=performance.now(),sx=new H,cx=new H,lx=new H,ux=new H,dx=0,fx=0;function px(e,t){qg=t===0,hy+=e,pg.advance(e*Pg),Vg();for(let e of Z)e.blob.body.clearForces();for(let t=gg.length-1;t>=0;t--)gg[t].update(e),gg[t].dead&&(vg(gg[t]),gg.splice(t,1));zg(e),Mg.length=0;for(let e of gg)Mg.push(e);for(let e of Ag)Mg.push(e);for(let e of jg)Mg.push(e);for(let t=og.length-1;t>=0;t--)og[t].update(e),og[t].dead&&(og[t].dispose(),og.splice(t,1));let n=og.length>=20;ux.copy(Yg.position).sub(X.center).setLength(ru).add(X.center),N_=Math.max(0,N_-e*2),Ig(),Rg(),dx=0,fx=0;for(let t of Z){let r=t.blob,i=t.brain;if(i.attentionPoint=ux,i.crystalBlocked=n,i.update(e,Mg),i.chompEvent&&(Jg.nom(),tb(i.chompEvent.pos)),i.danceHeartEvent&&tb(i.danceHeartEvent.pos),i.crystalEvent){let e=i.crystalEvent;og.push(new sm(Y,X,e)),Yb(e.pos),Jg.pum()}if(N_>.4){let e=r_.copy(r.com).sub(X.center).normalize(),t=i_.set(-e.z,0,e.x);t.lengthSq()<1e-4&&t.set(1,0,0),t.normalize();let n=a_.crossVectors(e,t),i=Math.random()*Math.PI*2;sx.copy(t).multiplyScalar(Math.cos(i)).addScaledVector(n,Math.sin(i)),r.body.addWind(sx.multiplyScalar(N_*13))}r.body.update(e,t.view),r.update(e,Yg),t.flight&&(Ih(r.body,t.flight,e,X.center,ru+.9*r.R)?(r.flying=!0,t.trailTimer-=e,t.trailTimer<=0&&(Xy(r.com),t.trailTimer=Ky)):(t.flight=null,r.flying=!1));let a=t.water.update(e,r.com,r.body.velocity);if(a>0&&(Lb(r.com,a),Jg.splash(a)),i.shakeEvent&&(Lb(i.shakeEvent.pos,.35),Jg.splash(.3)),t.water.inWater){let n=r.body.velocity.length();n>.6?(t.ringTimer-=e,t.ringTimer<=0&&(Gb(r.com),t.ringTimer=.6-.35*Math.min(1,n/6))):t.ringTimer=0}r.landImpact>0&&(i.phase===`air`?Jg.splat(r.landImpact*.35):(Jg.splat(r.landImpact),Uy(r.com,r.landImpact)),r.landImpact=0),r.sleep>.5?(t.zTimer-=e,t.zTimer<=0&&(ob(r.crownWorld(cx),r.up),t.zTimer=1.2)):t.zTimer=.6,i.boost&&i.boost.t>0?(t.boostTimer=(t.boostTimer||0)-e,t.boostTimer<=0&&(Uy(r.com,.15),t.boostTimer=1.4)):t.boostTimer=0,i.satiety>.8&&i.sleepState===`awake`&&(dx=.4),i.sleepState===`sleeping`&&(fx=1)}if(nu&&ag.length){for(let e of ag){let t=1/0;for(let n of Z)t=Math.min(t,e.blob.com.distanceToSquared(n.blob.com));e._d2=t}let t=ag.filter(e=>e._d2<rg*rg).sort((e,t)=>e._d2-t._d2).slice(0,ng),n=ig*ig;for(let e of Z)e.baseOthers=Z.filter(t=>t!==e).map(e=>({com:e.blob.body.com,radius:e.blob.R*Qh})).concat(t.filter(t=>t.blob.com.distanceToSquared(e.blob.com)<n).map(e=>({com:e.blob.body.com,radius:e.blob.R*Qh})));for(let r of t){let i=[...Z,...t.filter(e=>e!==r)].filter(e=>e.blob.com.distanceToSquared(r.blob.com)<n).map(e=>({com:e.blob.body.com,radius:e.blob.R*Qh}));r.view.others=i,r.blob.body.clearForces(),r.brain.update(e,Mg),r.blob.body.update(e,r.view),r.blob.update(e,Yg);let a=r.water.update(e,r.blob.com,r.blob.body.velocity);a>0&&(Lb(r.blob.com,a),Jg.splash(a)),r.blob.landImpact>0&&(Jg.splat(r.blob.landImpact*.35),r.blob.landImpact=0)}}Ry(e),ax(e),Ob(e,o_===`grab`&&E_===`sling`),Rb(e),Kb(e),Zy(e),Wy(e),nb(e),Xb(e),Cv(e),sb(e)}function mx(){requestAnimationFrame(mx);let e=performance.now(),t=Math.min((e-ox)/1e3,.05);if(ox=e,gy+=t,gy>=_y&&(gy=0,mg()),o_===`grab`&&__){let e=(performance.now()-C_)/1e3;if(E_===`undecided`&&(p_>T_?E_=`carry`:e>=w_&&Zb()),E_===`sling`)Qb(t);else{e>.12&&(y_+=(m_-y_)*Math.min(1,t*4));let n=J_(v_+y_,n_);b_.lerp(n,1-Math.exp(-t*10)),t>0&&(i_.copy(b_).sub(x_).multiplyScalar(1/t),S_.lerp(i_,.5)),x_.copy(b_),__.blob.body.setGrabTarget(b_,h_)}}else gb();let n=performance.now();for(let e=0;e<iv&&(px(t,e),!(performance.now()-n>24));e++);l_=Math.max(0,l_-t*.8);let r=o_===`grab`&&E_!==`sling`,i=r&&S_.length()<.7?.75:0,a=r?Math.max(l_,i):0;Q.setPurr(Math.max(a,dx)),Q.setSnore(fx),Kg(),uy(t),by(),$_&&($_.style.width=(hg.brain.satiety*100).toFixed(1)+`%`),ev&&(ev.style.width=(hg.brain.energy*100).toFixed(1)+`%`);let o=B.clamp((Xg.maxDist-Xg.dist)/(Xg.maxDist-Xg.minDist),0,1),s=o*o*o*o;lx.copy(X.center).lerp(hg.blob.com,s),Xg.target.lerp(lx,1-Math.exp(-t*5)),Xg.update(t),Gh.render(Y,Yg)}Qg(!0),mx();function hx(){let{w:e,h:t}=Wh(),n=!Number.isFinite(Xg.dist)||!Number.isFinite(Yg.position.x);!n&&Gh.domElement.width===Math.floor(e*Gh.getPixelRatio())&&Gh.domElement.height===Math.floor(t*Gh.getPixelRatio())||(n&&(Xg.dist=Xg.maxDist=ru*2.6),Yg.aspect=e/t,Yg.updateProjectionMatrix(),Gh.setSize(e,t),Gh.setPixelRatio(Math.min(window.devicePixelRatio,2)),Qg(n||!X_),Xg.update(0),Gh.render(Y,Yg))}window.addEventListener(`resize`,hx),new ResizeObserver(hx).observe(document.body);