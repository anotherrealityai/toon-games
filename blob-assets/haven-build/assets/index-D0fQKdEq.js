...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qs(e,t,n){let r=new Float32Array(Rs),i=new V(0,1,0);return new po({name:`SphericalGaussianBlur`,defines:{n:Rs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:tc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $s(){return new po({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:tc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ec(){return new po({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:tc(),fragmentShader:`
...
}`,ju=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new Mi(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new po({vertexShader:ku,fragmentShader:Au,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Xr(new Za(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Mu=class extends nt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,u=null,d=null,f=null,p=null,h=null,g=typeof XRWebGLBinding<`u`,_=new ju,v={},b=t.getContextAttributes(),x=null,S=null,C=[],D=[],ee=new B,te=null,O=new Zo;O.viewport=new Kt;let ne=new Zo;ne.viewport=new Kt;let k=[O,ne],A=new os,re=null,ie=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new On,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new On,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new On,C[e]=t),t.getHandSpace()};function j(e){let t=D.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ae(){r.removeEventListener(`select`,j),r.removeEventListener(`selectstart`,j),r.removeEventListener(`selectend`,j),r.removeEventListener(`squeeze`,j),r.removeEventListener(`squeezestart`,j),r.removeEventListener(`squeezeend`,j),r.removeEventListener(`end`,ae),r.removeEventListener(`inputsourceschange`,oe);for(let e=0;e<C.length;e++){let t=D[e];t!==null&&(D[e]=null,C[e].disconnect(t))}re=null,ie=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(x),p=null,f=null,d=null,r=null,S=null,pe.stop(),n.isPresenting=!1,e.setPixelRatio(te),e.setSize(ee.width,ee.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&L(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&L(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return h},this.getSession=function(){return r},this.setSession=async function(u){if(r=u,r!==null){if(x=e.getRenderTarget(),r.addEventListener(`select`,j),r.addEventListener(`selectstart`,j),r.addEventListener(`selectend`,j),r.addEventListener(`squeeze`,j),r.addEventListener(`squeezestart`,j),r.addEventListener(`squeezeend`,j),r.addEventListener(`end`,ae),r.addEventListener(`inputsourceschange`,oe),b.xrCompatible!==!0&&await t.makeXRCompatible(),te=e.getPixelRatio(),e.getSize(ee),g&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;b.depth&&(o=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=b.stencil?E:T,a=b.stencil?y:m);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};d=this.getBinding(),f=d.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new Jt(f.textureWidth,f.textureHeight,{format:w,type:l,depthTexture:new Ai(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new Jt(p.framebufferWidth,p.framebufferHeight,{format:w,type:l,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),pe.setContext(r),pe.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function oe(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=D.indexOf(n);r>=0&&(D[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=D.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=D.length){D.push(n),r=e;break}else if(D[e]===null){D[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let se=new V,ce=new V;function le(e,t,n){se.setFromMatrixPosition(t.matrixWorld),ce.setFromMatrixPosition(n.matrixWorld);let r=se.distanceTo(ce),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function ue(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),A.near=ne.near=O.near=t,A.far=ne.far=O.far=n,(re!==A.near||ie!==A.far)&&(r.updateRenderState({depthNear:A.near,depthFar:A.far}),re=A.near,ie=A.far),A.layers.mask=e.layers.mask|6,O.layers.mask=A.layers.mask&-5,ne.layers.mask=A.layers.mask&-3;let i=e.parent,a=A.cameras;ue(A,i);for(let e=0;e<a.length;e++)ue(a[e],i);a.length===2?le(A,O,ne):A.projectionMatrix.copy(O.projectionMatrix),de(e,A,i)};function de(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=ot*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return A},this.getFoveation=function(){if(!(f===null&&p===null))return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(A)},this.getCameraTexture=function(e){return v[e]};let M=null;function fe(t,i){if(u=i.getViewerPose(c||a),h=i,u!==null){let t=u.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==A.cameras.length&&(A.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=d.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=k[n];o===void 0&&(o=new Zo,o.layers.enable(n),o.viewport=new Kt,k[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(A.matrix.copy(o.matrix),A.matrix.decompose(A.position,A.quaternion,A.scale)),i===!0&&A.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&g){d=n.getBinding();let e=d.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&g){e.state.unbindTexture(),d=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new Mi,v[n]=e);let t=d.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=D[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}M&&M(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),h=null}let pe=new Ts;pe.setAnimationLoop(fe),this.setAnimationLoop=function(e){M=e},this.dispose=function(){}}},Nu=new Zt,Pu=new H;Pu.set(-1,0,0,0,1,0,0,0,1);function Fu(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,co(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(Nu.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(Pu),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function Iu(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(g(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,v));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return R(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let e=0,t=r.length;e<t;e++){let t=r[e];if(Array.isArray(t))for(let n=0,r=t.length;n<r;n++)p(t[n],e,n,a);else p(t,e,0,a)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(t,n,r,i){if(h(t,n,r,i)===!0){let n=t.__offset,r=t.value;if(Array.isArray(r)){let e=0;for(let n=0;n<r.length;n++){let i=r[n],a=_(i);m(i,t.__data,e),typeof i!=`number`&&typeof i!=`boolean`&&!i.isMatrix3&&!ArrayBuffer.isView(i)&&(e+=a.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(r,t.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,n,t.__data)}}function m(e,t,n){typeof e==`number`||typeof e==`boolean`?t[0]=e:e.isMatrix3?(t[0]=e.elements[0],t[1]=e.elements[1],t[2]=e.elements[2],t[3]=0,t[4]=e.elements[3],t[5]=e.elements[4],t[6]=e.elements[5],t[7]=0,t[8]=e.elements[6],t[9]=e.elements[7],t[10]=e.elements[8],t[11]=0):ArrayBuffer.isView(e)?t.set(new e.constructor(e.buffer,e.byteOffset,t.length)):e.toArray(t,n)}function h(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:ArrayBuffer.isView(i)?r[a]=i.slice():r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function g(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=_(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function _(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?L(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):L(`WebGLRenderer: Unsupported uniform value type.`,e),t}function v(t){let n=t.target;n.removeEventListener(`dispose`,v);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function y(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:y}}var Lu=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Ru=null;function zu(){return Ru===null&&(Ru=new $r(Lu,16,16,te,g),Ru.name=`DFG_LUT`,Ru.minFilter=o,Ru.magFilter=o,Ru.wrapS=t,Ru.wrapT=t,Ru.generateMipmaps=!1,Ru.needsUpdate=!0),Ru}var Bu=class{constructor(e={}){let{canvas:t=Ye(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:u=!1,powerPreference:d=`default`,failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:b=l}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);x=n.getContextAttributes().alpha}else x=a;let S=b,C=new Set([ne,O,ee]),w=new Set([l,m,f,y,_,v]),T=new Uint32Array(4),E=new Int32Array(4),D=new V,te=null,k=null,A=[],re=[],ie=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let j=this,ae=!1,oe=null,se=null,ce=null,le=null;this._outputColorSpace=Be;let ue=0,de=0,M=null,fe=-1,pe=null,me=new Kt,he=new Kt,ge=null,_e=new W(0),ve=0,ye=t.width,be=t.height,xe=1,Se=null,Ce=null,we=new Kt(0,0,ye,be),Te=new Kt(0,0,ye,be),Ee=!1,De=new gi,Oe=!1,ke=!1,Ae=new Zt,je=new V,Me=new Kt,Ne={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Pe=!1;function Fe(){return M===null?xe:1}let N=n;function Ie(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:p};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r185`),t.addEventListener(`webglcontextlost`,lt,!1),t.addEventListener(`webglcontextrestored`,ut,!1),t.addEventListener(`webglcontextcreationerror`,dt,!1),N===null){let t=`webgl2`;if(N=Ie(t,e),N===null)throw Ie(t)?Error(`THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.`):Error(`THREE.WebGLRenderer: Error creating WebGL context.`)}}catch(e){throw R(`WebGLRenderer: `+e.message),e}let Le,Re,P,ze,F,I,Ve,He,Ue,We,Ke,qe,Je,Xe,Qe,$e,tt,nt,rt,it,at,ot,st;function z(){Le=new ic(N),Le.init(),at=new Ou(N,Le),Re=new Ps(N,Le,e,at),P=new Eu(N,Le),Re.reversedDepthBuffer&&h&&P.buffers.depth.setReversed(!0),se=N.createFramebuffer(),ce=N.createFramebuffer(),le=N.createFramebuffer(),ze=new sc(N),F=new ou,I=new Du(N,Le,P,F,Re,at,ze),Ve=new rc(j),He=new Es(N),ot=new Ms(N,He),Ue=new ac(N,He,ze,ot),We=new lc(N,Ue,He,ot,ze),nt=new cc(N,Re,I),Qe=new Fs(F),Ke=new au(j,Ve,Le,Re,ot,Qe),qe=new Fu(j,F),Je=new uu,Xe=new _u(Le),tt=new js(j,Ve,P,We,x,s),$e=new Tu(j,We,Re),st=new Iu(N,ze,Re,P),rt=new Ns(N,Le,ze),it=new oc(N,Le,ze),ze.programs=Ke.programs,j.capabilities=Re,j.extensions=Le,j.properties=F,j.renderLists=Je,j.shadowMap=$e,j.state=P,j.info=ze}z(),S!==1009&&(ie=new dc(S,t.width,t.height,o,r,i));let ct=new Mu(j,N);this.xr=ct,this.getContext=function(){return N},this.getContextAttributes=function(){return N.getContextAttributes()},this.forceContextLoss=function(){let e=Le.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=Le.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return xe},this.setPixelRatio=function(e){e!==void 0&&(xe=e,this.setSize(ye,be,!1))},this.getSize=function(e){return e.set(ye,be)},this.setSize=function(e,n,r=!0){if(ct.isPresenting){L(`WebGLRenderer: Can't change size while VR device is presenting.`);return}ye=e,be=n,t.width=Math.floor(e*xe),t.height=Math.floor(n*xe),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),ie!==null&&ie.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(ye*xe,be*xe).floor()},this.setDrawingBufferSize=function(e,n,r){ye=e,be=n,xe=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){R(`WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){L(`WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}ie.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(me)},this.getViewport=function(e){return e.copy(we)},this.setViewport=function(e,t,n,r){e.isVector4?we.set(e.x,e.y,e.z,e.w):we.set(e,t,n,r),P.viewport(me.copy(we).multiplyScalar(xe).round())},this.getScissor=function(e){return e.copy(Te)},this.setScissor=function(e,t,n,r){e.isVector4?Te.set(e.x,e.y,e.z,e.w):Te.set(e,t,n,r),P.scissor(he.copy(Te).multiplyScalar(xe).round())},this.getScissorTest=function(){return Ee},this.setScissorTest=function(e){P.setScissorTest(Ee=e)},this.setOpaqueSort=function(e){Se=e},this.setTransparentSort=function(e){Ce=e},this.getClearColor=function(e){return e.copy(tt.getClearColor())},this.setClearColor=function(){tt.setClearColor(...arguments)},this.getClearAlpha=function(){return tt.getClearAlpha()},this.setClearAlpha=function(){tt.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(M!==null){let t=M.texture.format;e=C.has(t)}if(e){let e=M.texture.type,t=w.has(e),n=tt.getClearColor(),r=tt.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,N.clearBufferuiv(N.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,N.clearBufferiv(N.COLOR,0,E))}else r|=N.COLOR_BUFFER_BIT}t&&(r|=N.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=N.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&N.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),oe=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,lt,!1),t.removeEventListener(`webglcontextrestored`,ut,!1),t.removeEventListener(`webglcontextcreationerror`,dt,!1),tt.dispose(),Je.dispose(),Xe.dispose(),F.dispose(),Ve.dispose(),We.dispose(),ot.dispose(),st.dispose(),Ke.dispose(),ct.dispose(),ct.removeEventListener(`sessionstart`,vt),ct.removeEventListener(`sessionend`,yt),bt.stop()};function lt(e){e.preventDefault(),Ze(`WebGLRenderer: Context Lost.`),ae=!0}function ut(){Ze(`WebGLRenderer: Context Restored.`),ae=!1;let e=ze.autoReset,t=$e.enabled,n=$e.autoUpdate,r=$e.needsUpdate,i=$e.type;z(),ze.autoReset=e,$e.enabled=t,$e.autoUpdate=n,$e.needsUpdate=r,$e.type=i}function dt(e){R(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function ft(e){let t=e.target;t.removeEventListener(`dispose`,ft),pt(t)}function pt(e){mt(e),F.remove(e)}function mt(e){let t=F.get(e).programs;t!==void 0&&(t.forEach(function(e){Ke.releaseProgram(e)}),e.isShaderMaterial&&Ke.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=Ne);let o=i.isMesh&&i.matrixWorld.determinantAffine()<0,s=kt(e,t,n,r,i);P.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Ue.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;ot.setup(i,r,s,n,c);let h,g=rt;if(c!==null&&(h=He.get(c),g=it,g.setIndex(h)),i.isMesh)r.wireframe===!0?(P.setLineWidth(r.wireframeLinewidth*Fe()),g.setMode(N.LINES)):g.setMode(N.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),P.setLineWidth(e*Fe()),i.isLineSegments?g.setMode(N.LINES):i.isLineLoop?g.setMode(N.LINE_LOOP):g.setMode(N.LINE_STRIP)}else i.isPoints?g.setMode(N.POINTS):i.isSprite&&g.setMode(N.TRIANGLES);if(i.isBatchedMesh)if(Le.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?He.get(c).bytesPerElement:1,o=F.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(N,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function ht(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,Et(e,t,n),e.side=0,e.needsUpdate=!0,Et(e,t,n),e.side=2):Et(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),k=Xe.get(n),k.init(t),re.push(k),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),k.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];ht(a,n,e),r.add(a)}else ht(t,n,e),r.add(t)}),k=re.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){F.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}Le.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let gt=null;function _t(e){gt&&gt(e)}function vt(){bt.stop()}function yt(){bt.start()}let bt=new Ts;bt.setAnimationLoop(_t),typeof self<`u`&&bt.setContext(self),this.setAnimationLoop=function(e){gt=e,ct.setAnimationLoop(e),e===null?bt.stop():bt.start()},ct.addEventListener(`sessionstart`,vt),ct.addEventListener(`sessionend`,yt),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){R(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ae===!0)return;oe!==null&&oe.renderStart(e,t);let n=ct.enabled===!0&&ct.isPresenting===!0,r=ie!==null&&(M===null||n)&&ie.begin(j,M);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),ct.enabled===!0&&ct.isPresenting===!0&&(ie===null||ie.isCompositing()===!1)&&(ct.cameraAutoUpdate===!0&&ct.updateCamera(t),t=ct.getCamera()),e.isScene===!0&&e.onBeforeRender(j,e,t,M),k=Xe.get(e,re.length),k.init(t),k.state.textureUnits=I.getTextureUnits(),re.push(k),Ae.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),De.setFromProjectionMatrix(Ae,Ge,t.reversedDepth),ke=this.localClippingEnabled,Oe=Qe.init(this.clippingPlanes,ke),te=Je.get(e,A.length),te.init(),A.push(te),ct.enabled===!0&&ct.isPresenting===!0){let e=j.xr.getDepthSensingMesh();e!==null&&xt(e,t,-1/0,j.sortObjects)}xt(e,t,0,j.sortObjects),te.finish(),j.sortObjects===!0&&te.sort(Se,Ce,t.reversedDepth),Pe=ct.enabled===!1||ct.isPresenting===!1||ct.hasDepthSensing()===!1,Pe&&tt.addToRenderList(te,e),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Oe===!0&&Qe.beginShadows();let i=k.state.shadowsArray;if($e.render(i,e,t),Oe===!0&&Qe.endShadows(),(r&&ie.hasRenderPass())===!1){let n=te.opaque,r=te.transmissive;if(k.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];Ct(n,r,e,a)}Pe&&tt.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];St(te,e,n,n.viewport)}}else r.length>0&&Ct(n,r,e,t),Pe&&tt.render(e),St(te,e,t)}M!==null&&de===0&&(I.updateMultisampleRenderTarget(M),I.updateRenderTargetMipmap(M)),r&&ie.end(j),e.isScene===!0&&e.onAfterRender(j,e,t),ot.resetDefaultState(),fe=-1,pe=null,re.pop(),re.length>0?(k=re[re.length-1],I.setTextureUnits(k.state.textureUnits),Oe===!0&&Qe.setGlobalState(j.clippingPlanes,k.state.camera)):k=null,A.pop(),te=A.length>0?A[A.length-1]:null,oe!==null&&oe.renderEnd()};function xt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)k.pushLightProbeGrid(e);else if(e.isLight)k.pushLight(e),e.castShadow&&k.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||De.intersectsSprite(e)){r&&Me.setFromMatrixPosition(e.matrixWorld).applyMatrix4(Ae);let t=We.update(e),i=e.material;i.visible&&te.push(e,t,i,n,Me.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||De.intersectsObject(e))){let t=We.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),Me.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Me.copy(e.boundingSphere.center)),Me.applyMatrix4(e.matrixWorld).applyMatrix4(Ae)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&te.push(e,t,s,n,Me.z,o)}}else i.visible&&te.push(e,t,i,n,Me.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)xt(i[e],t,n,r)}function St(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;k.setupLightsView(n),Oe===!0&&Qe.setGlobalState(j.clippingPlanes,n),r&&P.viewport(me.copy(r)),i.length>0&&wt(i,t,n),a.length>0&&wt(a,t,n),o.length>0&&wt(o,t,n),P.buffers.depth.setTest(!0),P.buffers.depth.setMask(!0),P.buffers.color.setMask(!0),P.setPolygonOffset(!1)}function Ct(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(k.state.transmissionRenderTarget[r.id]===void 0){let e=Le.has(`EXT_color_buffer_half_float`)||Le.has(`EXT_color_buffer_float`);k.state.transmissionRenderTarget[r.id]=new Jt(1,1,{generateMipmaps:!0,type:e?g:l,minFilter:c,samples:Math.max(4,Re.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:U.workingColorSpace})}let a=k.state.transmissionRenderTarget[r.id],o=r.viewport||me;a.setSize(o.z*j.transmissionResolutionScale,o.w*j.transmissionResolutionScale);let s=j.getRenderTarget(),u=j.getActiveCubeFace(),d=j.getActiveMipmapLevel();j.setRenderTarget(a),j.getClearColor(_e),ve=j.getClearAlpha(),ve<1&&j.setClearColor(16777215,.5),j.clear(),Pe&&tt.render(n);let f=j.toneMapping;j.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),k.setupLightsView(r),Oe===!0&&Qe.setGlobalState(j.clippingPlanes,r),wt(e,n,r),I.updateMultisampleRenderTarget(a),I.updateRenderTargetMipmap(a),Le.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,Tt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(I.updateMultisampleRenderTarget(a),I.updateRenderTargetMipmap(a))}j.setRenderTarget(s,u,d),j.setClearColor(_e,ve),p!==void 0&&(r.viewport=p),j.toneMapping=f}function wt(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&Tt(o,t,n,s,l,c)}}function Tt(e,t,n,r,i,a){e.onBeforeRender(j,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(j,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,j.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,j.renderBufferDirect(n,t,r,i,e,a),i.side=2):j.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(j,t,n,r,i,a)}function Et(e,t,n){t.isScene!==!0&&(t=Ne);let r=F.get(e),i=k.state.lights,a=k.state.shadowsArray,o=i.state.version,s=Ke.getParameters(e,i.state,a,t,n,k.state.lightProbeGridArray),c=Ke.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Ve.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,ft),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return Ot(e,s),d}else s.uniforms=Ke.getUniforms(e),oe!==null&&e.isNodeMaterial&&oe.build(e,n,s),e.onBeforeCompile(s,j),d=Ke.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Qe.uniform),Ot(e,s),r.needsLights=jt(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=k.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function Dt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=vl.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function Ot(e,t){let n=F.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function B(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function kt(e,t,n,r,i){t.isScene!==!0&&(t=Ne),I.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=M===null?j.outputColorSpace:M.isXRRenderTarget===!0?M.texture.colorSpace:U.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Ve.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(M===null||M.isXRRenderTarget===!0)&&(h=j.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=F.get(r),y=k.state.lights;if(Oe===!0&&(ke===!0||e!==pe)){let t=e===pe&&r.id===fe;Qe.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Qe.numPlanes||v.numIntersection!==Qe.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=k.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=Et(r,t,i),oe&&r.isNodeMaterial&&oe.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(P.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==fe&&(fe=r.id,C=!0),v.needsLights){let e=B(k.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||pe!==e){P.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(N,`projectionMatrix`,e.projectionMatrix),T.setValue(N,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(N,je.setFromMatrixPosition(e.matrixWorld)),Re.logarithmicDepthBuffer&&T.setValue(N,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(N,`isOrthographic`,e.isOrthographicCamera===!0),pe!==e&&(pe=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(N,`directionalShadowMap`,y.state.directionalShadowMap,I),y.state.spotShadowMap.length>0&&T.setValue(N,`spotShadowMap`,y.state.spotShadowMap,I),y.state.pointShadowMap.length>0&&T.setValue(N,`pointShadowMap`,y.state.pointShadowMap,I)),i.isSkinnedMesh){T.setOptional(N,i,`bindMatrix`),T.setOptional(N,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(N,`boneTexture`,e.boneTexture,I))}i.isBatchedMesh&&(T.setOptional(N,i,`batchingTexture`),T.setValue(N,`batchingTexture`,i._matricesTexture,I),T.setOptional(N,i,`batchingIdTexture`),T.setValue(N,`batchingIdTexture`,i._indirectTexture,I),T.setOptional(N,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(N,`batchingColorTexture`,i._colorsTexture,I));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&nt.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(N,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=zu()),C){if(T.setValue(N,`toneMappingExposure`,j.toneMappingExposure),v.needsLights&&At(E,w),a&&r.fog===!0&&qe.refreshFogUniforms(E,a),qe.refreshMaterialUniforms(E,r,xe,be,k.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}vl.upload(N,Dt(v),E,I)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(vl.upload(N,Dt(v),E,I),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(N,`center`,i.center),T.setValue(N,`modelViewMatrix`,i.modelViewMatrix),T.setValue(N,`normalMatrix`,i.normalMatrix),T.setValue(N,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];st.update(n,x),st.bind(n,x)}}return x}function At(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function jt(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return ue},this.getActiveMipmapLevel=function(){return de},this.getRenderTarget=function(){return M},this.setRenderTargetTextures=function(e,t,n){let r=F.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),F.get(e.texture).__webglTexture=t,F.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=F.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0},this.setRenderTarget=function(e,t=0,n=0){M=e,ue=t,de=n;let r=null,i=!1,a=!1;if(e){let o=F.get(e);if(o.__useDefaultFramebuffer!==void 0){P.bindFramebuffer(N.FRAMEBUFFER,o.__webglFramebuffer),me.copy(e.viewport),he.copy(e.scissor),ge=e.scissorTest,P.viewport(me),P.scissor(he),P.setScissorTest(ge),fe=-1;return}else if(o.__webglFramebuffer===void 0)I.setupRenderTarget(e);else if(o.__hasExternalTextures)I.rebindTextures(e,F.get(e.texture).__webglTexture,F.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&F.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.`);I.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=F.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&I.useMultisampledRTT(e)===!1?F.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,me.copy(e.viewport),he.copy(e.scissor),ge=e.scissorTest}else me.copy(we).multiplyScalar(xe).floor(),he.copy(Te).multiplyScalar(xe).floor(),ge=Ee;if(n!==0&&(r=se),P.bindFramebuffer(N.FRAMEBUFFER,r)&&P.drawBuffers(e,r),P.viewport(me),P.scissor(he),P.setScissorTest(ge),i){let r=F.get(e.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=F.get(e.textures[t]);N.framebufferTextureLayer(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=F.get(e.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,t.__webglTexture,n)}fe=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=F.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){P.bindFramebuffer(N.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+s),!Re.textureFormatReadable(c)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Re.textureTypeReadable(l)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&N.readPixels(t,n,r,i,at.convert(c),at.convert(l),a)}finally{let e=M===null?null:F.get(M).__webglFramebuffer;P.bindFramebuffer(N.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=F.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){P.bindFramebuffer(N.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+s),!Re.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Re.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=N.createBuffer();N.bindBuffer(N.PIXEL_PACK_BUFFER,d),N.bufferData(N.PIXEL_PACK_BUFFER,a.byteLength,N.STREAM_READ),N.readPixels(t,n,r,i,at.convert(l),at.convert(u),0);let f=M===null?null:F.get(M).__webglFramebuffer;P.bindFramebuffer(N.FRAMEBUFFER,f);let p=N.fenceSync(N.SYNC_GPU_COMMANDS_COMPLETE,0);return N.flush(),await et(N,p,4),N.bindBuffer(N.PIXEL_PACK_BUFFER,d),N.getBufferSubData(N.PIXEL_PACK_BUFFER,0,a),N.deleteBuffer(d),N.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;I.setTexture2D(e,0),N.copyTexSubImage2D(N.TEXTURE_2D,n,0,0,o,s,i,a),P.unbindTexture()},this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=at.convert(t.format),_=at.convert(t.type),v;t.isData3DTexture?(I.setTexture3D(t,0),v=N.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(I.setTexture2DArray(t,0),v=N.TEXTURE_2D_ARRAY):(I.setTexture2D(t,0),v=N.TEXTURE_2D),P.activeTexture(N.TEXTURE0),P.pixelStorei(N.UNPACK_FLIP_Y_WEBGL,t.flipY),P.pixelStorei(N.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),P.pixelStorei(N.UNPACK_ALIGNMENT,t.unpackAlignment);let y=P.getParameter(N.UNPACK_ROW_LENGTH),b=P.getParameter(N.UNPACK_IMAGE_HEIGHT),x=P.getParameter(N.UNPACK_SKIP_PIXELS),S=P.getParameter(N.UNPACK_SKIP_ROWS),C=P.getParameter(N.UNPACK_SKIP_IMAGES);P.pixelStorei(N.UNPACK_ROW_LENGTH,h.width),P.pixelStorei(N.UNPACK_IMAGE_HEIGHT,h.height),P.pixelStorei(N.UNPACK_SKIP_PIXELS,l),P.pixelStorei(N.UNPACK_SKIP_ROWS,u),P.pixelStorei(N.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=F.get(e),r=F.get(t),h=F.get(n.__renderTarget),g=F.get(r.__renderTarget);P.bindFramebuffer(N.READ_FRAMEBUFFER,h.__webglFramebuffer),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,F.get(e).__webglTexture,i,d+n),N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,F.get(t).__webglTexture,a,m+n)),N.blitFramebuffer(l,u,o,s,f,p,o,s,N.DEPTH_BUFFER_BIT,N.NEAREST);P.bindFramebuffer(N.READ_FRAMEBUFFER,null),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||F.has(e)){let n=F.get(e),r=F.get(t);P.bindFramebuffer(N.READ_FRAMEBUFFER,ce),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,le);for(let e=0;e<c;e++)w?N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):N.framebufferTexture2D(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,n.__webglTexture,i),T?N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):N.framebufferTexture2D(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,r.__webglTexture,a),i===0?T?N.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):N.copyTexSubImage2D(v,a,f,p,l,u,o,s):N.blitFramebuffer(l,u,o,s,f,p,o,s,N.COLOR_BUFFER_BIT,N.NEAREST);P.bindFramebuffer(N.READ_FRAMEBUFFER,null),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?N.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?N.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):N.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?N.texSubImage2D(N.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?N.compressedTexSubImage2D(N.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):N.texSubImage2D(N.TEXTURE_2D,a,f,p,o,s,g,_,h);P.pixelStorei(N.UNPACK_ROW_LENGTH,y),P.pixelStorei(N.UNPACK_IMAGE_HEIGHT,b),P.pixelStorei(N.UNPACK_SKIP_PIXELS,x),P.pixelStorei(N.UNPACK_SKIP_ROWS,S),P.pixelStorei(N.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&N.generateMipmap(v),P.unbindTexture()},this.initRenderTarget=function(e){F.get(e).__webglFramebuffer===void 0&&I.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?I.setTextureCube(e,0):e.isData3DTexture?I.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?I.setTexture2DArray(e,0):I.setTexture2D(e,0),P.unbindTexture()},this.resetState=function(){ue=0,de=0,M=null,P.reset(),ot.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Ge}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=U._getDrawingBufferColorSpace(e),t.unpackColorSpace=U._getUnpackColorSpace()}},Vu=`blob-haven-build-progress-v1`,Hu={ground:`#e5d6bc`,water:`#7fcbd3`,deepWater:`#267c94`,plum:`#956b93`,sage:`#a5b78a`,leaf:`#688b79`,leafLight:`#9bb18a`,stone:`#c8b8a1`,ink:`#172b3c`,ivory:`#f6efdf`,accent:`#a0e6cf`,cyan:`#75d7e3`,cherry:`#ba214e`},Uu={bed:{name:`Лежанка`,radius:1.65,height:.65,color:Hu.plum,action:`На лежанку`,hint:`Мягкая поверхность для отдыха`},pad:{name:`Трамплин`,radius:1.55,height:.65,color:Hu.sage,action:`Попробовать`,hint:`Контакт с подушкой даёт упругий отскок`},slide:{name:`Спиральная горка`,radius:3.55,height:6.5,color:`#94afb9`,action:`На старт`,hint:`Два с четвертью витка и настоящий спуск`},pool:{name:`Резервуар`,radius:2.95,height:2.4,color:`#d2c4b0`,action:`В воду`,hint:`Плоский уровень, плавучесть и плавающий шар`},plant:{name:`Растения`,radius:.82,height:1.6,color:Hu.leaf,action:null,hint:`Оформление свободного места`},rock:{name:`Камень`,radius:.85,height:.9,color:Hu.stone,action:null,hint:`Твёрдое физическое препятствие`},catapult:{name:`Катапульта`,radius:1.8,height:2.35,color:`#c89e73`,action:`Зарядить`,hint:`Низкая чаша — для блоба. Коралловая кнопка — пуск. Потяни боковые ручки, чтобы повернуть.`}},Wu={slime:{name:`Водянистый слайм`,short:`Слайм`,color:Hu.cyan,radius:1.12,shell:.0045,center:.001,pressure:2.5,damping:.974,density:.68,spring:3.3},jelly:{name:`Вишнёвое желе`,short:`Желе`,color:Hu.cherry,radius:1.1,shell:.015,center:.005,pressure:7,damping:.987,density:.72,spring:5.6}},J={startAngle:.9,turns:2.25,radius:2.03,halfWidth:1.14,height:6.15,exit:.36,rail:.95,thickness:.18},Y={inner:2.58,outer:2.9,bottom:.16,level:1.94,rim:2.28},X={cupY:.16,cupZ:-.67,cupRadius:1.05,rim:.86,pivotY:1.3,pivotZ:.65,baseRadius:.82,frameHalfWidth:.38,buttonX:-.72,buttonZ:.83,handleX:.85,handleZ:1.42,turnStep:Math.PI/12,gravity:9.75,falloff:1.1,power:2.9,speed:1.132,angle:.22,maxTime:30};function Gu(e,t,n=1){let r=Math.hypot(e,t,n);return[e/r,t/r,n/r]}function Ku(e,t=[0,0,1]){if(!Array.isArray(e)||e.length!==3||!e.every(Number.isFinite))return[...t];let n=Math.hypot(...e);return!Number.isFinite(n)||n<.1?[...t]:Math.abs(n-1)<1e-12?[...e]:e.map(e=>e/n)}function qu(e,t){return Math.acos(Math.max(-1,Math.min(1,e[0]*t[0]+e[1]*t[1]+e[2]*t[2])))*10}function Ju(e,t){return Math.atan2(Math.sin(e-t),Math.cos(e-t))}function Yu(){return{schema:1,nextId:7,sound:!1,residents:{slime:{dir:Gu(-.06,-.12)},jelly:{dir:Gu(.12,-.34)}},objects:[{id:`o1`,type:`slide`,dir:Gu(-.54,.23),rotation:.25},{id:`o2`,type:`pool`,dir:Gu(.56,.24),rotation:0},{id:`o3`,type:`bed`,dir:Gu(-.34,-.68),rotation:.12},{id:`o4`,type:`pad`,dir:Gu(.37,-.64),rotation:0},{id:`o5`,type:`plant`,dir:Gu(-1.05,-.5),rotation:.2},{id:`o6`,type:`plant`,dir:Gu(.98,-.61),rotation:1}]}}function Xu(e,t,n=[]){if(!Object.hasOwn(Uu,e.type))return{ok:!1,reason:`Неизвестный предмет`};let r=Uu[e.type];if(t.length>=24&&!t.some(t=>t.id===e.id))return{ok:!1,reason:`На планете уже 24 предмета`};for(let n of t)if(n.id!==e.id&&qu(n.dir,e.dir)<r.radius+Uu[n.type].radius+.2)return{ok:!1,reason:`Оставь немного места между предметами`};for(let t of n)if(qu(e.dir,t.dir)<r.radius+t.radius*.65)return{ok:!1,reason:`Здесь блоб — выбери место рядом`};return{ok:!0,reason:``}}function Zu(e){let t=Yu();if(!e||typeof e!=`object`||Array.isArray(e))return t;if(Array.isArray(e.objects)){t.objects=[];let n=new Set;for(let r of e.objects.slice(0,24)){if(!r||!Object.hasOwn(Uu,r.type)||typeof r.id!=`string`||!/^o\d{1,6}$/.test(r.id)||n.has(r.id))continue;let e={id:r.id,type:r.type,dir:Ku(r.dir),rotation:Number.isFinite(r.rotation)?r.rotation%(Math.PI*2):0};Xu(e,t.objects).ok&&(t.objects.push(e),n.add(e.id))}}t.nextId=Math.max(1,...t.objects.map(e=>Number(e.id.slice(1))+1));for(let n of[`slime`,`jelly`])t.residents[n].dir=Ku(e.residents?.[n]?.dir,t.residents[n].dir);return t.sound=e.sound===!0,t}var Qu=class{constructor(e,t){let n=e.objects.find(e=>e.id===t);this.original=n?structuredClone(n):null,this.draft=n?structuredClone(n):{id:`o${e.nextId}`,type:t,dir:Gu(0,-.55),rotation:0}}move(e){this.draft.dir=Ku(e,this.draft.dir)}rotate(){this.draft.rotation=(this.draft.rotation+Math.PI/8)%(Math.PI*2)}commit(e,t=[]){let n=Xu(this.draft,e.objects,t);if(!n.ok)return n;let r=e.objects.findIndex(e=>e.id===this.draft.id);return r<0?(e.objects.push(structuredClone(this.draft)),e.nextId++):e.objects[r]=structuredClone(this.draft),{ok:!0,id:this.draft.id}}};function $u(e,t){let n=e.objects.findIndex(e=>e.id===t);return n<0?null:e.objects.splice(n,1)[0]}function ed(e,t,n=0,r=0){if(t>=1)return 0;let i=Math.min(1,(1-t)*8);return e===`bed`?i*(.17+.4*Math.exp(-(((t-.76)/.21)**2))*(1+.1*Math.cos(n*7)))-r*.09*(1-t):i*(.23+.4*Math.sqrt(Math.max(0,1-t*t)))-r*.16*(1-t*t)}var td=class{constructor(){this.last=null,this.frames=0,this.value=0}frame(e){if(this.last===null)return this.last=e,this.value;this.frames++;let t=e-this.last;return t>=600&&(this.value=Math.round(this.frames*1e3/t),this.frames=0,this.last=e),this.value}};function nd(e,t=1e-4){t=Math.max(t,2**-52);let n={},r=e.getIndex(),i=e.getAttribute(`position`),a=r?r.count:i.count,o=0,s=Object.keys(e.attributes),c={},l={},u=[],d=[`getX`,`getY`,`getZ`,`getW`],f=[`setX`,`setY`,`setZ`,`setW`];for(let t=0,n=s.length;t<n;t++){let n=s[t],r=e.attributes[n];c[n]=new r.constructor(new r.array.constructor(r.count*r.itemSize),r.itemSize,r.normalized);let i=e.morphAttributes[n];i&&(l[n]||(l[n]=[]),i.forEach((e,t)=>{let r=new e.array.constructor(e.count*e.itemSize);l[n][t]=new e.constructor(r,e.itemSize,e.normalized)}))}let p=t*.5,m=10**Math.log10(1/t),h=p*m;for(let t=0;t<a;t++){let i=r?r.getX(t):t,a=``;for(let t=0,n=s.length;t<n;t++){let n=s[t],r=e.getAttribute(n),o=r.itemSize;for(let e=0;e<o;e++)a+=`${~~(r[d[e]](i)*m+h)},`}if(a in n)u.push(n[a]);else{for(let t=0,n=s.length;t<n;t++){let n=s[t],r=e.getAttribute(n),a=e.morphAttributes[n],u=r.itemSize,p=c[n],m=l[n];for(let e=0;e<u;e++){let t=d[e],n=f[e];if(p[n](o,r[t](i)),a)for(let e=0,r=a.length;e<r;e++)m[e][n](o,a[e][t](i))}}n[a]=o,u.push(o),o++}}let g=e.clone();for(let t in e.attributes){let e=c[t];if(g.setAttribute(t,new e.constructor(e.array.slice(0,o*e.itemSize),e.itemSize,e.normalized)),t in l)for(let e=0;e<l[t].length;e++){let n=l[t][e];g.morphAttributes[t][e]=new n.constructor(n.array.slice(0,o*n.itemSize),n.itemSize,n.normalized)}}return g.setIndex(u),g}function rd(e=4){let t=new Uint8Array(e);for(let n=0;n<e;n++)t[n]=Math.round(n/(e-1)*255);let n=new $r(t,e,1,D);return n.minFilter=r,n.magFilter=r,n.generateMipmaps=!1,n.needsUpdate=!0,n}var id=rd(4);function ad(e=24){let t=new Uint8Array(e);for(let n=0;n<e;n++)t[n]=Math.round(n/(e-1)*255);let n=new $r(t,e,1,D);return n.minFilter=o,n.magFilter=o,n.generateMipmaps=!1,n.needsUpdate=!0,n}ad(24);function od(e,t={}){return new _o({color:e,gradientMap:id,...t})}var sd=1/120,cd=6,ld=8,ud=.02,dd=.005,fd=6,pd=.25,md=-6.5,hd=.986,gd=.45;function _d(e,t=1){let n=(1+Math.sqrt(5))/2,r=[[-1,n,0],[1,n,0],[-1,-n,0],[1,-n,0],[0,-1,n],[0,1,n],[0,-1,-n],[0,1,-n],[n,0,-1],[n,0,1],[-n,0,-1],[-n,0,1]].map(e=>new V(e[0],e[1],e[2])),i=[[0,11,5],[0,5,1],[0,1,7],[0,7,10],[0,10,11],[1,5,9],[5,11,4],[11,10,2],[10,7,6],[7,1,8],[3,9,4],[3,4,2],[3,2,6],[3,6,8],[3,8,9],[4,9,5],[2,4,11],[6,2,10],[8,6,7],[9,8,1]];for(let e=0;e<t;e++){let e=new Map,t=(t,n)=>{let i=t<n?t+`_`+n:n+`_`+t;if(e.has(i))return e.get(i);let a=r[t].clone().add(r[n]).multiplyScalar(.5),o=r.length;return r.push(a),e.set(i,o),o},n=[];for(let[e,r,a]of i){let i=t(e,r),o=t(r,a),s=t(a,e);n.push([e,i,s],[r,o,i],[a,s,o],[i,o,s])}i=n}return r=r.map(t=>t.normalize().multiplyScalar(e)),{verts:r,faces:i}}var vd=class{constructor(e,t,n=2,r={}){this.scene=e,this.radius=n,this.volumeUnits=r.volumeUnits??n**3,this.particleRadius=r.particleRadius??.22,this.shellStiffness=r.shellStiffness??ud,this.centerStiffness=r.centerStiffness??dd,this.pressureK=r.pressureK??fd,this.shellStiffScale=1,this.velDamp=r.velDamp??hd,this.gravityCenter=r.gravityCenter??null,this.gravityStrength=r.gravityStrength??Math.abs(md),this.gravityFalloffR=r.gravityFalloffR??null,this.gravityFalloffP=r.gravityFalloffP??2,this.waterZone=r.waterZone??null,this.gelColor=r.gelColor??16753592,this.coreColor=r.coreColor??16726883,this.outlineColor=r.outlineColor??3809072,this.gelOpacity=r.gelOpacity??.8,this.externalFace=r.externalFace??!1,this.subdivisions=r.subdivisions??2;let{verts:i,faces:a}=_d(n,this.subdivisions);this.faces=a,this.shellCount=i.length,this.pos=[],this.prev=[],this.ext=[];for(let e of i){let n=e.clone().add(t);this.pos.push(n),this.prev.push(n.clone()),this.ext.push(new V)}this.centerIdx=this.pos.length,this.pos.push(t.clone()),this.prev.push(t.clone()),this.ext.push(new V);let o=new Set;this.springs=[];let s=(e,t,n,r)=>{let i=e<t?e+`_`+t:t+`_`+e;o.has(i)||(o.add(i),this.springs.push({a:e,b:t,rest:this.pos[e].distanceTo(this.pos[t]),stiff:n,shell:r}))};for(let[e,t,n]of a)s(e,t,this.shellStiffness,!0),s(t,n,this.shellStiffness,!0),s(n,e,this.shellStiffness,!0);for(let e=0;e<this.shellCount;e++)s(e,this.centerIdx,this.centerStiffness,!1);this.restVolume=this._volume(),this.com=t.clone(),this.prevCom=t.clone(),this.velocity=new V,this.compression=0,this.grabActive=!1,this.grabParticles=[],this.grabLook=null,this.grabPoint=new V,this.grabStiff=0,this.grabbedMask=null,this.neckSoft=r.neckSoft??.12,this.returnRadius=r.returnRadius??null,this.returnStrength=r.returnStrength??1.5,this._buildMesh(),this._t1=new V,this._t2=new V,this._t3=new V,this._n=new V,this._up=new V(0,1,0),this._right=new V,this._dir=new V,this._acc=0,this._volGrad=[];for(let e=0;e<this.shellCount;e++)this._volGrad.push(new V)}_projectVolume(e){let t=this._volume(),n=this.restVolume-t;if(Math.abs(n)<1e-6*this.restVolume)return;for(let e of this._volGrad)e.set(0,0,0);for(let[e,t,n]of this.faces)this._volGrad[e].addScaledVector(this._t1.crossVectors(this.pos[t],this.pos[n]),1/6),this._volGrad[t].addScaledVector(this._t1.crossVectors(this.pos[n],this.pos[e]),1/6),this._volGrad[n].addScaledVector(this._t1.crossVectors(this.pos[e],this.pos[t]),1/6);let r=1e-9;for(let e of this._volGrad)r+=e.lengthSq();let i=e*n/r;for(let e=0;e<this.shellCount;e++)this.pos[e].addScaledVector(this._volGrad[e],i)}_volume(){let e=0;for(let[t,n,r]of this.faces){let i=this.pos[t],a=this.pos[n],o=this.pos[r];e+=i.x*(a.y*o.z-o.y*a.z)-i.y*(a.x*o.z-o.x*a.z)+i.z*(a.x*o.y-o.x*a.y)}return e/6}_buildMesh(){this.group=new En;let e=new to(this.radius,26,18);e.deleteAttribute(`uv`),e.deleteAttribute(`normal`),this.geo=nd(e);let t=od(this.gelColor,{transparent:!0,opacity:this.gelOpacity,depthWrite:!1});this.mesh=new Xr(this.geo,t),this.mesh.castShadow=!0,this.mesh.renderOrder=2,this.group.add(this.mesh);let n=new Rr({color:this.outlineColor,side:1});if(this.outline=new Xr(this.geo,n),this.outline.scale.setScalar(1.04),this.outline.renderOrder=0,this.group.add(this.outline),this.core=new Xr(new to(this.radius*.46,16,12),od(this.coreColor)),this.core.renderOrder=1,this.group.add(this.core),this.eyeWhites=[],this.eyePupils=[],!this.externalFace){let e=new _o({color:16777215}),t=new Rr({color:1710638});for(let n of[-1,1]){let r=new Xr(new to(.34,14,12),e),i=new Xr(new to(.17,12,10),t);r.userData.side=n,r.renderOrder=3,i.renderOrder=4,this.eyeWhites.push(r),this.eyePupils.push(i),this.group.add(r,i)}}this.front=new V(0,0,1),this.scene.add(this.group),this._bindMesh()}_bindMesh(){let e=this.geo.attributes.position,t=e.count;this.binds=Array(t);let n=new V;for(let r=0;r<t;r++){n.fromBufferAttribute(e,r).add(this.com);let t=[];for(let e=0;e<this.shellCount;e++)t.push({j:e,d:n.distanceTo(this.pos[e])});t.sort((e,t)=>e.d-t.d);let i=t.slice(0,6),a=this.radius*.12,o=0;for(let e of i)e.w=1/(e.d*e.d+a*a*4),o+=e.w;for(let e of i)e.w/=o;this.binds[r]=i}}clearForces(){for(let e of this.ext)e.set(0,0,0)}addWind(e){for(let t=0;t<this.shellCount;t++)this.ext[t].add(e)}addPointerPull(e,t,n){let r=this._t1;for(let i=0;i<this.shellCount;i++){r.copy(e).sub(this.pos[i]);let a=r.length();if(a>t)continue;let o=1-a/t;r.multiplyScalar(n*o/(a+.001));let s=n;r.length()>s&&r.setLength(s),this.ext[i].add(r)}}beginGrab(e,t=5){let n=[];for(let t=0;t<this.shellCount;t++)n.push({i:t,d:e.distanceToSquared(this.pos[t])});n.sort((e,t)=>e.d-t.d),this.grabParticles=n.slice(0,t).map(e=>e.i),this.grabActive=!0,this.grabbedMask?this.grabbedMask.fill(0):this.grabbedMask=new Uint8Array(this.pos.length);for(let e of this.grabParticles)this.grabbedMask[e]=1}pullGrab(e,t=9){if(!this.grabActive)return;let n=this._t1,r=t*1.25;for(let i of this.grabParticles){n.copy(e).sub(this.pos[i]);let a=n.length(),o=t*Math.min(a,1.2);n.multiplyScalar(o/(a+.001)),n.length()>r&&n.setLength(r),this.ext[i].add(n)}this.grabLook=e}setGrabTarget(e,t=.5){this.grabPoint.copy(e),this.grabStiff=t,this.grabLook=e}endGrab(){this.grabActive=!1,this.grabStiff=0,this.grabLook=null,this.grabbedMask&&this.grabbedMask.fill(0)}addVelocity(e){for(let t=0;t<=this.centerIdx;t++)this.prev[t].addScaledVector(e,-.008333333333333333)}stretchAlong(e,t){let n=Math.hypot(e.x,e.y,e.z)||1,r=e.x/n,i=e.y/n,a=e.z/n,o=this.shellCount,s=0;for(let e=0;e<o;e++){let t=this.pos[e];s+=(t.x-this.com.x)*r+(t.y-this.com.y)*i+(t.z-this.com.z)*a}s/=o;for(let e=0;e<o;e++){let n=this.pos[e],o=t*((n.x-this.com.x)*r+(n.y-this.com.y)*i+(n.z-this.com.z)*a-s)*sd;this.prev[e].x-=r*o,this.prev[e].y-=i*o,this.prev[e].z-=a*o}}hop(e){for(let t=0;t<=this.centerIdx;t++)this.prev[t].y-=e*(.6+Math.random()*.4)*sd}_step(e){let t=this._volume(),n=this.pressureK*(this.restVolume-t)/this.restVolume;if(n!==0)for(let[e,t,r]of this.faces){let i=this.pos[e],a=this.pos[t],o=this.pos[r];this._t1.subVectors(a,i),this._t2.subVectors(o,i),this._n.crossVectors(this._t1,this._t2),this._n.multiplyScalar(n/6),this.ext[e].add(this._n),this.ext[t].add(this._n),this.ext[r].add(this._n)}let r=this.gravityCenter,i=this.gravityStrength,a=this.waterZone,o=a?a.center:null,s=a?a.drag/sd:0;for(let e=0;e<=this.centerIdx;e++){let t=this.pos[e],n=this.prev[e],c=(t.x-n.x)*this.velDamp,l=(t.y-n.y)*this.velDamp,u=(t.z-n.z)*this.velDamp;n.copy(t);let d=this.ext[e].x,f=this.ext[e].y,p=this.ext[e].z;if(r){let e=r.x-t.x,n=r.y-t.y,a=r.z-t.z,o=Math.sqrt(e*e+n*n+a*a)||1e-6,s=this.gravityFalloffR,c=s!==null&&o>s?i*(s/o)**+this.gravityFalloffP/o:i/o;this.returnRadius&&o>this.returnRadius&&(c+=this.returnStrength*(o-this.returnRadius)/o),d+=e*c,f+=n*c,p+=a*c}else f+=md;if(a){let e=t.x-o.x,n=t.y-o.y,r=t.z-o.z,i=Math.sqrt(e*e+n*n+r*r)||1e-6;if(i<a.level&&(e*a.dir.x+n*a.dir.y+r*a.dir.z)/i>a.cosAng){let t=Math.min(a.level-i,a.maxDepth),o=a.buoyancy*t/(a.maxDepth*i);d+=e*o,f+=n*o,p+=r*o,d-=c*s,f-=l*s,p-=u*s}}let m=c+d*sd*sd,h=l+f*sd*sd,g=u+p*sd*sd,_=m*m+h*h+g*g;if(_>gd*gd){let e=gd/Math.sqrt(_);m*=e,h*=e,g*=e}t.x+=m,t.y+=h,t.z+=g}for(let t=0;t<ld;t++){if(this.grabActive&&this.grabStiff>0){let e=this.grabPoint,t=this.grabStiff;for(let n of this.grabParticles){let r=this.pos[n];r.x+=(e.x-r.x)*t,r.y+=(e.y-r.y)*t,r.z+=(e.z-r.z)*t}}let n=this.grabActive?this.grabbedMask:null;for(let e of this.springs){let t=this.pos[e.a],r=this.pos[e.b],i=r.x-t.x,a=r.y-t.y,o=r.z-t.z,s=Math.sqrt(i*i+a*a+o*o)||1e-6,c=n&&(n[e.a]||n[e.b])?this.neckSoft:1,l=(s-e.rest)/s*.5*e.stiff*this.shellStiffScale*c,u=i*l,d=a*l,f=o*l;t.x+=u,t.y+=d,t.z+=f,r.x-=u,r.y-=d,r.z-=f}if(this._projectVolume(pd),e){let n=t===ld-1;for(let t=0;t<=this.centerIdx;t++)e.resolveParticle(this.pos[t],this.prev[t],this.particleRadius,n)}}}update(e,t){this._acc+=Math.min(e,.05);let n=0;for(;this._acc>=sd&&n<cd;)this._step(t),this._acc-=sd,n++;this.prevCom.copy(this.com),this.com.set(0,0,0);for(let e=0;e<this.shellCount;e++)this.com.add(this.pos[e]);this.com.multiplyScalar(1/this.shellCount),e>0&&this.velocity.copy(this.com).sub(this.prevCom).multiplyScalar(1/e);let r=this._volume();this.compression=(this.restVolume-r)/this.restVolume,this._syncMesh()}_syncMesh(){let e=this.geo.attributes.position,t=this._t1;for(let n=0;n<e.count;n++){t.set(0,0,0);for(let e of this.binds[n])t.addScaledVector(this.pos[e.j],e.w);e.setXYZ(n,t.x-this.com.x,t.y-this.com.y,t.z-this.com.z)}e.needsUpdate=!0,this.geo.computeVertexNormals(),this.group.position.copy(this.com),this._t2.copy(this.pos[this.centerIdx]).sub(this.com),this.core.position.copy(this._t2),this.externalFace||this._updateEyes()}surfaceAlong(e,t,n){let r=Math.hypot(e.x,e.y,e.z)||1,i=e.x/r,a=e.y/r,o=e.z/r,s=0,c=-2;for(let e=0;e<this.shellCount;e++){let t=this.pos[e].x-this.com.x,n=this.pos[e].y-this.com.y,r=this.pos[e].z-this.com.z,l=Math.hypot(t,n,r)||1,u=(t*i+n*a+r*o)/l;u>c&&(c=u,s=e)}return n.set(this.pos[s].x-this.com.x+i*t,this.pos[s].y-this.com.y+a*t,this.pos[s].z-this.com.z+o*t),n}_updateEyes(){let e=this._t3.copy(this.velocity);if(e.y=0,e.lengthSq()>.05&&(e.normalize(),this.front.lerp(e,.12).normalize()),this.grabLook){let e=this._t3.copy(this.grabLook).sub(this.com);e.y=0,e.lengthSq()>.02&&(e.normalize(),this.front.lerp(e,.3).normalize())}let t=this._right.crossVectors(this._up,this.front).normalize();for(let e=0;e<2;e++){let n=this.eyeWhites[e].userData.side,r=this._dir.copy(this.front).addScaledVector(t,.42*n).addScaledVector(this._up,.34).normalize(),i=0,a=-2;for(let e=0;e<this.shellCount;e++){let t=this.pos[e].x-this.com.x,n=this.pos[e].y-this.com.y,o=this.pos[e].z-this.com.z,s=Math.hypot(t,n,o)||1,c=(t*r.x+n*r.y+o*r.z)/s;c>a&&(a=c,i=e)}let o=this._t2.copy(this.pos[i]).sub(this.com).addScaledVector(r,.16);this.eyeWhites[e].position.copy(o),this.eyePupils[e].position.copy(o).addScaledVector(r,.26)}}dispose(){this.scene.remove(this.group),this.geo.dispose()}},yd=.94,bd=.9;function xd(e,t,n,r,i,a,o){let s=e.x-r.x,c=e.y-r.y,l=e.z-r.z,u=Math.sqrt(s*s+c*c+l*l),d=i+n;if(u>=d)return;let f,p,m;u<1e-6?(f=0,p=1,m=0,u=1e-6):(f=s/u,p=c/u,m=l/u),e.x=r.x+f*d,e.y=r.y+p*d,e.z=r.z+m*d;let h=o?a:1,g=e.x-t.x,_=e.y-t.y,v=e.z-t.z,y=g*f+_*p+v*m,b=g-f*y,x=_-p*y,S=v-m*y;t.x=e.x-b*h,t.y=e.y-x*h,t.z=e.z-S*h}var Sd=new V,Cd=new V;function wd(e,t,n,r=new V){return Sd.set(-e.z,0,e.x),Sd.lengthSq()<1e-8&&Sd.set(1,0,0),Sd.normalize(),Cd.crossVectors(e,Sd).normalize(),r.copy(e).multiplyScalar(Math.cos(t)).addScaledVector(Sd,Math.cos(n)*Math.sin(t)).addScaledVector(Cd,Math.sin(n)*Math.sin(t)).normalize()}var Td=class{constructor({center:e=new V(0,0,0),radius:t=14,sea:n=null}={}){this.center=e.clone(),this.radius=t,this.obstacles=[],this.sea=null,this.waterZone=null,this._u=new V,this._t=new V,n&&this.setSea(n)}setSea({dir:e,radius:t,depth:n,shoreBand:r=t,buoyancy:i,drag:a,maxDepth:o,island:s=null}){if(!Number.isFinite(i)||!Number.isFinite(a)||!Number.isFinite(o))throw Error(`setSea: buoyancy/drag/maxDepth обязательны (конечные числа) — иначе солвер тихо взрывается в NaN`);let c=t/this.radius;if(this.sea={dir:e.clone().normalize(),radius:t,depth:n,angRadius:c,shoreBand:Math.min(Math.max(r,1e-6),t),cosAng:Math.cos(c),level:this.radius,island:null},s){let e=s.arc/this.radius;this.sea.island={dir:s.dir.clone().normalize(),arc:s.arc,flat:s.flat,rise:s.rise,angArc:e,cosAng:Math.cos(e),dryArc:0},this.sea.island.dryArc=this._measureDryArc()}return this.waterZone={center:this.center,dir:this.sea.dir,cosAng:this.sea.cosAng,level:this.sea.level,buoyancy:i,drag:a,maxDepth:o},this.sea}_measureDryArc(){let e=this.sea.island,t=new V,n=(n,r)=>(wd(e.dir,n/this.radius,r,t).multiplyScalar(this.radius).add(this.center),this.floorRadius(t)>=this.sea.level),r=1/0;for(let t=0;t<16;t++){let i=t/16*Math.PI*2;if(!n(0,i))return 0;let a=0,o=e.arc;for(let e=0;e<24;e++){let e=(a+o)/2;n(e,i)?a=e:o=e}r=Math.min(r,a)}return r}addObstacle(e,t){return this.obstacles.push({center:e.clone(),radius:t}),this.obstacles[this.obstacles.length-1]}floorRadius(e){let t=this.sea;if(!t)return this.radius;let n=e.x-this.center.x,r=e.y-this.center.y,i=e.z-this.center.z,a=Math.sqrt(n*n+r*r+i*i);if(a<1e-6)return this.radius;let o=(n*t.dir.x+r*t.dir.y+i*t.dir.z)/a;if(o<=t.cosAng)return this.radius;let s=Math.acos(o>1?1:o)*this.radius,c=Math.min(1,(t.radius-s)/t.shoreBand),l=this.radius-t.depth*c*c*(3-2*c),u=t.island;if(u){let e=(n*u.dir.x+r*u.dir.y+i*u.dir.z)/a;if(e>u.cosAng){let t=Math.acos(e>1?1:e)/u.angArc,n=Math.min(1,Math.max(0,(1-t)/(1-u.flat))),r=n*n*(3-2*n);l+=(this.radius+u.rise-l)*r}}return l}isWater(e){let t=this.sea;if(!t)return!1;let n=e.x-this.center.x,r=e.y-this.center.y,i=e.z-this.center.z,a=Math.sqrt(n*n+r*r+i*i)||1e-6;return a<t.level&&(n*t.dir.x+r*t.dir.y+i*t.dir.z)/a>t.cosAng}waterInfo(e,t){let n=this.sea;if(!n)return null;let r=e.distanceTo(this.center),i=this._u.copy(e).sub(this.center).multiplyScalar(1/(r||1e-6)),a=Math.acos(Ot.clamp(i.dot(n.dir),-1,1))*this.radius,o=n.radius-a,s=!1,c=n.island;if(c){let e=Math.acos(Ot.clamp(i.dot(c.dir),-1,1))*this.radius-c.dryArc;e<o&&(o=e,s=!0)}if(t){let e=s?c.dir:n.dir;this._t.copy(e).addScaledVector(i,-i.dot(e)),s||this._t.negate(),this._t.lengthSq()<1e-8&&(this._t.set(-i.z,0,i.x),this._t.lengthSq()<1e-8&&this._t.set(1,0,0)),t.copy(this._t).normalize()}return{over:r-n.level,depth:n.level-this.floorRadius(e),dist:o,toIsland:s}}resolveParticle(e,t,n,r=!0){xd(e,t,n,this.center,this.floorRadius(e),yd,r);for(let i of this.obstacles)xd(e,t,n,i.center,i.radius,bd,r)}},Ed=Math.PI*2,Dd=Ed*J.turns,Od=(J.height-J.exit)/Dd,kd=J.radius-J.halfWidth,Ad=J.radius+J.halfWidth,jd=J.thickness,Md=[[kd-jd,Ad+jd,-jd,0],[kd-jd,kd,-jd,J.rail],[Ad,Ad+jd,-jd,J.rail]],Nd=[1.9,4.3].map(e=>({x:Math.cos(e)*(Ad+.1),z:Math.sin(e)*(Ad+.1),height:J.height-Od*e})),Z=new V,Pd=new V,Fd=new V,Id=new V,Ld=new V,Rd=[0,0,0],zd=[0,0,0],Bd=[0,0,0],Vd=[0,0,0];function Hd(e,t){e.local(t,Z);let n=Math.hypot(Z.x,Z.z);if(n<.2&&Z.y>0&&Z.y<J.height+.35||Math.hypot(Z.x,Z.y-J.height-.45,Z.z)<.29)return!0;for(let e of Nd)if(Z.y>-.25&&Z.y<e.height&&Math.hypot(Z.x-e.x,Z.z-e.z)<.09)return!0;if(n<kd-jd||n>Ad+jd)return!1;let r=Math.atan2(Z.z,Z.x);for(r<0&&(r+=Ed);r<=Dd;r+=Ed){let e=Z.y-J.height+Od*r;for(let t of Md)if(n>t[0]+1e-6&&n<t[1]-1e-6&&e>t[2]+1e-6&&e<t[3]-1e-6)return!0}return!1}function Ud(e,t,n,r,i,a){return Md.some(o=>n>0-a+1e-6&&n<Dd+a-1e-6&&e>o[0]-r+1e-6&&e<o[1]+r-1e-6&&t>o[2]-i+1e-6&&t<o[3]+i-1e-6)}function Wd(e,t,n,r,i=!0){for(let a=0;a<5;a++){e.local(t,Z),e.local(n,Pd);let a=Math.hypot(Z.x,Z.z),o=Math.hypot(Pd.x,Pd.z),s=Z.y-J.height-.45,c=Math.hypot(Z.x,s,Z.z);if(c<.29+r){e.normal(Z.x,s,Z.z,Fd),Gd(t,n,Fd,.29+r-c,i);continue}if(a<.2+r&&Z.y>0&&Z.y<J.height+.35){let o=a>1e-7?Z.x/a:1,s=a>1e-7?Z.z/a:0;e.normal(o,0,s,Fd),Gd(t,n,Fd,.2+r-a,i);continue}let l=!1;for(let a of Nd){let o=Z.x-a.x,s=Z.z-a.z,c=Math.hypot(o,s);if(c<.1+r&&Z.y>-.25&&Z.y<a.height+.1){e.normal(c>1e-7?o/c:1,0,c>1e-7?s/c:0,Fd),Gd(t,n,Fd,.1+r-c,i),l=!0;break}}if(l)continue;let u=Math.atan2(Z.z,Z.x),d=Math.atan2(Pd.z,Pd.x),f=Math.atan2(Math.sin(d-u),Math.cos(d-u)),p=Math.sqrt(1+(Od/Math.max(a,.5))**2),m=r*p,h=r/Math.max(a,.5),g=null;for(let e=-1;e<=Math.ceil(J.turns);e++){let t=u+e*Ed,n=t+f;if(Rd[0]=o,Rd[1]=Pd.y-J.height+Od*n,Rd[2]=n,zd[0]=a,zd[1]=Z.y-J.height+Od*t,zd[2]=t,!(Math.max(Rd[2],zd[2])<-h||Math.min(Rd[2],zd[2])>Dd+h)&&!(Math.min(Rd[1],zd[1])>J.rail+m||Math.max(Rd[1],zd[1])<-jd-m))for(let e of Md){Bd[0]=e[0]-r,Vd[0]=e[1]+r,Bd[1]=e[2]-m,Vd[1]=e[3]+m,Bd[2]=0-h,Vd[2]=Dd+h;let n=0,i=1,o=-1,s=0,c=!0,l=!0;for(let e=0;e<3;e++){c&&=Rd[e]>=Bd[e]&&Rd[e]<=Vd[e],l&&=zd[e]>=Bd[e]&&zd[e]<=Vd[e];let t=zd[e]-Rd[e];if(Math.abs(t)<1e-10){(Rd[e]<Bd[e]||Rd[e]>Vd[e])&&(i=-1);continue}let r=(Bd[e]-Rd[e])/t,a=(Vd[e]-Rd[e])/t,u=-1;r>a&&([r,a]=[a,r],u=1),r>n&&(n=r,o=e,s=u),i=Math.min(i,a)}if(!c&&o>=0&&n<=i&&n>=0&&n<=1)(!g||n<g.time)&&(g={axis:o,sign:s,bound:s<0?Bd[o]:Vd[o],time:n,angle:t,gap:zd[1],endInside:l});else if(l)for(let e=0;e<3;e++)for(let n of[-1,1]){let i=n<0?Bd[e]:Vd[e],o=n*(i-zd[e])*(e===1?1/p:e===2?a:1);o<1e-7||Ud(e===0?i:zd[0],e===1?i:zd[1],e===2?i:zd[2],r,m,h)||(!g||g.time===0&&o<g.depth)&&(g={axis:e,sign:n,bound:i,time:0,depth:o,angle:t,gap:zd[1],endInside:!0})}}}if(!g)return!1;let _=g,v=_.angle,y=_.gap,b=a;_.endInside||(b=o+(a-o)*_.time,v=_.angle+f*(1-_.time),y=Pd.y+(Z.y-Pd.y)*_.time-J.height+Od*v),_.axis===0?b=_.bound:_.axis===1?y=_.bound:v=_.bound;let x=Math.cos(v),S=Math.sin(v);if(_.axis===0?e.normal(x*_.sign,0,S*_.sign,Fd):_.axis===1?e.normal(-Od*S/Math.max(b,.1)*_.sign,_.sign,Od*x/Math.max(b,.1)*_.sign,Fd):e.normal(-S*_.sign,0,x*_.sign,Fd),_.endInside){let e=_.axis===0?_.sign*(_.bound-a):_.axis===1?_.sign*(_.bound-_.gap)/p:_.sign*(_.bound-_.angle)*a;Gd(t,n,Fd,Math.max(0,e)+1e-5,i)}else{e.point(Ld.set(x*b,J.height-Od*v+y,S*b),Id);let r=t.clone().sub(n);t.copy(Id).addScaledVector(Fd,1e-5);let a=r.dot(Fd);r.addScaledVector(Fd,-Math.min(0,a)).multiplyScalar(i?.995:1),n.copy(t).sub(r)}}return!0}function Gd(e,t,n,r,i){if(r<=0)return;let a=e.x-t.x,o=e.y-t.y,s=e.z-t.z,c=a*n.x+o*n.y+s*n.z,l=i?.995:1;e.addScaledVector(n,r),t.set(e.x-(a-c*n.x)*l,e.y-(o-c*n.y)*l,e.z-(s-c*n.z)*l)}function Kd(e){let t=Math.min(1,Math.max(0,e/X.cupRadius));return X.cupY+(X.rim-X.cupY)*t**3}var qd=[];for(let e=0;e<=20;e++){let t=e/20*X.cupRadius;qd.push([t,Kd(t)])}for(let e=20;e>=0;e--){let t=e/20*X.cupRadius;qd.push([t+e/20*.07,Kd(t)-.11])}var Jd=[[0,X.rim+.055,X.cupZ+X.cupRadius],[0,X.pivotY,X.pivotZ],[0,X.pivotY+.46,X.pivotZ+1.08]],Yd=[],Xd=[],Zd=new Gi(Jd.map(e=>new V(...e))).getPoints(28);for(let e=1;e<Zd.length;e++)Yd.push([Zd[e-1].toArray(),Zd[e].toArray(),.095]);for(let e of[-1,1]){let t=e*X.frameHalfWidth,n=[t,.24,.03],r=[t,X.pivotY,X.pivotZ],i=[t,.24,1.28];Yd.push([n,r,.075],[r,i,.075],[i,n,.075]),Yd.push([[e*.7,.35,X.handleZ],[e*X.handleX,.35,X.handleZ],.075],[[e*X.handleX,.35,X.handleZ],[e*X.handleX,.65,X.handleZ],.12]),Xd.push([[e*X.handleX,.69,X.handleZ],.19],[[e*.55,X.pivotY,X.pivotZ],.14])}Yd.push([[-.52,X.pivotY,X.pivotZ],[.52,X.pivotY,X.pivotZ],.1]);var Qd=[[0,.03],[X.baseRadius+.05,.03],[X.baseRadius,.23],[0,.23]],$d=[[0,.165],[.35,.165],[.32,.295],[0,.295]],ef=[[0,.27],[.265,.27],[.255,.42],[0,.42]];function tf(e,t,n,r){for(let i=1;i<n.length;i++){let a=n[i-1],o=n[i],s=o[0]-a[0],c=o[1]-a[1],l=Math.max(0,Math.min(1,((e-a[0])*s+(t-a[1])*c)/(s*s+c*c||1)));if((e-a[0]-l*s)**2+(t-a[1]-l*c)**2<=r*r)return!0}return!1}var nf=new V;function rf(e,t,n){e.local(t,nf);let r=nf.x,i=nf.y,a=nf.z,o=n+.02;if(i<-.15-o||i>X.pivotY+.6+o||Math.abs(r)>1.8+o||Math.abs(a)>2+o)return!1;let s=Math.hypot(r,a-X.cupZ);if(s<X.cupRadius+.1+o&&i<X.rim+.06+o&&i>X.cupY-.12-o&&(tf(s,i,qd,o)||Math.hypot(s-X.cupRadius,i-X.rim)<.045+o)||tf(Math.hypot(r,a-X.pivotZ),i,Qd,o))return!0;let c=Math.hypot(r-X.buttonX,a-X.buttonZ);if(tf(c,i,$d,o)||tf(c,i,ef,o))return!0;for(let[e,t,n]of Yd){let s=t[0]-e[0],c=t[1]-e[1],l=t[2]-e[2],u=Math.max(0,Math.min(1,((r-e[0])*s+(i-e[1])*c+(a-e[2])*l)/(s*s+c*c+l*l)));if((r-e[0]-u*s)**2+(i-e[1]-u*c)**2+(a-e[2]-u*l)**2<=(n+o)**2)return!0}for(let[e,t]of Xd)if((r-e[0])**2+(i-e[1])**2+(a-e[2])**2<=(t+o)**2)return!0;return!1}function af(e){return new V(...e)}var of=class{constructor(e){this.object=e,this.type=e.type,this.id=e.id,this.up=af(e.dir),this.origin=this.up.clone().multiplyScalar(10);let t=Math.abs(this.up.x)>.85?new V(0,0,1):new V(1,0,0),n=t.addScaledVector(this.up,-t.dot(this.up)).normalize(),r=new V().crossVectors(n,this.up).normalize(),i=Math.cos(e.rotation),a=Math.sin(e.rotation);this.right=n.clone().multiplyScalar(i).addScaledVector(r,-a),this.front=n.clone().multiplyScalar(a).addScaledVector(r,i),this.quaternion=new kt().setFromRotationMatrix(new Zt().makeBasis(this.right,this.up,this.front));let o=Uu[this.type].height;this.boundCenter=this.origin.clone().addScaledVector(this.up,o*.5),this.boundRadius=Math.hypot(Uu[this.type].radius,o*.5)+.3,this.compression=0,this.q=new V,this.pq=new V,this.n=new V}local(e,t=new V){return t.copy(e).sub(this.origin),t.set(t.dot(this.right),t.dot(this.up),t.dot(this.front))}point(e,t=new V){return t.copy(this.origin).addScaledVector(this.right,e.x).addScaledVector(this.up,e.y).addScaledVector(this.front,e.z)}normal(e,t,n,r=this.n){return r.copy(this.right).multiplyScalar(e).addScaledVector(this.up,t).addScaledVector(this.front,n).normalize()}},sf=Math.PI*2*J.turns,cf=(J.height-J.exit)/sf;function lf(e,t,n,r,i,a){let o=e.local(t,e.q),s=Math.atan2(o.z,o.x);for(;s-i>Math.PI;)s-=Math.PI*2;for(;s-i<-Math.PI;)s+=Math.PI*2;if(s<0||s>sf)return;let c=Math.hypot(o.x,o.z),l=J.height-cf*s,u=J.radius-J.halfWidth,d=J.radius+J.halfWidth,f=o.y-l;if(f<-1.2||f>J.rail+r||c<u-.5||c>d+.5)return;if(f<r){let i=Math.sqrt(1+(cf/Math.max(c,.3))**2);df(t,n,e.normal(-cf*o.z/(c*c),1,cf*o.x/(c*c)),r-f/i,.995,a)}e.local(t,o);let p=Math.hypot(o.x,o.z);o.y-l>J.rail+r||(p<u+r&&df(t,n,e.normal(o.x/p,0,o.z/p),u+r-p,.995,a),p>d-r&&df(t,n,e.normal(-o.x/p,0,-o.z/p),p-d+r,.995,a))}function uf(e,t=0,n=new V){let r=J.radius+t;return n.set(Math.cos(e)*r,J.height-cf*e,Math.sin(e)*r)}function df(e,t,n,r,i,a){if(r<=0)return;e.addScaledVector(n,r);let o=e.x-t.x,s=e.y-t.y,c=e.z-t.z,l=o*n.x+s*n.y+c*n.z,u=a?i:1;t.set(e.x-(o-l*n.x)*u,e.y-(s-l*n.y)*u,e.z-(c-l*n.z)*u)}function ff(e,t,n,r,i,a,o=.95){let s=e.local(t,e.q).y-a;s<r&&df(t,n,e.up,r-s,o,i)}function pf(e,t,n,r,i=!0){if(e.type===`slide`){Wd(e,t,n,r,i);return}let a=e.local(t,e.q),o=e.local(n,e.pq),s=Math.hypot(a.x,a.z),c=Uu[e.type];if(!(s>c.radius+r+.35||a.y>c.height+r+.5||a.y<-.6)){if(e.type===`bed`||e.type===`pad`){let o=Math.atan2(s,10+a.y)*10/c.radius;if(o>=1)return;let l=t.clone().normalize(),u=10+ed(e.type,o,Math.atan2(a.z,a.x),e.compression),d=t.length();d<u+r&&df(t,n,l,u+r-d,.94,i);return}if(e.type!==`plant`){if(e.type===`catapult`){let s=a.z-X.cupZ,c=Math.hypot(a.x,s),l=e.launchTime==null||e.launchTime>=.8;if(l&&c<X.cupRadius+r&&a.y>X.cupY-.3-r&&a.y<X.rim+r){let l=Kd(c),u=Kd(Math.hypot(o.x,o.z-X.cupZ)),d=3*(X.rim-X.cupY)*Math.min(c,X.cupRadius)**2/X.cupRadius**3,f=Math.sqrt(1+d*d),p=e.normal(-d*a.x/Math.max(c,.001),1,-d*s/Math.max(c,.001));o.y>=u-.08?df(t,n,p,r-(a.y-l)/f,.98,i):a.y<l-.04&&df(t,n,p.negate(),r+(a.y-l+.12)/f,.98,i)}if(l&&c>X.cupRadius-r&&c<X.cupRadius+.08+r&&a.y>X.rim-.2&&a.y<X.rim+r){let l=c<X.cupRadius+.04;o.y>=X.rim?ff(e,t,n,r,i,X.rim,.98):df(t,n,e.normal(a.x/c*(l?-1:1),0,s/c*(l?-1:1)),l?c-X.cupRadius+r:X.cupRadius+.08+r-c,.98,i)}Math.hypot(a.x,a.z-X.pivotZ)<X.baseRadius&&a.y<.24+r&&ff(e,t,n,r,i,.24,.95);return}if(e.type===`rock`){let a=e.point(new V(0,.22,0)),o=t.clone().sub(a),s=o.length(),c=.76+r;s<c&&df(t,n,o.normalize(),c-s,.9,i);return}if(e.type===`pool`){s<Y.outer+r&&a.y<Y.bottom+r&&ff(e,t,n,r,i,Y.bottom,.94),e.local(t,a);let c=Math.hypot(a.x,a.z);if(c>Y.inner-r&&c<Y.outer+r&&a.y<Y.rim+r){if(o.y>=Y.rim-.05&&a.y>Y.rim-r*2){ff(e,t,n,r,i,Y.rim,.93);return}let s=c<(Y.inner+Y.outer)*.5,l=e.normal(a.x/Math.max(c,.001),0,a.z/Math.max(c,.001));s&&l.negate(),df(t,n,l,s?c-(Y.inner-r):Y.outer+r-c,.96,i)}return}}}}function mf(e,t,n=Y.level){let r=Math.max(0,Math.min(t*2,n-(e-t)));return r*r*(3*t-r)/(4*t**3)}var hf=class extends Td{constructor(e){super({radius:10}),this.frames=[],this.floaters=[],this.syncObjects(e)}syncObjects(e){let t=new Map(this.frames.map(e=>[e.id,e])),n=new Map(this.floaters.map(e=>[e.poolId,e]));this.frames=e.map(e=>{let n=new of(e);return n.launchTime=t.get(e.id)?.launchTime,n}),this.floaters=[];for(let e of this.frames)if(e.type===`pool`){let r=n.get(e.id),i=t.get(e.id);if(r&&i){let t=i.local(r.pos);e.point(t,r.pos),r.velocity.set(0,0,0),r.frame=e,this.floaters.push(r)}else this.floaters.push(new Af(e))}}frame(e){return this.frames.find(t=>t.id===e)}resolveParticle(e,t,n,r=!0){super.resolveParticle(e,t,n,r);for(let i of this.frames)pf(i,e,t,n,r)}},gf=class{constructor(e,t){this.world=e,this.body=t,this.frames=[],this.others=[],this.decks=new Map}prepare(e){let t=0;for(let e=0;e<this.body.shellCount;e++)t=Math.max(t,this.body.pos[e].distanceTo(this.body.com));this.frames=this.world.frames.filter(e=>e.boundCenter.distanceTo(this.body.com)<e.boundRadius+t+.5),this.decks.clear();for(let e of this.frames)if(e.type===`slide`){let t=e.local(this.body.com),n=Math.hypot(t.x,t.z);if(n>J.radius-J.halfWidth&&n<J.radius+J.halfWidth){let n=Math.atan2(t.z,t.x);n<0&&(n+=Math.PI*2);for(let r=n;r<=Math.PI*2*J.turns;r+=Math.PI*2){let n=J.height-(J.height-J.exit)*r/(Math.PI*2*J.turns),i=t.y-n;if(i>=0&&i<2.4){this.decks.set(e.id,r);break}}}}this.others=e.filter(e=>e.body!==this.body).map(e=>({com:e.body.com,radius:e.body.radius*.7}))}resolveParticle(e,t,n,r){Td.prototype.resolveParticle.call(this.world,e,t,n,r);for(let i of this.frames)pf(i,e,t,n,r),this.decks.has(i.id)&&lf(i,e,t,n,this.decks.get(i.id),r);for(let i of this.others)xd(e,t,n,i.com,i.radius,.98,r);for(let i of this.world.floaters)e.distanceToSquared(i.pos)<1.3&&xd(e,t,n,i.pos,i.radius,.99,r)}};function _f(e){return new of({id:`body`,type:`bed`,dir:e,rotation:0})}function vf(e,t,n){if(t===`slime`)return e.clone().multiplyScalar(n);let r=(Math.abs(e.x)**6+Math.abs(e.y)**6+Math.abs(e.z)**6)**(1/6);return e.clone().multiplyScalar(n*.83/r)}function yf(e,t,n,r){let i=Wu[n],a=_f(r),o=a.origin.clone().addScaledVector(a.up,i.radius+.4),s=new vd(e,o,i.radius,{subdivisions:2,externalFace:!0,gravityCenter:t.center,gravityStrength:6.5,particleRadius:.085,returnRadius:30,returnStrength:1.7,shellStiffness:i.shell,centerStiffness:i.center,pressureK:i.pressure,velDamp:i.damping,gelColor:i.color,gelOpacity:1}),c=e=>{let t=vf(e.clone().normalize(),n,i.radius);return a.right.clone().multiplyScalar(t.x).addScaledVector(a.up,t.y).addScaledVector(a.front,t.z)};for(let e=0;e<s.shellCount;e++)s.pos[e].copy(c(s.pos[e].clone().sub(o))).add(o),s.prev[e].copy(s.pos[e]);for(let e of s.springs)e.rest=s.pos[e.a].distanceTo(s.pos[e.b]);s.restVolume=s._volume();let l=s.geo.attributes.position,u=new V;for(let e=0;e<l.count;e++)u.fromBufferAttribute(l,e).copy(c(u)),l.setXYZ(e,u.x,u.y,u.z);s._bindMesh(),s.mesh.material.dispose(),s.mesh.material=new go({color:i.color,roughness:n===`jelly`?.12:.17,metalness:0,clearcoat:1,clearcoatRoughness:.1,transmission:n===`jelly`?.82:.38,thickness:n===`jelly`?1.8:.7,ior:n===`jelly`?1.38:1.33,attenuationColor:new W(n===`jelly`?`#a31843`:`#a0ecf4`),attenuationDistance:n===`jelly`?3.1:4.5}),s.mesh.renderOrder=2,s.mesh.receiveShadow=!0,s.outline.visible=!1,s.core.visible=!1;let d={type:n,species:n,body:s,view:new gf(t,s),age:0,padContacts:new Map,padCooldown:new Map,slide:null,pool:null};d.view.prepare([d]);for(let e=0;e<90;e++)s.clearForces(),s.update(1/60,d.view);return d}function bf(e,t,n){Cf(e),e.loaded=null;let r=e.body,i=r.com.clone(),a=new kt().setFromUnitVectors(i.clone().normalize(),n);for(let e=0;e<r.pos.length;e++)r.pos[e].sub(i).applyQuaternion(a).add(t),r.prev[e].copy(r.pos[e]);r.com.copy(t),r.prevCom.copy(t),r.velocity.set(0,0,0),r._acc=0,r.endGrab(),r.clearForces(),r.update(0,e.view),e.slide=null,e.pool=null,e.padContacts.clear(),e.padCooldown.clear(),e.skinPrevious=null}function xf(e){let t=e.body,n=e.view.frames.filter(e=>e.type===`slide`);if(!n.length){e.skinPrevious=null;return}let r=t.geo.attributes.position;e.skinPrevious??=Array.from({length:r.count},()=>null);let i=new V;for(let a=0;a<r.count;a++){i.fromBufferAttribute(r,a).add(t.com);let o=e.skinPrevious[a]??i.clone();for(let t of n)Wd(t,i,o,.065,!1),e.view.decks.has(t.id)&&lf(t,i,o,.065,e.view.decks.get(t.id),!1);e.skinPrevious[a]=o.copy(i),i.sub(t.com),r.setXYZ(a,i.x,i.y,i.z)}if(!e.skinSamples){e.skinSamples=[];let n=t.geo.index;for(let t=0;t<n.count;t+=3){let r=n.getX(t),i=n.getX(t+1),a=n.getX(t+2);e.skinSamples.push([r,i,a],[r,i],[i,a],[a,r])}}let a=new V,o=new V,s=new V,c=new V;for(let i=0;i<5;i++){let i=0;for(let l of e.skinSamples){a.set(0,0,0);for(let e of l)a.add(c.fromBufferAttribute(r,e));if(a.multiplyScalar(1/l.length).add(t.com),n.some(e=>Hd(e,a))){o.copy(a),s.copy(a);for(let t of n)Wd(t,a,s,.065,!1),e.view.decks.has(t.id)&&lf(t,a,s,.065,e.view.decks.get(t.id),!1);a.sub(o);for(let e of l)c.fromBufferAttribute(r,e).add(a),r.setXYZ(e,c.x,c.y,c.z);i++}}if(!i)break}for(let n=0;n<r.count;n++)e.skinPrevious[n].fromBufferAttribute(r,n).add(t.com);r.needsUpdate=!0,t.geo.computeVertexNormals(),t.geo.computeBoundingSphere()}function Sf(e,t,n=[]){let r=e.body.radius,i;if(t.type===`slide`)i=uf(J.startAngle).add(new V(0,r+.3,0));else if(t.type===`pool`)i=new V(-.5,Y.level+r+.25,0);else if(t.type===`catapult`){let a=wf(n.filter(t=>t!==e),t);if(i=new V(0,X.cupY+r+.1,X.cupZ),a.length){let e=t.local(a[0].body.com).x>0?-1:1;i.set(e*(X.cupRadius+.25),X.rim+r+.45,X.cupZ)}}else i=new V(0,.65+r+.1,0);bf(e,t.point(i),t.up),t.type===`slide`&&(e.slide={id:t.id,last:J.startAngle,angle:J.startAngle,travel:0,lowest:J.height,started:!0}),t.type===`catapult`&&(e.loaded={id:t.id,age:0})}function Cf(e){e.flight&&(e.lastFlight={angle:e.flight.angle,time:e.flight.time},e.flight=null,e.body.gravityStrength=6.5,e.body.gravityFalloffR=null,e.body.gravityFalloffP=2,e.body.velDamp=Wu[e.type].damping)}function wf(e,t){return t.type!==`catapult`||t.launchTime!=null&&t.launchTime<.8?[]:e.filter(e=>!e.flight&&!e.body.grabActive&&e.body.pos.slice(0,e.body.shellCount).some(n=>rf(t,n,e.body.particleRadius)))}function Tf(e,t,n,r){let i=e.frame(n);if(!i||i.type!==`catapult`||!Number.isFinite(r)||i.launchTime!=null&&i.launchTime<.8)return!1;let a=wf(t,i),o=new kt().setFromAxisAngle(i.up,r);i.object.rotation=(i.object.rotation+r)%(Math.PI*2);let s=new of(i.object);s.launchTime=i.launchTime,e.frames[e.frames.indexOf(i)]=s;for(let e of a){let t=e.body;for(let e=0;e<t.pos.length;e++)t.pos[e].sub(i.origin).applyQuaternion(o).add(i.origin),t.prev[e].sub(i.origin).applyQuaternion(o).add(i.origin);t.com.sub(i.origin).applyQuaternion(o).add(i.origin),t.prevCom.sub(i.origin).applyQuaternion(o).add(i.origin),t.velocity.applyQuaternion(o),e.skinPrevious=null,t.update(0,e.view)}return!0}function Ef(e,t){let n=wf(e,t);for(let e of n)Df(e,t);return n.length&&(t.launchTime=0),n}function Df(e,t){let n=e.body;n.endGrab();let r=n.com.clone().normalize(),i=t.front.clone().negate();i.addScaledVector(r,-i.dot(r)).normalize();let a=n.com.length(),o=X.speed*Math.sqrt(X.gravity*a);n.gravityStrength=X.gravity,n.gravityFalloffR=a*X.falloff,n.gravityFalloffP=X.power,n.velDamp=1;for(let e=0;e<n.pos.length;e++)n.prev[e].copy(n.pos[e]);n.addVelocity(i.clone().multiplyScalar(Math.cos(X.angle)*o).addScaledVector(r,Math.sin(X.angle)*o)),e.flight={time:0,angle:0,lastDir:r.clone(),normal:new V().crossVectors(r,i).normalize(),maxRadius:a},e.loaded=null,e.slide=null,e.lastFlight=null}function Of(e,t){let n=e.body,r=Wu[e.type],i=new V,a=new V,o=new V,s=0;for(let e=0;e<n.shellCount;e++){if(t.local(n.pos[e],i),Math.hypot(i.x,i.z)>Y.inner-.02||i.y<Y.bottom-.25||i.y>Y.rim+n.radius*2)continue;a.copy(n.pos[e]).normalize().multiplyScalar(6.5).addScaledVector(t.up,-6.5),n.ext[e].add(a);let c=Ot.clamp((Y.level-i.y)/.25,0,1);c<=0||(s++,n.ext[e].addScaledVector(t.up,6.5/r.density*c),o.copy(n.pos[e]).sub(n.prev[e]).multiplyScalar(120),n.ext[e].addScaledVector(o,-2.1*c))}return s/n.shellCount}function kf(e,t,n,r=()=>{}){for(let e of t.frames)e.compression*=Math.exp(-n*6),e.launchTime!=null&&(e.launchTime+=n);for(let i of e){let a=i.body,o=Wu[i.type];i.age+=n,i.view.prepare(e),a.clearForces(),i.pool=null,i.flight&&a.grabActive&&Cf(i);let s=!1;for(let e of i.view.frames){let t=e.local(a.com),c=Math.hypot(t.x,t.z);if(e.type===`pool`){let t=Of(i,e);t>.05&&(i.pool={id:e.id,submerged:t})}if(e.type===`slide`&&c<Uu.slide.radius+1.2&&t.y>-.1&&t.y<J.height+a.radius*2&&(s=!0),e.type===`pad`||e.type===`bed`){let t=Math.min(...a.pos.slice(0,a.shellCount).map(t=>e.local(t).y)),s=c<Uu[e.type].radius*.66&&t<.68&&!a.grabActive;s&&(e.compression=Math.min(1,e.compression+n*5));let l=Math.max(0,(i.padCooldown.get(e.id)??0)-n);i.padCooldown.set(e.id,l);let u=s?(i.padContacts.get(e.id)??0)+n:0;i.padContacts.set(e.id,u),e.type===`pad`&&u>.5&&l===0&&a.velocity.dot(e.up)<.4&&(a.addVelocity(e.up.clone().multiplyScalar(o.spring)),i.padCooldown.set(e.id,3.2),i.padContacts.set(e.id,0),r(`spring`,i.type===`jelly`?1:.65))}}a.velDamp=i.flight?1:s?.9985:o.damping,a.update(n,i.view),xf(i);let c=i.view.frames.find(e=>e.type===`catapult`&&wf([i],e).length);if(i.loaded=c?{id:c.id,age:i.loaded?.id===c.id?i.loaded.age+n:0}:null,i.flight){let e=i.flight,t=a.com.clone().normalize();e.time+=n,e.angle+=Math.atan2(new V().crossVectors(e.lastDir,t).dot(e.normal),e.lastDir.dot(t)),e.lastDir.copy(t),e.maxRadius=Math.max(e.maxRadius,a.com.length()),(e.time>X.maxTime||e.time>.7&&(a.com.length()<10+a.radius*.95||i.pool))&&Cf(i)}if(i.slide){let e=t.frame(i.slide.id);if(!e)i.slide=null;else{let t=e.local(a.com),n=Math.atan2(t.z,t.x),r=n-i.slide.last;for(;r>Math.PI;)r-=Math.PI*2;for(;r<-Math.PI;)r+=Math.PI*2;i.slide.angle+=r,i.slide.travel+=Math.max(0,r),i.slide.last=n,i.slide.lowest=Math.min(i.slide.lowest,t.y)}}}for(let r of t.floaters)r.update(n,e)}var Af=class{constructor(e){this.poolId=e.id,this.frame=e,this.radius=.32,this.density=.32,this.pos=e.point(new V(.85,Y.level+.6,.65)),this.velocity=new V,this.held=!1}update(e,t=[]){if(this.held)return;let n=this.frame,r=n.local(this.pos),i=Math.hypot(r.x,r.z)<Y.inner,a=i&&r.y>-.1?n.up:this.pos.clone().normalize(),o=i?mf(r.y,this.radius):0;this.velocity.addScaledVector(a,(-6.5+6.5*o/this.density)*e),this.velocity.multiplyScalar(Math.exp(-e*(.08+o*2.5)));for(let n of t){let t=this.pos.clone().sub(n.body.com),r=t.length(),i=n.body.radius*.7+this.radius;r>.01&&r<i&&(t.multiplyScalar(1/r),this.velocity.addScaledVector(t,(i-r)*6*e))}let s=this.velocity.length();s>12&&this.velocity.multiplyScalar(12/s);let c=this.pos.clone();this.pos.addScaledVector(this.velocity,e),xd(this.pos,c,this.radius,new V,10,.97,!0),pf(n,this.pos,c,this.radius,!0),this.velocity.copy(this.pos).sub(c).divideScalar(e)}},jf=class extends Pn{constructor(){super(),this.name=`RoomEnvironment`,this.position.y=-3.5;let e=new Ni;e.deleteAttribute(`uv`);let t=new ho({side:1}),n=new ho,r=new $o(16777215,900,28,2);r.position.set(.418,16.199,.3),this.add(r);let i=new Xr(e,t);i.position.set(-.757,13.219,.717),i.scale.set(31.713,28.305,28.591),this.add(i);let a=new ci(e,n,6),o=new Tn;o.position.set(-10.906,2.009,1.846),o.rotation.set(0,-.195,0),o.scale.set(2.328,7.905,4.651),o.updateMatrix(),a.setMatrixAt(0,o.matrix),o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),o.updateMatrix(),a.setMatrixAt(1,o.matrix),o.position.set(6.167,.857,7.803),o.rotation.set(0,.561,0),o.scale.set(3.927,6.285,3.687),o.updateMatrix(),a.setMatrixAt(2,o.matrix),o.position.set(-2.017,.018,6.124),o.rotation.set(0,.333,0),o.scale.set(2.002,4.566,2.064),o.updateMatrix(),a.setMatrixAt(3,o.matrix),o.position.set(2.291,-.756,-2.621),o.rotation.set(0,-.286,0),o.scale.set(1.546,1.552,1.496),o.updateMatrix(),a.setMatrixAt(4,o.matrix),o.position.set(-2.193,-.369,-5.547),o.rotation.set(0,.516,0),o.scale.set(3.875,3.487,2.986),o.updateMatrix(),a.setMatrixAt(5,o.matrix),this.add(a);let s=new Xr(e,Mf(50));s.position.set(-16.116,14.37,8.208),s.scale.set(.1,2.428,2.739),this.add(s);let c=new Xr(e,Mf(50));c.position.set(-16.109,18.021,-8.207),c.scale.set(.1,2.425,2.751),this.add(c);let l=new Xr(e,Mf(17));l.position.set(14.904,12.198,-1.832),l.scale.set(.15,4.265,6.331),this.add(l);let u=new Xr(e,Mf(43));u.position.set(-.462,8.89,14.52),u.scale.set(4.38,5.441,.088),this.add(u);let d=new Xr(e,Mf(20));d.position.set(3.235,11.486,-12.541),d.scale.set(2.5,2,.1),this.add(d);let f=new Xr(e,Mf(100));f.position.set(0,20,0),f.scale.set(1,.1,1),this.add(f)}dispose(){let e=new Set;this.traverse(t=>{t.isMesh&&(e.add(t.geometry),e.add(t.material))});for(let t of e)t.dispose()}};function Mf(e){return new vo({color:0,emissive:16777215,emissiveIntensity:e})}var Nf=(e,t=.55)=>new ho({color:e,roughness:t});function Pf(e,t,n,r=[0,0,0]){let i=new Xr(t,n);return i.position.set(...r),i.castShadow=i.receiveShadow=!0,e.add(i),i}function Ff(e,t,n,r,i){let a=new V(...t),o=new V(...n),s=Pf(e,new Fi(r,r,a.distanceTo(o),10),i,a.clone().add(o).multiplyScalar(.5).toArray());return s.quaternion.setFromUnitVectors(new V(0,1,0),o.sub(a).normalize()),s}function If(e,t,n=0){e.traverse(e=>{e.isMesh&&(e.userData.catapultControl=t,e.userData.turnDirection=n)})}function Lf(e,t){let n=new Dr;return n.setAttribute(`position`,new G(e,3)),n.setIndex(t),n.computeVertexNormals(),n}function Rf(e){let t=document.createElement(`canvas`);t.width=1024,t.height=512;let n=t.getContext(`2d`);n.fillStyle=Hu.ground,n.fillRect(0,0,1024,512);let r=77,i=()=>(r=Math.imul(r,1664525)+1013904223>>>0,r/4294967296);for(let e=0;e<6e3;e++)n.fillStyle=e%3?`rgba(129,105,88,.075)`:`rgba(255,255,244,.3)`,n.beginPath(),n.arc(i()*1024,i()*512,.4+i()*1.8,0,Math.PI*2),n.fill();let a=new ki(t);a.colorSpace=Be;let o=Pf(e,new to(10,96,64),new ho({map:a,roughness:.89}));return o.castShadow=!1,o}function zf(){let e=[],t=[],n=J.halfWidth,r=J.rail,i=J.thickness,a=[[-n-i,-i],[n+i,-i],[n+i,r],[n,r],[n,0],[-n,0],[-n,r],[-n-i,r]];for(let t=0;t<=176;t++)for(let[n,r]of a){let i=uf(t/176*sf,n);e.push(i.x,i.y+r,i.z)}for(let e=0;e<176;e++)for(let n=0;n<a.length;n++){let r=e*8+n,i=e*8+(n+1)%8;t.push(r,r+8,i,r+8,i+8,i)}for(let e of qa.triangulateShape(a.map(e=>new B(...e)),[]))t.push(...e.slice().reverse()),t.push(...e.map(e=>1408+e));return Lf(e,t)}function Bf(e,t=0){let n=[],r=[],i=Uu[e].radius;for(let a=0;a<=14;a++)for(let o=0;o<=64;o++){let s=a/14,c=o/64*Math.PI*2,l=s*i/10;if(n.push(Math.cos(c)*Math.sin(l)*10,Math.cos(l)*(10+ed(e,s,c,t))-10+.018,Math.sin(c)*Math.sin(l)*10),a<14&&o<64){let e=a*65+o;r.push(e,e+64+1,e+1,e+1,e+64+1,e+64+2)}}return Lf(n,r)}var Vf=class{constructor(e,t){this.root=new En,e.add(this.root),this.id=t.id,this.type=t.type,this.compression=0;let n=Nf(`#d4dfd5`,.38),r=Nf(`#d8a0a2`,.36),i=Nf(`#f1e6d3`,.65);if(t.type===`slide`){Pf(this.root,zf(),n).material.side=2,Pf(this.root,new Fi(.2,.2,J.height+.35,24),r,[0,(J.height+.35)/2,0]),Pf(this.root,new to(.29,20,12),r,[0,J.height+.45,0]);for(let e of[-1,1]){let t=Array.from({length:177},(t,n)=>uf(n/176*sf,e*(J.halfWidth+.08)).add(new V(0,J.rail,0)));Pf(this.root,new ro(new Gi(t),176,.055,6,!1),r)}for(let e of Nd)Pf(this.root,new Fi(.07,.1,e.height+.25,10),i,[e.x,e.height/2-.125,e.z])}else if(t.type===`catapult`){let e=Nf(`#b99570`,.65),t=Nf(`#547a7b`,.4),n=Nf(`#ded2b5`,.32),r=Nf(`#9bc9b5`,.45);Pf(this.root,new Fi(X.baseRadius,X.baseRadius+.05,.2,48),e,[0,.13,X.pivotZ]);let i=Pf(this.root,new no(X.baseRadius-.03,.035,8,48),n,[0,.245,X.pivotZ]);i.rotation.x=Math.PI/2;for(let t of[-1,1]){let n=t*X.frameHalfWidth,r=[n,.24,.03],i=[n,X.pivotY,X.pivotZ],a=[n,.24,1.28];Ff(this.root,r,i,.075,e),Ff(this.root,i,a,.075,e),Ff(this.root,a,r,.075,e)}Ff(this.root,[-.52,X.pivotY,X.pivotZ],[.52,X.pivotY,X.pivotZ],.1,t);for(let e of[-.55,.55])Pf(this.root,new to(.14,16,10),n,[e,X.pivotY,X.pivotZ]);this.arm=new En,this.arm.position.set(0,X.pivotY,X.pivotZ),this.root.add(this.arm);let a=Jd.map(e=>new V(...e).sub(new V(0,X.pivotY,X.pivotZ)));Pf(this.arm,new ro(new Gi(a),28,.095,10,!1),e);let o=qd.map(([e,t])=>new B(e,t-X.cupY)),s=new En;s.position.set(0,X.cupY-X.pivotY,X.cupZ-X.pivotZ),this.arm.add(s),Pf(s,new Xa(o,64),t).material.side=2;let c=Pf(s,new no(X.cupRadius,.045,10,64),n,[0,X.rim-X.cupY,0]);c.rotation.x=Math.PI/2,If(s,`load`);for(let e of[-1,1]){let i=new En;this.root.add(i),Ff(i,[e*.7,.35,X.handleZ],[e*X.handleX,.35,X.handleZ],.075,n),Pf(i,new Fi(.12,.12,.3,16),t,[e*X.handleX,.5,X.handleZ]),Pf(i,new to(.19,18,12),r,[e*X.handleX,.69,X.handleZ]),If(i,`turn`,e)}let l=new En;l.position.set(X.buttonX,.23,X.buttonZ),this.root.add(l),Pf(l,new Fi(.32,.35,.13,32),n),this.buttonCap=new En,this.buttonCap.position.y=.115,l.add(this.buttonCap),Pf(this.buttonCap,new Fi(.255,.265,.15,32),Nf(`#da8070`,.33));let u=new fa;u.moveTo(-.075,-.09),u.lineTo(.11,0),u.lineTo(-.075,.09),u.closePath();let d=Pf(this.buttonCap,new $a(u),new Rr({color:`#fff0d8`}),[0,.078,0]);d.rotation.x=-Math.PI/2,If(l,`fire`)}else if(t.type===`pool`){Pf(this.root,new Fi(Y.outer,Y.outer,.18,80),i,[0,.07,0]);let e=[[Y.inner,.16],[Y.inner,Y.rim],[Y.outer,Y.rim],[Y.outer,-.5],[Y.inner,-.5],[Y.inner,.16]].map(e=>new B(...e)),t=Pf(this.root,new Xa(e,80),new go({color:`#bdcfd0`,transparent:!0,opacity:.27,roughness:.16,metalness:.05,side:2,depthWrite:!1}));t.renderOrder=3;for(let e of[.18,Y.rim]){let t=Pf(this.root,new no((Y.inner+Y.outer)/2,.16,10,80),i,[0,e,0]);t.rotation.x=Math.PI/2}let n=new go({color:Hu.water,transparent:!0,opacity:.44,roughness:.19,metalness:.12,clearcoat:1,side:2,depthWrite:!1});n.onBeforeCompile=e=>{e.uniforms.uTime={value:0},this.waterShader=e,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
varying vec3 vWater;`).replace(`#include <begin_vertex>`,`#include <begin_vertex>
vWater=position;`),e.fragmentShader=e.fragmentShader.replace(`#include <common>`,`#include <common>
varying vec3 vWater;uniform float uTime;`).replace(`#include <color_fragment>`,`#include <color_fragment>
float w=pow(max(0.,sin(vWater.x*8.+sin(vWater.y*6.+uTime*.5)+uTime*.8)),18.);diffuseColor.rgb+=vec3(.07,.10,.12)*w;`)},this.water=Pf(this.root,new Pi(Y.inner,80),n,[0,Y.level,0]),this.water.rotation.x=-Math.PI/2,this.water.castShadow=!1,this.water.renderOrder=4,this.ball=Pf(this.root,new to(.32,24,16),Nf(`#ba8054`,.38));let r=Pf(this.ball,new no(.318,.015,5,32),Nf(`#efcea4`));r.rotation.x=.7}else if(t.type===`bed`||t.type===`pad`)this.cushion=Pf(this.root,Bf(t.type),Nf(Uu[t.type].color,.69)),this.cushion.material.side=2;else if(t.type===`rock`)Pf(this.root,new to(.76,24,16),Nf(Hu.stone,.87),[0,.22,0]);else if(t.type===`plant`){Pf(this.root,new to(.72,24,12),Nf(`#a3ae87`,.9)).scale.set(1,.16,1);for(let e=0;e<7;e++){let t=new En;t.rotation.y=e*2.4,this.root.add(t);let n=Pf(t,new to(1,14,10),Nf(e%3?Hu.leaf:Hu.plum,.8),[0,.55,.17]);n.scale.set(.17,.7,.105),n.rotation.x=.38+e%3*.2}}this.root.traverse(e=>{e.isMesh&&(e.userData.objectId=t.id)}),this.update(t)}update(e,t=null,n=0){this.frame=t??new of(e),this.root.position.copy(this.frame.origin),this.root.quaternion.copy(this.frame.quaternion),this.arm&&(this.arm.rotation.x=this.frame.launchTime!=null&&this.frame.launchTime<.8?Math.sin(this.frame.launchTime/.8*Math.PI)*.7:0),this.buttonCap&&(this.buttonCap.position.y=.115-(this.buttonHeld||this.frame.launchTime!=null&&this.frame.launchTime<.16?.09:0)),this.waterShader&&(this.waterShader.uniforms.uTime.value=n),this.cushion&&Math.abs(this.compression-this.frame.compression)>.025&&(this.compression=this.frame.compression,this.cushion.geometry.dispose(),this.cushion.geometry=Bf(this.type,this.compression))}setPreview(e){this.root.traverse(t=>{t.isMesh&&(t.material.transparent=!0,t.material.opacity=.55,t.material.depthWrite=!1,t.material.color.set(e?`#a0e6cf`:`#d97f88`),t.castShadow=!1)})}dispose(){this.root.removeFromParent();let e=new Set;this.root.traverse(t=>{t.isMesh&&(t.geometry.dispose(),e.add(t.material))});for(let t of e)t.dispose()}};function Hf(e){let t=[];for(let e=0;e<=96;e++){let n=e/96*Math.PI*2;t.push(new V(Math.cos(n),0,Math.sin(n)))}let n=new Di(new Dr().setFromPoints(t),new _i({color:Hu.accent,transparent:!0,opacity:.9}));return e.add(n),n.visible=!1,{line:n,show(e,t=!0){let r=new of(e),i=Uu[e.type].radius+.18;n.position.copy(r.origin).addScaledVector(r.up,-i*i/20+.06),n.quaternion.copy(r.quaternion),n.scale.setScalar(i),n.material.color.set(t?Hu.accent:`#f69299`),n.visible=!0}}}function Uf(e,t,n=!0){e.add(new zo(`#e6f1f2`,`#617477`,1.35));let r=new ns(`#fff1d7`,2.8);r.position.set(-8,14,18),r.castShadow=n,r.shadow.mapSize.set(1024,1024),Object.assign(r.shadow.camera,{left:-13,right:13,top:13,bottom:-13,near:1,far:50}),r.shadow.normalBias=.025,r.shadow.bias=-2e-4,e.add(r);let i=new ns(`#addbe6`,1);i.position.set(10,5,-8),e.add(i);let a=new qs(t),o=new jf,s=a.fromScene(o,.035);return e.environment=s.texture,e.environmentIntensity=.45,o.dispose(),a.dispose(),s}var Wf=class{constructor(e){this.resident=e,this.body=e.body,this.time=0;let t=this.body.radius,n=new go({color:`#122b39`,roughness:.18,clearcoat:1});this.eyes=[];for(let e of[-1,1]){let r=new Xr(new to(t*.068,16,10),n);r.scale.set(1,1.14,.8);let i=new Xr(new to(t*.018,8,6),new Rr({color:`#fffbea`}));i.position.set(-t*.016,t*.025,t*.058),r.add(i),this.body.group.add(r),this.eyes.push({eye:r,side:e})}let r=new sa(new V(-t*.085,0,0),new V(0,-t*.09,.008),new V(t*.085,0,0));this.mouth=new Xr(new ro(r,16,t*.015,8,!1),n),this.body.group.add(this.mouth)}update(e,t){this.time+=t;let n=this.body,r=n.radius;n.com.clone().normalize();let i=e.position.clone().sub(n.com).normalize(),a=new V().crossVectors(e.up,i).normalize(),o=new V().crossVectors(i,a).normalize(),s=n.geo.attributes.position,c=new V,l=new Zt,u=(e,t,n)=>{let u=i.clone().addScaledVector(a,t).addScaledVector(o,n).normalize(),d=0,f=0;for(let e=0;e<s.count;e++){c.fromBufferAttribute(s,e);let t=c.length(),n=Math.max(0,c.dot(u)/Math.max(.001,t)-.94)**2;d+=n,f+=t*n}e.position.copy(u).multiplyScalar((d?f/d:r)+.025);let p=new V().crossVectors(o,u).normalize(),m=new V().crossVectors(u,p).normalize();l.makeBasis(p,m,u),e.quaternion.setFromRotationMatrix(l)},d=Math.max(0,Math.cos(this.time*1.7))**90;this.eyes.forEach(({eye:e,side:t})=>{u(e,t*.22,.13),e.scale.y=1.14*(1-d*.85)}),u(this.mouth,0,-.07)}},Gf=class{constructor(){this.enabled=!1,this.context=null}unlock(){this.enabled&&(this.context??=new(window.AudioContext||window.webkitAudioContext),this.context.resume())}play(e=`touch`,t=1){if(!this.enabled||!this.context)return;let n=this.context,r=n.currentTime,i=n.createOscillator(),a=n.createGain(),o={touch:240,spring:330,shell:560,birth:520,observe:690}[e]??240;i.type=e===`shell`?`triangle`:`sine`,i.frequency.setValueAtTime(o*t,r),i.frequency.exponentialRampToValueAtTime(o*(e===`spring`?1.8:.58),r+.16),a.gain.setValueAtTime(1e-4,r),a.gain.exponentialRampToValueAtTime(.055*t,r+.012),a.gain.exponentialRampToValueAtTime(1e-4,r+.24),i.connect(a),a.connect(n.destination),i.start(r),i.stop(r+.26)}},Kf=.2,qf=class{constructor(e,t){this.plane=new fi().setFromNormalAndCoplanarPoint(t,e),this.target=e.clone(),this.locked=!1,this.point=new V}get height(){return this.target.length()-10}setHeight(e){return this.locked=!0,this.target.setLength(10+Ot.clamp(e,Kf,12)),this.target}change(e){return this.setHeight(this.height+e)}move(e){if(!e.intersectPlane(this.plane,this.point))return this.target;let t=this.locked?this.height:Ot.clamp(this.point.length()-10,Kf,12);return this.target.copy(this.point).setLength(10+t),this.target}},Q=e=>document.getElementById(e),Jf=Q(`scene`),Yf=Vu,Xf=null;try{Xf=JSON.parse(localStorage.getItem(Yf))}catch{}var Zf=Zu(Xf),Qf=new Pn,$f=new Zo(40,1,.1,180),ep=new Bu({canvas:Jf,alpha:!0,antialias:!0,powerPreference:`high-performance`});ep.setPixelRatio(Math.min(devicePixelRatio||1,1.5)),ep.outputColorSpace=Be,ep.toneMapping=4,ep.toneMappingExposure=.98,ep.shadowMap.enabled=!0,ep.shadowMap.type=1,Uf(Qf,ep);var tp=Rf(Qf),np=new hf(Zf.objects),rp=new Map,ip=Hf(Qf),ap=Object.entries(Zf.residents).map(([e,t])=>yf(Qf,np,e,t.dir)),op=ap.map(e=>new Wf(e)),sp=new Gf,cp=new td,lp=new bs,up=new B,dp=new V,fp=new V,pp=`slime`,mp=null,hp=null,gp=null,_p=null,vp=0,yp=.13,bp=1,xp=45,$=null,Sp=null,Cp=null,wp=0,Tp=0,Ep=0,Dp=0,Op=0,kp=!1,Ap=new Map,jp=null,Mp=new Map,Np=new Ti(new Dr().setFromPoints([new V,new V]),new xo({color:`#a3e7d0`,dashSize:.22,gapSize:.13,transparent:!0,opacity:.8,depthTest:!1}));Np.visible=!1,Np.renderOrder=8,Qf.add(Np);var Pp=new Xr(new Qa(.21,.28,32),new Rr({color:`#a3e7d0`,side:2,transparent:!0,opacity:.9,depthTest:!1}));Pp.visible=!1,Pp.renderOrder=8,Qf.add(Pp);function Fp(){let e=$?.lift;if(!e)return;let t=e.target;$.resident?$.resident.body.setGrabTarget(t,.32):($.ball.pos.copy(t),$.ball.velocity.set(0,0,0));let n=t.clone().normalize(),r=n.clone().multiplyScalar(10.08),i=Np.geometry.attributes.position;i.setXYZ(0,r.x,r.y,r.z),i.setXYZ(1,t.x,t.y,t.z),i.needsUpdate=!0,Np.geometry.computeBoundingSphere(),Np.computeLineDistances(),Pp.position.copy(r),Pp.quaternion.setFromUnitVectors(new V(0,0,1),n),Np.visible=Pp.visible=!0,Q(`height-range`).value=e.height.toFixed(1),Q(`height-value`).textContent=e.height.toFixed(1)}function Ip(e,t){$f.getWorldDirection(fp),$.lift=new qf(e,fp),Q(`grab-height`).hidden=!1,Q(`app`).classList.add(`grabbing`),Q(`height-help`).textContent=t.pointerType===`touch`?`Второй палец ↑↓ — поднять / опустить`:`Колесо ↑↓ · Page Up / Down`,Q(`hint`).textContent=t.pointerType===`touch`?`Держи блоба · вторым пальцем регулируй высоту`:`Держи блоба · колесо поднимает и опускает`,Fp()}function Lp(){jp=null,Np.visible=Pp.visible=!1,Q(`grab-height`).hidden=!0,Q(`app`).classList.remove(`grabbing`),Q(`hint`).textContent=`Потяни блоба · при захвате можно менять высоту`}Q(`height-range`).addEventListener(`input`,e=>{$?.lift&&($.lift.setHeight(Number(e.target.value)),Fp())});var Rp={bed:`<ellipse cx="20" cy="25" rx="16" ry="8"/><path d="M5 24Q20 9 35 24M12 28q8-6 16 0"/>`,pad:`<path d="M6 27Q2 9 20 10T34 27Q20 36 6 27Z"/><path d="M12 22q8-10 16 0"/>`,slide:`<path d="M20 4v32M28 8c14 9-29 5-22 16s38 5 25-4M8 13c-11 12 35 8 25 21"/>`,pool:`<ellipse cx="20" cy="14" rx="16" ry="7"/><path d="M4 14v15c0 10 32 10 32 0V14M7 24q6-6 13 0t13 0"/>`,plant:`<path d="M20 35V13M20 28Q1 25 5 9q16 0 15 19M20 21Q19 4 33 4q5 13-13 17"/>`,rock:`<path d="m4 29 6-17 17-6 10 15-5 13-19 3Z"/><path d="m10 12 11 9 6-15M21 21l11 13"/>`},zp=e=>`<svg viewBox="0 0 40 40" fill="none" stroke="${Uu[e].color}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${Rp[e]}</svg>`;Rp.catapult=`<path d="M6 33h29M11 31V17m18 14V17M9 18h22M20 23 30 7M22 7q7 8 14 0"/>`,Q(`catalog-items`).innerHTML=Object.entries(Uu).map(([e,t])=>`<button data-add="${e}">${zp(e)}<span>${t.name}</span></button>`).join(``);var Bp=document.createElement(`p`);Bp.textContent=`Катапульта: коснись чаши, чтобы добавить выбранного жителя, или положи его вручную. Коралловая кнопка запускает всех блобов, которые касаются катапульты. Можно добавить второго. Потяни боковую ручку для поворота; короткое нажатие поворачивает на один шаг. Во время полёта камера остаётся под твоим управлением.`,Q(`help-panel`).append(Bp);function Vp(e,t=3){Q(`toast`).textContent=e,Q(`toast`).classList.add(`visible`),Ep=t}function Hp(){for(let e of ap)Zf.residents[e.type].dir=e.body.com.clone().normalize().toArray();try{localStorage.setItem(Yf,JSON.stringify(Zf))}catch{kp||=(Vp(`Сохранение недоступно в настройках браузера`,6),!0)}}function Up(){sp.enabled=Zf.sound,Q(`sound`).setAttribute(`aria-pressed`,String(Zf.sound)),Q(`sound`).setAttribute(`aria-label`,Zf.sound?`Выключить звук`:`Включить звук`),Q(`sound`).textContent=Zf.sound?`♫`:`♪`}function Wp(){np.syncObjects(Zf.objects);for(let[e,t]of rp)Zf.objects.some(t=>t.id===e)||(t.dispose(),rp.delete(e));for(let e of Zf.objects)rp.has(e.id)||rp.set(e.id,new Vf(Qf,e)),rp.get(e.id).update(e,np.frame(e.id));Q(`object-count`).textContent=`${Zf.objects.length} / 24`,Q(`object-list`).innerHTML=Zf.objects.filter(e=>Uu[e.type].action).map(e=>`<button data-object="${e.id}" aria-pressed="${mp===e.id}">${{slide:`Горка`,pool:`Вода`,bed:`Лежанка`,pad:`Трамплин`,catapult:`Катапульта`}[e.type]}</button>`).join(``)}function Gp(e){pp=e,document.querySelectorAll(`[data-resident]`).forEach(t=>t.setAttribute(`aria-pressed`,String(t.dataset.resident===e))),mp&&Kp()}function Kp(){let e=Zf.objects.find(e=>e.id===mp);if(!e){Q(`context`).hidden=!0,ip.line.visible=!1;return}let t=Uu[e.type];Q(`context`).hidden=!1,Q(`object-title`).textContent=t.name,Q(`object-hint`).textContent=t.hint,Q(`try-object`).hidden=!t.action,Q(`try-object`).disabled=!1,Q(`try-object`).textContent=`${t.action} · ${Wu[pp].short}`,e.type===`catapult`&&qp(),ip.show(e),document.querySelectorAll(`[data-object]`).forEach(t=>t.setAttribute(`aria-pressed`,String(t.dataset.object===e.id)))}function qp(){let e=ap.find(e=>e.type===pp),t=np.frame(mp),n=t?.launchTime!=null&&t.launchTime<.8,r=wf(ap,t),i=r.includes(e);Q(`try-object`).disabled=n,Q(`try-object`).textContent=n?`Рычаг возвращается`:i?`Запустить${r.length>1?` обоих`:``}`:`${r.length?`Добавить`:`Зарядить`} · ${Wu[pp].short}`}function Jp(e){let t=np.frame(e);if(!t)return;let n=Ef(ap,t);if(!n.length){Vp(`Блобы должны касаться катапульты`);return}Zp(),sp.unlock(),sp.play(`spring`,1),Vp(n.length>1?`Полетели оба!`:`Полетели!`,1.5)}function Yp(e,t){if(Tf(np,ap,e,t)){let t=rp.get(e),n=np.frame(e);return t.update(n.object,n,Tp),!0}return!1}function Xp(e){am(),mp=e,Q(`catalog`).hidden=!0,Q(`help-panel`).hidden=!0,Kp()}function Zp(){mp=null,Q(`context`).hidden=!0,ip.line.visible=!1,document.querySelectorAll(`[data-object]`).forEach(e=>e.setAttribute(`aria-pressed`,`false`))}function Qp(e){let t=np.frame(e);if(t){if(_p=e,vp=.15,yp=.65,bp=1,t.type===`catapult`){let n=[tp,...[...rp.values()].map(e=>e.root),...ap.map(e=>e.body.mesh)],r=new bs,i=[{p:[0,X.rim,X.cupZ],control:`load`},{p:[0,X.pivotY,X.pivotZ]},{p:[X.buttonX,.4,X.buttonZ],control:`fire`},{p:[-X.handleX,.65,X.handleZ],control:`turn`,side:-1},{p:[X.handleX,.65,X.handleZ],control:`turn`,side:1}].map(e=>({...e,point:t.point(new V(...e.p))})),a={yaw:.15,pitch:.65,blocked:1/0};Qf.updateMatrixWorld(!0);for(let[t,o]of[[-1.2,.3],[1.2,.3],[-.65,.55],[.65,.55],[0,.75],[Math.PI,.75],[0,1.1]]){vp=t,yp=o,om();let s=0;for(let t of i){let i=t.point.clone().sub($f.position),a=i.length();r.set($f.position,i.normalize()),r.far=a+.02;let o=r.intersectObjects(n,!0)[0];if(!o)continue;let c=o.object.userData,l=c.objectId===e&&(!t.control||c.catapultControl===t.control&&(t.side==null||c.turnDirection===t.side)),u=t.control===`load`&&ap.some(t=>t.body.mesh===o.object&&t.loaded?.id===e);!l&&!u&&s++}if(s<a.blocked&&(a={yaw:t,pitch:o,blocked:s}),s===0)break}vp=a.yaw,yp=a.pitch}om()}}function $p(){_p=null,vp=0,yp=.13,bp=1,om()}function em(e=mp){let t=np.frame(e),n=ap.find(e=>e.type===pp);if(!(!t||!Uu[t.type].action)){if(dm(),t.type===`catapult`){if(t.launchTime!=null&&t.launchTime<.8)return;if(wf(ap,t).includes(n)){Jp(e);return}Sf(n,t,ap),Qp(e),Kp(),Q(`hint`).textContent=`Можно добавить второго блоба · кнопка запустит всех касающихся`,Hp();return}Sf(n,t),Qp(e),sp.unlock(),sp.play(t.type===`pool`?`touch`:`spring`,.5),Q(`hint`).textContent=t.type===`slide`?`Отпускаем — блоб скатывается сам`:t.type===`pool`?`Потяни за блоба или подхвати деревянный шар`:`Посмотри, как ведёт себя выбранный материал`,Hp()}}function tm(){return ap.map(e=>({dir:e.body.com.clone().normalize().toArray(),radius:e.body.radius}))}function nm(){let e=$f.position.clone().normalize(),t=null,n=-1/0;for(let r=0;r<360;r++){let i=1-2*(r+.5)/360,a=r*2.39996323,o=Math.sqrt(1-i*i),s=[Math.cos(a)*o,i,Math.sin(a)*o];if(Xu({...hp.draft,dir:s},Zf.objects,tm()).ok){let r=af(s).dot(e);r>n&&(t=s,n=r)}}return t}function rm(e){if(dm(),am(),Zp(),Q(`catalog`).hidden=!0,Q(`help-panel`).hidden=!0,hp=new Qu(Zf,e),!hp.original){let e=nm();e&&hp.move(e)}gp=new Vf(Qf,hp.draft),hp.original&&(rp.get(hp.original.id).root.visible=!1),Q(`placement`).hidden=!1,Q(`toolbar`).hidden=!0,Q(`app`).classList.add(`placing`),Q(`placing-name`).textContent=Uu[hp.draft.type].name,im()}function im(){if(!hp)return;let e=Xu(hp.draft,Zf.objects,tm());gp.update(hp.draft),gp.setPreview(e.ok),ip.show(hp.draft,e.ok),Q(`confirm-place`).disabled=!e.ok,Q(`hint`).textContent=e.ok?`Коснись нового места на сфере · поворот мира за пустой фон`:e.reason}function am(){gp&&=(gp.dispose(),null),hp?.original&&(rp.get(hp.original.id).root.visible=!0),hp=null,Q(`placement`).hidden=!0,Q(`toolbar`).hidden=!1,Q(`app`).classList.remove(`placing`),ip.line.visible=!1,Q(`hint`).textContent=`Потяни блоба · при захвате можно менять высоту`}document.querySelectorAll(`[data-resident]`).forEach(e=>e.addEventListener(`click`,()=>Gp(e.dataset.resident))),Q(`object-list`).addEventListener(`click`,e=>{let t=e.target.closest(`[data-object]`)?.dataset.object;t&&Xp(t)}),Q(`catalog-items`).addEventListener(`click`,e=>{let t=e.target.closest(`[data-add]`)?.dataset.add;t&&rm(t)}),Q(`build`).addEventListener(`click`,()=>{let e=Q(`catalog`).hidden;am(),Zp(),Q(`catalog`).hidden=!e}),Q(`close-catalog`).addEventListener(`click`,()=>{Q(`catalog`).hidden=!0}),Q(`confirm-place`).addEventListener(`click`,()=>{if(!hp)return;let e=hp.commit(Zf,tm());if(!e.ok){Vp(e.reason);return}let t=e.id;am(),Wp(),Xp(t),Hp(),Vp(`Место сохранено`,1.7)}),Q(`cancel-place`).addEventListener(`click`,am),Q(`rotate-place`).addEventListener(`click`,()=>{hp?.rotate(),im()}),Q(`close-context`).addEventListener(`click`,Zp),Q(`try-object`).addEventListener(`click`,()=>em()),Q(`focus-object`).addEventListener(`click`,()=>Qp(mp)),Q(`move-object`).addEventListener(`click`,()=>rm(mp)),Q(`delete-object`).addEventListener(`click`,()=>{let e=mp;$u(Zf,e)&&(Zp(),Wp(),_p===e&&$p(),Hp(),Vp(`Предмет убран. Его можно снова добавить.`,2))}),Q(`home`).addEventListener(`click`,$p),Q(`zoom-in`).addEventListener(`click`,()=>{bp=Math.max(.58,bp*.85),om()}),Q(`zoom-out`).addEventListener(`click`,()=>{bp=Math.min(1.65,bp/.85),om()}),Q(`sound`).addEventListener(`click`,()=>{Zf.sound=!Zf.sound,Up(),sp.unlock(),sp.play(`touch`,.5),Hp()}),Q(`help`).addEventListener(`click`,()=>{let e=Q(`help-panel`).hidden;Zp(),Q(`catalog`).hidden=!0,Q(`help-panel`).hidden=!e}),Q(`close-help`).addEventListener(`click`,()=>{Q(`help-panel`).hidden=!0});function om(){let e=_p&&np.frame(_p);if(e){let t=Uu[e.type].height,n=Uu[e.type].radius;dp.copy(e.origin).addScaledVector(e.up,(t+1.12)*.48);let r=Math.atan(Math.tan(Ot.degToRad(20))*Math.min(1,$f.aspect)),i=Math.max(n*1.15,(t+2.3)*.55)/Math.sin(r)*1.12*bp;$f.position.copy(dp).addScaledVector(e.right,Math.sin(vp)*Math.cos(yp)*i).addScaledVector(e.up,Math.sin(yp)*i).addScaledVector(e.front,Math.cos(vp)*Math.cos(yp)*i),$f.up.copy(e.up),$f.lookAt(dp)}else $f.up.set(0,1,0),$f.position.set(Math.sin(vp)*Math.cos(yp),Math.sin(yp),Math.cos(vp)*Math.cos(yp)).multiplyScalar(xp*bp),$f.lookAt(0,.3,0);$f.updateMatrixWorld()}function sm(){let e=Jf.getBoundingClientRect(),t=Math.max(1,e.width),n=Math.max(1,e.height);ep.setSize(t,n,!1),$f.aspect=t/n;let r=Ot.degToRad($f.fov/2),i=Math.atan(Math.tan(r)*$f.aspect);xp=Math.max(13.5/Math.sin(r),13.5/Math.sin(i)),$f.updateProjectionMatrix(),om()}function cm(e){let t=Jf.getBoundingClientRect();up.set((e.clientX-t.left)/t.width*2-1,1-(e.clientY-t.top)/t.height*2),lp.setFromCamera(up,$f),Qf.updateMatrixWorld(!0)}function lm(){return lp.intersectObjects([tp,...ap.map(e=>e.body.mesh),...[...rp.values()].map(e=>e.root)],!0).find(e=>e.object.visible&&(!e.object.parent||e.object.parent.visible))}function um(){return lp.intersectObject(tp,!1)[0]}function dm(){$?.resident&&$.resident.body.endGrab(),$?.ball&&($.ball.held=!1),$?.objectId&&rp.has($.objectId)&&(rp.get($.objectId).buttonHeld=!1),$?.kind===`launcher-turn`&&Hp();let e=[...Ap.keys()];$=null,Sp=null,Ap.clear(),Lp();for(let t of e)Jf.hasPointerCapture(t)&&Jf.releasePointerCapture(t);Jf.style.cursor=``}Jf.addEventListener(`pointerdown`,e=>{if(e.button!==0)return;if(sp.unlock(),Ap.set(e.pointerId,{x:e.clientX,y:e.clientY}),Jf.setPointerCapture(e.pointerId),$?.lift){jp||={id:e.pointerId,y:e.clientY};return}if(Ap.size===2){$?.objectId&&rp.has($.objectId)&&(rp.get($.objectId).buttonHeld=!1),$=null;let e=[...Ap.values()];Sp={distance:Math.hypot(e[0].x-e[1].x,e[0].y-e[1].y),zoom:bp};return}cm(e);let t=lm(),n=um();if($={id:e.pointerId,x:e.clientX,y:e.clientY,startX:e.clientX,startY:e.clientY,kind:`orbit`},hp&&n){$.kind=`place`,hp.move(n.point.clone().normalize().toArray()),im();return}if(hp)return;if(t?.object.userData.catapultControl){let e=t.object.userData,n=e.objectId,r=np.frame(n);if($.objectId=n,$.control=e.catapultControl,$.kind=`launcher-${e.catapultControl}`,$.turnDirection=e.turnDirection,Xp(n),e.catapultControl===`fire`&&(rp.get(n).buttonHeld=!0),e.catapultControl===`turn`){$.reference=new of({...r.object,rotation:0}),$.turnPlane=new fi().setFromNormalAndCoplanarPoint(r.up,t.point);let e=$.reference.local(t.point);$.turnAngle=Math.atan2(e.z,e.x),Jf.style.cursor=`grabbing`,Q(`hint`).textContent=`Потяни ручку по кругу · короткое нажатие поворачивает на шаг`}return}let r=null;for(let e of ap){let t=lp.intersectObject(e.body.mesh,!1)[0];t&&(!n||t.distance<n.distance)&&(!r||t.distance<r.distance)&&(r={...t,resident:e})}let i=null;for(let e of np.floaters){let t=rp.get(e.poolId),r=t?.ball&&lp.intersectObject(t.ball,!0)[0];r&&(!n||r.distance<n.distance)&&(!i||r.distance<i.distance)&&(i={...r,ball:e})}i&&(!r||i.distance<r.distance)?($.kind=`ball`,$.ball=i.ball,$.ball.held=!0,$.ball.velocity.set(0,0,0),Ip($.ball.pos,e)):r?($.kind=`grab`,$.resident=r.resident,Gp(r.resident.type),r.resident.body.beginGrab(r.point),Ip(r.point,e),sp.play(`touch`,.55),Jf.style.cursor=`grabbing`):t?.object.userData.objectId&&($.kind=`object`,$.objectId=t.object.userData.objectId)}),Jf.addEventListener(`pointermove`,e=>{if(Ap.has(e.pointerId)&&Ap.set(e.pointerId,{x:e.clientX,y:e.clientY}),jp?.id===e.pointerId&&$?.lift){$.lift.change((jp.y-e.clientY)*.035),jp.y=e.clientY,Fp();return}if(Sp&&Ap.size>=2){let e=[...Ap.values()],t=Math.hypot(e[0].x-e[1].x,e[0].y-e[1].y);bp=Ot.clamp(Sp.zoom*Sp.distance/Math.max(t,20),.58,1.65),om();return}if(!$){cm(e);let t=lm()?.object.userData.catapultControl;Jf.style.cursor=t?`pointer`:``,Jf.title=t===`fire`?`Нажать кнопку запуска`:t===`turn`?`Потянуть ручку для поворота`:t===`load`?`Положить блоба в чашу`:``;return}if($.id!==e.pointerId)return;let t=e.clientX-$.x,n=e.clientY-$.y;if($.kind===`launcher-turn`){if(Math.hypot(e.clientX-$.startX,e.clientY-$.startY)>4&&($.dragged=!0),$.dragged&&(cm(e),lp.ray.intersectPlane($.turnPlane,dp))){let e=$.reference.local(dp);if(Math.hypot(e.x,e.z)>.25){let t=Math.atan2(e.z,e.x);Yp($.objectId,Ju($.turnAngle,t)),$.turnAngle=t}}$.x=e.clientX,$.y=e.clientY;return}if($.kind===`launcher-fire`||$.kind===`launcher-load`){Math.hypot(e.clientX-$.startX,e.clientY-$.startY)>10&&($.cancelled=!0,$.kind===`launcher-fire`&&(rp.get($.objectId).buttonHeld=!1));return}if($.lift)cm(e),$.lift.move(lp.ray),Fp();else if($.kind===`place`){cm(e);let t=um();t&&(hp.move(t.point.clone().normalize().toArray()),im())}else Math.hypot(e.clientX-$.startX,e.clientY-$.startY)>7&&($.kind=`orbit`),$.kind===`orbit`&&(vp-=t*.006,yp=Ot.clamp(yp+n*.006,_p?.08:-1.35,1.35),om());$.x=e.clientX,$.y=e.clientY}),Jf.addEventListener(`pointerup`,e=>{if(Ap.delete(e.pointerId),jp?.id===e.pointerId){jp=null,Jf.hasPointerCapture(e.pointerId)&&Jf.releasePointerCapture(e.pointerId);return}if(Sp){Ap.size<2&&(Sp=null);return}if(!$||$.id!==e.pointerId)return;let t=$;if($=null,t.resident&&t.resident.body.endGrab(),t.ball&&(t.ball.held=!1),t.objectId&&rp.has(t.objectId)&&(rp.get(t.objectId).buttonHeld=!1),Lp(),t.kind===`launcher-turn`&&(t.dragged||Yp(t.objectId,t.turnDirection*X.turnStep)),!t.cancelled&&t.kind===`launcher-fire`&&Jp(t.objectId),!t.cancelled&&t.kind===`launcher-load`){cm(e);let n=lm();n?.object.userData.objectId===t.objectId&&n.object.userData.catapultControl===t.control&&(Xp(t.objectId),wf(ap,np.frame(t.objectId)).some(e=>e.type===pp)?Qp(t.objectId):em(t.objectId))}t.kind===`object`&&Xp(t.objectId),Jf.hasPointerCapture(e.pointerId)&&Jf.releasePointerCapture(e.pointerId),Jf.style.cursor=``,Hp()}),Jf.addEventListener(`pointercancel`,e=>{jp?.id===e.pointerId?(jp=null,Ap.delete(e.pointerId)):dm()}),Jf.addEventListener(`lostpointercapture`,e=>{$?.id===e.pointerId&&dm()}),Jf.addEventListener(`wheel`,e=>{if(e.preventDefault(),$?.lift){$.lift.change(-e.deltaY*(e.deltaMode===1?.22:e.deltaMode===2?2:.012)),Fp();return}bp=Ot.clamp(bp+e.deltaY*7e-4,.58,1.65),om()},{passive:!1}),window.addEventListener(`keydown`,e=>{$?.lift&&(e.key===`PageUp`||e.key===`PageDown`)&&(e.preventDefault(),$.lift.change(e.key===`PageUp`?.5:-.5),Fp())}),window.addEventListener(`keydown`,e=>{e.key===`Escape`&&(dm(),am(),Zp(),Q(`catalog`).hidden=!0,Q(`help-panel`).hidden=!0),!(!e.key.startsWith(`Arrow`)||e.target instanceof HTMLInputElement)&&(e.preventDefault(),vp+=e.key===`ArrowLeft`?.12:e.key===`ArrowRight`?-.12:0,yp=Ot.clamp(yp+(e.key===`ArrowUp`?.1:e.key===`ArrowDown`?-.1:0),_p?.08:-1.35,1.35),om())});function fm(){dm(),Hp(),Cp=null,wp=0}window.addEventListener(`pagehide`,fm),window.addEventListener(`blur`,fm),document.addEventListener(`visibilitychange`,()=>{document.hidden?fm():Cp=null}),window.addEventListener(`resize`,sm),new ResizeObserver(sm).observe(Jf);function pm(e){let t=!1;for(let n of ap){let r=Mp.get(n);if(!n.flight){r&&(r.line.removeFromParent(),r.line.geometry.dispose(),r.line.material.dispose(),Mp.delete(n),t=!0);continue}if(!r){let e=new Ti(new Dr,new _i({color:Wu[n.type].color,transparent:!0,opacity:.65}));e.visible=!1,Qf.add(e),r={line:e,points:[],sample:0},Mp.set(n,r)}r.sample+=e,r.sample>.1&&(r.sample=0,r.points.push(n.body.com.clone()),r.points.length>160&&r.points.shift(),r.line.geometry.dispose(),r.line.geometry=new Dr().setFromPoints(r.points),r.line.visible=r.points.length>1)}Mp.size&&!hp&&!$&&!mp&&(Q(`hint`).textContent=`В полёте: ${Mp.size}`),t&&!Mp.size&&(Vp(`Полёт завершён`,2),!hp&&!$&&!mp&&(Q(`hint`).textContent=`Выбери катапульту, чтобы запустить ещё раз`),Hp())}function mm(e){if(requestAnimationFrame(mm),document.hidden){Cp=null;return}let t=Cp===null?0:(e-Cp)/1e3;Cp=e,Tp+=t;let n=cp.frame(e);Q(`fps`).textContent=n?`${n} FPS`:`— FPS`,wp+=Math.min(t,.08);let r=0;if(hp)wp=0;else for(;wp>=1/60&&r<5;)kf(ap,np,1/60,(e,t)=>sp.play(e,t)),wp-=1/60,r++;Op+=t,Op>=1/30&&(op.forEach(e=>e.update($f,Math.min(Op,.1))),Op=0);for(let e of Zf.objects)rp.get(e.id).update(e,np.frame(e.id),Tp);for(let e of np.floaters){let n=rp.get(e.poolId);n?.ball&&(n.ball.position.copy(e.frame.local(e.pos)),n.ball.rotation.z+=e.velocity.length()*t*.4)}mp&&np.frame(mp)?.type===`catapult`&&qp(),pm(t),hp&&im(),ep.render(Qf,$f),Ep>0&&(Ep-=t,Ep<=0&&Q(`toast`).classList.remove(`visible`)),Dp+=t,Dp>6&&(Dp=0,Hp())}Wp(),Up(),sm(),requestAnimationFrame(mm);